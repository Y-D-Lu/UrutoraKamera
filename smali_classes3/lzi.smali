...
.method private constructor <init>(J)V
    ...
    :goto_0
    iput-boolean v2, p0, Llzi;->a:Z

    const-wide v2, -0x48b164af344c099cL    # -2.7449039323390247E-42
    ...
    :goto_b
    iput-boolean v2, p0, Llzi;->u:Z

    const-wide v2, 0xfa9ec4f9092e562L
    ...
    :goto_c
    iput-boolean v2, p0, Llzi;->e:Z

    const-wide v2, 0x7797f8f46ee8bdddL    # 1.2367705031688756E268
    ...
    :goto_d
    iput-boolean v2, p0, Llzi;->f:Z

    const-wide v2, -0x1e0bd9a8f13256afL    # -7.252164780065535E163
    ...
    :goto_e
    iput-boolean v2, p0, Llzi;->g:Z

    const-wide v2, -0x55b7bd44b599e6bdL    # -5.289009149368313E-105
    ...
    :goto_f
    iput-boolean v2, p0, Llzi;->h:Z

    const-wide v2, 0x75a1c741b91fa421L    # 4.271079562535346E258
    ...
    :goto_10
    iput-boolean v2, p0, Llzi;->v:Z

    const-wide v2, -0x4dfd464d221b97d3L    # -8.682039402490598E-68
    ...
    :goto_11
    iput-boolean v2, p0, Llzi;->i:Z

    const-wide v2, -0xffe2ce2b1d1e534L    # -3.459139540238904E231
    ...
    const-wide v2, 0x378ddc0389d0e1ccL    # 4.284617931824817E-41
    ...
    :goto_13
    iput-boolean v2, p0, Llzi;->j:Z

    const-wide v2, -0x336a95b2ac133008L    # -8.603241946579695E60
    ...
    :goto_14
    iput-boolean v2, p0, Llzi;->k:Z

    const-wide v2, -0x11c581b08f71ae13L    # -9.576669495584178E222
    ...
    :goto_15
    iput-boolean v2, p0, Llzi;->l:Z

    const-wide v2, -0x549b7ccc49f081fL
    ...
    const-wide v2, -0xe8924003a5cef11L    # -3.721353008558174E238
...
.method public static a()Llzi;
    ...
    invoke-static {v1}, Llzi;->j(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-static {v2}, Llzi;->j(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v9, v8, Loyg;->a:Ljava/nio/ByteBuffer;

    invoke-virtual {v9, v7}, Ljava/nio/ByteBuffer;->putChar(C)Ljava/nio/ByteBuffer;
    ...
    iget-object v7, v7, Loyg;->a:Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {v9, v7}, Loyg;->ae([B)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v7, v8, Loyg;->a:Ljava/nio/ByteBuffer;
    ...
    iget-object v1, v8, Loyg;->a:Ljava/nio/ByteBuffer;
    ...
    iput-boolean v5, v1, Loyn;->d:Z

    iget v0, v1, Loyn;->c:I

    iget-object v3, v1, Loyn;->b:Ljava/security/MessageDigest;
...
.method public static isXiaomi12()Z
    ...
    const-string v0, "jasmine_sprout"
...
.method public final SM-G780G()Z
    .locals 2
...
.method public final is10tpro()Z
    .locals 2
...
.method public final is12tpro()Z
    .locals 2
...
.method public final isRealme9()Z
    .locals 2

    sget-object v1, Landroid/os/Build;->DEVICE:Ljava/lang/String;

    const-string v0, "RMX3392"
