...
.method public constructor <init>(Landroid/content/Context;J)V
    ...
    iput-object v0, p0, Lpmv;->a:Ljava/util/List;
    ...
    iput-object v0, p0, Lpmv;->b:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/ArrayDeque;

    invoke-direct {v0}, Ljava/util/ArrayDeque;-><init>()V

    iput-object v0, p0, Lpmv;->c:Ljava/util/Queue;
    ...
    iput-object v1, p0, Lpmv;->d:Lcom/google/mediapipe/framework/Graph;
    ...
    iget-object p1, p0, Lpmv;->d:Lcom/google/mediapipe/framework/Graph;
    ...
    :cond_0
    iget-object v1, p0, Lpmv;->d:Lcom/google/mediapipe/framework/Graph;
    ...
    :try_start_2
    invoke-virtual {v1, v0}, Lcom/google/mediapipe/framework/Graph;->d([B)V

    :goto_0
    new-instance p1, Lcom/google/mediapipe/framework/AndroidPacketCreator;

    iget-object v0, p0, Lpmv;->d:Lcom/google/mediapipe/framework/Graph;

    invoke-direct {p1, v0}, Lcom/google/mediapipe/framework/AndroidPacketCreator;-><init>(Lcom/google/mediapipe/framework/Graph;)V

    iput-object p1, p0, Lpmv;->e:Lcom/google/mediapipe/framework/AndroidPacketCreator;

    const-string p1, "input_video"

    iput-object p1, p0, Lpmv;->f:Ljava/lang/String;

    const-string p1, "output_video"

    iput-object p1, p0, Lpmv;->g:Ljava/lang/String;

    iget-object p1, p0, Lpmv;->d:Lcom/google/mediapipe/framework/Graph;

    invoke-virtual {p1, p2, p3}, Lcom/google/mediapipe/framework/Graph;->e(J)V

    iget-object p1, p0, Lpmv;->g:Ljava/lang/String;

    if-eqz p1, :cond_1

    iget-object p2, p0, Lpmv;->d:Lcom/google/mediapipe/framework/Graph;

    new-instance p3, Lpmu;

    invoke-direct {p3, p0}, Lpmu;-><init>(Lpmv;)V
    ...
    iget-object p2, p0, Lpmv;->g:Ljava/lang/String;

    invoke-virtual {p1, p2}, Lcom/google/mediapipe/framework/Graph;->g(Ljava/lang/String;)V
...
.method public final a(Lcom/google/mediapipe/framework/TextureFrame;)V
    ...
    iget-object v5, p0, Lpmv;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :try_start_1
    iget-object v5, p0, Lpmv;->c:Ljava/util/Queue;
    ...
    iget-object v8, p0, Lpmv;->c:Ljava/util/Queue;
    ...
    :try_start_3
    iget-object v6, p0, Lpmv;->e:Lcom/google/mediapipe/framework/AndroidPacketCreator;
    ...
    :try_start_4
    iget-object v3, p0, Lpmv;->d:Lcom/google/mediapipe/framework/Graph;

    iget-object v4, p0, Lpmv;->f:Ljava/lang/String;
