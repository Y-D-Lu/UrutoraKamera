...
.method public constructor <init>(Lcom/google/geo/lightfield/processing/ProgressCallback;)V
    ...
    iput-object p1, p0, Lpjg;->b:Lcom/google/geo/lightfield/processing/ProgressCallback;
...
.method public final a()V
    ...
    sget-boolean v0, Lpjg;->a:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, Lpjg;->c:Lpjf;
    ...
    sput-boolean v1, Lpjg;->a:Z

    const/4 v1, 0x2

    invoke-virtual {v0, v1}, Lpjf;->obtainMessage(I)Landroid/os/Message;

    move-result-object v1

    invoke-virtual {v0, v1}, Lpjf;->sendMessage(Landroid/os/Message;)Z

    :try_start_0
    iget-object v0, p0, Lpjg;->d:Landroid/os/Looper;
...
.method public final setProgress(F)V
    ...
    iget-object v1, v0, Lpjf;->a:Ljava/lang/ref/WeakReference;
