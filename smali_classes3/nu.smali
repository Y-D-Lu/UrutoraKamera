...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0}, Lnu;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-boolean p1, p0, Lnu;->c:Z

    invoke-virtual {p0}, Lnu;->getContext()Landroid/content/Context;
...
.method public final setCompoundDrawablesRelativeWithIntrinsicBounds(IIII)V
    ...
    invoke-static {v0, p3}, Ljr;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0, p4}, Ljr;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    :goto_3
    invoke-virtual {p0, p1, p2, p3, v1}, Lnu;->setCompoundDrawablesRelativeWithIntrinsicBounds(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method public final setCompoundDrawablesWithIntrinsicBounds(IIII)V
    ...
    :cond_3
    :goto_3
    invoke-virtual {p0, p1, p2, p3, v1}, Lnu;->setCompoundDrawablesWithIntrinsicBounds(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method public final setLineHeight(I)V
    ...
    invoke-static {p0, p1}, Lfz;->b(Landroid/widget/TextView;I)V
...
.method public final setTypeface(Landroid/graphics/Typeface;I)V
    ...
    invoke-static {v0, p1, p2}, Len;->a(Landroid/content/Context;Landroid/graphics/Typeface;I)Landroid/graphics/Typeface;
