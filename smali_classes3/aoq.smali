...
.method public final run()V
    ...
    invoke-static {v2, v5, v0}, Larn;->a(Landroid/content/Context;Ljava/lang/Class;Z)V

    iget-object v0, p0, Laoq;->b:Landroid/content/Context;

    const-class v2, Landroidx/work/impl/background/systemalarm/ConstraintProxy$BatteryChargingProxy;

    invoke-static {v0, v2, v1}, Larn;->a(Landroid/content/Context;Ljava/lang/Class;Z)V

    iget-object v0, p0, Laoq;->b:Landroid/content/Context;

    const-class v1, Landroidx/work/impl/background/systemalarm/ConstraintProxy$StorageNotLowProxy;

    invoke-static {v0, v1, v3}, Larn;->a(Landroid/content/Context;Ljava/lang/Class;Z)V

    iget-object v0, p0, Laoq;->b:Landroid/content/Context;

    const-class v1, Landroidx/work/impl/background/systemalarm/ConstraintProxy$NetworkStateProxy;

    invoke-static {v0, v1, v4}, Larn;->a(Landroid/content/Context;Ljava/lang/Class;Z)V
    :try_end_0
