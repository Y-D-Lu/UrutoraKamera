...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {p0, p2}, Lnzp;->setForeground(Landroid/graphics/drawable/Drawable;)V
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {p0}, Lnzp;->getRight()I

    move-result v4

    invoke-virtual {p0}, Lnzp;->getLeft()I

    move-result v5

    sub-int/2addr v4, v5

    invoke-virtual {p0}, Lnzp;->getBottom()I

    move-result v5

    invoke-virtual {p0}, Lnzp;->getTop()I
    ...
    :cond_0
    invoke-virtual {p0}, Lnzp;->getPaddingLeft()I

    move-result v1

    invoke-virtual {p0}, Lnzp;->getPaddingTop()I

    move-result v6

    invoke-virtual {p0}, Lnzp;->getPaddingRight()I

    move-result v7

    sub-int/2addr v4, v7

    invoke-virtual {p0}, Lnzp;->getPaddingBottom()I
...
.method protected final drawableStateChanged()V
    ...
    invoke-virtual {p0}, Lnzp;->getDrawableState()[I
...
.method protected final onLayout(ZIIII)V
    ...
    iget-boolean p2, p0, Lnzp;->b:Z

    or-int/2addr p1, p2

    iput-boolean p1, p0, Lnzp;->b:Z
...
.method public final setForeground(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, v0}, Lnzp;->unscheduleDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, v0}, Lnzp;->setWillNotDraw(Z)V
    ...
    invoke-virtual {p0, p1}, Lnzp;->setWillNotDraw(Z)V

    :cond_3
    :goto_0
    invoke-virtual {p0}, Lnzp;->requestLayout()V

    invoke-virtual {p0}, Lnzp;->invalidate()V
...
.method public final setForegroundGravity(I)V
    ...
    iget-object p1, p0, Lnzp;->c:Landroid/graphics/drawable/Drawable;
