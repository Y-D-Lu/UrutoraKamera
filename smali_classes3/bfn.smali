...
.method private final e(Lbfm;)Lbfg;
    ...
    iget-object p1, p1, Lbfm;->b:Lbfh;

    invoke-interface {p1, p0}, Lbfh;->b(Lbfn;)Lbfg;
...
.method public final declared-synchronized a(Ljava/lang/Class;Ljava/lang/Class;)Lbfg;
    ...
    iget-object v6, p0, Lbfn;->c:Ljava/util/Set;
    ...
    :cond_1
    invoke-virtual {v5, p1}, Lbfm;->a(Ljava/lang/Class;)Z

    move-result v6

    if-eqz v6, :cond_0

    iget-object v6, v5, Lbfm;->a:Ljava/lang/Class;
    ...
    invoke-direct {p0, v5}, Lbfn;->e(Lbfm;)Lbfg;
    ...
    iget-object p1, p0, Lbfn;->d:Lfc;

    new-instance p2, Lbfk;

    invoke-direct {p2, v0, p1}, Lbfk;-><init>(Ljava/util/List;Lfc;)V
    :try_end_0
    ...
    invoke-direct {v0, p1, p2}, Layf;-><init>(Ljava/lang/Class;Ljava/lang/Class;)V
    ...
    :try_start_4
    iget-object p2, p0, Lbfn;->c:Ljava/util/Set;
...
.method final declared-synchronized b(Ljava/lang/Class;)Ljava/util/List;
    ...
    :try_start_1
    iget-object v0, p0, Lbfn;->c:Ljava/util/Set;
...
.method final declared-synchronized c(Ljava/lang/Class;)Ljava/util/List;
    .locals 4
    ...
    iget-object v2, v2, Lbfm;->a:Ljava/lang/Class;
...
.method final declared-synchronized d(Ljava/lang/Class;Ljava/lang/Class;Lbfh;)V
    .locals 1
    ...
    iget-object p1, p0, Lbfn;->b:Ljava/util/List;
