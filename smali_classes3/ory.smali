...
# static fields
.field static final a:Lory;


# instance fields
.field final transient d:Loom;
...
.method public final contains(Ljava/lang/Object;)Z
    ...
    iget-object v2, p0, Lory;->b:Ljava/util/Comparator;
...
.method public final containsAll(Ljava/util/Collection;)Z
    ...
    :cond_1
    invoke-virtual {p0}, Lory;->gH()Loti;
    ...
    :goto_0
    :try_start_0
    invoke-virtual {p0, v4, v2}, Lopm;->O(Ljava/lang/Object;Ljava/lang/Object;)I
    ...
    :cond_7
    :goto_3
    invoke-super {p0, p1}, Lopm;->containsAll(Ljava/util/Collection;)Z
...
.method public final bridge synthetic descendingIterator()Ljava/util/Iterator;
    ...
    invoke-virtual {p0}, Lory;->gG()Loti;
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    :cond_2
    invoke-virtual {p0}, Lory;->isEmpty()Z
    ...
    :cond_3
    iget-object v1, p0, Lory;->b:Ljava/util/Comparator;

    invoke-static {v1, p1}, Lobr;->z(Ljava/util/Comparator;Ljava/lang/Iterable;)Z
    ...
    invoke-virtual {p0, v3, v4}, Lopm;->O(Ljava/lang/Object;Ljava/lang/Object;)I
    ...
    :cond_7
    invoke-virtual {p0, p1}, Lory;->containsAll(Ljava/util/Collection;)Z
...
.method final g(II)Lory;
    ...
    invoke-virtual {v1, p1, p2}, Loom;->b(II)Loom;

    move-result-object p1

    iget-object p2, p0, Lory;->b:Ljava/util/Comparator;

    invoke-direct {v0, p1, p2}, Lory;-><init>(Loom;Ljava/util/Comparator;)V

    return-object v0

    :cond_2
    iget-object p1, p0, Lory;->b:Ljava/util/Comparator;

    invoke-static {p1}, Lory;->Q(Ljava/util/Comparator;)Lory;
...
.method public final k()Lopm;
    ...
    iget-object v0, p0, Lory;->b:Ljava/util/Comparator;
    ...
    invoke-static {v0}, Lory;->Q(Ljava/util/Comparator;)Lory;
...
.method public final n(Ljava/lang/Object;Z)Lopm;
    ...
    invoke-virtual {p0, p2, p1}, Lory;->g(II)Lory;
...
.method public final q(Ljava/lang/Object;ZLjava/lang/Object;Z)Lopm;
    ...
    invoke-virtual {p1, p3, p4}, Lopm;->n(Ljava/lang/Object;Z)Lopm;
...
.method public final t(Ljava/lang/Object;Z)Lopm;
    ...
    invoke-virtual {p0, p1, p2}, Lory;->g(II)Lory;
