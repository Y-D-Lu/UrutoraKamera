...
.field private static final k:Llvp;
...
.method public static s(Llvp;Llzv;)[F
    ...
    sget v4, Lcom/Helper;->getSunlightFix:I
...
.method public static v(Llvp;)Lcom/google/googlex/gcam/StaticMetadata;
    ...
    const-string v0, "pref_model_key_front"

    goto :goto_0

    :cond_0
    const-string v4, "pref_aux_key"
    ...
    :goto_0
    invoke-static {v0}, Lcom/Helper;->SetDevice(Ljava/lang/String;)Ljava/lang/String;
...
.method public final j(Llzv;)Lcom/google/googlex/gcam/AwbInfo;
    ...
    sget-object v9, Lpkr;->c:Ljava/lang/String;

    const-string v0, "CaptureResult missing COLOR_CORRECTION_TRANSFORM."

    invoke-static {v9, v0}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I

    new-instance v9, Lcom/google/googlex/gcam/FloatArray9;

    invoke-direct {v9}, Lcom/google/googlex/gcam/FloatArray9;-><init>()V

    const/4 v0, 0x0

    invoke-virtual {v9, v0, v10}, Lcom/google/googlex/gcam/FloatArray9;->b(IF)V

    invoke-virtual {v9, v7, v0}, Lcom/google/googlex/gcam/FloatArray9;->b(IF)V

    const/4 v1, 0x2

    invoke-virtual {v9, v1, v0}, Lcom/google/googlex/gcam/FloatArray9;->b(IF)V

    const/4 v1, 0x3

    invoke-virtual {v9, v1, v0}, Lcom/google/googlex/gcam/FloatArray9;->b(IF)V

    invoke-virtual {v9, v8, v10}, Lcom/google/googlex/gcam/FloatArray9;->b(IF)V
    ...
    :cond_2
    invoke-static {v9}, Lpkr;->z(Landroid/hardware/camera2/params/ColorSpaceTransform;)Lcom/google/googlex/gcam/FloatArray9;
    ...
    :goto_3
    invoke-static {v5, p1}, Lcom/Fix/ColorTransform;->getPseudoCT(Lcom/google/googlex/gcam/FloatArray9;Llzv;)Lcom/google/googlex/gcam/FloatArray9;
    ...
    invoke-virtual {v5, v2, v0}, Lcom/google/googlex/gcam/FloatArray4;->d(IF)V

    const/4 v2, 0x1

    invoke-virtual {v5, v2, v10}, Lcom/google/googlex/gcam/FloatArray4;->d(IF)V
    ...
    const-string v1, "CaptureResult is present COLOR_CORRECTION_GAINS NEUTRAL."
...
.method public final m(Llzv;Lcom/google/googlex/gcam/GyroSampleVector;Ljava/util/Map;)Lcom/google/googlex/gcam/FrameMetadata;
    ...
    invoke-static {}, Lcom/NoiseModels;->NoiseModelSelector()I

    move-result v6

    invoke-static {v6}, Lcom/NoiseModels;->mode(I)V

    if-eqz v6, :cond_20

    invoke-static {v11, v2}, Lcom/NoiseModels;->j(Llvp;Llzr;)Ljava/lang/Object;
    ...
    invoke-static {v3, v2}, Lcom/Helper;->getNoiseModelerLog([Landroid/util/Pair;Llzv;)V
    ...
    invoke-static {v11}, Lcom/Helper;->getBlackLevel(Llvp;)[F

    move-result-object v0

    if-eqz v3, :cond_22

    invoke-static {v0, v3}, Lcom/Helper;->setCorrectionDBL([F[F)[F
...
.method public final p(Llzv;)Lcom/google/googlex/gcam/SpatialGainMap;
    ...
    :cond_4
    invoke-static {v1}, Lcom/SpatialGainMapValue;->getSpatialGainMap(Llzv;)Lcom/google/googlex/gcam/SpatialGainMap;
...
.method public final u(Lcom/google/googlex/gcam/FrameRequest;Llzv;Lgzs;)V
    ...
    invoke-virtual {v0, v5}, Lcom/google/googlex/gcam/FrameRequest;->setDesired_analog_gain(F)V

    invoke-virtual/range {p1 .. p1}, Lcom/google/googlex/gcam/FrameRequest;->b()F

    move-result v6

    sget v8, Lcom/Helper;->sFront:I

    if-nez v8, :cond_b

    sget v8, Lcom/Helper;->sModeNS:I

    if-eqz v8, :cond_2

    sget v8, Lcom/custom/OneShot;->OneShotState:I

    if-eqz v8, :cond_1

    const-string v8, "pref_aemode_oneshot_key"
    ...
    sput v6, Lcom/Fix/IsoTime;->sGetDesired_digital_gain:F

    invoke-static {v8}, Lcom/Fix/IsoTime;->isoTimeOneShotParametrs(I)V

    sget v4, Lcom/Fix/IsoTime;->sGetDesired_exposure_time_ms:F

    sget v5, Lcom/Fix/IsoTime;->sGetDesired_analog_gain:F

    sget v6, Lcom/Fix/IsoTime;->sGetDesired_digital_gain:F

    goto :goto_0

    :cond_1
    sget v8, Lcom/custom/Astro;->AstroState:I

    if-eqz v8, :cond_2

    const-string v8, "pref_aemode_astro_key"
    ...
    invoke-static {v8}, Lcom/Fix/IsoTime;->isoTimeAstroParametrs(I)V
    ...
    invoke-static {v8}, Lcom/Fix/IsoTime;->isoTimeParametrs(I)V
    ...
    :cond_b
    const-string v8, "pref_aemode_front_key"
    ...
    invoke-static {v8}, Lcom/Fix/IsoTime;->isoTimeFParametrs(I)V
