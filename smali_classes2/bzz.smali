...
.method public final run()V
    ...
    .line 61
    .local v0, "caaVar2":Lcaa;
    iget-object v4, v0, Lcaa;->c:Lcac;

    .line 62
    .local v4, "cacVar2":Lcac;
    ...
    new-instance v6, Ldefpackage/q1;

    invoke-direct {v6, p0, v4}, Ldefpackage/q1;-><init>(Lbzz;Lcac;)V
    ...
    .line 24
    .end local v0    # "caaVar2":Lcaa;
    .end local v3    # "bzyVar2":Lbzy;
    .end local v4    # "cacVar2":Lcac;
    :pswitch_0
    iget-object v0, p0, Lbzz;->a:Lcaa;
    ...
    .line 26
    .local v4, "cacVar":Lcac;
    invoke-virtual {v4}, Landroid/widget/FrameLayout;->animate()Landroid/view/ViewPropertyAnimator;

    move-result-object v5

    new-instance v6, Ldefpackage/p1;

    invoke-direct {v6, p0, v4}, Ldefpackage/p1;-><init>(Lbzz;Lcac;)V
    ...
    .line 42
    .local v3, "bzyVar":Lbzy;
    iget-object v5, v3, Lbzy;->c:Landroid/animation/AnimatorSet;
    ...
    iget-object v6, v3, Lbzy;->a:Landroid/widget/TextView;

    invoke-virtual {v5, v6}, Landroid/animation/AnimatorSet;->setTarget(Ljava/lang/Object;)V

    .line 44
    iget-object v6, v3, Lbzy;->c:Landroid/animation/AnimatorSet;
    ...
    iget-object v7, v3, Lbzy;->b:Landroid/widget/TextView;

    invoke-virtual {v6, v7}, Landroid/animation/AnimatorSet;->setTarget(Ljava/lang/Object;)V

    .line 46
    iget-object v7, v3, Lbzy;->g:Landroid/animation/AnimatorSet;
    ...
    .line 57
    iput-object v8, v3, Lbzy;->g:Landroid/animation/AnimatorSet;
    ...
    .local v4, "cacVar2":Lcac;
    :cond_1
    iget-object v5, v3, Lbzy;->d:Landroid/animation/AnimatorSet;
    ...
    .line 83
    iget-object v6, v3, Lbzy;->d:Landroid/animation/AnimatorSet;
    ...
    iget-object v9, v3, Lbzy;->e:Landroid/view/animation/Interpolator;
    ...
    invoke-direct {v1, v3}, Lbzx;-><init>(Lbzy;)V
