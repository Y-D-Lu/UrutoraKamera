...
.method static constructor <clinit>()V
    ...
    sget-object v0, Lj$/time/format/DateTimeFormatterBuilder$$ExternalSyntheticLambda0;->INSTANCE:Lj$/time/format/DateTimeFormatterBuilder$$ExternalSyntheticLambda0;
...
.method public static getLocalizedDateTimePattern(Lj$/time/format/FormatStyle;Lj$/time/format/FormatStyle;Lj$/time/chrono/Chronology;Ljava/util/Locale;)Ljava/lang/String;
    ...
    const-string p2, "Can\'t determine pattern from "
...
.method private parseField(CILj$/time/temporal/TemporalField;)V
    ...
    const-string v6, "Too many pattern letters: "
    ...
    invoke-direct {p3, v7}, Ljava/lang/StringBuilder;-><init>(I)V
    ...
    invoke-virtual {p0, p3, p2, v5, p1}, Lj$/time/format/DateTimeFormatterBuilder;->appendValue(Lj$/time/temporal/TemporalField;IILj$/time/format/SignStyle;)Lj$/time/format/DateTimeFormatterBuilder;
    ...
    invoke-virtual {p0, p3, v8, v8, p1}, Lj$/time/format/DateTimeFormatterBuilder;->appendValueReduced(Lj$/time/temporal/TemporalField;IILj$/time/chrono/ChronoLocalDate;)Lj$/time/format/DateTimeFormatterBuilder;
    ...
    invoke-virtual {p0, p1, p2, p2, v3}, Lj$/time/format/DateTimeFormatterBuilder;->appendFraction(Lj$/time/temporal/TemporalField;IIZ)Lj$/time/format/DateTimeFormatterBuilder;
    ...
    :cond_1f
    invoke-virtual {p0, p3, v8}, Lj$/time/format/DateTimeFormatterBuilder;->appendValue(Lj$/time/temporal/TemporalField;I)Lj$/time/format/DateTimeFormatterBuilder;
...
.method private parsePattern(Ljava/lang/String;)V
    ...
    :cond_9
    sget-object v4, Lj$/time/format/DateTimeFormatterBuilder;->FIELD_MAP:Ljava/util/Map;
    ...
    invoke-direct {p0, v2, v1, v4}, Lj$/time/format/DateTimeFormatterBuilder;->parseField(CILj$/time/temporal/TemporalField;)V
    ...
    invoke-virtual {p0, v1, v6}, Lj$/time/format/DateTimeFormatterBuilder;->appendOffset(Ljava/lang/String;Ljava/lang/String;)Lj$/time/format/DateTimeFormatterBuilder;
    ...
    invoke-virtual {p0, v1, v3}, Lj$/time/format/DateTimeFormatterBuilder;->appendOffset(Ljava/lang/String;Ljava/lang/String;)Lj$/time/format/DateTimeFormatterBuilder;
    ...
    invoke-direct {v3, v2, v1, v1, v11}, Lj$/time/format/DateTimeFormatterBuilder$WeekBasedFieldPrinterParser;-><init>(CIII)V
    ...
    invoke-virtual {p0, v5}, Lj$/time/format/DateTimeFormatterBuilder;->appendLiteral(C)Lj$/time/format/DateTimeFormatterBuilder;
