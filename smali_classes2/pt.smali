...
.method public final run()V
    ...
    invoke-direct {v3, v1, v2, v12}, Lob;-><init>(Lpy;Ljava/util/ArrayList;I)V
    ...
    iget-object v12, v13, Loi;->a:Lqs;

    iget-object v12, v12, Lqs;->a:Landroid/view/View;

    const-wide/16 v13, 0x78

    invoke-static {v12, v3, v13, v14}, Lgl;->B(Landroid/view/View;Ljava/lang/Runnable;J)V

    goto :goto_1

    .line 59
    :cond_2
    invoke-virtual {v3}, Lob;->run()V

    .line 62
    .end local v2    # "arrayList2":Ljava/util/ArrayList;
    .end local v3    # "obVar":Lob;
    :cond_3
    :goto_1
    if-eqz v8, :cond_5
    ...
    .local v18, "size":I
    invoke-static {v12, v3, v10, v11}, Lgl;->B(Landroid/view/View;Ljava/lang/Runnable;J)V
    ...
    invoke-static {v12, v3, v1, v2}, Lgl;->B(Landroid/view/View;Ljava/lang/Runnable;J)V
    ...
    .line 78
    .end local v3    # "obVar3":Lob;
    .end local v16    # "pyVar":Lpy;
    .end local v17    # "arrayList4":Ljava/util/ArrayList;
    .local v1, "pyVar":Lpy;
    :cond_b
    move-object/from16 v16, v1

    .end local v1    # "pyVar":Lpy;
    .restart local v16    # "pyVar":Lpy;
    goto :goto_6
    ...
    .local v1, "recyclerView":Landroid/support/v7/widget/RecyclerView;
    :cond_d
    iget-object v2, v0, Lpt;->a:Landroid/support/v7/widget/RecyclerView;
