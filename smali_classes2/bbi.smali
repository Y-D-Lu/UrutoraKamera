...
.method public final b(Ljava/lang/Class;)Lbcj;
    .locals 22
    .param p1, "cls"    # Ljava/lang/Class;
    ...
    iget-object v0, v1, Lbbi;->c:Laya;

    iget-object v10, v0, Laya;->c:Layi;

    .line 68
    .local v10, "ayiVar":Layi;
    iget-object v11, v1, Lbbi;->g:Ljava/lang/Class;

    .line 69
    .local v11, "cls2":Ljava/lang/Class;
    iget-object v12, v1, Lbbi;->j:Ljava/lang/Class;

    .line 70
    .local v12, "cls3":Ljava/lang/Class;
    iget-object v13, v10, Layi;->d:Lbkj;

    .line 71
    .local v13, "bkjVar":Lbkj;
    iget-object v0, v13, Lbkj;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .local v15, "bmdVar":Lbmd;
    :goto_0
    invoke-virtual {v15, v9, v11, v12}, Lbmd;->a(Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/Class;)V

    .line 76
    iget-object v2, v13, Lbkj;->b:Lwy;

    monitor-enter v2

    .line 77
    :try_start_0
    iget-object v0, v13, Lbkj;->b:Lwy;

    invoke-virtual {v0, v15}, Lxf;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 80
    iget-object v7, v10, Layi;->d:Lbkj;

    .line 81
    .local v7, "bkjVar2":Lbkj;
    ...
    iget-object v0, v10, Layi;->b:Lbkm;

    invoke-virtual {v0, v9, v11}, Lbkm;->b(Ljava/lang/Class;Ljava/lang/Class;)Ljava/util/List;
    ...
    iget-object v2, v10, Layi;->h:Ljdy;

    invoke-virtual {v2, v5, v12}, Ljdy;->q(Ljava/lang/Class;Ljava/lang/Class;)Ljava/util/List;
    ...
    iget-object v2, v10, Layi;->b:Lbkm;

    invoke-virtual {v2, v9, v5}, Lbkm;->a(Ljava/lang/Class;Ljava/lang/Class;)Ljava/util/List;

    move-result-object v17

    iget-object v2, v10, Layi;->h:Ljdy;

    invoke-virtual {v2, v5, v4}, Ljdy;->p(Ljava/lang/Class;Ljava/lang/Class;)Lbjg;

    move-result-object v18

    iget-object v2, v10, Layi;->e:Lfc;
    ...
    .end local v7    # "bkjVar2":Lbkj;
    .local v17, "bkjVar2":Lbkj;
    move-object/from16 v7, v18

    move-object/from16 v18, v8

    .end local v8    # "bcjVar":Lbcj;
    .local v18, "bcjVar":Lbcj;
    ...
    .restart local v17    # "bkjVar2":Lbkj;
    .restart local v18    # "bcjVar":Lbcj;
    const/4 v14, 0x0
    ...
    .line 94
    .local v3, "bcjVar2":Lbcj;
    iget-object v4, v10, Layi;->d:Lbkj;

    .line 95
    .local v4, "bkjVar3":Lbkj;
    iget-object v5, v4, Lbkj;->b:Lwy;

    monitor-enter v5

    .line 96
    :try_start_1
    iget-object v0, v4, Lbkj;->b:Lwy;

    new-instance v2, Lbmd;

    invoke-direct {v2, v9, v11, v12}, Lbmd;-><init>(Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/Class;)V
    ...
    :cond_6
    sget-object v6, Lbkj;->a:Lbcj;

    :goto_4
    invoke-virtual {v0, v2, v6}, Lxf;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 78
    .end local v1    # "arrayList":Ljava/util/ArrayList;
    .end local v3    # "bcjVar2":Lbcj;
    .end local v4    # "bkjVar3":Lbkj;
    .end local v17    # "bkjVar2":Lbkj;
    .end local v18    # "bcjVar":Lbcj;
    :catchall_1
    move-exception v0
...
.method public final e()Ljava/util/List;
    ...
    .line 121
    .local v3, "bffVar":Lbff;
    iget-object v4, p0, Lbbi;->b:Ljava/util/List;

    iget-object v5, v3, Lbff;->a:Lazp;
    ...
    :goto_1
    iget-object v5, v3, Lbff;->b:Ljava/util/List;
    ...
    iget-object v6, v3, Lbff;->b:Ljava/util/List;
