...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lnxd;->a:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lnxd;->b:Landroid/graphics/Rect;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, Lnxd;->a:Landroid/graphics/Rect;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lnxd;->b:Landroid/graphics/Rect;
...
.method public final B(Landroid/view/View;)I
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lnxd;->x(Landroid/view/View;)F
    ...
    invoke-static {p1, v1, v0}, Laao;->d(III)I
...
.method protected final X(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)V
    ...
    invoke-virtual {p0, v0}, Lnxd;->z(Ljava/util/List;)Landroid/view/View;
    ...
    iget-object v5, p0, Lnxd;->a:Landroid/graphics/Rect;
    ...
    iget v7, v1, Laah;->bottomMargin:I

    sub-int/2addr v6, v7

    invoke-virtual {v5, v2, v3, v4, v6}, Landroid/graphics/Rect;->set(IIII)V

    iget-object v2, p1, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->f:Lgy;
    ...
    :cond_0
    iget-object p1, p0, Lnxd;->b:Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, v0}, Lnxd;->B(Landroid/view/View;)I
