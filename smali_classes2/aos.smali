...
.method public constructor <init>(Landroid/content/Context;ILjava/lang/String;Laox;)V
    ...
    iput-object v0, p0, Laos;->h:Ljava/lang/Object;
    ...
    iget-object v1, p4, Laox;->j:Laso;

    invoke-direct {v0, p1, v1, p0}, Lapd;-><init>(Landroid/content/Context;Laso;Lapc;)V

    iput-object v0, p0, Laos;->e:Lapd;
...
.method private final d()V
    ...
    iget-object v5, p0, Laos;->f:Landroid/os/PowerManager$WakeLock;
    ...
    iget-object v7, p0, Laos;->c:Ljava/lang/String;
...
.method public final a(Ljava/lang/String;Z)V
    ...
    invoke-static {v1}, Laoo;->b(Landroid/content/Context;)Landroid/content/Intent;
...
.method public final c()V
    ...
    iget-object v6, p0, Laos;->c:Ljava/lang/String;
    ...
    .line 82
    iget-object v2, p0, Laos;->a:Landroid/content/Context;

    iget-object v5, p0, Laos;->c:Ljava/lang/String;

    invoke-static {v2, v5}, Laoo;->f(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;

    move-result-object v2

    .line 83
    .local v2, "f":Landroid/content/Intent;
    iget-object v5, p0, Laos;->d:Laox;

    .line 84
    .local v5, "aoxVar":Laox;
    new-instance v6, Laou;

    iget v7, p0, Laos;->b:I

    invoke-direct {v6, v5, v2, v7}, Laou;-><init>(Laox;Landroid/content/Intent;I)V

    invoke-virtual {v5, v6}, Laox;->d(Ljava/lang/Runnable;)V

    .line 85
    iget-object v6, p0, Laos;->d:Laox;

    iget-object v6, v6, Laox;->d:Lann;

    iget-object v7, p0, Laos;->c:Ljava/lang/String;

    invoke-virtual {v6, v7}, Lann;->f(Ljava/lang/String;)Z
    ...
    iget-object v8, p0, Laos;->c:Ljava/lang/String;
    ...
    .line 89
    iget-object v3, p0, Laos;->a:Landroid/content/Context;

    iget-object v4, p0, Laos;->c:Ljava/lang/String;

    invoke-static {v3, v4}, Laoo;->e(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;

    move-result-object v3

    .line 90
    .local v3, "e":Landroid/content/Intent;
    iget-object v4, p0, Laos;->d:Laox;

    .line 91
    .local v4, "aoxVar2":Laox;
    new-instance v7, Laou;

    iget v8, p0, Laos;->b:I

    invoke-direct {v7, v4, v3, v8}, Laou;-><init>(Laox;Landroid/content/Intent;I)V

    invoke-virtual {v4, v7}, Laox;->d(Ljava/lang/Runnable;)V

    .line 92
    .end local v3    # "e":Landroid/content/Intent;
    .end local v4    # "aoxVar2":Laox;
    ...
    .end local v5    # "aoxVar":Laox;
    .end local v6    # "l3":Lkus;
    :goto_0
    goto :goto_1
...
.method public final e(Ljava/util/List;)V
    ...
    iget-object v4, v4, Laox;->d:Lann;

    iget-object v5, p0, Laos;->c:Ljava/lang/String;

    invoke-virtual {v4, v5}, Lann;->g(Ljava/lang/String;)Z
    ...
    iget-object v4, v4, Laox;->c:Lasb;

    .line 118
    .local v4, "asbVar":Lasb;
    iget-object v5, p0, Laos;->c:Ljava/lang/String;

    .line 119
    .local v5, "str":Ljava/lang/String;
    iget-object v6, v4, Lasb;->d:Ljava/lang/Object;
    ...
    .line 123
    invoke-virtual {v4, v5}, Lasb;->a(Ljava/lang/String;)V

    .line 124
    new-instance v2, Lasa;

    invoke-direct {v2, v4, v5}, Lasa;-><init>(Lasb;Ljava/lang/String;)V

    .line 125
    .local v2, "asaVar":Lasa;
    iget-object v3, v4, Lasb;->b:Ljava/util/Map;

    invoke-interface {v3, v5, v2}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 126
    iget-object v3, v4, Lasb;->c:Ljava/util/Map;

    invoke-interface {v3, v5, p0}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 127
    iget-object v3, v4, Lasb;->a:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    .end local v2    # "asaVar":Lasa;
    .end local v7    # "l2":Lkus;
    monitor-exit v6

    .line 129
    .end local v4    # "asbVar":Lasb;
    .end local v5    # "str":Ljava/lang/String;
    goto :goto_0

    .line 128
    .restart local v4    # "asbVar":Lasb;
