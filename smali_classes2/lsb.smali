...
.method public final b(Ljava/lang/Object;)V
    ...
    invoke-direct {v5, v6}, Llvl;-><init>(Landroid/hardware/camera2/params/OutputConfiguration;)V

    invoke-direct {v4, v5}, Llzw;-><init>(Llzx;)V
    ...
    iget-object v4, p0, Llsb;->e:Llsc;

    iget-object v4, v4, Llsc;->c:Lljf;
    ...
    :cond_0
    :try_start_1
    iget-object v2, p0, Llsb;->e:Llsc;

    iget-object v2, v2, Llsc;->a:Lltv;

    iget-object v3, p0, Llsb;->a:Llsp;

    invoke-virtual {v2, v3}, Lltv;->d(Llsp;)V
    ...
    invoke-virtual {v2, v3, v1}, Lltv;->a(Llsp;Ljava/util/Collection;)V

    .line 49
    iget-object v2, p0, Llsb;->b:Llzp;

    iget-object v3, p0, Llsb;->a:Llsp;

    iget-object v4, p0, Llsb;->c:Landroid/os/Handler;

    invoke-interface {v2, v0, v3, v4}, Llzp;->f(Ljava/util/List;Llzn;Landroid/os/Handler;)V

    .line 50
    iget-object v2, p0, Llsb;->e:Llsc;

    iget-object v2, v2, Llsc;->c:Lljf;
    :try_end_1
    ...
    iget-object v3, p0, Llsb;->d:Llap;

    invoke-virtual {v3}, Llap;->close()V

    .line 53
    iget-object v3, p0, Llsb;->e:Llsc;

    iget-object v3, v3, Llsc;->c:Lljf;
