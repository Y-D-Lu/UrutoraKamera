...
.field public static final b:Lkng;
...
.method public final a()Lkvk;
    ...
    .line 21
    iget-object v0, p0, Lkij;->j:Lkim;

    .line 22
    .local v0, "kimVar":Lkim;
    iget-object v1, p0, Lkij;->c:Landroid/content/Context;

    .line 23
    .local v1, "context":Landroid/content/Context;
    invoke-virtual {p0}, Lkfq;->b()I

    move-result v2

    .line 24
    .local v2, "b2":I
    sget-object v3, Lkgd;->a:Lknw;

    const-string v4, "Signing out"

    invoke-virtual {v3, v4}, Lknw;->b(Ljava/lang/String;)V

    .line 25
    invoke-static {v1}, Lkgd;->a(Landroid/content/Context;)V
    ...
    .line 28
    .local v3, "kivVar":Lkiv;
    new-instance v4, Lklf;

    invoke-direct {v4, v0}, Lklf;-><init>(Lkim;)V

    .line 29
    .local v4, "klfVar":Lcom/google/android/gms/common/api/internal/BasePendingResult;
    invoke-virtual {v4, v3}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->j(Lkiv;)V
    ...
    invoke-direct {v3, v0}, Lkfz;-><init>(Lkim;)V

    .line 33
    .local v3, "kfzVar":Lkfz;
    invoke-virtual {v0, v3}, Lkim;->c(Lkji;)V
    ...
    .local v3, "basePendingResult":Lcom/google/android/gms/common/api/internal/BasePendingResult;
    :goto_0
    invoke-static {v3}, Lmip;->dw(Lkip;)Lkvk;
...
.method public final declared-synchronized b()I
    ...
    .line 41
    iget-object v0, p0, Lkij;->c:Landroid/content/Context;
    ...
    .line 43
    .local v1, "khmVar":Lkhm;
    const v2, 0xbdfcb8

    invoke-virtual {v1, v0, v2}, Lkhn;->f(Landroid/content/Context;I)I
    ...
    .line 46
    .end local p0    # "this":Lkfq;
    :cond_0
    const/4 v3, 0x0

    invoke-virtual {v1, v0, v2, v3}, Lkhn;->g(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {v0, v3}, Lkor;->a(Landroid/content/Context;Ljava/lang/String;)I
