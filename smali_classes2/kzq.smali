...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;Lkik;Lkil;Lkmf;)V
    ...
    invoke-direct {v3, v4}, Lnvb;-><init>([C)V

    iput-object v3, p0, Lkzq;->u:Lnvb;
...
.method public final h(Lklw;)V
    ...
    .line 109
    iget-object v4, p0, Lkmb;->c:Landroid/content/Context;
    ...
    invoke-static {v4, v5, v6}, Lmip;->cf(Landroid/content/Context;Landroid/content/Intent;I)Landroid/app/PendingIntent;

    move-result-object v6

    invoke-virtual {p0, p1, v0, v6}, Lkmb;->y(Lklw;ILandroid/app/PendingIntent;)V
    :try_end_0
    ...
    invoke-virtual {p0, p1, v1, v2}, Lkmb;->y(Lklw;ILandroid/app/PendingIntent;)V
    ...
    :cond_3
    :goto_0
    invoke-super {p0, p1}, Lkmb;->h(Lklw;)V
...
.method public final x(ILandroid/os/IBinder;Landroid/os/Bundle;I)V
    ...
    .line 139
    iget-object v0, p0, Lkzq;->u:Lnvb;

    invoke-virtual {v0, p2}, Lnvb;->d(Landroid/os/IBinder;)V

    .line 140
    iget-object v0, p0, Lkzq;->v:Lnvb;

    invoke-virtual {v0, p2}, Lnvb;->d(Landroid/os/IBinder;)V

    .line 141
    iget-object v0, p0, Lkzq;->w:Lnvb;

    invoke-virtual {v0, p2}, Lnvb;->d(Landroid/os/IBinder;)V

    .line 142
    iget-object v0, p0, Lkzq;->x:Lnvb;

    invoke-virtual {v0, p2}, Lnvb;->d(Landroid/os/IBinder;)V

    .line 143
    iget-object v0, p0, Lkzq;->a:Lnvb;

    invoke-virtual {v0, p2}, Lnvb;->d(Landroid/os/IBinder;)V

    .line 144
    iget-object v0, p0, Lkzq;->y:Lnvb;

    invoke-virtual {v0, p2}, Lnvb;->d(Landroid/os/IBinder;)V

    .line 145
    iget-object v0, p0, Lkzq;->z:Lnvb;
    ...
    .line 150
    :cond_0
    invoke-super {p0, p1, p2, p3, p4}, Lkmb;->x(ILandroid/os/IBinder;Landroid/os/Bundle;I)V
