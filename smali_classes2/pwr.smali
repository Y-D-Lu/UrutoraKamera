...
.method public final onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    iget-object v1, p0, Lpwr;->a:Lcom/google/vr/ndk/base/DaydreamApi;
    ...
    .line 29
    .local v2, "pxkVar":Lpxk;
    if-nez p2, :cond_0

    .line 30
    const/4 v3, 0x0

    .local v3, "pxmVar":Lpxm;
    goto :goto_1

    .line 32
    .end local v3    # "pxmVar":Lpxm;
    :cond_0
    ...
    invoke-direct {v4, p2}, Lpxm;-><init>(Landroid/os/IBinder;)V
    ...
    .local v3, "pxmVar":Lpxm;
    :goto_1
    iput-object v3, v1, Lcom/google/vr/ndk/base/DaydreamApi;->e:Lpxm;

    .line 37
    :try_start_0
    iget-object v4, p0, Lpwr;->a:Lcom/google/vr/ndk/base/DaydreamApi;

    .line 38
    .local v4, "daydreamApi2":Lcom/google/vr/ndk/base/DaydreamApi;
    iget-object v5, v4, Lcom/google/vr/ndk/base/DaydreamApi;->e:Lpxm;

    .line 39
    .local v5, "pxmVar2":Lpxm;
    const/4 v6, 0x2
    ...
    invoke-virtual {v5, v6, v7}, Lbmn;->y(ILandroid/os/Parcel;)Landroid/os/Parcel;
    ...
    invoke-direct {v9, v7}, Lpxk;-><init>(Landroid/os/IBinder;)V
    ...
    .line 46
    iput-object v2, v4, Lcom/google/vr/ndk/base/DaydreamApi;->f:Lpxk;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    .line 49
    .end local v4    # "daydreamApi2":Lcom/google/vr/ndk/base/DaydreamApi;
    .end local v5    # "pxmVar2":Lpxm;
    ...
    .end local v5    # "i":I
    :cond_5
    iget-object v5, p0, Lpwr;->a:Lcom/google/vr/ndk/base/DaydreamApi;
