...
.method private final w(Llzv;)Lojc;
    ...
    invoke-static {v3, v5}, Lbpv;->a(ILandroid/graphics/Rect;)Lbpv;
    ...
    :cond_3
    iget-object v2, v0, Lbof;->d:Lkoq;

    .line 38
    .local v2, "koqVar":Lkoq;
    iget v5, v2, Lkoq;->b:I
    ...
    .line 48
    .end local v9    # "ojcVar":Lojc;
    :cond_5
    sget-object v9, Loih;->a:Loih;

    .line 49
    .local v9, "ojcVar3":Lojc;
    array-length v10, v8
    ...
    invoke-static {v8, v10}, Lbpv;->a(ILandroid/graphics/Rect;)Lbpv;
    ...
    invoke-interface {v1, v11}, Llzr;->d(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-static {v3, v4}, Lbpv;->a(ILandroid/graphics/Rect;)Lbpv;
...
.method public final b(Llzv;)V
    ...
    :goto_0
    invoke-static/range {v16 .. v16}, Lhkd;->a(I)Lhkd;
    ...
    .line 145
    invoke-virtual/range {p0 .. p1}, Lbof;->a(Llzv;)Z

    move-result v19

    .line 146
    .local v19, "a2":Z
    invoke-direct/range {p0 .. p1}, Lbof;->w(Llzv;)Lojc;
    ...
    .end local v7    # "i":Lojc;
    :cond_5
    iget-object v7, v0, Lbof;->a:Lggz;

    .line 155
    .local v7, "ggzVar":Lggz;
    ...
    iget-object v8, v8, Lbpv;->b:Landroid/graphics/Rect;
    ...
    invoke-virtual {v9, v10}, Lnle;->k(Landroid/graphics/PointF;)Landroid/graphics/PointF;
    ...
    .line 159
    .local v2, "gglVar":Lggl;
    const/4 v3, 0x0

    invoke-virtual {v2, v3}, Lggl;->a(Z)V
    ...
    iput-object v10, v2, Lggl;->b:Ljava/lang/Integer;

    .line 161
    iput-object v1, v2, Lggl;->a:Landroid/graphics/PointF;
    ...
    .line 164
    iget-object v3, v2, Lggl;->a:Landroid/graphics/PointF;

    .line 165
    .local v3, "pointF2":Landroid/graphics/PointF;
    if-eqz v3, :cond_c

    iget-object v9, v2, Lggl;->b:Ljava/lang/Integer;
    ...
    iget-object v9, v2, Lggl;->c:Ljava/lang/Boolean;
    ...
    iget-object v5, v2, Lggl;->c:Ljava/lang/Boolean;

    invoke-virtual {v5}, Ljava/lang/Boolean;->booleanValue()Z

    move-result v5

    invoke-direct {v9, v3, v1, v5}, Lggm;-><init>(Landroid/graphics/PointF;IZ)V
    ...
    iget-object v3, v3, Lbpv;->b:Landroid/graphics/Rect;
    ...
    :goto_3
    iget-object v10, v0, Lbof;->c:Lggo;
    ...
    invoke-direct/range {v5 .. v11}, Lggn;-><init>(Lhkc;Lhkd;FZLojc;I)V

    invoke-virtual {v2, v0}, Lggo;->fB(Ljava/lang/Object;)V

    goto :goto_5

    .line 165
    .end local v21    # "w2":Lojc;
    ...
    iget-object v1, v2, Lggl;->a:Landroid/graphics/PointF;
    ...
    .line 170
    :cond_d
    iget-object v1, v2, Lggl;->b:Ljava/lang/Integer;
    ...
    .line 173
    :cond_e
    iget-object v1, v2, Lggl;->c:Ljava/lang/Boolean;
    ...
    .end local v17    # "a":Lhkd;
    .end local v18    # "f2":Ljava/lang/Float;
    .end local v19    # "a2":Z
    .end local v20    # "w":Lojc;
