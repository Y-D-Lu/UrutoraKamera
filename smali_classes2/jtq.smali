...
# direct methods
.method public constructor <init>(Ljts;Landroid/net/Uri;I)V
    .locals 0
    .param p1, "jtsVar"    # Ljts;
...
.method public final run()V
    ...
    .line 44
    .local v0, "jtsVar2":Ljts;
    iget-object v1, p0, Ljtq;->b:Landroid/net/Uri;

    .line 45
    .local v1, "uri2":Landroid/net/Uri;
    iget-object v2, v0, Ljts;->a:Ljtt;

    .line 46
    .local v2, "jttVar2":Ljtt;
    invoke-static {}, Llar;->b()V

    .line 47
    invoke-virtual {v2, v1}, Ljtt;->a(Landroid/net/Uri;)Ljava/lang/Long;
    ...
    .line 27
    .end local v0    # "jtsVar2":Ljts;
    .end local v1    # "uri2":Landroid/net/Uri;
    .end local v2    # "jttVar2":Ljtt;
    :pswitch_0
    iget-object v0, p0, Ljtq;->a:Ljts;

    .line 28
    .local v0, "jtsVar":Ljts;
    iget-object v1, p0, Ljtq;->b:Landroid/net/Uri;
    ...
    .line 35
    :cond_0
    iget-object v4, v2, Ljtu;->c:Landroid/app/DownloadManager;
    ...
    .line 36
    iget-object v4, v2, Ljtt;->b:Ljava/lang/Object;

    monitor-enter v4

    .line 37
    :try_start_0
    iget-object v5, v2, Ljtt;->a:Landroid/content/SharedPreferences;
    ...
    iget-object v5, v2, Ljtu;->d:Landroid/content/Context;
    ...
    .line 52
    iget-object v4, v2, Ljtu;->d:Landroid/content/Context;
    ...
    iget-object v6, v2, Ljtt;->b:Ljava/lang/Object;

    monitor-enter v6

    .line 57
    :try_start_1
    iget-object v7, v2, Ljtt;->a:Landroid/content/SharedPreferences;
