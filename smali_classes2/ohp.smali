...
.method public final a()Lohq;
    ...
    iget-object v1, p0, Lohp;->b:Ljava/time/Duration;
    ...
    iget-object v1, p0, Lohp;->h:Ljava/time/Duration;
    ...
    iget-object v2, p0, Lohp;->a:Ljava/lang/Boolean;

    invoke-virtual {v2}, Ljava/lang/Boolean;->booleanValue()Z

    move-result v4

    iget-object v5, p0, Lohp;->b:Ljava/time/Duration;

    iget-object v2, p0, Lohp;->c:Ljava/lang/Integer;

    invoke-virtual {v2}, Ljava/lang/Integer;->intValue()I

    move-result v6

    iget-object v2, p0, Lohp;->d:Ljava/lang/Integer;

    invoke-virtual {v2}, Ljava/lang/Integer;->intValue()I

    move-result v7

    iget-object v2, p0, Lohp;->e:Ljava/lang/Integer;

    invoke-virtual {v2}, Ljava/lang/Integer;->intValue()I

    move-result v8

    iget-object v2, p0, Lohp;->f:Ljava/lang/Integer;

    invoke-virtual {v2}, Ljava/lang/Integer;->intValue()I

    move-result v9

    iget-object v2, p0, Lohp;->g:Ljava/lang/Integer;

    invoke-virtual {v2}, Ljava/lang/Integer;->intValue()I

    move-result v10

    iget-object v11, p0, Lohp;->h:Ljava/time/Duration;

    move-object v2, v1

    invoke-direct/range {v2 .. v11}, Lohq;-><init>(IZLjava/time/Duration;IIIIILjava/time/Duration;)V
    ...
    iget-object v2, p0, Lohp;->i:Ljava/lang/Integer;
    ...
    .line 28
    :cond_3
    iget-object v2, p0, Lohp;->b:Ljava/time/Duration;
    ...
    .line 46
    :cond_9
    iget-object v2, p0, Lohp;->h:Ljava/time/Duration;
...
.method public final b(I)V
    ...
    iput-object v0, p0, Lohp;->i:Ljava/lang/Integer;
