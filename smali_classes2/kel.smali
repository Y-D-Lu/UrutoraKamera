...
.method public final C()V
    ...
    invoke-virtual {v0, v1, v2}, Lkfm;->c(J)Z
    ...
    .line 73
    .local v1, "kecVar":Lkec;
    iget-object v2, v1, Lkec;->b:Lked;

    .line 74
    .local v2, "kedVar2":Lked;
    invoke-static {}, Lkdo;->a()V
    ...
    invoke-virtual {v4}, Lkdt;->d()Landroid/content/Context;
    ...
    .line 82
    .local v12, "keyVar":Lkey;
    const/4 v13, 0x0

    :try_start_0
    iput-object v13, v1, Lkec;->c:Lkey;
    ...
    invoke-virtual/range {v5 .. v10}, Lknx;->c(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z

    move-result v5

    .line 85
    .local v5, "c":Z
    iget-object v6, v1, Lkec;->b:Lked;
    ...
    invoke-virtual {v6, v7, v8}, Lkdt;->r(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    :cond_1
    :try_start_1
    sget-object v7, Lkeu;->y:Lket;

    invoke-virtual {v7}, Lket;->a()Ljava/lang/Object;
    ...
    :try_start_2
    iget-object v8, v1, Lkec;->b:Lked;

    const-string v9, "Wait for service connect was interrupted"

    invoke-virtual {v8, v9}, Lkdt;->t(Ljava/lang/String;)V
    ...
    .line 95
    iget-object v6, v1, Lkec;->c:Lkey;

    .line 96
    .local v6, "keyVar2":Lkey;
    iput-object v13, v1, Lkec;->c:Lkey;
    ...
    .line 106
    :cond_3
    iput-object v12, v0, Lked;->c:Lkey;
    ...
    .line 109
    .end local v1    # "kecVar":Lkec;
    .end local v2    # "kedVar2":Lked;
    .end local v3    # "intent":Landroid/content/Intent;
    .end local v4    # "d":Landroid/content/Context;
    .end local v11    # "a":Lknx;
    :cond_4
    :goto_2
    ...
    .line 110
    iget-object v1, p0, Lkel;->k:Lkfm;

    invoke-virtual {v1}, Lkfm;->a()V
...
.method public final F()V
    ...
    .line 205
    .local v1, "j":J
    invoke-virtual/range {p0 .. p0}, Lkel;->b()J
    ...
    .line 207
    iget-object v3, v0, Lkel;->h:Lkfb;

    invoke-virtual {v3}, Lkfb;->c()V
    ...
    .line 213
    .local v3, "kfbVar":Lkfb;
    invoke-virtual {v3}, Lkfb;->b()V

    .line 214
    iget-boolean v4, v3, Lkfb;->c:Z

    if-nez v4, :cond_1

    .line 215
    invoke-virtual {v3}, Lkfb;->a()Landroid/content/Context;
    ...
    .line 220
    invoke-virtual {v3}, Lkfb;->d()Z

    move-result v8

    iput-boolean v8, v3, Lkfb;->d:Z

    .line 221
    iget-object v8, v3, Lkfb;->b:Lkdx;

    invoke-virtual {v8}, Lkdx;->d()Lkfa;

    move-result-object v8

    iget-boolean v9, v3, Lkfb;->d:Z
    ...
    invoke-virtual {v8, v10, v9}, Lkdt;->r(Ljava/lang/String;Ljava/lang/Object;)V

    .line 222
    const/4 v8, 0x1

    iput-boolean v8, v3, Lkfb;->c:Z

    .line 224
    .end local v4    # "a":Landroid/content/Context;
    .end local v7    # "intentFilter":Landroid/content/IntentFilter;
    :cond_1
    iget-object v4, v0, Lkel;->h:Lkfb;

    .line 225
    .local v4, "kfbVar2":Lkfb;
    iget-boolean v7, v4, Lkfb;->c:Z

    if-nez v7, :cond_2

    .line 226
    iget-object v7, v4, Lkfb;->b:Lkdx;

    invoke-virtual {v7}, Lkdx;->d()Lkfa;

    move-result-object v7

    const-string v8, "Connectivity unknown. Receiver not registered"

    invoke-virtual {v7, v8}, Lkdt;->t(Ljava/lang/String;)V

    .line 228
    :cond_2
    iget-boolean v7, v4, Lkfb;->d:Z
    ...
    .line 230
    invoke-direct/range {p0 .. p0}, Lkel;->I()V

    .line 231
    return-void

    .line 234
    .end local v3    # "kfbVar":Lkfb;
    .end local v4    # "kfbVar2":Lkfb;
    :cond_3
    invoke-direct/range {p0 .. p0}, Lkel;->I()V
    ...
    invoke-virtual {v0, v12, v11}, Lkdt;->r(Ljava/lang/String;Ljava/lang/Object;)V

    .line 246
    iget-object v11, v0, Lkel;->j:Lkep;

    invoke-virtual {v11}, Lkep;->e()Z
    ...
    .line 247
    iget-object v5, v0, Lkel;->j:Lkep;

    invoke-virtual {v5, v9, v10}, Lkep;->d(J)V
    ...
    .line 251
    .local v11, "kepVar":Lkep;
    iget-wide v12, v11, Lkep;->d:J
    ...
    .end local v12    # "abs":J
    :cond_7
    iget-object v12, v11, Lkep;->b:Lkdx;

    .line 255
    .local v12, "kdxVar":Lkdx;
    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v13

    iget-wide v5, v11, Lkep;->d:J
    ...
    .line 259
    .local v5, "kepVar2":Lkep;
    invoke-virtual {v5}, Lkep;->e()Z
    ...
    .line 266
    :cond_9
    iget-object v6, v5, Lkep;->b:Lkdx;

    .line 267
    .local v6, "kdxVar2":Lkdx;
    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J
    ...
    .end local v1    # "max":J
    .local v18, "max":J
    invoke-virtual {v5}, Lkep;->b()Landroid/os/Handler;

    move-result-object v1

    iget-object v2, v5, Lkep;->c:Ljava/lang/Runnable;
    ...
    invoke-virtual {v1, v3, v2}, Lkdt;->o(Ljava/lang/String;Ljava/lang/Object;)V

    .line 276
    return-void

    .line 205
    .end local v5    # "kepVar2":Lkep;
    .end local v6    # "kdxVar2":Lkdx;
    .end local v7    # "b2":J
    .end local v9    # "min":J
    .end local v11    # "kepVar":Lkep;
    .end local v12    # "abs":J
    .end local v14    # "j":J
    .end local v18    # "max":J
    .end local v20    # "b":J
    ...
    .end local v1    # "j":J
    :cond_d
    iget-object v1, v0, Lkel;->h:Lkfb;

    invoke-virtual {v1}, Lkfb;->c()V
