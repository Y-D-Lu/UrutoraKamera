...
.method private final d(Ljava/lang/String;Ljava/lang/String;Lojz;)V
    ...
    .line 34
    iget-object v1, p0, Ldgt;->d:Ljava/util/Map;
...
.method public final a(Ldgs;ZLdgr;)Landroid/database/Cursor;
    ...
    .param p2, "z"    # Z
    .param p3, "dgrVar"    # Ldgr;

    .line 40
    invoke-interface/range {p1 .. p1}, Lojz;->a()Ljava/lang/Object;
    ...
    .line 47
    .local v8, "ijsVar":Lijs;
    new-instance v9, Ljava/util/ArrayList;

    iget-object v10, v8, Lijs;->n:[Ljava/lang/Enum;
    ...
    iget-wide v11, v8, Lijs;->m:J

    const-string v13, "TIMING_CREATION"

    invoke-static {v13, v10, v11, v12}, Lijm;->a(Ljava/lang/String;IJ)Lijm;
    ...
    .local v17, "length":I
    invoke-virtual {v8, v13}, Lijs;->g(Ljava/lang/Enum;)J

    move-result-wide v10

    invoke-static {v14, v15, v10, v11}, Lijm;->a(Ljava/lang/String;IJ)Lijm;
    ...
    invoke-interface {v15, v0, v14, v13}, Ldgr;->a(Ljava/util/List;ILijm;)Z
    ...
    .end local v1    # "i":I
    .local v19, "i":I
    iget-object v1, v13, Lijm;->a:Ljava/lang/String;
    ...
    .end local v7    # "i2":I
    .end local v8    # "ijsVar":Lijs;
    .local v20, "i2":I
    .local v21, "ijsVar":Lijs;
    iget-wide v7, v13, Lijm;->c:J
    ...
    .end local v19    # "i":I
    .end local v20    # "i2":I
    .end local v21    # "ijsVar":Lijs;
    .end local v22    # "arrayList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ldefpackage/ijm;>;"
    .local v0, "a2":Ljava/util/List;
    .local v1, "i":I
    .local v7, "i2":I
    .restart local v8    # "ijsVar":Lijs;
    .local v9, "arrayList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ldefpackage/ijm;>;"
    .restart local v10    # "i4":I
    :cond_3
    move-object/from16 v18, v0
...
.method public final b(Ljava/lang/String;Ljava/lang/Class;Ldgs;)V
    ...
    invoke-direct {v1, p0, p3}, Ldefpackage/r5;-><init>(Ldgt;Ldgs;)V
    ...
    iget-object v2, p0, Ldgt;->f:Ljava/lang/String;
    ...
    new-instance v5, Ldefpackage/t5;

    invoke-direct {v5, p0, p3, v1}, Ldefpackage/t5;-><init>(Ldgt;Ldgs;Ljava/lang/Object;)V

    invoke-direct {p0, v2, v4, v5}, Ldgt;->d(Ljava/lang/String;Ljava/lang/String;Lojz;)V
    ...
    .line 111
    :cond_0
    iget-object v0, p0, Ldgt;->e:Ljava/util/Map;
