...
.method public constructor <init>(Lodu;[B)V
    ...
    iput-object v0, p0, Lniq;->c:Ljava/lang/Object;
    ...
    invoke-direct {v0, v1}, Lnit;-><init>([B)V

    iput-object v0, p0, Lniq;->b:Lnji;

    .line 21
    iget-object v0, p1, Lodu;->a:Landroid/content/Context;

    iput-object v0, p0, Lniq;->a:Landroid/content/Context;
...
.method private static final i()V
    ...
    throw v0
    :try_end_0
    .catch Lniw; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final a(Landroid/net/Uri;)Landroid/net/Uri;
    ...
    .line 40
    invoke-virtual {p0, p1}, Lniq;->c(Landroid/net/Uri;)Ljava/io/File;
    ...
    invoke-static {v3}, Lnje;->b(Ljava/util/List;)Ljava/lang/String;
    ...
    .end local p0    # "this":Lniq;
    .end local p1    # "uri":Landroid/net/Uri;
    throw v0
    :try_end_0
    .catch Lnix; {:try_start_0 .. :try_end_0} :catch_0

    .line 48
    .restart local p0    # "this":Lniq;
...
.method public final c(Landroid/net/Uri;)Ljava/io/File;
    ...
    .line 66
    iget-object v1, p0, Lniq;->a:Landroid/content/Context;
    ...
    invoke-direct {v3, v4}, Lnix;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v3, v6}, Lnix;-><init>(Ljava/lang/String;)V
    ...
    throw v3
    :try_end_1
    .catch Lnix; {:try_start_1 .. :try_end_1} :catch_1
    ...
    throw v3
    :try_end_2
    .catch Lnix; {:try_start_2 .. :try_end_2} :catch_2
    ...
    :try_end_3
    .catch Lnix; {:try_start_3 .. :try_end_3} :catch_6
    ...
    invoke-static {v1}, Lmyw;->d(Landroid/content/Context;)Ljava/io/File;
    ...
    invoke-static {v5}, Lnip;->a(Ljava/lang/String;)Landroid/accounts/Account;

    move-result-object v5

    invoke-static {v5}, Lnip;->c(Landroid/accounts/Account;)Z
    ...
    :cond_9
    :try_start_5
    new-instance v5, Lnix;

    const-string v8, "AccountManager cannot be null"

    invoke-direct {v5, v8}, Lnix;-><init>(Ljava/lang/String;)V
    ...
    throw v5
    :try_end_5
    .catch Lnix; {:try_start_5 .. :try_end_5} :catch_3
    ...
    invoke-direct {v8, v5}, Lnix;-><init>(Ljava/lang/Throwable;)V
    ...
    throw v8
    :try_end_7
    .catch Lnix; {:try_start_7 .. :try_end_7} :catch_5
    ...
    invoke-direct {v2, v5}, Lnix;-><init>(Ljava/lang/String;)V
    ...
    throw v2
    :try_end_8
    .catch Lnix; {:try_start_8 .. :try_end_8} :catch_6
    ...
    iget-object v4, p0, Lniq;->a:Landroid/content/Context;
    ...
    .line 183
    iget-object v4, p0, Lniq;->c:Ljava/lang/Object;

    monitor-enter v4

    .line 184
    :try_start_9
    iget-object v5, p0, Lniq;->d:Ljava/lang/String;

    if-nez v5, :cond_b

    .line 185
    iget-object v5, p0, Lniq;->a:Landroid/content/Context;

    invoke-virtual {v5}, Landroid/content/Context;->createDeviceProtectedStorageContext()Landroid/content/Context;

    move-result-object v5

    invoke-static {v5}, Lmyw;->d(Landroid/content/Context;)Ljava/io/File;
    ...
    iput-object v5, p0, Lniq;->d:Ljava/lang/String;
    ...
    invoke-direct {v4, v8}, Lniw;-><init>(Ljava/lang/String;)V
    ...
    throw v4
    :try_end_a
    .catch Lniw; {:try_start_a .. :try_end_a} :catch_7
...
.method public final d(Landroid/net/Uri;)Ljava/io/InputStream;
    ...
    invoke-virtual {p0, p1}, Lniq;->a(Landroid/net/Uri;)Landroid/net/Uri;
...
.method public final f(Landroid/net/Uri;)Z
    ...
    invoke-interface {v0, v1}, Lnji;->f(Landroid/net/Uri;)Z
