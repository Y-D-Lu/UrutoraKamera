...
.method public constructor <init>(Ljava/io/FileOutputStream;Lmkd;Ljava/util/concurrent/Executor;)V
    ...
    invoke-direct {v1, p0, v0}, Ldefpackage/kw;-><init>(Lmkb;Ljava/util/concurrent/Executor;)V

    iput-object v1, p0, Lmkb;->e:Ljava/util/concurrent/Executor;
...
.method public final declared-synchronized a()Lmln;
    ...
    invoke-direct {v1, p0, v0}, Lmka;-><init>(Lmkb;I)V

    .line 51
    .local v1, "mkaVar":Lmka;
    iget-object v2, p0, Lmkb;->e:Ljava/util/concurrent/Executor;

    new-instance v3, Ldefpackage/lw;

    invoke-direct {v3, p0, v1}, Ldefpackage/lw;-><init>(Lmkb;Lmka;)V
    ...
    .line 47
    .end local v0    # "i":I
    .end local v1    # "mkaVar":Lmka;
    .end local p0    # "this":Lmkb;
    :catchall_0
    move-exception v0
