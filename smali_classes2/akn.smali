...
.method public constructor <init>(Lakn;)V
    ...
    .line 70
    iget-object v2, p1, Lakn;->j:Ljava/lang/String;

    iput-object v2, p0, Lakn;->j:Ljava/lang/String;
    ...
    .line 73
    invoke-virtual {v0, v2, p0}, Lxf;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 75
    :cond_0
    iget-object v3, p1, Lakn;->k:Ljava/lang/Boolean;

    iput-object v3, p0, Lakn;->k:Ljava/lang/Boolean;
...
.method public final a(Lakl;Landroid/graphics/Matrix;Landroid/graphics/Canvas;II)V
    ...
    .line 91
    .local v5, "min":F
    iget-object v12, v7, Lakl;->a:Landroid/graphics/Matrix;

    .line 92
    .local v12, "matrix2":Landroid/graphics/Matrix;
    iget-object v13, v6, Lakn;->o:Landroid/graphics/Matrix;
    ...
    .local v18, "hypot":D
    iget-object v1, v6, Lakn;->m:Landroid/graphics/Path;
    ...
    .line 104
    iget-object v2, v0, Lakm;->m:[Lem;

    .line 105
    .local v2, "emVarArr":[Lem;
    if-eqz v2, :cond_2

    .line 106
    invoke-static {v2, v1}, Lem;->a([Lem;Landroid/graphics/Path;)V
    ...
    .end local v2    # "emVarArr":[Lem;
    .local v25, "emVarArr":[Lem;
    ...
    .line 116
    .local v2, "akkVar":Lakk;
    move-object/from16 v26, v0

    .end local v0    # "akmVar":Lakm;
    .local v26, "akmVar":Lakm;
    iget v0, v2, Lakk;->g:F
    ...
    .end local v3    # "f5":F
    .local v17, "f5":F
    iget-object v3, v6, Lakn;->p:Landroid/graphics/PathMeasure;
    ...
    iput-object v3, v6, Lakn;->p:Landroid/graphics/PathMeasure;

    .line 124
    :cond_7
    iget-object v3, v6, Lakn;->p:Landroid/graphics/PathMeasure;

    iget-object v7, v6, Lakn;->m:Landroid/graphics/Path;
    ...
    .end local v0    # "f7":F
    .local v16, "f7":F
    iget-object v0, v6, Lakn;->p:Landroid/graphics/PathMeasure;
    ...
    .line 140
    .local v0, "dyVar":Ldy;
    iget-object v9, v6, Lakn;->c:Landroid/graphics/Paint;
    ...
    iput-object v9, v6, Lakn;->c:Landroid/graphics/Paint;
    ...
    .line 147
    iget-object v14, v0, Ldy;->a:Landroid/graphics/Shader;
    ...
    iget v14, v2, Lakk;->f:F

    invoke-static {v4, v14}, Lakq;->a(IF)I
    ...
    .line 160
    .end local v0    # "dyVar":Ldy;
    .end local v9    # "paint2":Landroid/graphics/Paint;
    :cond_c
    iget-object v0, v2, Lakk;->b:Ldy;
    ...
    .line 162
    .local v0, "dyVar2":Ldy;
    iget-object v4, v6, Lakn;->b:Landroid/graphics/Paint;
    ...
    iput-object v4, v6, Lakn;->b:Landroid/graphics/Paint;
    ...
    iget-object v9, v2, Lakk;->k:Landroid/graphics/Paint$Join;
    ...
    .line 172
    :cond_e
    iget-object v14, v2, Lakk;->j:Landroid/graphics/Paint$Cap;
    ...
    .line 178
    iget-object v7, v0, Ldy;->a:Landroid/graphics/Shader;
    ...
    invoke-static {v7, v3}, Lakq;->a(IF)I
    ...
    .line 189
    iget-object v3, v6, Lakn;->n:Landroid/graphics/Path;
    ...
    .end local v25    # "emVarArr":[Lem;
    .end local v26    # "akmVar":Lakm;
    .end local v27    # "hypot2":D
    .end local v29    # "f4":F
    .local v0, "akmVar":Lakm;
    .local v1, "hypot":D
...
.method public setAlpha(F)V
    ...
    invoke-virtual {p0, v0}, Lakn;->setRootAlpha(I)V
