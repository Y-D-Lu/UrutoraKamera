...
# direct methods
.method public constructor <init>(Lbev;I)V
    .locals 0
    .param p1, "bevVar"    # Lbev;
    .param p2, "i"    # I
...
.method private final e(Ljava/net/URL;ILjava/net/URL;Ljava/util/Map;)Ljava/io/InputStream;
    ...
    invoke-direct {v1, v2, v0}, Lazf;-><init>(Ljava/lang/String;I)V

    .end local p0    # "this":Lbal;
    ...
    .line 60
    iput-object v2, p0, Lbal;->c:Ljava/net/HttpURLConnection;
    :try_end_1
    ...
    .line 63
    iget-object v3, p0, Lbal;->c:Ljava/net/HttpURLConnection;

    invoke-virtual {v3}, Ljava/net/HttpURLConnection;->getInputStream()Ljava/io/InputStream;

    move-result-object v3

    iput-object v3, p0, Lbal;->d:Ljava/io/InputStream;

    .line 64
    iget-boolean v3, p0, Lbal;->e:Z
    ...
    invoke-static {v3}, Lbal;->b(Ljava/net/HttpURLConnection;)I
    ...
    .line 70
    iget-object v0, p0, Lbal;->c:Ljava/net/HttpURLConnection;
    :try_end_2
    ...
    invoke-direct {v5, v6, v7, v8}, Lblt;-><init>(Ljava/io/InputStream;J)V

    iput-object v5, p0, Lbal;->d:Ljava/io/InputStream;
    ...
    .line 77
    :goto_2
    iget-object v1, p0, Lbal;->d:Ljava/io/InputStream;
    :try_end_3
    ...
    invoke-static {v0}, Lbal;->b(Ljava/net/HttpURLConnection;)I

    move-result v8

    invoke-direct {v6, v7, v8, v5}, Lazf;-><init>(Ljava/lang/String;ILjava/lang/Throwable;)V
    ...
    invoke-direct {v5, v6, v0}, Lazf;-><init>(Ljava/lang/String;I)V
    ...
    iget-object v5, p0, Lbal;->c:Ljava/net/HttpURLConnection;

    invoke-virtual {v5}, Ljava/net/HttpURLConnection;->getResponseMessage()Ljava/lang/String;

    move-result-object v5

    invoke-direct {v0, v5, v3}, Lazf;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v5, v6, v3, v0}, Lazf;-><init>(Ljava/lang/String;ILjava/lang/Throwable;)V
    ...
    invoke-virtual {p0}, Lbal;->d()V

    .line 98
    add-int/lit8 v6, p2, 0x1

    invoke-direct {p0, v5, v6, p1, p4}, Lbal;->e(Ljava/net/URL;ILjava/net/URL;Ljava/util/Map;)Ljava/io/InputStream;
    ...
    :goto_3
    invoke-direct {v7, v8, v3, v5}, Lazf;-><init>(Ljava/lang/String;ILjava/lang/Throwable;)V
    ...
    invoke-direct {v5, v6, v3}, Lazf;-><init>(Ljava/lang/String;I)V
    ...
    invoke-static {v5}, Lbal;->b(Ljava/net/HttpURLConnection;)I

    move-result v5

    invoke-direct {v3, v4, v5, v0}, Lazf;-><init>(Ljava/lang/String;ILjava/lang/Throwable;)V
    ...
    invoke-direct {v2, v3, v1, v0}, Lazf;-><init>(Ljava/lang/String;ILjava/lang/Throwable;)V
...
.method public final d()V
    ...
    .line 121
    iget-object v0, p0, Lbal;->d:Ljava/io/InputStream;
    ...
    :cond_0
    :goto_0
    iget-object v1, p0, Lbal;->c:Ljava/net/HttpURLConnection;
...
.method public final f(Layc;Lbab;)V
    ...
    .line 139
    :try_start_0
    iget-object v0, p0, Lbal;->a:Lbev;

    .line 140
    .local v0, "bevVar":Lbev;
    iget-object v1, v0, Lbev;->f:Ljava/net/URL;

    if-nez v1, :cond_2

    .line 141
    iget-object v1, v0, Lbev;->e:Ljava/lang/String;
    ...
    .line 142
    iget-object v1, v0, Lbev;->d:Ljava/lang/String;
    ...
    .line 144
    iget-object v2, v0, Lbev;->c:Ljava/net/URL;

    .line 145
    .local v2, "url":Ljava/net/URL;
    invoke-static {v2}, Laae;->s(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object v2, v0, Lbev;->e:Ljava/lang/String;
    ...
    iget-object v2, v0, Lbev;->e:Ljava/lang/String;

    invoke-direct {v1, v2}, Ljava/net/URL;-><init>(Ljava/lang/String;)V

    iput-object v1, v0, Lbev;->f:Ljava/net/URL;
    ...
    iget-object v2, p0, Lbal;->a:Lbev;

    iget-object v2, v2, Lbev;->b:Lbew;

    .line 154
    .local v2, "bewVar":Lbew;
    move-object v3, v2

    check-cast v3, Lbez;

    iget-object v3, v3, Lbez;->c:Ljava/util/Map;
    ...
    iget-object v4, v4, Lbez;->b:Ljava/util/Map;
    ...
    iget-object v10, v10, Lbey;->a:Ljava/lang/String;
    ...
    iput-object v5, v4, Lbez;->c:Ljava/util/Map;
    ...
    iget-object v5, v5, Lbez;->c:Ljava/util/Map;

    invoke-direct {p0, v1, v3, v4, v5}, Lbal;->e(Ljava/net/URL;ILjava/net/URL;Ljava/util/Map;)Ljava/io/InputStream;

    move-result-object v3

    invoke-interface {p2, v3}, Lbab;->b(Ljava/lang/Object;)V
    :try_end_2
    .catch Ljava/io/IOException; {:try_start_2 .. :try_end_2} :catch_0

    .line 183
    .end local v0    # "bevVar":Lbev;
    .end local v1    # "url2":Ljava/net/URL;
    .end local v2    # "bewVar":Lbew;
    goto :goto_3
