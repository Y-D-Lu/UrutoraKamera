...
.method public constructor <init>(Lcom/google/android/material/tabs/TabLayout;Landroid/content/Context;)V
    ...
    iput-object p1, p0, Locw;->d:Lcom/google/android/material/tabs/TabLayout;
    ...
    invoke-virtual {p0, p1}, Locw;->setWillNotDraw(Z)V
...
.method public final a()V
    ...
    invoke-virtual {p0, v0}, Locw;->getChildAt(I)Landroid/view/View;

    move-result-object v0

    iget-object v1, p0, Locw;->d:Lcom/google/android/material/tabs/TabLayout;

    iget-object v2, v1, Lcom/google/android/material/tabs/TabLayout;->i:Landroid/graphics/drawable/Drawable;

    invoke-static {v1, v0}, Lobr;->i(Lcom/google/android/material/tabs/TabLayout;Landroid/view/View;)Landroid/graphics/RectF;
...
.method public final b(I)V
    ...
    iget-object v0, p0, Locw;->d:Lcom/google/android/material/tabs/TabLayout;
    ...
    invoke-virtual {p0}, Locw;->requestLayout()V
...
.method public final c(Landroid/view/View;Landroid/view/View;F)V
    ...
    iget-object v2, p0, Locw;->d:Lcom/google/android/material/tabs/TabLayout;

    iget-object v1, v2, Lcom/google/android/material/tabs/TabLayout;->x:Lobr;
    ...
    invoke-virtual/range {v1 .. v6}, Lobr;->j(Lcom/google/android/material/tabs/TabLayout;Landroid/view/View;Landroid/view/View;FLandroid/graphics/drawable/Drawable;)V

    goto :goto_0

    :cond_0
    iget-object p1, p0, Locw;->d:Lcom/google/android/material/tabs/TabLayout;
    ...
    iget-object p3, p0, Locw;->d:Lcom/google/android/material/tabs/TabLayout;
...
.method public final d(ZII)V
    ...
    invoke-virtual {p0, p2}, Locw;->getChildAt(I)Landroid/view/View;
    ...
    invoke-direct {v2, p0, v0, v1}, Locu;-><init>(Locw;Landroid/view/View;Landroid/view/View;)V
    ...
    iput-object p1, p0, Locw;->a:Landroid/animation/ValueAnimator;
    ...
    new-instance p3, Locv;

    invoke-direct {p3, p0, p2}, Locv;-><init>(Locw;I)V
    ...
    :cond_1
    iget-object p1, p0, Locw;->a:Landroid/animation/ValueAnimator;
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    :pswitch_0
    invoke-virtual {p0}, Locw;->getHeight()I
    ...
    iget-object v3, p0, Locw;->d:Lcom/google/android/material/tabs/TabLayout;
...
.method protected final onLayout(ZIIII)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Locw;->d(ZII)V
...
.method protected final onMeasure(II)V
    ...
    :cond_1
    invoke-virtual {p0}, Locw;->getChildCount()I
    ...
    invoke-virtual {p0, v3}, Locw;->getChildAt(I)Landroid/view/View;
    ...
    :cond_4
    invoke-virtual {p0}, Locw;->getContext()Landroid/content/Context;

    move-result-object v3

    const/16 v5, 0x10

    invoke-static {v3, v5}, Lobr;->v(Landroid/content/Context;I)F
    ...
    invoke-virtual {p0}, Locw;->getMeasuredWidth()I
    ...
    invoke-virtual {p0, v1}, Locw;->getChildAt(I)Landroid/view/View;
