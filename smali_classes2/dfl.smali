...
.method public constructor <init>(Landroid/content/Context;Lddf;)V
    ...
    invoke-direct {v1, v0, v0}, Llig;-><init>(II)V

    iput-object v1, p0, Ldfl;->a:Llig;
...
.method public static d(Llig;DLlig;)Llig;
    ...
    :cond_1
    :goto_0
    invoke-virtual/range {p0 .. p0}, Llig;->b()J
    ...
    .line 40
    .local v13, "round2":I
    iget v14, v1, Llig;->a:I

    .line 41
    .local v14, "i3":I
    if-gt v10, v14, :cond_2

    iget v15, v1, Llig;->b:I

    if-gt v13, v15, :cond_2

    .line 42
    new-instance v15, Llig;

    invoke-direct {v15, v10, v13}, Llig;-><init>(II)V
    ...
    invoke-direct {v5, v2, v3}, Llig;-><init>(II)V
...
.method public final c(Lazp;Llig;)Lbkx;
    ...
    invoke-virtual {v1, p1}, Lbko;->x(Lazp;)Lbko;

    move-result-object v1

    check-cast v1, Lbkx;

    invoke-virtual {v1}, Lbko;->H()Lbko;

    move-result-object v1

    check-cast v1, Lbkx;

    invoke-virtual {v1}, Lbko;->p()Lbko;
    ...
    invoke-virtual {v1, v2, v3}, Lbko;->t(II)Lbko;
