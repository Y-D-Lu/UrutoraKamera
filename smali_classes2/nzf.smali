...
.method public constructor <init>(Lcom/google/android/material/floatingactionbutton/FloatingActionButton;Lnyv;)V
    ...
    .line 66
    .local v0, "nztVar":Lnzt;
    iput-object v0, p0, Lnzf;->A:Lnzt;

    .line 67
    new-instance v1, Lnzc;

    invoke-direct {v1, p0}, Lnzc;-><init>(Lnzf;)V

    invoke-static {v1}, Lnzf;->o(Lnze;)Landroid/animation/ValueAnimator;

    move-result-object v1

    invoke-virtual {v0, v1}, Lnzt;->a(Landroid/animation/ValueAnimator;)V

    .line 68
    new-instance v1, Lnzb;

    invoke-direct {v1, p0}, Lnzb;-><init>(Lnzf;)V
    ...
    invoke-direct {v1, p0}, Lnzd;-><init>(Lnzf;)V
    ...
    invoke-direct {v1, p0}, Lnza;-><init>(Lnzf;)V
...
.method public final b(Lnwm;FFF)Landroid/animation/AnimatorSet;
    ...
    invoke-virtual {p1, v2}, Lnwm;->b(Ljava/lang/String;)Lnwn;

    move-result-object v2

    invoke-virtual {v2, v1}, Lnwn;->b(Landroid/animation/Animator;)V

    .line 94
    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 95
    iget-object v2, p0, Lnzf;->x:Lcom/google/android/material/floatingactionbutton/FloatingActionButton;
    ...
    invoke-virtual {p1, v4}, Lnwm;->b(Ljava/lang/String;)Lnwn;

    move-result-object v6

    invoke-virtual {v6, v2}, Lnwn;->b(Landroid/animation/Animator;)V

    .line 97
    invoke-virtual {v0, v2}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 98
    iget-object v6, p0, Lnzf;->x:Lcom/google/android/material/floatingactionbutton/FloatingActionButton;
    ...
    invoke-virtual {v4, v6}, Lnwn;->b(Landroid/animation/Animator;)V

    .line 100
    invoke-virtual {v0, v6}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 101
    iget-object v4, p0, Lnzf;->E:Landroid/graphics/Matrix;

    invoke-virtual {p0, p4, v4}, Lnzf;->d(FLandroid/graphics/Matrix;)V

    .line 102
    iget-object v4, p0, Lnzf;->x:Lcom/google/android/material/floatingactionbutton/FloatingActionButton;
    ...
    invoke-direct {v8, p0}, Lnyy;-><init>(Lnzf;)V

    new-array v3, v3, [Landroid/graphics/Matrix;

    new-instance v9, Landroid/graphics/Matrix;

    iget-object v10, p0, Lnzf;->E:Landroid/graphics/Matrix;
    ...
    invoke-virtual {v4, v3}, Lnwn;->b(Landroid/animation/Animator;)V
    ...
    invoke-static {v4, v0}, Lohh;->aa(Landroid/animation/AnimatorSet;Ljava/util/List;)V
...
.method public final c(FFF)Landroid/animation/AnimatorSet;
    ...
    .line 116
    invoke-static {v12, v13}, Lohh;->aa(Landroid/animation/AnimatorSet;Ljava/util/List;)V

    .line 117
    iget-object v0, v11, Lnzf;->x:Lcom/google/android/material/floatingactionbutton/FloatingActionButton;
    ...
    invoke-static {v1, v2}, Lobr;->g(Landroid/content/Context;I)Landroid/util/TypedValue;
    ...
    invoke-static {v8, v0}, Lobr;->u(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 133
    invoke-static {v8, v0}, Lobr;->t(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v7}, Lobr;->s([Ljava/lang/String;I)F

    move-result v7

    invoke-static {v0, v15}, Lobr;->s([Ljava/lang/String;I)F
    ...
    invoke-static {v0, v1}, Lobr;->s([Ljava/lang/String;I)F
    ...
    invoke-static {v0, v2}, Lobr;->s([Ljava/lang/String;I)F
    ...
    .line 151
    :try_start_0
    invoke-static {v7, v2}, Lem;->a([Lem;Landroid/graphics/Path;)V
    :try_end_0
...
.method public final h(Lobz;)V
    ...
    .line 206
    :cond_0
    iget-object v1, p0, Lnzf;->k:Lnyp;

    .line 207
    .local v1, "nypVar":Lnyp;
    if-eqz v1, :cond_1

    .line 208
    iput-object p1, v1, Lnyp;->h:Lobz;
...
.method public final j()V
    ...
    invoke-virtual {v1, v8}, Lnyv;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 231
    .local v5, "i4":I
    iget-object v6, v1, Lnyv;->a:Lcom/google/android/material/floatingactionbutton/FloatingActionButton;
