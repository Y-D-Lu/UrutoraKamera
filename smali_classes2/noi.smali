...
.method public final a(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 67
    iget-object v3, v2, Lnuj;->f:Ljava/util/List;
    ...
    invoke-static {v11, v0}, Lqmd;->u(Ljava/util/List;I)Ljava/lang/Object;
    ...
    .line 74
    .local v11, "npeVar2":Lnpe;
    if-eqz v11, :cond_0

    iget-wide v12, v11, Lnpe;->i:J
    ...
    .local v13, "npeVar":Lnpe;
    goto :goto_1

    .line 78
    .end local v12    # "i":I
    .end local v13    # "npeVar":Lnpe;
    :cond_0
    iget-object v12, v2, Lnuj;->d:Ljava/util/List;

    invoke-static {v12, v5}, Lqmd;->u(Ljava/util/List;I)Ljava/lang/Object;
    ...
    .line 79
    .local v12, "npeVar3":Lnpe;
    if-eqz v12, :cond_1

    iget-wide v13, v12, Lnpe;->i:J
    ...
    .line 81
    .local v13, "i":I
    iget-object v14, v2, Lnuj;->d:Ljava/util/List;
    ...
    .line 84
    .end local v13    # "i":I
    .end local v14    # "npeVar":Lnpe;
    :cond_1
    iget-object v13, v2, Lnuj;->e:Ljava/util/List;

    invoke-static {v13, v6}, Lqmd;->u(Ljava/util/List;I)Ljava/lang/Object;
    ...
    .line 85
    .local v13, "npeVar4":Lnpe;
    if-eqz v13, :cond_2

    iget-wide v14, v13, Lnpe;->i:J
    ...
    .line 87
    .local v14, "i":I
    iget-object v15, v2, Lnuj;->e:Ljava/util/List;
    ...
    invoke-static {v1, v14}, Lqno;->a(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {v2, v1, v15}, Lnuj;->c(ILjava/lang/Throwable;)V
    ...
    .end local v13    # "npeVar":Lnpe;
    :cond_4
    iget-object v1, v2, Lnuj;->c:Ljava/util/List;

    const-string v7, "annotations"

    invoke-virtual {v2, v1, v0, v7}, Lnuj;->a(Ljava/util/List;ILjava/lang/String;)V

    .line 102
    iget-object v1, v2, Lnuj;->d:Ljava/util/List;

    const-string v7, "attachments"

    invoke-virtual {v2, v1, v5, v7}, Lnuj;->a(Ljava/util/List;ILjava/lang/String;)V
    ...
    invoke-direct {v1, v7, v4}, Lnqi;-><init>(Lnqh;Ljava/util/List;)V

    return-object v1

    .line 61
    .end local v2    # "nujVar":Lnuj;
    ...
    .line 58
    .local v1, "nmnVar":Lnmn;
    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    .line 59
    iget-object v2, v1, Lnmn;->a:Ljava/lang/String;

    return-object v2

    .line 53
    .end local v1    # "nmnVar":Lnmn;
    :pswitch_3
    move-object/from16 v1, p1
    ...
    iget-object v4, v1, Lqkl;->b:Ljava/lang/Object;
    ...
    invoke-direct {v5, v3, v4}, Lnqi;-><init>(Lnqh;Ljava/util/List;)V
