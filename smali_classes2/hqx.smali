...
# direct methods
.method public constructor <init>(Lhqz;I)V
    .locals 0
    .param p1, "hqzVar"    # Lhqz;
    .param p2, "i"    # I
...
.method public final run()V
    ...
    .line 32
    .end local v0    # "hqzVar":Lhqz;
    :pswitch_0
    iget-object v0, p0, Lhqx;->a:Lhqz;

    .line 33
    .restart local v0    # "hqzVar":Lhqz;
    iget-object v1, v0, Lhqz;->e:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    .line 40
    iget-object v3, v0, Lhqz;->d:Lhsm;

    invoke-virtual {v3}, Lhsm;->a()Ljava/io/File;
    ...
    :goto_0
    invoke-virtual {v0, v5}, Lhqd;->H(Ljava/lang/String;)V

    .line 44
    iget-object v5, v0, Lhqz;->e:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    invoke-virtual {v0, v3}, Lhqd;->W(Landroid/graphics/Bitmap;)V

    .line 47
    iget-object v3, v0, Lhqz;->e:Ljava/util/concurrent/locks/ReentrantLock;
    :try_end_2
    ...
    .line 60
    iget-object v6, v0, Lhqz;->e:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    :goto_4
    invoke-virtual {v0, v7}, Lhqd;->H(Ljava/lang/String;)V
    ...
    invoke-direct {v6, v3, v4}, Llig;-><init>(II)V
    ...
    .line 88
    .local v6, "ikcVar":Likc;
    invoke-virtual {v6, v5}, Likc;->a(Lcom/google/android/libraries/camera/exif/ExifInterface;)V
    ...
    .line 90
    invoke-virtual {v0, v1, v6}, Lhqz;->r([BLikc;)Lpht;

    .line 91
    iget-object v7, v0, Lhqz;->e:Ljava/util/concurrent/locks/ReentrantLock;
    :try_end_6
