...
# direct methods
.method public constructor <init>(Landroid/hardware/SensorManager;Llis;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Llww;->c:Landroid/hardware/SensorManager;
    ...
    iput-object p1, p0, Llww;->a:Llis;

    new-instance p1, Ljava/util/HashSet;

    invoke-direct {p1}, Ljava/util/HashSet;-><init>()V

    iput-object p1, p0, Llww;->d:Ljava/util/Set;

    const/4 p1, 0x0

    iput-object p1, p0, Llww;->b:Llwv;
...
.method private final declared-synchronized c()V
    ...
    :try_start_0
    iget-object v0, p0, Llww;->a:Llis;

    const-string v1, "Shutting down gyro direct channel"

    invoke-interface {v0, v1}, Llis;->b(Ljava/lang/String;)V

    iget-object v0, p0, Llww;->b:Llwv;

    if-eqz v0, :cond_1

    iget-object v1, v0, Llwv;->b:Landroid/hardware/SensorDirectChannel;

    iget-object v2, v0, Llwv;->c:Landroid/hardware/Sensor;
    ...
    iget-object v0, v0, Llwv;->a:Llxh;

    invoke-virtual {v0}, Llxh;->a()V

    const/4 v0, 0x0

    iput-object v0, p0, Llww;->b:Llwv;
    :try_end_0
...
.method private final declared-synchronized d()V
    ...
    invoke-direct {v1, v0}, Llxh;-><init>(Landroid/hardware/HardwareBuffer;)V
    :try_end_3
    ...
    invoke-direct {v3, v1}, Llwx;-><init>(Llxh;)V
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_3

    :try_start_5
    iget-object v4, p0, Llww;->c:Landroid/hardware/SensorManager;
    ...
    :cond_2
    :try_start_8
    iget-object v0, p0, Llww;->c:Landroid/hardware/SensorManager;
    ...
    invoke-direct {v4, v1, v2, v0, v3}, Llwv;-><init>(Llxh;Landroid/hardware/SensorDirectChannel;Landroid/hardware/Sensor;Llwx;)V

    iput-object v4, p0, Llww;->b:Llwv;
    :try_end_c
    ...
    :goto_1
    :try_start_d
    iget-object v3, p0, Llww;->a:Llis;

    const-string v4, "Failed to start direct gyro provider: Creating direct channel threw an exception."

    invoke-interface {v3, v4, v0}, Llis;->e(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_d
...
.method public final declared-synchronized a(Ljava/lang/String;)Llxa;
    ...
    :try_start_0
    iget-object v0, p0, Llww;->d:Ljava/util/Set;
    ...
    invoke-interface {v1}, Llxa;->a()Ljava/lang/String;
    ...
    invoke-direct {v0, p0, p1}, Llwu;-><init>(Llww;Ljava/lang/String;)V

    iget-object p1, p0, Llww;->d:Ljava/util/Set;

    invoke-interface {p1, v0}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    iget-object p1, p0, Llww;->a:Llis;

    iget-object v1, v0, Llwu;->a:Ljava/lang/String;
...
.method public final declared-synchronized b(Llxa;)V
    ...
    iget-object p1, p1, Llwu;->a:Ljava/lang/String;

    iget-object v1, p0, Llww;->d:Ljava/util/Set;
