...
.method private static declared-synchronized b()Ljava/lang/ClassLoader;
    ...
    :try_start_0
    sget-object v1, Lkoj;->b:Ljava/lang/Thread;

    const/4 v2, 0x0

    if-nez v1, :cond_1

    invoke-static {}, Lkoj;->c()Ljava/lang/Thread;

    move-result-object v1

    sput-object v1, Lkoj;->b:Ljava/lang/Thread;
    ...
    :try_start_2
    sget-object v3, Lkoj;->b:Ljava/lang/Thread;
...
.method private static declared-synchronized c()Ljava/lang/Thread;
    ...
    invoke-direct {v1, v8}, Lkoi;-><init>(Ljava/lang/ThreadGroup;)V
    :try_end_3
