...
.method public constructor <init>(Landroid/app/Activity;Z)V
    ...
    invoke-direct {p0, v0}, Ljp;->z(Landroid/view/View;)V
    ...
    iput-object v1, p0, Ljp;->f:Landroid/view/View;
...
.method private final A(Z)V
    ...
    invoke-interface {v0}, Loa;->w()V

    .line 89
    iget-object v0, p0, Ljp;->d:Loa;

    invoke-interface {v0}, Loa;->z()V
...
.method private final z(Landroid/view/View;)V
    ...
    invoke-virtual {v2}, Landroid/support/v7/widget/Toolbar;->f()Loa;
    ...
    iput-object v3, p0, Ljp;->e:Landroid/support/v7/widget/ActionBarContextView;
    ...
    iput-object v3, p0, Ljp;->c:Landroid/support/v7/widget/ActionBarContainer;

    .line 128
    iget-object v4, p0, Ljp;->d:Loa;

    .line 129
    .local v4, "oaVar":Loa;
    if-eqz v4, :cond_8

    iget-object v5, p0, Ljp;->e:Landroid/support/v7/widget/ActionBarContextView;
    ...
    .line 132
    invoke-interface {v4}, Loa;->b()Landroid/content/Context;

    move-result-object v5

    iput-object v5, p0, Ljp;->a:Landroid/content/Context;

    .line 133
    iget-object v5, p0, Ljp;->d:Loa;

    invoke-interface {v5}, Loa;->a()I
    ...
    .line 134
    iput-boolean v6, p0, Ljp;->u:Z

    .line 136
    :cond_4
    iget-object v5, p0, Ljp;->a:Landroid/content/Context;
    ...
    .line 138
    .local v7, "i2":I
    iget-object v8, p0, Ljp;->d:Loa;

    invoke-interface {v8}, Loa;->y()V

    .line 139
    invoke-static {v5}, Lga;->g(Landroid/content/Context;)Z

    move-result v8

    invoke-direct {p0, v8}, Ljp;->A(Z)V

    .line 140
    iget-object v8, p0, Ljp;->a:Landroid/content/Context;

    const/4 v9, 0x0

    sget-object v10, Ljq;->a:[I
    ...
    .line 142
    iget-object v9, p0, Ljp;->b:Landroid/support/v7/widget/ActionBarOverlayLayout;
    ...
    .line 151
    iget-object v9, p0, Ljp;->c:Landroid/support/v7/widget/ActionBarContainer;

    int-to-float v10, v6

    invoke-static {v9, v10}, Lgl;->K(Landroid/view/View;F)V
...
.method public final b()Landroid/content/Context;
    ...
    iget-object v3, p0, Ljp;->a:Landroid/content/Context;

    invoke-direct {v2, v3, v1}, Landroid/view/ContextThemeWrapper;-><init>(Landroid/content/Context;I)V

    iput-object v2, p0, Ljp;->t:Landroid/content/Context;
...
.method public final c(Ljv;)Ljw;
    ...
    iget-object v2, p0, Ljp;->e:Landroid/support/v7/widget/ActionBarContextView;

    invoke-virtual {v2}, Landroid/view/ViewGroup;->getContext()Landroid/content/Context;

    move-result-object v2

    invoke-direct {v1, p0, v2, p1}, Ljo;-><init>(Ljp;Landroid/content/Context;Ljv;)V

    .line 185
    .local v1, "joVar2":Ljo;
    iget-object v2, v1, Ljo;->a:Lkw;

    invoke-virtual {v2}, Lkw;->s()V

    .line 187
    :try_start_0
    iget-object v2, v1, Ljo;->b:Ljv;

    iget-object v3, v1, Ljo;->a:Lkw;

    invoke-interface {v2, v1, v3}, Ljv;->c(Ljw;Landroid/view/Menu;)Z
    ...
    :cond_1
    :try_start_1
    iput-object v1, p0, Ljp;->g:Ljo;

    .line 191
    invoke-virtual {v1}, Ljo;->g()V

    .line 192
    iget-object v2, p0, Ljp;->e:Landroid/support/v7/widget/ActionBarContextView;

    invoke-virtual {v2, v1}, Landroid/support/v7/widget/ActionBarContextView;->h(Ljw;)V

    .line 193
    const/4 v2, 0x1

    invoke-virtual {p0, v2}, Ljp;->v(Z)V
...
.method public final d(Z)V
    ...
    .line 207
    iget-object v0, p0, Ljp;->w:Ljava/util/ArrayList;
    ...
    .line 209
    iget-object v2, p0, Ljp;->w:Ljava/util/ArrayList;
...
.method public final g(Z)V
    ...
    :goto_0
    invoke-virtual {p0, v1, v0}, Ljp;->w(II)V
...
.method public final h(Z)V
    ...
    .line 232
    :cond_0
    invoke-virtual {v1}, Lke;->a()V

    .line 233
    return-void

    .line 230
    .end local v1    # "keVar":Lke;
    :cond_1
    :goto_0
    return-void
.end method
...
.method public final n(ILandroid/view/KeyEvent;)Z
    ...
    .line 266
    :cond_2
    invoke-virtual {v2, v3}, Lkw;->setQwertyMode(Z)V

    .line 267
    invoke-virtual {v2, p1, p2, v1}, Lkw;->performShortcut(ILandroid/view/KeyEvent;I)Z
...
.method public final v(Z)V
    ...
    invoke-interface {v1, v2}, Loa;->n(I)V

    .line 310
    iget-object v1, p0, Ljp;->e:Landroid/support/v7/widget/ActionBarContextView;

    invoke-virtual {v1, v0}, Llu;->setVisibility(I)V
    ...
    invoke-interface {v1, v0}, Loa;->n(I)V

    .line 314
    iget-object v0, p0, Ljp;->e:Landroid/support/v7/widget/ActionBarContextView;

    invoke-virtual {v0, v3}, Llu;->setVisibility(I)V
    ...
    invoke-interface {v1, v2, v4, v5}, Loa;->c(IJ)Lgo;
    ...
    invoke-virtual {v2, v0, v6, v7}, Llu;->b(IJ)Lgo;
    ...
    invoke-interface {v1, v0, v6, v7}, Loa;->c(IJ)Lgo;

    move-result-object v0

    .line 322
    .restart local v0    # "c":Lgo;
    iget-object v1, p0, Ljp;->e:Landroid/support/v7/widget/ActionBarContextView;

    invoke-virtual {v1, v3, v4, v5}, Llu;->b(IJ)Lgo;

    move-result-object v1

    .line 324
    .restart local v1    # "b":Lgo;
    :goto_1
    new-instance v2, Lke;
    ...
    .line 325
    .local v2, "keVar":Lke;
    iget-object v3, v2, Lke;->a:Ljava/util/ArrayList;

    invoke-virtual {v3, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 326
    iget-object v3, v1, Lgo;->a:Ljava/lang/ref/WeakReference;
    ...
    .local v4, "duration":J
    :goto_2
    iget-object v6, v0, Lgo;->a:Ljava/lang/ref/WeakReference;
    ...
    .line 332
    :cond_6
    iget-object v7, v2, Lke;->a:Ljava/util/ArrayList;

    invoke-virtual {v7, v0}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 333
    invoke-virtual {v2}, Lke;->b()V
...
.method public final w(II)V
    ...
    invoke-interface {v1, v2}, Loa;->i(I)V
