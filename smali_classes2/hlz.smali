...
.method public static final a(Ljava/lang/String;Landroid/content/pm/PackageManager;)Z
    ...
    invoke-static {v6, v8, v9}, Ld;->v(Lova;Ljava/lang/String;C)V
    ...
    .line 32
    .local v8, "oywVar":Loyw;
    move-object v9, v8

    check-cast v9, Loyv;

    iget-object v9, v9, Loyv;->d:Loyw;

    check-cast v9, Loys;

    .line 33
    .local v9, "oysVar":Loys;
    if-nez v9, :cond_9
    ...
    iget-object v10, v10, Loyv;->b:Loyr;

    .line 35
    .local v10, "oyrVar":Loyr;
    iget-object v11, v10, Loyr;->b:[C
    ...
    iget-object v14, v14, Loyv;->b:Loyr;
    ...
    iget-object v14, v14, Loyv;->c:Ljava/lang/Character;

    .line 81
    .local v14, "ch":Ljava/lang/Character;
    new-instance v15, Loys;

    invoke-direct {v15, v10}, Loys;-><init>(Loyr;)V
    ...
    iput-object v9, v14, Loyv;->d:Loyw;
    ...
    iget-object v5, v10, Loyr;->a:Ljava/lang/String;
    ...
    invoke-direct {v4, v5, v0}, Loyr;-><init>(Ljava/lang/String;[C)V
    ...
    .line 87
    .local v3, "oyvVar":Loyv;
    :try_start_1
    iget-object v4, v9, Loyv;->b:Loyr;

    invoke-virtual {v2, v0}, Ljava/lang/String;->charAt(I)C

    move-result v5

    invoke-virtual {v4, v5}, Loyr;->c(C)Z
    ...
    invoke-static {v4, v5, v2}, Lobr;->aK(ZLjava/lang/String;Ljava/lang/Object;)V

    .line 85
    .end local v3    # "oyvVar":Loyv;
    ...
    .line 90
    .local v0, "oyvVar2":Loyv;
    iget-object v3, v9, Loyv;->c:Ljava/lang/Character;
    ...
    invoke-direct {v2, v9}, Loyu;-><init>(Loyw;)V

    invoke-virtual {v2, v6}, Loyw;->f([B)Ljava/lang/String;
    ...
    .line 96
    .end local v0    # "oyvVar2":Loyv;
    .end local v3    # "ch2":Ljava/lang/Character;
    .end local v8    # "oywVar":Loyw;
    .end local v9    # "oysVar":Loys;
    .local v6, "f":Ljava/lang/String;
    :goto_a
