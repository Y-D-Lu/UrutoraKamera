...
.method public constructor <init>(Landroid/content/Context;Loaf;)V
    ...
    invoke-virtual {p0, v0}, Loas;->setAlpha(I)V
...
.method public b(ZZZ)Z
    ...
    .line 50
    iget-object v7, p0, Loas;->b:Landroid/animation/ValueAnimator;

    sget-object v8, Lnwj;->b:Landroid/animation/TimeInterpolator;
    ...
    :cond_1
    :goto_0
    iput-object v7, p0, Loas;->b:Landroid/animation/ValueAnimator;

    .line 56
    new-instance v8, Loap;

    invoke-direct {v8, p0}, Loap;-><init>(Loas;)V
    ...
    .line 62
    iget-object v1, p0, Loas;->c:Landroid/animation/ValueAnimator;
    ...
    :cond_4
    :goto_1
    iput-object v1, p0, Loas;->c:Landroid/animation/ValueAnimator;

    .line 68
    new-instance v2, Loaq;

    invoke-direct {v2, p0}, Loaq;-><init>(Loas;)V
    ...
    invoke-direct {p0, v1}, Loas;->a([Landroid/animation/ValueAnimator;)V
    ...
    .local v1, "z4":Z
    :goto_5
    iget-object v2, p0, Loas;->e:Loaf;

    if-eqz p1, :cond_d

    invoke-virtual {v2}, Loaf;->c()Z
    ...
    invoke-direct {p0, v2}, Loas;->a([Landroid/animation/ValueAnimator;)V
...
.method public final k(Lga;)V
    ...
    .line 166
    :cond_0
    iget-object v1, p0, Loas;->f:Ljava/util/List;
    ...
    iput-object v1, p0, Loas;->f:Ljava/util/List;
