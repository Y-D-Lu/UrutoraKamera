...
# direct methods
.method public constructor <init>(Lkmb;ILandroid/os/IBinder;Landroid/os/Bundle;)V
    .locals 0
    ...
    .line 17
    invoke-direct {p0, p1, p2, p4}, Lklt;-><init>(Lkmb;ILandroid/os/Bundle;)V

    .line 18
    iput-object p1, p0, Lklz;->h:Lkmb;

    .line 19
    iput-object p3, p0, Lklz;->g:Landroid/os/IBinder;
...
.method public final c()Z
    ...
    :try_start_0
    iget-object v2, p0, Lklz;->g:Landroid/os/IBinder;
    ...
    iget-object v4, p0, Lklz;->h:Lkmb;

    invoke-virtual {v4}, Lkmb;->c()Ljava/lang/String;
    ...
    iget-object v5, p0, Lklz;->g:Landroid/os/IBinder;

    invoke-virtual {v4, v5}, Lkmb;->b(Landroid/os/IBinder;)Landroid/os/IInterface;
    ...
    iget-object v5, p0, Lklz;->h:Lkmb;

    const/4 v6, 0x2

    const/4 v7, 0x4

    invoke-virtual {v5, v6, v7, v4}, Lkmb;->z(IILandroid/os/IInterface;)Z
    ...
    .line 52
    .local v5, "kmbVar":Lkmb;
    const/4 v6, 0x0

    iput-object v6, v5, Lkmb;->l:Lkhi;

    .line 53
    iget-object v6, v5, Lkmb;->p:Lkmn;

    .line 54
    .local v6, "kmnVar":Lkmn;
    const/4 v7, 0x1
    ...
    .line 57
    :cond_2
    iget-object v8, v6, Lkmn;->a:Lkjq;

    invoke-interface {v8}, Lkjq;->b()V
    :try_end_0
    ...
    .line 49
    .end local v5    # "kmbVar":Lkmb;
    .end local v6    # "kmnVar":Lkmn;
    :cond_3
    :goto_0
    return v1
