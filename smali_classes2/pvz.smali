...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lpvz;->a:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/ContentProviderClient;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lpvz;->b:Landroid/content/ContentProviderClient;

    const-string p1, "device_params"

    invoke-static {p2, p1}, Lqmd;->an(Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;

    move-result-object p1

    iput-object p1, p0, Lpvz;->c:Landroid/net/Uri;
    ...
    iput-object p1, p0, Lpvz;->d:Landroid/net/Uri;
    ...
    iput-object p1, p0, Lpvz;->e:Landroid/net/Uri;
    ...
    iput-object p1, p0, Lpvz;->f:Landroid/net/Uri;
...
.method private final g(Lpql;Landroid/net/Uri;Ljava/lang/String;)Lpqm;
    .locals 1

    invoke-direct {p0, p2, p3}, Lpvz;->h(Landroid/net/Uri;Ljava/lang/String;)[B
    ...
    :cond_0
    :try_start_0
    invoke-interface {p1, p2}, Lpql;->d([B)Lpql;

    move-result-object p1

    invoke-interface {p1}, Lpql;->j()Lpqm;
    ...
    sget-object p2, Lpvz;->a:Ljava/lang/String;
...
.method private final h(Landroid/net/Uri;Ljava/lang/String;)[B
    ...
    :try_start_0
    iget-object v1, p0, Lpvz;->b:Landroid/content/ContentProviderClient;
    ...
    :cond_1
    :try_start_2
    sget-object v1, Lpvz;->a:Ljava/lang/String;
...
.method public final a(Lpxg;)Lozn;
    ...
    iget-object v0, p0, Lpvz;->f:Landroid/net/Uri;

    invoke-direct {p0, v1, v0, p1}, Lpvz;->g(Lpql;Landroid/net/Uri;Ljava/lang/String;)Lpqm;
...
.method public final b()Lpxd;
    ...
    iget-object v1, p0, Lpvz;->c:Landroid/net/Uri;

    const/4 v2, 0x0

    invoke-direct {p0, v0, v1, v2}, Lpvz;->g(Lpql;Landroid/net/Uri;Ljava/lang/String;)Lpqm;
...
.method public final c()Lpxe;
    ...
    iget-object v1, p0, Lpvz;->e:Landroid/net/Uri;
...
.method public final d()Lpxf;
    ...
    iget-object v1, p0, Lpvz;->d:Landroid/net/Uri;
...
.method public final e()V
    ...
    iget-object v0, p0, Lpvz;->b:Landroid/content/ContentProviderClient;
...
.method public final f(Lpxd;)Z
    ...
    iget-object v0, p0, Lpvz;->c:Landroid/net/Uri;
    ...
    :try_start_0
    iget-object p1, p0, Lpvz;->b:Landroid/content/ContentProviderClient;
    ...
    sget-object v0, Lpvz;->a:Ljava/lang/String;
