...
.method public constructor <init>(Landroid/content/ContentProviderClient;Ljava/lang/String;)V
    ...
    invoke-static {p2, v0}, Lqmd;->an(Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v0

    iput-object v0, p0, Lpvz;->c:Landroid/net/Uri;
    ...
    iput-object v0, p0, Lpvz;->d:Landroid/net/Uri;
    ...
    iput-object v0, p0, Lpvz;->e:Landroid/net/Uri;
    ...
    iput-object v0, p0, Lpvz;->f:Landroid/net/Uri;
...
.method private final g(Lpql;Landroid/net/Uri;Ljava/lang/String;)Lpqm;
    ...
    :cond_0
    :try_start_0
    invoke-interface {p1, v0}, Lpql;->d([B)Lpql;

    move-result-object v2

    invoke-interface {v2}, Lpql;->j()Lpqm;
    ...
    sget-object v3, Lpvz;->a:Ljava/lang/String;
...
.method public final a(Lpxg;)Lozn;
    ...
    .line 142
    iget-object v3, p0, Lpvz;->f:Landroid/net/Uri;

    invoke-direct {p0, v2, v3, v0}, Lpvz;->g(Lpql;Landroid/net/Uri;Ljava/lang/String;)Lpqm;
...
.method public final f(Lpxd;)Z
    ...
    .line 171
    :try_start_0
    iget-object v3, p0, Lpvz;->b:Landroid/content/ContentProviderClient;
    ...
    .line 175
    iget-object v4, p0, Lpvz;->b:Landroid/content/ContentProviderClient;
