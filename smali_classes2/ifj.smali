...
.method public constructor <init>(Landroid/content/Context;Lojz;Lcom/google/android/apps/camera/bottombar/RoundedThumbnailView;)V
    ...
    iput-object v0, p0, Lifj;->f:Landroid/view/ViewGroup;
    ...
    iput-object v1, p0, Lifj;->b:Ljava/time/Duration;

    .line 33
    new-instance v1, Ldefpackage/Zi;

    invoke-direct {v1, p0, p3}, Ldefpackage/Zi;-><init>(Lifj;Lcom/google/android/apps/camera/bottombar/RoundedThumbnailView;)V
...
.method public final a(Landroid/view/View;)V
    ...
    sget-object v6, Ljrz;->PORTRAIT:Ljrz;

    .line 59
    .local v6, "jrzVar":Ljrz;
    iget-object v7, v0, Lifj;->c:Ljrz;
    ...
    .line 73
    :goto_0
    iget-object v7, v0, Lifj;->f:Landroid/view/ViewGroup;
    ...
    .line 75
    .local v8, "width2":I
    iget-object v9, v0, Lifj;->f:Landroid/view/ViewGroup;
    ...
    .line 76
    .local v9, "height":I
    iget-object v10, v0, Lifj;->a:Lcom/google/android/apps/camera/bottombar/RoundedThumbnailView;
    ...
    iget-object v12, v0, Lifj;->f:Landroid/view/ViewGroup;
    ...
    iget-object v12, v0, Lifj;->a:Lcom/google/android/apps/camera/bottombar/RoundedThumbnailView;
    ...
    .line 82
    .local v11, "constraintSetVar":LConstraintSet;
    iget-object v12, v0, Lifj;->d:Landroid/support/constraint/ConstraintLayout;

    invoke-virtual {v11, v12}, LConstraintSet;->d(Landroid/support/constraint/ConstraintLayout;)V
    ...
    invoke-virtual {v11, v12}, LConstraintSet;->b(Landroid/support/constraint/ConstraintLayout;)V

    .line 87
    .end local v1    # "rect":Landroid/graphics/Rect;
    .end local v2    # "jbtVar":Ljbt;
    .end local v3    # "rect2":Landroid/graphics/Rect;
    .end local v4    # "size":Landroid/util/Size;
    .end local v5    # "point":Landroid/graphics/Point;
    .end local v6    # "jrzVar":Ljrz;
    .end local v7    # "width":I
    .end local v8    # "width2":I
    .end local v9    # "height":I
    .end local v10    # "height2":I
    .end local v11    # "constraintSetVar":LConstraintSet;
    :cond_0
    return-void
...
.method public final b(Landroid/support/constraint/ConstraintLayout;)V
    ...
    invoke-direct {v0, p0, p1}, Ldefpackage/aj;-><init>(Lifj;Landroid/support/constraint/ConstraintLayout;)V
    ...
    invoke-virtual {p0, v1}, Lifj;->a(Landroid/view/View;)V
    ...
    .line 108
    iget-object v4, p0, Lifj;->a:Lcom/google/android/apps/camera/bottombar/RoundedThumbnailView;

    iget-object v5, p0, Lifj;->c:Ljrz;

    invoke-static {v5}, Lmip;->eq(Ljrz;)I
