...
.method public final d()Z
    ...
    :try_start_0
    iget-object v5, p0, Leku;->c:Landroid/media/MediaCodec;
    ...
    iget-object v6, p0, Leku;->f:Lekt;

    iget-object v6, v6, Lekt;->e:Landroid/opengl/EGLContext;

    iget-object v7, p0, Leku;->c:Landroid/media/MediaCodec;

    invoke-virtual {v7}, Landroid/media/MediaCodec;->createInputSurface()Landroid/view/Surface;

    move-result-object v7

    invoke-direct {v5, v6, v7}, Lnlb;-><init>(Landroid/opengl/EGLContext;Landroid/view/Surface;)V

    .line 76
    .local v5, "nlbVar":Lnlb;
    iput-object v5, p0, Leku;->e:Lnlb;

    .line 77
    invoke-virtual {v5}, Lnlb;->b()V

    .line 78
    iget-object v6, p0, Leku;->f:Lekt;

    .line 79
    .local v6, "ektVar2":Lekt;
    new-instance v7, Lekv;

    iget-object v8, v6, Lekt;->f:Lcom/google/android/libraries/vision/opengl/Texture;

    iget v9, v6, Lekt;->d:I

    invoke-direct {v7, v8, v9}, Lekv;-><init>(Lcom/google/android/libraries/vision/opengl/Texture;I)V

    .line 80
    .local v7, "ekvVar":Lekv;
    iput-object v7, p0, Leku;->d:Lekv;
    ...
    .line 83
    invoke-virtual {v7, v8}, Lekv;->a([F)V

    .line 84
    iget-object v9, p0, Leku;->e:Lnlb;

    iget-object v9, v9, Lnlb;->a:Landroid/opengl/EGLDisplay;
    ...
    .line 86
    :try_start_1
    iget-object v9, p0, Leku;->c:Landroid/media/MediaCodec;

    invoke-virtual {v9}, Landroid/media/MediaCodec;->start()V

    .line 87
    iput-boolean v2, p0, Leku;->h:Z
    :try_end_1
    ...
    invoke-interface {v9, v2}, Lova;->h(Ljava/lang/Throwable;)Lova;
    ...
    .end local v5    # "nlbVar":Lnlb;
    .end local v6    # "ektVar2":Lekt;
    .end local v7    # "ekvVar":Lekv;
    .end local v8    # "fArr":[F
    :catch_1
    move-exception v2
    ...
    invoke-interface {v5, v2}, Lova;->h(Ljava/lang/Throwable;)Lova;
    ...
    iput-object v3, p0, Leku;->c:Landroid/media/MediaCodec;
    :try_end_3
