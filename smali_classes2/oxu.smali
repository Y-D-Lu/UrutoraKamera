...
.method public static constructor <clinit>()V
    ...
    .line 17
    .local v4, "ovmVar":Lovm;
    const/16 v5, 0xa

    new-array v6, v5, [Loxu;

    .line 18
    .local v6, "oxuVarArr":[Loxu;
    const/4 v7, 0x0
    ...
    sget-object v9, Lovn;->a:Lovn;

    invoke-direct {v8, v7, v4, v9}, Loxu;-><init>(ILovm;Lovn;)V
    ...
    .line 16
    .end local v4    # "ovmVar":Lovm;
    .end local v6    # "oxuVarArr":[Loxu;
    ...
    sput-object v1, Loxu;->c:Ljava/util/Map;
...
.method private constructor <init>(ILovm;Lovn;)V
    .locals 3
    .param p1, "i"    # I
    .param p2, "ovmVar"    # Lovm;
    .param p3, "ovnVar"    # Lovn;
    ...
    .line 32
    iget-object v0, p2, Lovm;->o:Ljava/lang/String;
    ...
    invoke-virtual {p3, v1}, Lovn;->f(Ljava/lang/StringBuilder;)V
...
.method public static b(ILovm;Lovn;)Loxu;
    .locals 1
    .param p0, "i"    # I
    .param p1, "ovmVar"    # Lovm;
    .param p2, "ovnVar"    # Lovn;
    ...
    :cond_0
    sget-object v0, Loxu;->c:Ljava/util/Map;
