...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    iput-object v0, p0, Lbga;->a:Landroid/content/Context;
...
.method public final a(Ljava/lang/Object;IILazt;)Lbff;
    ...
    iget-object v4, p0, Lbga;->a:Landroid/content/Context;

    invoke-direct {v3, v4, v0}, Lbfa;-><init>(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    invoke-direct {v1, v0}, Lblo;-><init>(Ljava/lang/Object;)V

    .line 37
    .local v1, "bloVar":Lblo;
    ...
    invoke-direct {v4, v5}, Lbat;-><init>(Landroid/content/ContentResolver;)V

    invoke-static {v2, v0, v4}, Lbav;->b(Landroid/content/Context;Landroid/net/Uri;Lbaw;)Lbav;

    move-result-object v4

    invoke-direct {v3, v1, v4}, Lbff;-><init>(Lazp;Lbac;)V

    return-object v3

    .line 47
    .end local v1    # "bloVar":Lblo;
    ...
    new-instance v5, Lbau;

    invoke-virtual {v2}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v6

    invoke-direct {v5, v6}, Lbau;-><init>(Landroid/content/ContentResolver;)V

    invoke-static {v2, v0, v5}, Lbav;->b(Landroid/content/Context;Landroid/net/Uri;Lbaw;)Lbav;

    move-result-object v5

    invoke-direct {v4, v1, v5}, Lbff;-><init>(Lazp;Lbac;)V

    return-object v4

    .line 45
    .end local v1    # "bloVar2":Lblo;
...
.method public final b(Ljava/lang/Object;)Z
    ...
    invoke-static {v0}, Lvj;->e(Landroid/net/Uri;)Z
