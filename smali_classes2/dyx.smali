...
.method public constructor <init>(Llxb;Ldzb;Ldyz;III)V
    ...
    .param p2, "dzbVar"    # Ldzb;
    .param p3, "dyzVar"    # Ldyz;
    .param p4, "i"    # I
    .param p5, "i2"    # I
    .param p6, "i3"    # I
    ...
    :goto_2
    iput-boolean v1, p0, Ldyx;->f:Z

    .line 35
    iput-boolean v2, p0, Ldyx;->h:Z
...
.method public final declared-synchronized a(Lhjz;Lhjz;)F
    ...
    .line 39
    :try_start_0
    iget-object v3, v1, Ldyx;->i:Ldza;

    .line 40
    .local v3, "dzaVar":Ldza;
    iget-boolean v4, v1, Ldyx;->h:Z
    ...
    invoke-virtual {v3, v4}, Ldza;->f(Landroid/graphics/Rect;)[F
    ...
    .line 47
    .local v14, "f3":[F
    iget-wide v5, v0, Lhjz;->b:J

    .line 48
    .local v5, "j2":J
    iget-wide v7, v0, Lhjz;->d:J
    ...
    .local v16, "f4":F
    .local v19, "f5":F
    iget-wide v7, v2, Lhjz;->b:J

    move-wide/from16 v17, v7

    .line 55
    .local v17, "j6":J
    iget-wide v7, v2, Lhjz;->d:J
    ...
    invoke-virtual/range {v4 .. v9}, Ldza;->c(JJ[F)J
    ...
    invoke-virtual/range {v10 .. v15}, Ldza;->c(JJ[F)J
    ...
    invoke-virtual {v3, v9, v10, v7}, Ldza;->b(J[F)J
    ...
    invoke-virtual/range {v16 .. v21}, Ldza;->c(JJ[F)J
    ...
    invoke-virtual/range {v22 .. v27}, Ldza;->c(JJ[F)J
    ...
    .local v13, "f6":[F
    .local v14, "j7":J
    invoke-virtual {v3, v14, v15, v13}, Ldza;->b(J[F)J

    move-result-wide v43

    .line 63
    .local v43, "b2":J
    invoke-virtual {v3, v8, v4, v7}, Ldza;->a(FF[F)F

    move-result v70

    .line 64
    .local v70, "a2":F
    invoke-virtual {v3, v2, v0, v13}, Ldza;->a(FF[F)F
    ...
    .local v16, "f5":F
    .local v19, "f4":F
    iget-object v2, v0, Lhjz;->a:Ljava/lang/String;

    iget-object v0, v3, Ldza;->d:Llig;
    ...
    invoke-virtual/range {v28 .. v38}, Ldza;->e(Ljava/lang/String;JJJLlig;[FZ)[F
    ...
    invoke-virtual/range {v39 .. v49}, Ldza;->e(Ljava/lang/String;JJJLlig;[FZ)[F

    move-result-object v2

    .line 67
    .local v2, "e2":[F
    iget-object v4, v3, Ldza;->b:Lenm;

    move-wide/from16 v57, v32

    move-wide/from16 v59, v34

    invoke-static/range {v55 .. v60}, Ldza;->d(JJJ)J
    ...
    invoke-static/range {v61 .. v66}, Ldza;->d(JJJ)J
    ...
    invoke-interface/range {v67 .. v77}, Lenm;->d(JFFFJFFF)[F

    move-result-object v4

    invoke-static {v4}, Lmou;->a([F)Lmou;
    ...
    invoke-virtual {v4, v0}, Lmou;->e([F)[F
    ...
    .end local v3    # "dzaVar":Ldza;
    .end local v4    # "a4":Lmou;
    .local v36, "dzaVar":Ldza;
    .local v39, "a4":Lmou;
    ...
    .end local v6    # "i":I
    .end local v26    # "arrayList":Ljava/util/ArrayList;
    .end local v36    # "dzaVar":Ldza;
    .end local v39    # "a4":Lmou;
    .end local v40    # "f3":[F
    .end local v47    # "f":F
    .end local v48    # "size":I
    .end local v53    # "j3":J
    .end local p0    # "this":Ldyx;
    .local v0, "arrayList":Ljava/util/ArrayList;
    .restart local v3    # "dzaVar":Ldza;
    .restart local v4    # "a4":Lmou;
...
.method public final b(JLhjz;)Ljava/util/List;
    ...
    iget-object v15, v1, Ldyx;->i:Ldza;

    .line 90
    .local v15, "dzaVar":Ldza;
    if-eqz v4, :cond_c
    ...
    iget-wide v11, v4, Lhjz;->c:J

    .line 112
    .local v11, "j2":J
    iget v13, v4, Lhjz;->g:F

    .line 113
    .local v13, "f":F
    iget v14, v4, Lhjz;->h:F

    .line 114
    .local v14, "f2":F
    iget-object v5, v4, Lhjz;->n:Landroid/graphics/Rect;

    invoke-virtual {v15, v5}, Ldza;->f(Landroid/graphics/Rect;)[F

    move-result-object v10

    .line 115
    .local v10, "f3":[F
    invoke-virtual {v15, v13, v14, v10}, Ldza;->a(FF[F)F

    move-result v24

    .line 116
    .local v24, "a3":F
    iget-wide v8, v4, Lhjz;->b:J

    .line 117
    .local v8, "j3":J
    iget-wide v6, v4, Lhjz;->d:J
    ...
    .end local v10    # "f3":[F
    .local v3, "f3":[F
    invoke-virtual/range {v5 .. v10}, Ldza;->c(JJ[F)J
    ...
    .end local v25    # "j4":J
    .local v9, "j4":J
    invoke-virtual {v15, v9, v10, v3}, Ldza;->b(J[F)J
    ...
    .line 168
    .local v8, "i6":I
    iget-object v12, v15, Ldza;->e:Ljava/lang/Object;
    ...
    .line 171
    :try_start_0
    iget-object v0, v15, Ldza;->f:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 177
    .local v22, "mouVar2":Lmou;
    move-wide/from16 v46, v1

    move-object/from16 v1, v19

    .end local v19    # "mouVar":Lmou;
    .local v1, "mouVar":Lmou;
    .local v46, "j5":J
    if-nez v1, :cond_1
    ...
    .end local v22    # "mouVar2":Lmou;
    .local v2, "mouVar2":Lmou;
    if-nez v2, :cond_2
    ...
    .end local v1    # "mouVar":Lmou;
    .local v51, "mouVar":Lmou;
    ...
    invoke-interface {v1, v10}, Lova;->G(I)Lova;
    ...
    invoke-interface {v1, v10}, Lova;->o(Ljava/lang/String;)V
    ...
    invoke-interface {v7, v9}, Lova;->G(I)Lova;
    ...
    invoke-interface {v7, v9}, Lova;->o(Ljava/lang/String;)V
    ...
    .line 250
    .end local v2    # "mouVar2":Lmou;
    .end local v51    # "mouVar":Lmou;
    move/from16 v13, v45
    ...
    .line 246
    .end local v0    # "obj":Ljava/lang/Object;
    .restart local v2    # "mouVar2":Lmou;
    .restart local v51    # "mouVar":Lmou;
    :catchall_1
    move-exception v0
    ...
    .local v45, "i6":I
    .restart local p0    # "this":Ldyx;
    .restart local p1    # "j":J
    .restart local p3    # "hjzVar":Lhjz;
    :cond_8
    move-wide/from16 v46, v1
    ...
    iget-object v1, v15, Ldza;->f:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 135
    .local v54, "j9":J
    iget-object v2, v4, Lhjz;->a:Ljava/lang/String;
    ...
    iget-object v6, v15, Ldza;->d:Llig;
    ...
    .end local v15    # "dzaVar":Ldza;
    .local v1, "dzaVar":Ldza;
    move/from16 v15, v20

    invoke-virtual/range {v5 .. v15}, Ldza;->e(Ljava/lang/String;JJJLlig;[FZ)[F
    ...
    .line 144
    .local v6, "fArr3":[F
    iget-object v7, v1, Ldza;->b:Lenm;

    add-long v36, v29, v50

    move-wide/from16 v38, v54

    invoke-static/range {v36 .. v41}, Ldza;->d(JJJ)J
    ...
    invoke-interface/range {v17 .. v23}, Lenm;->c(JFFF[F)Z
    ...
    invoke-interface {v0, v2, v5, v6}, Lova;->q(Ljava/lang/String;J)V
    ...
    iget-object v3, v2, Ldyx;->i:Ldza;

    .line 98
    .local v3, "dzaVar2":Ldza;
    if-eqz v3, :cond_f
...
.method public final declared-synchronized c()V
    ...
    .line 266
    new-instance v1, Ldefpackage/o7;

    invoke-direct {v1, p0, v0}, Ldefpackage/o7;-><init>(Ldyx;Llxa;)V
    ...
    .end local p0    # "this":Ldyx;
    :cond_0
    iget-object v1, p0, Ldyx;->g:Llxa;

    .line 274
    .local v1, "lxaVar2":Llxa;
    if-eqz v1, :cond_1

    .line 275
    invoke-interface {v1}, Llxa;->close()V

    .line 277
    :cond_1
    const/4 v2, 0x0

    iput-object v2, p0, Ldyx;->i:Ldza;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized f(Llig;Ljava/lang/String;)V
    ...
    iget-object v1, v0, Ldzb;->d:Lgsf;

    invoke-virtual {v1}, Lgsf;->b()Llig;
    ...
    iput-object v11, p0, Ldyx;->i:Ldza;

    .line 307
    iget-object v1, p0, Ldyx;->b:Llxb;

    invoke-interface {v1, p2}, Llxb;->a(Ljava/lang/String;)Llxa;

    move-result-object v1

    .line 308
    .local v1, "a2":Llxa;
    iput-object v1, p0, Ldyx;->g:Llxa;
    ...
    .line 293
    .end local v0    # "dzbVar":Ldzb;
    .end local v1    # "a2":Llxa;
