...
.method public constructor <init>(Landroid/media/MediaCodec;Landroid/media/MediaFormat;Lmpi;Lmrg;)V
    ...
    .param p3, "mpiVar"    # Lmpi;
    .param p4, "mrgVar"    # Lmrg;
    ...
    invoke-direct {v1, v2}, Lmrn;-><init>(Landroid/view/Surface;)V
    ...
    invoke-static {v2, v3}, Lmmf;->d(II)Lmme;

    move-result-object v2

    invoke-static {p3, v1, v2}, Lmrd;->l(Lmpi;Lmtu;Lmme;)Lmrd;
...
.method public final declared-synchronized a(Lmad;Lgbf;)Lgbe;
    ...
    iget-object v7, p0, Lgbd;->d:Lmpi;

    invoke-static {v7, v6}, Lmqg;->b(Lmpi;Lcom/google/android/libraries/oliveoil/gl/EGLImage;)Lmqg;
    ...
    .local v7, "b2":Lmqg;
    :try_start_1
    iget-object v8, p0, Lgbd;->d:Lmpi;

    new-instance v9, Ldefpackage/wd;

    invoke-direct {v9, p0, v3, v4}, Ldefpackage/wd;-><init>(Lgbd;J)V

    invoke-interface {v8, v9}, Ljava/util/concurrent/Executor;->execute(Ljava/lang/Runnable;)V

    .line 63
    iget-object v8, p0, Lgbd;->e:Lmrg;

    iget-object v9, p0, Lgbd;->a:Lmrd;

    invoke-virtual {v8, v7, v9, v1}, Lmrg;->e(Lmqg;Lmrd;[F)V
    ...
    .end local v7    # "b2":Lmqg;
    :goto_0
    const/4 v6, 0x1

    :try_start_2
    iput-boolean v6, p0, Lgbd;->f:Z
    ...
    :goto_1
    iget-object v8, p0, Lgbd;->c:Landroid/media/MediaCodec;
    ...
    .line 82
    iget-object v9, p0, Lgbd;->c:Landroid/media/MediaCodec;
    ...
    .line 84
    :cond_1
    new-instance v9, Lgbk;

    iget-object v10, p0, Lgbd;->c:Landroid/media/MediaCodec;

    invoke-direct {v9, v7, v10, v8}, Lgbk;-><init>(Landroid/media/MediaCodec$BufferInfo;Landroid/media/MediaCodec;I)V

    .line 85
    .local v9, "gbkVar":Lgbk;
    iget-object v10, v9, Lgbk;->a:Landroid/media/MediaCodec$BufferInfo;
    ...
    .line 86
    :cond_2
    invoke-virtual {v9}, Lgbk;->close()V
