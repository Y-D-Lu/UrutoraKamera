...
.method public constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    iput-object p1, p0, Lna;->c:Landroid/widget/ProgressBar;
...
.method private final b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v1, p2}, Lna;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;

    invoke-interface {v0}, Leq;->b()V
    ...
    :goto_2
    invoke-direct {p0, v5, v4}, Lna;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Lna;->a:Landroid/graphics/Bitmap;

    if-nez v2, :cond_6

    iput-object v0, p0, Lna;->a:Landroid/graphics/Bitmap;
...
.method public a(Landroid/util/AttributeSet;I)V
    ...
    iget-object v0, p0, Lna;->c:Landroid/widget/ProgressBar;
    ...
    invoke-virtual {p1, p2}, Lrn;->i(I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Lna;->c:Landroid/widget/ProgressBar;
    ...
    invoke-direct {p0, v7, v1}, Lna;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    invoke-virtual {p1, v1}, Lrn;->i(I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-eqz v0, :cond_3

    iget-object v1, p0, Lna;->c:Landroid/widget/ProgressBar;

    invoke-direct {p0, v0, p2}, Lna;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
