...
.method public final a()Laii;
    ...
    iget-object v0, v1, Laig;->f:Landroid/content/Context;

    if-eqz v0, :cond_18

    .line 42
    iget-object v2, v1, Laig;->b:Ljava/util/concurrent/Executor;

    .line 43
    .local v2, "executor2":Ljava/util/concurrent/Executor;
    if-nez v2, :cond_0

    iget-object v0, v1, Laig;->g:Ljava/util/concurrent/Executor;
    ...
    iput-object v0, v1, Laig;->g:Ljava/util/concurrent/Executor;

    .line 46
    iput-object v0, v1, Laig;->b:Ljava/util/concurrent/Executor;
    ...
    .line 48
    iput-object v2, v1, Laig;->g:Ljava/util/concurrent/Executor;
    ...
    .line 50
    iput-object v3, v1, Laig;->b:Ljava/util/concurrent/Executor;

    .line 52
    .end local v3    # "executor":Ljava/util/concurrent/Executor;
    :cond_2
    :goto_0
    iget-object v0, v1, Laig;->c:Lajt;

    .line 53
    .local v0, "ajtVar":Lajt;
    if-nez v0, :cond_3

    .line 54
    new-instance v3, Lakc;

    invoke-direct {v3}, Lakc;-><init>()V
    ...
    .line 56
    .end local v0    # "ajtVar":Lajt;
    .local v15, "ajtVar":Lajt;
    :goto_1
    move-object v6, v15

    .line 57
    .local v6, "ajtVar2":Lajt;
    iget-object v14, v1, Laig;->f:Landroid/content/Context;

    .line 58
    .local v14, "context":Landroid/content/Context;
    iget-object v13, v1, Laig;->e:Ljava/lang/String;

    .line 59
    .local v13, "str":Ljava/lang/String;
    iget-object v12, v1, Laig;->k:Laih;

    .line 60
    .local v12, "aihVar":Laih;
    iget-object v11, v1, Laig;->a:Ljava/util/ArrayList;

    .line 61
    .local v11, "arrayList":Ljava/util/ArrayList;
    iget-boolean v10, v1, Laig;->h:Z
    ...
    iget-object v9, v1, Laig;->b:Ljava/util/concurrent/Executor;

    iget-object v8, v1, Laig;->g:Ljava/util/concurrent/Executor;

    iget-boolean v7, v1, Laig;->i:Z

    iget-boolean v5, v1, Laig;->j:Z
    ...
    .end local v12    # "aihVar":Laih;
    .local v21, "aihVar":Laih;
    ...
    invoke-direct/range {v3 .. v14}, Lahy;-><init>(Landroid/content/Context;Ljava/lang/String;Lajt;Laih;Ljava/util/List;ZILjava/util/concurrent/Executor;Ljava/util/concurrent/Executor;ZZ)V

    .line 68
    .local v3, "ahyVar":Lahy;
    iget-object v0, v1, Laig;->d:Ljava/lang/Class;

    invoke-static {v0}, Lfw;->j(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    .line 69
    .local v4, "aiiVar":Laii;
    invoke-virtual {v4, v3}, Laii;->b(Lahy;)Laju;

    move-result-object v0

    iput-object v0, v4, Laii;->c:Laju;

    .line 70
    invoke-virtual {v4}, Laii;->d()Ljava/util/Set;
    ...
    .line 76
    iget-object v0, v3, Lahy;->g:Ljava/util/List;
    ...
    .end local v0    # "size":I
    :cond_6
    iget-object v11, v4, Laii;->g:Ljava/util/Map;

    .line 82
    .local v11, "map":Ljava/util/Map;
    invoke-virtual {v4}, Laii;->n()Ljava/util/List;
    ...
    .line 93
    const-class v13, Laix;

    iget-object v14, v4, Laii;->c:Laju;

    invoke-static {v13, v14}, Laii;->q(Ljava/lang/Class;Laju;)Ljava/lang/Object;
    ...
    .line 103
    .local v14, "ajuVar":Laju;
    move-object v0, v14

    check-cast v0, Lakb;

    iget-object v10, v0, Lakb;->a:Ljava/lang/Object;
    ...
    iget-object v0, v0, Lakb;->b:Laka;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1

    .line 105
    .local v0, "akaVar":Laka;
    if-eqz v0, :cond_8
    ...
    .line 108
    .restart local v0    # "akaVar":Laka;
    :cond_8
    :goto_7
    move-object/from16 v18, v0

    .end local v0    # "akaVar":Laka;
    .local v18, "akaVar":Laka;
    :try_start_2
    move-object v0, v14

    check-cast v0, Lakb;

    iput-boolean v13, v0, Lakb;->c:Z

    .line 109
    .end local v18    # "akaVar":Laka;
    monitor-exit v10
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1

    .line 110
    iget-object v0, v3, Lahy;->e:Ljava/util/List;

    iput-object v0, v4, Laii;->f:Ljava/util/List;

    .line 111
    iget-object v0, v3, Lahy;->i:Ljava/util/concurrent/Executor;

    iput-object v0, v4, Laii;->a:Ljava/util/concurrent/Executor;

    .line 112
    new-instance v0, Lajb;

    iget-object v10, v3, Lahy;->j:Ljava/util/concurrent/Executor;

    invoke-direct {v0, v10}, Lajb;-><init>(Ljava/util/concurrent/Executor;)V

    iput-object v0, v4, Laii;->b:Ljava/util/concurrent/Executor;

    .line 113
    iget-boolean v0, v3, Lahy;->h:Z

    iput-boolean v0, v4, Laii;->e:Z

    .line 114
    invoke-virtual {v4}, Laii;->c()Ljava/util/Map;
    ...
    iget-object v1, v3, Lahy;->f:Ljava/util/List;
    ...
    iget-object v5, v3, Lahy;->f:Ljava/util/List;
    ...
    .line 134
    iget-object v2, v4, Laii;->k:Ljava/util/Map;
    ...
    .restart local v29    # "executor2":Ljava/util/concurrent/Executor;
    .restart local v30    # "d":Ljava/util/Set;
    iget-object v0, v3, Lahy;->f:Ljava/util/List;
    ...
    .line 89
    .local v1, "ajdVar":Lajd;
    iget-object v2, v3, Lahy;->d:Laih;

    iget-object v2, v2, Laih;->a:Ljava/util/HashMap;
    ...
    new-array v10, v5, [Lajd;

    const/4 v5, 0x0

    aput-object v1, v10, v5

    invoke-virtual {v2, v10}, Laih;->a([Lajd;)V

    .line 92
    .end local v1    # "ajdVar":Lajd;
    :cond_13
    move-object/from16 v1, p0
    ...
    iget-object v1, v3, Lahy;->g:Ljava/util/List;
    ...
    .line 149
    :cond_15
    iget-object v2, v3, Lahy;->g:Ljava/util/List;
    ...
    .line 160
    iget-object v2, v4, Laii;->g:Ljava/util/Map;

    iget-object v5, v3, Lahy;->g:Ljava/util/List;
