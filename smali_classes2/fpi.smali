...
.method public constructor <init>(Lgvb;Llda;Landroid/util/DisplayMetrics;Lkas;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    iput-object v0, p0, Lfpi;->c:Ljava/util/Optional;
...
.method public final a(Landroid/view/MotionEvent;Landroid/view/MotionEvent;Landroid/graphics/Rect;Z)V
    ...
    iget-object v2, v0, Lfpi;->b:Lfvs;

    move-object/from16 v3, p1

    invoke-virtual {v2, v3}, Lfvs;->b(Landroid/view/MotionEvent;)V

    .line 67
    iget-object v2, v0, Lfpi;->k:Lkas;
    ...
    .line 74
    :cond_1
    iget-object v7, v0, Lfpi;->c:Ljava/util/Optional;
    ...
    iput-object v7, v0, Lfpi;->c:Ljava/util/Optional;

    .line 77
    :cond_2
    iget-object v7, v0, Lfpi;->g:Landroid/util/DisplayMetrics;
    ...
    .line 80
    .local v10, "z3":Z
    sget-object v11, Llic;->CLOCKWISE_0:Llic;

    const/4 v13, 0x0

    if-eq v9, v11, :cond_8

    sget-object v11, Llic;->CLOCKWISE_180:Llic;
    ...
    .line 113
    invoke-virtual/range {p0 .. p0}, Lfpi;->b()V
    ...
    invoke-static {v6, v11}, Lfpi;->f(FF)Landroid/util/Range;
    ...
    invoke-static {v1, v2}, Lfpi;->f(FF)Landroid/util/Range;

    move-result-object v1

    invoke-static {v11, v1}, Lfpi;->d(FLandroid/util/Range;)F
    ...
    .line 120
    invoke-static {v1, v6}, Lfpi;->e(FLandroid/util/Range;)F

    move-result v2

    .line 121
    .local v2, "e":F
    iget-object v11, v0, Lfpi;->b:Lfvs;

    invoke-virtual {v11}, Lfvs;->a()F
    ...
    invoke-static {v2, v5}, Lfpi;->d(FLandroid/util/Range;)F
    ...
    invoke-static {v2, v5}, Lfpi;->e(FLandroid/util/Range;)F
    ...
    invoke-static {v2, v3}, Lfpi;->f(FF)Landroid/util/Range;

    move-result-object v2

    invoke-static {v1, v2}, Lfpi;->e(FLandroid/util/Range;)F
    ...
    invoke-interface {v3, v8}, Llij;->fB(Ljava/lang/Object;)V
    ...
    iget-object v1, v0, Lfpi;->g:Landroid/util/DisplayMetrics;
    ...
    .line 143
    invoke-direct {v0, v5}, Lfpi;->g(Landroid/util/Range;)V
...
.method public final c(Landroid/util/Range;)V
    ...
    .line 164
    iget-object v3, p0, Lfpi;->i:Ljava/util/concurrent/ScheduledExecutorService;

    new-instance v4, Lfph;

    const/4 v5, 0x0

    invoke-direct {v4, p0, p1, v5}, Lfph;-><init>(Lfpi;Landroid/util/Range;I)V
