...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lmh;->r:Landroid/util/SparseBooleanArray;

    .line 38
    new-instance v0, Lmg;

    invoke-direct {v0, p0}, Lmg;-><init>(Lmh;)V

    iput-object v0, p0, Lmh;->l:Lmg;
...
.method public final a(Lkz;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    :cond_1
    iget-object v2, p0, Lkj;->d:Landroid/view/LayoutInflater;
    ...
    .local v2, "llVar":Lll;
    :goto_0
    invoke-interface {v2, p1}, Lll;->f(Lkz;)V
    ...
    iget-object v4, p0, Lkj;->f:Llm;

    check-cast v4, Landroid/support/v7/widget/ActionMenuView;

    iput-object v4, v3, Landroid/support/v7/view/menu/ActionMenuItemView;->b:Lkv;

    .line 50
    iget-object v4, p0, Lmh;->s:Lki;
    ...
    invoke-direct {v4, p0}, Lki;-><init>(Lmh;)V

    iput-object v4, p0, Lmh;->s:Lki;

    .line 53
    :cond_2
    iget-object v4, p0, Lmh;->s:Lki;

    iput-object v4, v3, Landroid/support/v7/view/menu/ActionMenuItemView;->c:Lki;
    ...
    instance-of v4, v3, Lmk;

    if-nez v4, :cond_5

    .line 63
    invoke-static {v3}, Landroid/support/v7/widget/ActionMenuView;->n(Landroid/view/ViewGroup$LayoutParams;)Lmk;
...
.method public final b(Landroid/content/Context;Lkw;)V
    ...
    .line 80
    .local v1, "i":I
    iget-boolean v2, p0, Lmh;->m:Z

    if-eqz v2, :cond_2

    .line 81
    iget-object v2, p0, Lmh;->g:Lme;
    ...
    iget-object v3, p0, Lkj;->a:Landroid/content/Context;

    invoke-direct {v2, p0, v3}, Lme;-><init>(Lmh;Landroid/content/Context;)V

    iput-object v2, p0, Lmh;->g:Lme;
...
.method public final e()Z
    ...
    .line 148
    .local v15, "i7":I
    iget-object v7, v0, Lmh;->r:Landroid/util/SparseBooleanArray;
    ...
    .end local v5    # "i2":I
    .local v19, "i2":I
    invoke-virtual {v0, v4, v2, v9}, Lmh;->a(Lkz;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 166
    :cond_4
    invoke-virtual {v4, v14}, Lkz;->k(Z)V
    ...
    invoke-virtual {v6, v7}, Lkz;->k(Z)V

    .line 187
    .end local v6    # "kzVar3":Lkz;
    :cond_d
    ...
    .line 200
    :cond_10
    invoke-virtual {v4, v11}, Lkz;->k(Z)V
    ...
    invoke-virtual {v4, v7}, Lkz;->k(Z)V
    ...
    .restart local v11    # "z3":Z
    :goto_9
    iget-boolean v4, v0, Lmh;->q:Z

    if-eqz v4, :cond_16

    iget-boolean v4, v1, Lkz;->p:Z
...
.method public final f(Lls;)Z
    ...
    .local v1, "lsVar2":Lls;
    :goto_0
    iget-object v3, v1, Lls;->j:Lkw;

    .line 220
    .local v3, "kwVar":Lkw;
    iget-object v4, p0, Lkj;->c:Lkw;
    ...
    iget-object v4, v1, Lls;->k:Lkz;

    .line 226
    .local v4, "kzVar":Lkz;
    iget-object v3, p0, Lkj;->f:Llm;
    ...
    iget-object v9, p0, Lkj;->b:Landroid/content/Context;

    invoke-direct {v3, p0, v9, p1, v6}, Lmb;-><init>(Lmh;Landroid/content/Context;Lls;Landroid/view/View;)V

    .line 261
    .local v3, "mbVar":Lmb;
    iput-object v3, p0, Lmh;->j:Lmb;

    .line 262
    invoke-virtual {v3, v0}, Lli;->d(Z)V

    .line 263
    iget-object v9, p0, Lmh;->j:Lmb;

    invoke-virtual {v9}, Lli;->h()Z
    ...
    .line 272
    invoke-interface {v9, v10}, Llj;->b(Lkw;)Z
    ...
    .line 264
    .end local v9    # "ljVar":Llj;
    .end local v10    # "lsVar3":Lls;
    :cond_6
...
.method public final i()V
    ...
    .line 288
    invoke-virtual {v4}, Lkw;->k()V

    .line 289
    iget-object v5, p0, Lkj;->c:Lkw;

    invoke-virtual {v5}, Lkw;->f()Ljava/util/ArrayList;
    ...
    invoke-interface {v11}, Lll;->a()Lkz;
    ...
    .local v11, "a":Lkz;
    :goto_1
    invoke-virtual {p0, v9, v10, v0}, Lmh;->a(Lkz;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 327
    iget-object v5, v4, Lkw;->d:Ljava/util/ArrayList;
    ...
    .line 335
    invoke-virtual {v5}, Lkw;->e()Ljava/util/ArrayList;

    move-result-object v1

    .line 337
    :cond_a
    iget-boolean v6, p0, Lmh;->m:Z
    ...
    iget-object v8, p0, Lkj;->a:Landroid/content/Context;

    invoke-direct {v3, p0, v8}, Lme;-><init>(Lmh;Landroid/content/Context;)V

    iput-object v3, p0, Lmh;->g:Lme;
    ...
    iget-object v9, p0, Lmh;->g:Lme;

    invoke-virtual {v8, v9}, Landroid/view/ViewGroup;->removeView(Landroid/view/View;)V

    .line 369
    .end local v6    # "parent":Landroid/view/ViewParent;
    .end local v7    # "lmVar":Llm;
    :cond_11
    iget-object v6, p0, Lkj;->f:Llm;

    check-cast v6, Landroid/support/v7/widget/ActionMenuView;

    iget-boolean v7, p0, Lmh;->m:Z
...
.method public final j(Landroid/support/v7/widget/ActionMenuView;)V
    ...
    .line 373
    iput-object p1, p0, Lkj;->f:Llm;

    .line 374
    iget-object v0, p0, Lkj;->c:Lkw;
...
.method public final k()Z
    ...
    iput-object v2, p0, Lmh;->k:Lmc;

    .line 383
    return v1

    .line 385
    .end local v3    # "lmVar":Llm;
    :cond_0
    iget-object v2, p0, Lmh;->i:Lmf;
...
.method public final m()Z
    ...
    invoke-virtual {v1}, Lkw;->e()Ljava/util/ArrayList;
    ...
    iget-object v3, p0, Lkj;->b:Landroid/content/Context;

    iget-object v4, p0, Lkj;->c:Lkw;

    iget-object v5, p0, Lmh;->g:Lme;

    invoke-direct {v2, p0, v3, v4, v5}, Lmf;-><init>(Lmh;Landroid/content/Context;Lkw;Landroid/view/View;)V

    invoke-direct {v0, p0, v2}, Lmc;-><init>(Lmh;Lmf;)V
