...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lknx;->a:Ljava/util/concurrent/ConcurrentHashMap;

    .line 22
    return-void
.end method

.method public static a()Lknx;
    .locals 2
    ...
    .line 26
    sget-object v0, Lknx;->b:Ljava/lang/Object;

    monitor-enter v0

    .line 27
    :try_start_0
    sget-object v1, Lknx;->c:Lknx;
...
.method public final b(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    ...
    .line 49
    invoke-static {p2}, Lknx;->e(Landroid/content/ServiceConnection;)Z

    move-result v0

    if-eqz v0, :cond_1

    iget-object v0, p0, Lknx;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {p1, v0}, Lknx;->d(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object v1, p0, Lknx;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_1
    :goto_0
    invoke-static {p1, p2}, Lknx;->d(Landroid/content/Context;Landroid/content/ServiceConnection;)V
...
.method public final c(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    invoke-virtual {v4, v3, v2}, Lkhx;->f(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    :cond_1
    :goto_0
    invoke-static {p4}, Lknx;->e(Landroid/content/ServiceConnection;)Z
    ...
    .line 74
    iget-object v3, p0, Lknx;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 85
    iget-object v2, p0, Lknx;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 85
    iget-object v4, p0, Lknx;->a:Ljava/util/concurrent/ConcurrentHashMap;
