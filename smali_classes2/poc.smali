...
.method private static c(Ljava/util/Iterator;I)Lpoc;
    ...
    invoke-static {p0, v3}, Lpoc;->c(Ljava/util/Iterator;I)Lpoc;
    ...
    .line 64
    invoke-static {v2, v3}, Lpra;->g(Lpoc;Lpoc;)Lpoc;
    ...
    .line 68
    .local v7, "praVar":Lpra;
    iget-object v8, v7, Lpra;->f:Lpoc;
    ...
    iget-object v6, v7, Lpra;->e:Lpoc;

    iget-object v8, v7, Lpra;->f:Lpoc;

    invoke-static {v8, v3}, Lpra;->g(Lpoc;Lpoc;)Lpoc;

    move-result-object v8

    invoke-direct {v0, v6, v8}, Lpra;-><init>(Lpoc;Lpoc;)V
    ...
    invoke-virtual {v6}, Lpoc;->f()I

    move-result v6

    iget-object v8, v7, Lpra;->f:Lpoc;

    invoke-virtual {v8}, Lpoc;->f()I
    ...
    iget-object v9, v7, Lpra;->f:Lpoc;

    invoke-direct {v8, v9, v3}, Lpra;-><init>(Lpoc;Lpoc;)V
    ...
    invoke-direct {v0, v2, v3}, Lpra;-><init>(Lpoc;Lpoc;)V
    ...
    invoke-static {v2, v0}, Lplk;->aK(Lpoc;Ljava/util/ArrayDeque;)V

    .line 80
    invoke-static {v3, v0}, Lplk;->aK(Lpoc;Ljava/util/ArrayDeque;)V
    ...
    invoke-direct {v7, v8, v6}, Lpra;-><init>(Lpoc;Lpoc;)V
...
.method public static s(Ljava/nio/ByteBuffer;)Lpoc;
    ...
    invoke-direct {v2, v1}, Lpob;-><init>([B)V
...
.method public static u([BII)Lpoc;
    ...
    invoke-direct {v1, v0}, Lpob;-><init>([B)V
...
.method public static w(Ljava/io/InputStream;)Lpoc;
    ...
    invoke-static {v2, v4, v3}, Lpoc;->u([BII)Lpoc;
    ...
    invoke-static {v3, v2}, Lpoc;->c(Ljava/util/Iterator;I)Lpoc;
...
.method public static y([BII)Lpoc;
    .locals 1
    .param p0, "bArr"    # [B
    .param p1, "i"    # I
    .param p2, "i2"    # I
...
.method public final hashCode()I
    ...
    invoke-virtual {p0, v1, v2, v1}, Lpoc;->i(III)I
...
.method public bridge synthetic iterator()Ljava/util/Iterator;
    ...
    .line 15
    invoke-virtual {p0}, Lpoc;->iterator()Lpnz;
