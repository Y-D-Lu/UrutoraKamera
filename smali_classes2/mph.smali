...
.method public final call()Ljava/lang/Object;
    ...
    iget-object v1, v0, Lmph;->a:Lmpi;

    .line 24
    .local v1, "mpiVar":Lmpi;
    iget-object v2, v0, Lmph;->b:Lcom/google/android/libraries/oliveoil/gl/EGLImage;
    ...
    .line 34
    .local v16, "mqqVar":Lmqq;
    new-instance v17, Lmqt;

    invoke-interface/range {v16 .. v16}, Lmqq;->h()Lmrh;

    move-result-object v4

    invoke-interface/range {v16 .. v16}, Lmqq;->f()Landroid/opengl/EGLDisplay;

    move-result-object v5

    invoke-interface/range {v16 .. v16}, Lmqq;->g()Landroid/opengl/EGLSurface;

    move-result-object v6

    invoke-interface/range {v16 .. v16}, Lmqq;->e()Landroid/opengl/EGLContext;

    move-result-object v7

    invoke-interface/range {v16 .. v16}, Lmqq;->d()Landroid/opengl/EGLConfig;

    move-result-object v8

    new-instance v10, Lmor;

    invoke-virtual {v2}, Lcom/google/android/libraries/oliveoil/gl/EGLImage;->b()Lmme;

    move-result-object v3

    invoke-direct {v10, v3}, Lmor;-><init>(Lmme;)V
    ...
    invoke-direct/range {v3 .. v13}, Lmqt;-><init>(Lmrh;Landroid/opengl/EGLDisplay;Landroid/opengl/EGLSurface;Landroid/opengl/EGLContext;Landroid/opengl/EGLConfig;ILmor;Lmqq;II)V
