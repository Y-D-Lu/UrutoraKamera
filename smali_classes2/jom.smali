...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v2, p0, Ljom;->G:Landroid/graphics/RectF;

    const-wide/16 v2, -0x1

    iput-wide v2, p0, Ljom;->h:J
    ...
    iput-boolean v0, p0, Ljom;->k:Z

    const-string v3, ""

    iput-object v3, p0, Ljom;->l:Ljava/lang/String;

    const/4 v3, 0x0

    iput-object v3, p0, Ljom;->m:Landroid/animation/AnimatorSet;

    iput-object v3, p0, Ljom;->H:Landroid/animation/AnimatorSet;

    const/4 v3, 0x4

    invoke-virtual {p0, v3}, Ljom;->setVisibility(I)V
    ...
    iput-object v3, p0, Ljom;->q:Landroid/view/animation/Interpolator;

    invoke-virtual {p0}, Ljom;->getContext()Landroid/content/Context;
    ...
    iput-object v3, p0, Ljom;->r:Landroid/view/animation/Interpolator;

    new-instance v3, Landroid/graphics/Paint;

    invoke-direct {v3}, Landroid/graphics/Paint;-><init>()V

    iput-object v3, p0, Ljom;->a:Landroid/graphics/Paint;
    ...
    iput-object v4, p0, Ljom;->p:Landroid/graphics/Paint;
    ...
    iput-object v4, p0, Ljom;->b:Landroid/graphics/Paint;
    ...
    iput-object v2, p0, Ljom;->c:Landroid/graphics/Paint;
    ...
    iput-object v3, p0, Ljom;->s:Ljava/lang/String;

    new-instance v5, Ljoj;

    invoke-direct {v5, p0}, Ljoj;-><init>(Ljom;)V
    ...
    :goto_0
    iput-boolean v0, p0, Ljom;->A:Z

    return-void
.end method

.method static bridge synthetic c(Ljom;)V
    .locals 1
...
.method static bridge synthetic d(Ljom;)V
    .locals 2

    const-wide/16 v0, -0x1

    iput-wide v0, p0, Ljom;->h:J
...
.method public final a()V
    ...
    invoke-direct {v2, p0, v3}, Ljoi;-><init>(Ljom;I)V

    invoke-direct {p0, v1, v2}, Ljom;->f(Landroid/animation/ValueAnimator;Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V
    ...
    invoke-direct {p0, v0, v2}, Ljom;->f(Landroid/animation/ValueAnimator;Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V
    ...
    iput-object v0, p0, Ljom;->H:Landroid/animation/AnimatorSet;
    ...
    invoke-direct {v1, p0}, Ljol;-><init>(Ljom;)V
...
.method public final b(I)V
    ...
    iget-object p1, p0, Ljom;->H:Landroid/animation/AnimatorSet;
    ...
    iget-object p1, p0, Ljom;->m:Landroid/animation/AnimatorSet;
    ...
    invoke-direct {p0, v1, v2}, Ljom;->e(Landroid/animation/ValueAnimator;Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V
    ...
    invoke-direct {v3, p0, v0}, Ljoi;-><init>(Ljom;I)V

    invoke-direct {p0, v2, v3}, Ljom;->e(Landroid/animation/ValueAnimator;Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V
    ...
    invoke-direct {v3, p0, p1}, Ljoi;-><init>(Ljom;I)V

    invoke-direct {p0, v0, v3}, Ljom;->e(Landroid/animation/ValueAnimator;Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V
    ...
    iput-object v0, p0, Ljom;->m:Landroid/animation/AnimatorSet;
    ...
    invoke-direct {v0, p0}, Ljok;-><init>(Ljom;)V
    ...
    invoke-virtual {p0}, Ljom;->invalidate()V
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v2, p0, Ljom;->l:Ljava/lang/String;
    ...
    iget-object v2, p0, Ljom;->s:Ljava/lang/String;
    ...
    iget-object v4, p0, Ljom;->b:Landroid/graphics/Paint;
    ...
    iget-object v1, p0, Ljom;->l:Ljava/lang/String;
    ...
    iget-object v1, p0, Ljom;->s:Ljava/lang/String;
    ...
    iget-object v4, p0, Ljom;->c:Landroid/graphics/Paint;
    ...
    invoke-virtual {p0, v1}, Ljom;->announceForAccessibility(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, p0, Ljom;->G:Landroid/graphics/RectF;
    ...
    iget-object v11, p0, Ljom;->p:Landroid/graphics/Paint;
