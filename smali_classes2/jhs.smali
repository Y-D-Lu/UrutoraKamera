...
.method public constructor <init>(Landroid/content/Context;Lddf;)V
    ...
    invoke-direct/range {p0 .. p0}, Ljhs;-><init>()V
    ...
    iput-boolean v3, v0, Ljhs;->c:Z

    .line 40
    iget-object v3, v0, Ljhs;->a:Ljava/util/List;

    .line 41
    .local v3, "list":Ljava/util/List;
    sget-object v10, Lcuv;->STANDARD:Lcuv;

    .line 42
    .local v10, "cuvVar":Lcuv;
    const v4, 0x7f1104fd
    ...
    invoke-direct/range {v4 .. v9}, Ljhp;-><init>(Ljava/lang/Object;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V
    ...
    .line 46
    iget-object v4, v0, Ljhs;->a:Ljava/util/List;
    ...
    invoke-direct/range {v13 .. v18}, Ljhp;-><init>(Ljava/lang/Object;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V

    invoke-interface {v4, v8}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 52
    .end local v4    # "list2":Ljava/util/List;
    .end local v5    # "cuvVar2":Lcuv;
    ...
    sget-object v5, Lcuv;->ACTIVE:Lcuv;

    .line 55
    .local v5, "cuvVar3":Lcuv;
    const v6, 0x7f1104fc
    ...
    sget-object v5, Lcuv;->CINEMATIC:Lcuv;

    .line 62
    .local v5, "cuvVar4":Lcuv;
    const v6, 0x7f1104ff
...
.method public constructor <init>(Landroid/content/Context;Lddf;[B)V
    ...
    iput-boolean v2, v0, Ljhs;->c:Z

    .line 71
    iget-object v2, v0, Ljhs;->a:Ljava/util/List;
    ...
    new-instance v5, Ljhp;

    sget-object v14, Lhss;->MARS_STORE:Lhss;
...
.method public final d(I)V
    ...
    .line 96
    invoke-virtual {p0, p1}, Ljhs;->getItem(I)Ljhp;
    ...
    invoke-interface {v0, v1}, Ljhq;->a(Ljhp;)V
...
.method public final e(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v2}, Ljhs;->d(I)V

    .line 114
    return-void

    .line 116
    .end local v1    # "jhpVar":Ljhp;
    :cond_0
    goto :goto_0
...
.method public final getItem(I)Ljhp;
    .locals 1
    .param p1, "i"    # I
...
.method public final getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 136
    .local v1, "jhrVar":Ljhr;
    invoke-virtual {p2, v1}, Landroid/view/View;->setTag(Ljava/lang/Object;)V

    goto :goto_0

    .line 138
    .end local v1    # "jhrVar":Ljhr;
    :cond_0
    ...
    invoke-static {v0, v3}, Laar;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p3, v4}, Lobr;->e(Landroid/view/View;I)I
    ...
    .line 158
    .local v4, "e":I
    iget-object v5, v1, Ljhr;->e:Landroid/widget/ImageView;

    invoke-virtual {v5, v4}, Landroid/widget/ImageView;->setColorFilter(I)V

    .line 159
    iget-object v5, v1, Ljhr;->c:Landroid/widget/TextView;

    invoke-virtual {v5, v4}, Landroid/widget/TextView;->setTextColor(I)V

    .line 160
    iget-object v5, v1, Ljhr;->d:Landroid/widget/TextView;
    ...
    .line 165
    :goto_1
    iget-object v4, v1, Ljhr;->a:Landroid/view/ViewGroup;
    ...
    .line 169
    iget-object v3, v1, Ljhr;->e:Landroid/widget/ImageView;
    ...
    .line 176
    iget-object v3, v1, Ljhr;->f:Landroid/widget/ImageView;
    ...
    .line 180
    :cond_6
    iget-object v4, v1, Ljhr;->c:Landroid/widget/TextView;

    iget-object v5, v2, Ljhp;->b:Ljava/lang/String;

    invoke-virtual {v4, v5}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    .line 181
    iget-object v4, v1, Ljhr;->d:Landroid/widget/TextView;
    ...
    .line 183
    iget-boolean v5, v2, Ljhp;->f:Z

    if-eqz v5, :cond_7

    iget-object v5, v2, Ljhp;->d:Ljava/lang/String;

    goto :goto_3

    :cond_7
    iget-object v5, v2, Ljhp;->e:Ljava/lang/String;
