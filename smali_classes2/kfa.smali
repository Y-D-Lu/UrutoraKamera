...
.method public final b(Lkex;Ljava/lang/String;)V
    .locals 2

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Lkex;->toString()Ljava/lang/String;
    ...
    :goto_1
    invoke-virtual {p0, p2, p1}, Lkdt;->u(Ljava/lang/String;Ljava/lang/Object;)V
...
.method public final declared-synchronized c(ILjava/lang/String;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0}, Lkdt;->g()Lken;

    move-result-object v0

    iget-object v1, v0, Lken;->b:Ljava/lang/Boolean;
    ...
    sget-object v5, Lkob;->a:Ljava/lang/String;
    ...
    :try_start_6
    invoke-static {v7}, Lkoa;->a(Ljava/io/Closeable;)V
    :try_end_6
    ...
    :goto_0
    :try_start_8
    invoke-static {v4}, Lkoa;->a(Ljava/io/Closeable;)V
    ...
    :goto_2
    sput-object v5, Lkob;->a:Ljava/lang/String;
    ...
    iput-object v1, v0, Lken;->b:Ljava/lang/Boolean;
    ...
    invoke-virtual {v1, v5}, Lkdt;->n(Ljava/lang/String;)V
    ...
    :cond_8
    :goto_4
    iget-object v0, v0, Lken;->b:Ljava/lang/Boolean;
    ...
    sget-object v1, Lkdv;->a:Ljava/lang/String;

    invoke-static {p3}, Lkfa;->C(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object p3

    invoke-static {p4}, Lkfa;->C(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object p4

    invoke-static {p5}, Lkfa;->C(Ljava/lang/Object;)Ljava/lang/String;
    ...
    :cond_a
    iget-object p2, p0, Lkdt;->b:Lkdx;

    iget-object p3, p2, Lkdx;->f:Lkff;

    if-eqz p3, :cond_c

    invoke-virtual {p3}, Lkdu;->B()Z
    ...
    :cond_b
    iget-object v4, p2, Lkdx;->f:Lkff;

    :cond_c
    :goto_6
    if-eqz v4, :cond_11

    iget-object p2, v4, Lkff;->d:Lkfe;

    iget-object p3, p2, Lkfe;->a:Lkff;

    iget-object p3, p3, Lkff;->a:Landroid/content/SharedPreferences;

    invoke-virtual {p2}, Lkfe;->b()Ljava/lang/String;
    ...
    iget-object p5, p2, Lkfe;->a:Lkff;

    iget-object p5, p5, Lkff;->a:Landroid/content/SharedPreferences;

    invoke-interface {p5}, Landroid/content/SharedPreferences;->edit()Landroid/content/SharedPreferences$Editor;

    move-result-object p5

    invoke-virtual {p2}, Lkfe;->a()Ljava/lang/String;
    ...
    invoke-virtual {p2}, Lkfe;->c()Ljava/lang/String;
