...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v2, p0}, Ltg;-><init>(Lth;)V

    invoke-virtual {p0, v2}, Lth;->setOutlineProvider(Landroid/view/ViewOutlineProvider;)V
    ...
    iput-object v2, p0, Lth;->h:Landroid/view/animation/Interpolator;
    ...
    iput-object v4, p0, Lth;->b:Landroid/content/res/ColorStateList;

    iget-object v4, p0, Lth;->a:Landroid/graphics/drawable/ShapeDrawable;

    invoke-virtual {v4}, Landroid/graphics/drawable/ShapeDrawable;->getPaint()Landroid/graphics/Paint;

    move-result-object v4

    iget-object v5, p0, Lth;->b:Landroid/content/res/ColorStateList;
    ...
    iput-object v4, p0, Lth;->c:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v4}, Lth;->b(I)V
    ...
    invoke-virtual {p0, v4}, Lth;->a(F)V
    ...
    invoke-virtual {p0, v3}, Lth;->setClickable(Z)V
...
.method public final a(F)V
    ...
    sget-object v1, Lth;->PRESSED_ENABLED_STATE_SET:[I
    ...
    sget-object v1, Lth;->ENABLED_FOCUSED_STATE_SET:[I
    ...
    invoke-direct {p0, p1}, Lth;->d(Landroid/animation/Animator;)V

    invoke-virtual {v0, v1, p1}, Landroid/animation/StateListAnimator;->addState([ILandroid/animation/Animator;)V

    sget-object p1, Lth;->EMPTY_STATE_SET:[I

    new-array v1, v2, [F

    invoke-virtual {p0}, Lth;->getElevation()F
    ...
    invoke-direct {p0, v1}, Lth;->d(Landroid/animation/Animator;)V

    invoke-virtual {v0, p1, v1}, Landroid/animation/StateListAnimator;->addState([ILandroid/animation/Animator;)V

    invoke-virtual {p0, v0}, Lth;->setStateListAnimator(Landroid/animation/StateListAnimator;)V
...
.method public final b(I)V
    ...
    invoke-virtual {p0}, Lth;->isInEditMode()Z
    ...
    iput-object v0, p0, Lth;->g:Landroid/graphics/drawable/RippleDrawable;
    ...
    iput-object p1, p0, Lth;->g:Landroid/graphics/drawable/RippleDrawable;

    iget-object p1, p0, Lth;->a:Landroid/graphics/drawable/ShapeDrawable;
...
.method protected final drawableStateChanged()V
    ...
    iget-object v0, p0, Lth;->a:Landroid/graphics/drawable/ShapeDrawable;

    invoke-virtual {v0}, Landroid/graphics/drawable/ShapeDrawable;->getPaint()Landroid/graphics/Paint;

    move-result-object v0

    iget-object v1, p0, Lth;->b:Landroid/content/res/ColorStateList;

    invoke-virtual {p0}, Lth;->getDrawableState()[I

    move-result-object v2

    iget-object v3, p0, Lth;->b:Landroid/content/res/ColorStateList;
...
.method protected final onLayout(ZIIII)V
    ...
    iget-object p1, p0, Lth;->c:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p2, p0, Lth;->c:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p3, p0, Lth;->c:Landroid/graphics/drawable/Drawable;

    invoke-static {p3}, Lth;->c(Landroid/graphics/drawable/Drawable;)Z
    ...
    iget-object p5, p0, Lth;->c:Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p5}, Lth;->c(Landroid/graphics/drawable/Drawable;)Z
...
.method protected final onMeasure(II)V
    ...
    :cond_3
    iget-object v2, p0, Lth;->c:Landroid/graphics/drawable/Drawable;

    invoke-static {v2}, Lth;->c(Landroid/graphics/drawable/Drawable;)Z
    ...
    iget-object v3, p0, Lth;->c:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0}, Lth;->getResources()Landroid/content/res/Resources;
    ...
    :goto_4
    invoke-virtual {p0, p1, p1}, Lth;->setMeasuredDimension(II)V
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :pswitch_0
    invoke-virtual {p0}, Lth;->getBackground()Landroid/graphics/drawable/Drawable;
