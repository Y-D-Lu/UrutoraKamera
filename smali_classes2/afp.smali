...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p0, v1}, Lafm;-><init>(Lafp;Landroid/os/Looper;)V
...
.method public static a(Landroid/content/Context;)Lafp;
    ...
    invoke-direct {v1, v2}, Lafp;-><init>(Landroid/content/Context;)V
...
.method public final b(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)V
    ...
    iget-object v6, p0, Lafp;->f:Ljava/util/HashMap;
...
.method public final c(Landroid/content/BroadcastReceiver;)V
    ...
    .line 71
    .local v4, "afoVar":Lafo;
    iput-boolean v3, v4, Lafo;->d:Z
    ...
    .local v5, "i":I
    :goto_1
    iget-object v6, v4, Lafo;->a:Landroid/content/IntentFilter;
    ...
    .line 78
    .local v9, "afoVar2":Lafo;
    iget-object v10, v9, Lafo;->b:Landroid/content/BroadcastReceiver;

    if-ne v10, p1, :cond_1

    .line 79
    iput-boolean v3, v9, Lafo;->d:Z

    .line 80
    invoke-virtual {v7, v8}, Ljava/util/ArrayList;->remove(I)Ljava/lang/Object;

    .line 76
    .end local v9    # "afoVar2":Lafo;
    :cond_1
    ...
    .line 84
    iget-object v8, p0, Lafp;->f:Ljava/util/HashMap;
...
.method public final d(Landroid/content/Intent;)V
    ...
    iget-object v3, v1, Lafp;->b:Ljava/util/HashMap;
    ...
    iget-object v4, v1, Lafp;->a:Landroid/content/Context;
    ...
    .line 110
    :cond_0
    iget-object v5, v1, Lafp;->f:Ljava/util/HashMap;
    ...
    iget-object v6, v8, Lafo;->a:Landroid/content/IntentFilter;
    ...
    iget-object v5, v8, Lafo;->a:Landroid/content/IntentFilter;
    ...
    .end local v8    # "afoVar":Lafo;
    .local v0, "afoVar":Lafo;
    ...
    .end local v5    # "i3":I
    :cond_8
    iget-object v5, v1, Lafp;->c:Ljava/util/ArrayList;

    new-instance v6, Lafn;

    invoke-direct {v6, v2, v0}, Lafn;-><init>(Landroid/content/Intent;Ljava/util/ArrayList;)V

    invoke-virtual {v5, v6}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 163
    iget-object v5, v1, Lafp;->g:Landroid/os/Handler;
