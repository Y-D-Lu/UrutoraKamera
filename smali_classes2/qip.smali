...
.method public constructor <init>(JLjava/util/concurrent/TimeUnit;Ljava/util/concurrent/ThreadFactory;)V
    ...
    iput-object v2, p0, Lqip;->b:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    iput-object v2, p0, Lqip;->c:Lqby;

    .line 28
    iput-object p4, p0, Lqip;->d:Ljava/util/concurrent/ThreadFactory;
    ...
    :goto_1
    iput-object v2, p0, Lqip;->e:Ljava/util/concurrent/ScheduledExecutorService;

    .line 37
    iput-object v3, p0, Lqip;->f:Ljava/util/concurrent/Future;
...
.method public final a()V
    ...
    .line 42
    iget-object v0, p0, Lqip;->c:Lqby;

    invoke-virtual {v0}, Lqby;->gT()V

    .line 43
    iget-object v0, p0, Lqip;->f:Ljava/util/concurrent/Future;
    ...
    .line 47
    :cond_0
    iget-object v1, p0, Lqip;->e:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public final run()V
    ...
    .line 55
    iget-object v0, p0, Lqip;->b:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    .line 57
    .local v0, "nanoTime":J
    iget-object v2, p0, Lqip;->b:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    .line 60
    .local v3, "qirVar":Lqir;
    iget-wide v4, v3, Lqir;->a:J
    ...
    .line 63
    :cond_0
    iget-object v4, p0, Lqip;->b:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    .line 64
    iget-object v4, p0, Lqip;->c:Lqby;

    invoke-virtual {v4, v3}, Lqby;->e(Lqbz;)V

    .line 66
    .end local v3    # "qirVar":Lqir;
    :cond_1
    goto :goto_0
