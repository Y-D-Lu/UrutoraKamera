...
.method public constructor <init>(Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;ZZZLandroid/view/View;)V
    ...
    .line 42
    iput-object v1, p0, Lgtz;->a:Landroid/view/View;
    ...
    iput-object v5, p0, Lgtz;->f:Lope;

    .line 50
    iget-object v5, p1, Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;->b:Ljrz;

    iput-object v5, p0, Lgtz;->g:Ljrz;
...
.method public final a()Landroid/animation/Animator;
    ...
    iget-object v10, p0, Lgtz;->e:Landroid/widget/FrameLayout;

    iget v11, p0, Lgtz;->j:I

    invoke-direct {v9, v10, v11}, Ljsb;-><init>(Landroid/view/View;I)V

    invoke-virtual {v8, v9}, Landroid/animation/ObjectAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    .line 71
    invoke-virtual {v0, v8}, Looh;->g(Ljava/lang/Object;)V
    ...
    .line 74
    .local v7, "jrzVar":Ljrz;
    iget-object v8, p0, Lgtz;->g:Ljrz;
    ...
    .line 82
    iget-object v8, p0, Lgtz;->k:Landroid/view/View;

    invoke-static {v8}, Ljsa;->e(Landroid/view/View;)[I

    move-result-object v8

    aget v8, v8, v6

    iget-object v9, p0, Lgtz;->a:Landroid/view/View;
    ...
    iget-object v9, p0, Lgtz;->k:Landroid/view/View;

    invoke-virtual {v9}, Landroid/view/View;->getHeight()I

    move-result v9

    iget-object v10, p0, Lgtz;->a:Landroid/view/View;
    ...
    .line 90
    .local v10, "f4":F
    iget-object v11, p0, Lgtz;->a:Landroid/view/View;
    ...
    iget-object v5, p0, Lgtz;->a:Landroid/view/View;

    iget v6, p0, Lgtz;->c:I

    invoke-direct {v4, v5, v6}, Ljsb;-><init>(Landroid/view/View;I)V

    invoke-virtual {v3, v4}, Landroid/animation/ObjectAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    .line 94
    iget-boolean v4, p0, Lgtz;->h:Z
    ...
    iget-object v5, p0, Lgtz;->d:Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;

    invoke-direct {v4, v5}, Ljru;-><init>(Landroid/view/View;)V

    invoke-virtual {v3, v4}, Landroid/animation/ObjectAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    .line 97
    :cond_3
    new-instance v4, Ldefpackage/Ve;

    invoke-direct {v4, p0}, Ldefpackage/Ve;-><init>(Lgtz;)V
    ...
    iget-object v5, p0, Lgtz;->f:Lope;

    invoke-virtual {v5}, Ljava/util/AbstractCollection;->stream()Ljava/util/stream/Stream;

    move-result-object v5

    new-instance v6, Ldefpackage/We;

    invoke-direct {v6, p0}, Ldefpackage/We;-><init>(Lgtz;)V
    ...
    .line 150
    invoke-virtual {v0, v4}, Looh;->g(Ljava/lang/Object;)V
    ...
    invoke-static {v5}, Lobr;->al(Ljava/util/List;)Ljava/util/List;
    ...
    .line 155
    new-instance v5, Ldefpackage/Xe;

    invoke-direct {v5, p0}, Ldefpackage/Xe;-><init>(Lgtz;)V

    invoke-static {v5}, Lmip;->ew(Ljava/util/function/Consumer;)Landroid/animation/Animator$AnimatorListener;
