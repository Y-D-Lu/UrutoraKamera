...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ldfr;->c:[Ljava/lang/String;

    new-array v0, v5, [Ljava/lang/String;

    aput-object v9, v0, v3

    sput-object v0, Ldfr;->d:[Ljava/lang/String;

    return-void
.end method

.method public constructor <init>(Landroid/content/ContentResolver;Lmbj;Lddf;)V
    .locals 2

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ldfr;->g:Landroid/content/ContentResolver;
    ...
    iget-object p2, p2, Lmbj;->n:Ljava/lang/String;
    ...
    iput-object p1, p0, Ldfr;->h:Ljava/lang/String;

    iput-object p3, p0, Ldfr;->i:Lddf;
...
# virtual methods
.method public final b(Landroid/database/Cursor;)Ldfn;
    .locals 19
    ...
    invoke-static {v3, v4, v0}, Ldfr;->a(JZ)Landroid/net/Uri;
    ...
    :cond_1
    :goto_0
    iget-object v13, v1, Ldfr;->i:Lddf;

    sget-object v17, Lddl;->a:Lddi;

    invoke-interface {v13}, Lddf;->e()V
    ...
    :cond_2
    iget-object v0, v1, Ldfr;->g:Landroid/content/ContentResolver;
    ...
    invoke-static {v15, v0}, Llig;->h(II)Llig;
    ...
    invoke-static {v13, v1, v15, v0}, Ld;->w(Lova;Ljava/lang/String;CLjava/lang/Throwable;)V

    const/4 v1, 0x0

    invoke-static {v1, v1}, Llig;->h(II)Llig;
    ...
    invoke-static {v13, v2, v14}, Lobr;->aq(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {v2, v13, v14}, Lobr;->aq(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {v2, v9, v14}, Lobr;->aq(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {v15, v0, v1, v14}, Lobr;->as(ZLjava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V

    invoke-static {}, Ldfo;->k()Ldfn;

    move-result-object v0

    invoke-virtual {v0, v3, v4}, Ldfn;->b(J)V

    invoke-virtual {v0, v5}, Ldfn;->h(Ljava/lang/String;)V

    invoke-virtual {v0, v6}, Ldfn;->f(Ljava/lang/String;)V

    invoke-virtual {v0, v11}, Ldfn;->c(Lj$/time/Instant;)V

    invoke-virtual {v0, v12}, Ldfn;->e(Lj$/time/Instant;)V

    invoke-virtual {v0, v14}, Ldfn;->i(Landroid/net/Uri;)V
    ...
    :goto_7
    invoke-virtual {v0, v13}, Ldfn;->d(Z)V
...
.method final c(Landroid/net/Uri;Lhsp;)Ldfo;
    .locals 8

    iget-object v0, p0, Ldfr;->g:Landroid/content/ContentResolver;

    sget-object v1, Ldfr;->c:[Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Ldfr;->b(Landroid/database/Cursor;)Ldfn;

    move-result-object p1

    iput-object p2, p1, Ldfn;->a:Lhsp;
    ...
    invoke-static {v7, v4}, Lobr;->aw(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
...
.method public final d(Landroid/net/Uri;[Ljava/lang/String;JJILj$/util/function/Function;)Ljava/util/List;
    ...
    sget-object v2, Ldfr;->d:[Ljava/lang/String;
    ...
    sget-object v2, Ldfr;->c:[Ljava/lang/String;
    ...
    invoke-static {v2, v5}, Lobr;->aG(ZLjava/lang/Object;)V

    const/4 v2, 0x5

    new-array v6, v2, [Ljava/lang/String;

    iget-object v2, v1, Ldfr;->h:Ljava/lang/String;
    ...
    iget-object v2, v1, Ldfr;->g:Landroid/content/ContentResolver;

    sget-object v5, Ldfr;->b:Ljava/lang/String;

    sget-object v7, Ldfr;->a:Ljava/lang/String;
    ...
    :try_end_1
    .catch Lokf; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-interface {v6, v0}, Loug;->h(Ljava/lang/Throwable;)Lova;
    ...
    invoke-interface {v0, v6}, Loug;->o(Ljava/lang/String;)V

    iget-object v0, v1, Ldfr;->i:Lddf;
...
.method final e(Lj$/time/Instant;Lj$/time/Instant;Z)Ljava/util/List;
    ...
    sget-object v3, Ldfr;->d:[Ljava/lang/String;
    ...
    invoke-direct {v9, p3}, Ldfq;-><init>(Z)V

    const v8, 0x7fffffff

    move-object v1, p0

    invoke-virtual/range {v1 .. v9}, Ldfr;->d(Landroid/net/Uri;[Ljava/lang/String;JJILj$/util/function/Function;)Ljava/util/List;
