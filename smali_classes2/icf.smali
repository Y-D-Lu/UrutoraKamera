...
.method public constructor <init>(Lidt;Landroid/content/Context;Lhnx;ZLbue;Lddf;Lhub;Lhuf;Lhug;)V
    .locals 1
    .param p1, "idtVar"    # Lidt;
    .param p2, "context"    # Landroid/content/Context;
    .param p3, "hnxVar"    # Lhnx;
    .param p4, "z"    # Z
    .param p5, "bueVar"    # Lbue;
    .param p6, "ddfVar"    # Lddf;
    .param p7, "hubVar"    # Lhub;
...
.method public static a(Ljava/util/function/Function;)Ljava/util/function/Predicate;
    ...
    invoke-direct {v0, v1, p0, v2}, Lidg;-><init>(Ljava/util/Map;Ljava/util/function/Function;I)V
...
.method public final c(Ljava/lang/String;)Z
    ...
    .line 75
    invoke-virtual {v1}, Lidm;->b()Ljava/lang/String;
...
.method public final d(I)Landroid/content/pm/ResolveInfo;
    ...
    .line 81
    iget-object v2, p0, Licf;->b:Landroid/content/Context;
...
.method public final e(Lbty;)I
    ...
    .line 94
    iget-object v1, p0, Licf;->j:Ljava/util/Map;
    ...
    .line 97
    iget-object v6, p0, Licf;->a:Lidt;

    invoke-interface {v6, v3}, Lidt;->j(Ljava/lang/String;)Z
    ...
    invoke-interface {v3, v5, v6}, Lhug;->e(Lhts;Ljava/lang/Object;)V
    ...
    iget-object v4, p0, Licf;->i:Ljava/util/Map;
    ...
    .line 116
    iget-object v5, p0, Licf;->a:Lidt;

    invoke-interface {v5, v1}, Lidt;->i(Ljava/lang/String;)Z
    ...
    .line 117
    iget-object v5, p0, Licf;->i:Ljava/util/Map;
...
.method public final f(Landroid/content/pm/ResolveInfo;Lbty;)I
    .locals 10
    ...
    iget-object v8, p0, Licf;->h:Lddf;

    sget-object v9, Lddl;->aJ:Lddg;
    ...
    sget-object v8, Licf;->e:Lope;

    iget-object v9, p1, Landroid/content/pm/ResolveInfo;->activityInfo:Landroid/content/pm/ActivityInfo;

    iget-object v9, v9, Landroid/content/pm/ActivityInfo;->packageName:Ljava/lang/String;

    invoke-virtual {v8, v9}, Lood;->contains(Ljava/lang/Object;)Z

    move-result v8

    if-eqz v8, :cond_2

    iget-object v8, p0, Licf;->b:Landroid/content/Context;
    ...
    :cond_5
    :goto_3
    iget-object v8, p0, Licf;->f:Lhnx;

    invoke-interface {v8, v7}, Lhnx;->g(Landroid/content/Intent;)V
