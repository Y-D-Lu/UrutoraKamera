...
.method public constructor <init>(IIILpwg;Z)V
    ...
    iput-object v1, p0, Lpwf;->d:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance v1, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v1, v2}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v1, p0, Lpwf;->e:Ljava/util/concurrent/atomic/AtomicBoolean;

    const/4 v1, 0x1

    new-array v1, v1, [I

    iput-object v1, p0, Lpwf;->f:[I

    iput-boolean v2, p0, Lpwf;->i:Z

    iput-boolean v2, p0, Lpwf;->j:Z

    new-instance v1, Ljava/lang/Object;

    invoke-direct {v1}, Ljava/lang/Object;-><init>()V

    iput-object v1, p0, Lpwf;->k:Ljava/lang/Object;
    ...
    iput-object p1, p0, Lpwf;->o:Landroid/os/HandlerThread;
...
.method public final b(I)V
    ...
    iget-boolean p1, p0, Lpwf;->n:Z

    if-eqz p1, :cond_1

    new-instance p1, Landroid/os/Handler;

    iget-object v0, p0, Lpwf;->o:Landroid/os/HandlerThread;
    ...
    :goto_0
    iget-object v0, p0, Lpwf;->g:Landroid/graphics/SurfaceTexture;
    ...
    invoke-direct {v1, p0}, Lpwe;-><init>(Lpwf;)V
    ...
    iput-object p1, p0, Lpwf;->h:Landroid/view/Surface;

    goto :goto_1

    :cond_3
    iget-object p1, p0, Lpwf;->g:Landroid/graphics/SurfaceTexture;
    ...
    iput-boolean p1, p0, Lpwf;->i:Z

    iget-object p1, p0, Lpwf;->b:Lpwg;

    if-eqz p1, :cond_4

    invoke-interface {p1}, Lpwg;->c()V
...
.method public final c(Lpwc;)V
    ...
    iput-object v0, p0, Lpwf;->g:Landroid/graphics/SurfaceTexture;

    iget-object v1, p0, Lpwf;->h:Landroid/view/Surface;
    ...
    :cond_2
    iput-object v0, p0, Lpwf;->h:Landroid/view/Surface;
    ...
    iget-object v7, p0, Lpwf;->c:[F

    move-object v2, p1

    invoke-virtual/range {v2 .. v7}, Lpwc;->a(IIJ[F)V
