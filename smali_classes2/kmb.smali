...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;Lkmr;Lkhn;ILkmn;Lkmo;Ljava/lang/String;)V
    .locals 2
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "looper"    # Landroid/os/Looper;
    .param p3, "kmrVar"    # Lkmr;
    .param p4, "khnVar"    # Lkhn;
    .param p5, "i"    # I
    .param p6, "kmnVar"    # Lkmn;
    .param p7, "kmoVar"    # Lkmo;
    ...
    invoke-static {p4, v0}, Lmip;->du(Ljava/lang/Object;Ljava/lang/Object;)V

    .line 57
    new-instance v0, Lklu;

    invoke-direct {v0, p0, p2}, Lklu;-><init>(Lkmb;Landroid/os/Looper;)V

    iput-object v0, p0, Lkmb;->d:Landroid/os/Handler;
...
.method public final H(ILandroid/os/IInterface;)V
    ...
    .local v4, "z2":Z
    :goto_2
    invoke-static {v4}, Lmip;->dl(Z)V

    .line 73
    iget-object v6, v1, Lkmb;->e:Ljava/lang/Object;
    ...
    .line 75
    iput-object v3, v1, Lkmb;->u:Landroid/os/IInterface;
    :try_end_0
    ...
    :pswitch_0
    :try_start_1
    invoke-static/range {p2 .. p2}, Lmip;->dk(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 94
    .local v7, "klxVar2":Lklx;
    if-eqz v7, :cond_3

    :try_start_3
    iget-object v0, v1, Lkmb;->b:Lkmw;

    move-object v8, v0

    .local v8, "kmwVar":Lkmw;
    if-eqz v0, :cond_3

    .line 95
    iget-object v0, v8, Lkmw;->a:Ljava/lang/String;

    .line 96
    .local v0, "str3":Ljava/lang/String;
    iget-object v9, v8, Lkmw;->b:Ljava/lang/String;
    ...
    .line 103
    iget-object v11, v1, Lkmb;->t:Lkmr;

    .line 104
    .local v11, "kmrVar2":Lkmr;
    iget-object v12, v1, Lkmb;->b:Lkmw;

    .line 105
    .local v12, "kmwVar3":Lkmw;
    iget-object v13, v12, Lkmw;->a:Ljava/lang/String;

    .line 106
    .local v13, "str5":Ljava/lang/String;
    iget-object v14, v12, Lkmw;->b:Ljava/lang/String;
    ...
    .line 108
    .local v15, "i3":I
    invoke-virtual/range {p0 .. p0}, Lkmb;->v()Ljava/lang/String;

    .line 109
    iget-object v5, v1, Lkmb;->b:Lkmw;

    iget-boolean v5, v5, Lkmw;->d:Z

    invoke-virtual {v11, v13, v14, v7, v5}, Lkmr;->a(Ljava/lang/String;Ljava/lang/String;Landroid/content/ServiceConnection;Z)V

    .line 110
    iget-object v5, v1, Lkmb;->o:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .end local v8    # "kmwVar":Lkmw;
    .end local v9    # "str4":Ljava/lang/String;
    .end local v10    # "sb":Ljava/lang/StringBuilder;
    .end local v11    # "kmrVar2":Lkmr;
    .end local v12    # "kmwVar3":Lkmw;
    ...
    invoke-direct {v0, v1, v5}, Lklx;-><init>(Lkmb;I)V

    move-object v5, v0

    .line 113
    .local v5, "klxVar3":Lklx;
    iput-object v5, v1, Lkmb;->v:Lklx;

    .line 114
    new-instance v0, Lkmw;

    invoke-virtual/range {p0 .. p0}, Lkmb;->w()Ljava/lang/String;

    move-result-object v8

    invoke-virtual/range {p0 .. p0}, Lkmb;->d()Ljava/lang/String;

    move-result-object v9

    invoke-virtual/range {p0 .. p0}, Lkmb;->A()Z

    move-result v10

    invoke-direct {v0, v8, v9, v10}, Lkmw;-><init>(Ljava/lang/String;Ljava/lang/String;Z)V

    move-object v8, v0

    .line 115
    .local v8, "kmwVar4":Lkmw;
    iput-object v8, v1, Lkmb;->b:Lkmw;

    .line 116
    iget-boolean v0, v8, Lkmw;->d:Z
    :try_end_4
    ...
    :try_start_5
    invoke-virtual/range {p0 .. p0}, Lkmb;->a()I
    ...
    .restart local v4    # "z2":Z
    .restart local p0    # "this":Lkmb;
    .restart local p1    # "i":I
    .restart local p2    # "iInterface":Landroid/os/IInterface;
    :cond_5
    :try_start_6
    iget-object v0, v1, Lkmb;->t:Lkmr;

    move-object v9, v0

    .line 121
    .local v9, "kmrVar3":Lkmr;
    iget-object v0, v1, Lkmb;->b:Lkmw;

    move-object v10, v0

    .line 122
    .local v10, "kmwVar5":Lkmw;
    iget-object v0, v10, Lkmw;->a:Ljava/lang/String;

    move-object v11, v0

    .line 123
    .local v11, "str8":Ljava/lang/String;
    iget-object v0, v10, Lkmw;->b:Ljava/lang/String;
    ...
    iget-boolean v0, v0, Lkmw;->d:Z

    move v15, v0

    .line 127
    .local v15, "z3":Z
    invoke-virtual/range {p0 .. p0}, Lkmb;->F()V

    .line 128
    new-instance v0, Lkmq;

    invoke-direct {v0, v11, v12, v15}, Lkmq;-><init>(Ljava/lang/String;Ljava/lang/String;Z)V

    move-object/from16 v17, v0

    .line 129
    .local v17, "kmqVar":Lkmq;
    iget-object v2, v9, Lkmr;->c:Ljava/util/HashMap;
    ...
    .line 130
    :try_start_7
    iget-object v0, v9, Lkmr;->c:Ljava/util/HashMap;
    :try_end_7
    .catchall {:try_start_7 .. :try_end_7} :catchall_6

    move-object/from16 v3, v17

    .end local v17    # "kmqVar":Lkmq;
    .local v3, "kmqVar":Lkmq;
    :try_start_8
    ...
    invoke-direct {v4, v9, v3}, Lkms;-><init>(Lkmr;Lkmq;)V

    move-object v0, v4

    .line 133
    invoke-virtual {v0, v5, v5}, Lkms;->c(Landroid/content/ServiceConnection;Landroid/content/ServiceConnection;)V

    .line 134
    invoke-virtual {v0, v14}, Lkms;->d(Ljava/lang/String;)V

    .line 135
    iget-object v4, v9, Lkmr;->c:Ljava/util/HashMap;
    ...
    :try_start_a
    iget-object v4, v9, Lkmr;->e:Landroid/os/Handler;
    :try_end_a
    ...
    .end local v7    # "klxVar2":Lklx;
    .local v18, "klxVar2":Lklx;
    :try_start_b
    invoke-virtual {v4, v7, v3}, Landroid/os/Handler;->removeMessages(ILjava/lang/Object;)V

    .line 138
    invoke-virtual {v0, v5}, Lkms;->a(Landroid/content/ServiceConnection;)Z
    ...
    .line 148
    :pswitch_3
    iget-object v4, v0, Lkms;->f:Landroid/content/ComponentName;

    iget-object v7, v0, Lkms;->d:Landroid/os/IBinder;

    invoke-virtual {v5, v4, v7}, Lklx;->onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    .line 158
    :try_start_d
    iget-object v2, v1, Lkmb;->b:Lkmw;

    .line 159
    .local v2, "kmwVar6":Lkmw;
    iget-object v4, v2, Lkmw;->a:Ljava/lang/String;

    .line 160
    .local v4, "str10":Ljava/lang/String;
    iget-object v7, v2, Lkmw;->b:Ljava/lang/String;
    ...
    .end local v2    # "kmwVar6":Lkmw;
    .local v21, "kmwVar6":Lkmw;
    add-int v2, v19, v20
    ...
    iget-object v4, v1, Lkmb;->o:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v4}, Ljava/util/concurrent/atomic/AtomicInteger;->get()I

    move-result v4

    invoke-virtual {v1, v2, v4}, Lkmb;->G(II)V
    :try_end_d
    ...
    .end local v3    # "kmqVar":Lkmq;
    .local v16, "kmqVar":Lkmq;
    :try_start_f
    invoke-virtual {v0}, Ljava/lang/StringBuilder;->toString()Ljava/lang/String;
    ...
    .end local v5    # "klxVar3":Lklx;
    .end local v8    # "kmwVar4":Lkmw;
    .end local v9    # "kmrVar3":Lkmr;
    .end local v10    # "kmwVar5":Lkmw;
    .end local v11    # "str8":Ljava/lang/String;
    .end local v12    # "str9":Ljava/lang/String;
    .end local v13    # "i4":I
    .end local v14    # "v":Ljava/lang/String;
    .end local v15    # "z3":Z
    .end local v16    # "kmqVar":Lkmq;
    .end local v17    # "z2":Z
    .end local v18    # "klxVar2":Lklx;
    .end local p0    # "this":Lkmb;
    .end local p1    # "i":I
    .end local p2    # "iInterface":Landroid/os/IInterface;
    throw v7
    ...
    .end local v19    # "kmsVar":Lkms;
    .restart local v3    # "kmqVar":Lkmq;
    .restart local v5    # "klxVar3":Lklx;
    .restart local v8    # "kmwVar4":Lkmw;
    .restart local v9    # "kmrVar3":Lkmr;
    .restart local v10    # "kmwVar5":Lkmw;
    ...
    .restart local v17    # "z2":Z
    .restart local v18    # "klxVar2":Lklx;
    .restart local p0    # "this":Lkmb;
    .restart local p1    # "i":I
    .restart local p2    # "iInterface":Landroid/os/IInterface;
    :catchall_3
    ...
    .line 79
    .local v0, "klxVar":Lklx;
    if-eqz v0, :cond_9

    .line 80
    iget-object v2, v1, Lkmb;->t:Lkmr;

    .line 81
    .local v2, "kmrVar":Lkmr;
    iget-object v3, v1, Lkmb;->b:Lkmw;

    .line 82
    .local v3, "kmwVar2":Lkmw;
    iget-object v4, v3, Lkmw;->a:Ljava/lang/String;

    .line 83
    .local v4, "str":Ljava/lang/String;
    iget-object v5, v3, Lkmw;->b:Ljava/lang/String;
    ...
    .line 86
    iget-object v8, v1, Lkmb;->b:Lkmw;

    iget-boolean v8, v8, Lkmw;->d:Z

    invoke-virtual {v2, v4, v5, v0, v8}, Lkmr;->a(Ljava/lang/String;Ljava/lang/String;Landroid/content/ServiceConnection;Z)V

    .line 87
    const/4 v8, 0x0

    iput-object v8, v1, Lkmb;->v:Lklx;

    .line 176
    .end local v0    # "klxVar":Lklx;
    .end local v2    # "kmrVar":Lkmr;
    .end local v3    # "kmwVar2":Lkmw;
...
.method public h(Lklw;)V
    ...
    invoke-virtual {p0, v0, v1}, Lkmb;->H(ILandroid/os/IInterface;)V
...
.method public i()V
    ...
    .end local v2    # "i":I
    :cond_0
    iget-object v2, p0, Lkmb;->h:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v1, v0}, Lkmb;->H(ILandroid/os/IInterface;)V
...
.method public final r(Lkmy;Ljava/util/Set;)V
    ...
    iput-object v2, v1, Lkmm;->f:[Lcom/google/android/gms/common/api/Scope;
    ...
    .line 310
    :cond_1
    iput-object v2, v1, Lkmm;->h:Landroid/accounts/Account;

    .line 311
    if-eqz p1, :cond_2

    .line 312
    iget-object v3, p1, Lbmn;->a:Landroid/os/IBinder;

    iput-object v3, v1, Lkmm;->e:Landroid/os/IBinder;
    ...
    :try_start_0
    iget-object v5, p0, Lkmb;->f:Ljava/lang/Object;
    ...
    .line 322
    :try_start_1
    iget-object v6, p0, Lkmb;->r:Lknc;

    .line 323
    .local v6, "kncVar":Lknc;
    if-eqz v6, :cond_4

    .line 324
    new-instance v7, Lknb;

    iget-object v8, p0, Lkmb;->o:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v8}, Ljava/util/concurrent/atomic/AtomicInteger;->get()I

    move-result v8

    invoke-direct {v7, p0, v8}, Lknb;-><init>(Lkmb;I)V

    .line 325
    .local v7, "knbVar":Lknb;
    ...
    invoke-static {v1, v8, v3}, Lsk;->a(Lkmm;Landroid/os/Parcel;I)V

    .line 331
    iget-object v10, v6, Lknc;->a:Landroid/os/IBinder;
    ...
    .end local v1    # "kmmVar":Lkmm;
    .end local p0    # "this":Lkmb;
    .end local p1    # "kmyVar":Lkmy;
    ...
    .restart local v1    # "kmmVar":Lkmm;
    .restart local p0    # "this":Lkmb;
    .restart local p1    # "kmyVar":Lkmy;
    ...
    .line 350
    iget-object v5, p0, Lkmb;->o:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v5}, Ljava/util/concurrent/atomic/AtomicInteger;->get()I

    move-result v5

    invoke-virtual {p0, v2, v4, v4, v5}, Lkmb;->x(ILandroid/os/IBinder;Landroid/os/Bundle;I)V
    ...
    .line 341
    iget-object v3, p0, Lkmb;->d:Landroid/os/Handler;
...
.method public final y(Lklw;ILandroid/app/PendingIntent;)V
    .locals 3
    .param p1, "klwVar"    # Lklw;
    .param p2, "i"    # I
    ...
    .line 396
    .local v0, "handler":Landroid/os/Handler;
    iget-object v1, p0, Lkmb;->o:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public final z(IILandroid/os/IInterface;)Z
    ...
    .line 404
    :cond_0
    invoke-virtual {p0, p2, p3}, Lkmb;->H(ILandroid/os/IInterface;)V
