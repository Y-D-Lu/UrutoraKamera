...
.method public final a(Landroid/view/View;Lgy;)Lgy;
    ...
    .line 28
    .local v4, "d2":I
    iget-object v5, v3, Liy;->m:Landroid/support/v7/widget/ActionBarContextView;
    ...
    .line 39
    :cond_1
    iget-object v10, v3, Liy;->G:Landroid/graphics/Rect;

    .line 40
    .local v10, "rect":Landroid/graphics/Rect;
    iget-object v11, v3, Liy;->H:Landroid/graphics/Rect;
    ...
    .line 42
    iget-object v12, v3, Liy;->s:Landroid/view/ViewGroup;

    .line 43
    .local v12, "viewGroup":Landroid/view/ViewGroup;
    sget-object v0, Lsd;->a:Ljava/lang/reflect/Method;
    ...
    .line 52
    .local v14, "i4":I
    iget-object v15, v3, Liy;->s:Landroid/view/ViewGroup;

    invoke-static {v15}, Lgl;->r(Landroid/view/View;)Lgy;
    ...
    iget-object v9, v3, Liy;->t:Landroid/view/View;
    ...
    .end local v0    # "i2":I
    .local v20, "i2":I
    iget-object v0, v3, Liy;->f:Landroid/content/Context;

    invoke-direct {v9, v0}, Landroid/view/View;-><init>(Landroid/content/Context;)V

    iput-object v9, v3, Liy;->t:Landroid/view/View;
    ...
    iget-object v5, v3, Liy;->s:Landroid/view/ViewGroup;

    move/from16 v18, v6

    .end local v6    # "i":I
    .local v18, "i":I
    iget-object v6, v3, Liy;->t:Landroid/view/View;
    ...
    .line 71
    iget-object v5, v3, Liy;->t:Landroid/view/View;
    ...
    invoke-static {v5}, Lgl;->k(Landroid/view/View;)I
    ...
    iget-object v6, v3, Liy;->f:Landroid/content/Context;
    ...
    invoke-static {v6, v0}, Laas;->a(Landroid/content/Context;I)I
    ...
    invoke-static {v0, v6}, Laas;->a(Landroid/content/Context;I)I
    ...
    .line 101
    iget-object v2, v3, Liy;->m:Landroid/support/v7/widget/ActionBarContextView;
    ...
    :cond_11
    :goto_d
    iget-object v2, v3, Liy;->t:Landroid/view/View;
    ...
    invoke-virtual {v9, v5, v0, v7, v8}, Lgy;->k(IIII)Lgy;
    ...
    invoke-static {v7, v5}, Lgl;->s(Landroid/view/View;Lgy;)Lgy;
