...
.method public final a(Llzv;DD)V
    ...
    invoke-interface {v6, v7, v8, v9, v10}, Ldha;->b(JJ)V

    .line 24
    :cond_0
    iget-wide v6, v0, Lgru;->c:D
    ...
    .line 28
    iget-object v12, v0, Lgru;->a:Llis;

    .line 29
    .local v12, "lisVar":Llis;
    ...
    invoke-interface {v12, v14}, Llis;->f(Ljava/lang/String;)V

    .line 40
    .end local v10    # "d4":D
    .end local v12    # "lisVar":Llis;
    ...
    iput-wide v10, v0, Lgru;->c:D

    goto :goto_0

    .line 45
    :cond_2
    iput-wide v2, v0, Lgru;->c:D
