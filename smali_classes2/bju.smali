...
.method private static e(Landroid/content/Context;)Landroid/app/Activity;
    ...
    invoke-static {v0}, Lbju;->e(Landroid/content/Context;)Landroid/app/Activity;
...
.method public final a(Landroid/content/Context;)Layn;
    ...
    invoke-virtual {p0, v0}, Lbju;->b(Lby;)Layn;
    ...
    invoke-virtual {p0, v1}, Lbju;->a(Landroid/content/Context;)Layn;
    ...
    invoke-virtual {p0, v1}, Lbju;->b(Lby;)Layn;
    ...
    .line 67
    :cond_2
    invoke-static {v0}, Lbju;->f(Landroid/app/Activity;)V
    ...
    invoke-static {v0}, Lbju;->g(Landroid/content/Context;)Z

    move-result v2

    .line 70
    .local v2, "g":Z
    invoke-virtual {p0, v1}, Lbju;->c(Landroid/app/FragmentManager;)Lbjt;

    move-result-object v3

    .line 71
    .local v3, "c":Lbjt;
    iget-object v4, v3, Lbjt;->c:Layn;

    .line 72
    .local v4, "aynVar":Layn;
    if-eqz v4, :cond_3
    ...
    iget-object v6, v3, Lbjt;->a:Lbjj;

    iget-object v7, v3, Lbjt;->b:Lbjv;

    invoke-static {v5, v6, v7, v0}, Lbkh;->b(Laxv;Lbjp;Lbjv;Landroid/content/Context;)Layn;
    ...
    .line 77
    invoke-virtual {v5}, Layn;->h()V

    .line 79
    :cond_4
    iput-object v5, v3, Lbjt;->c:Layn;
    ...
    invoke-static {v0, v1, v2, v3}, Lbkh;->b(Laxv;Lbjp;Lbjv;Landroid/content/Context;)Layn;

    move-result-object v0

    iput-object v0, p0, Lbju;->c:Layn;
...
.method public final b(Lby;)Layn;
    ...
    invoke-virtual {p0, v0}, Lbju;->a(Landroid/content/Context;)Layn;
    ...
    .line 108
    .local v2, "d":Lbke;
    iget-object v3, v2, Lbke;->c:Layn;

    .line 109
    .local v3, "aynVar":Layn;
    if-nez v3, :cond_2
    ...
    iget-object v5, v2, Lbke;->a:Lbjj;

    iget-object v6, v2, Lbke;->b:Lbjv;

    invoke-static {v4, v5, v6, p1}, Lbkh;->b(Laxv;Lbjp;Lbjv;Landroid/content/Context;)Layn;
    ...
    .line 112
    invoke-virtual {v3}, Layn;->h()V

    .line 114
    :cond_1
    iput-object v3, v2, Lbke;->c:Layn;
...
.method public final c(Landroid/app/FragmentManager;)Lbjt;
    ...
    .line 123
    .local v2, "bjtVar2":Lbjt;
    iget-object v3, p0, Lbju;->a:Ljava/util/Map;
...
.method public final d(Lcu;)Lbke;
    ...
    .line 135
    .local v2, "bkeVar2":Lbke;
    iget-object v3, p0, Lbju;->b:Ljava/util/Map;
    ...
    .line 137
    .local v3, "h":Ldd;
    invoke-virtual {v3, v2, v0}, Ldd;->n(Lbu;Ljava/lang/String;)V

    .line 138
    invoke-virtual {v3}, Ldd;->h()V
