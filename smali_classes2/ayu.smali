...
.method public static g(Ljava/io/File;J)Layu;
    ...
    invoke-direct {v1, p0, p1, p2}, Layu;-><init>(Ljava/io/File;J)V

    .line 64
    .local v1, "ayuVar":Layu;
    iget-object v3, v1, Layu;->f:Ljava/io/File;
    ...
    .line 66
    :try_start_1
    invoke-direct {v1}, Layu;->m()V

    .line 67
    iget-object v3, v1, Layu;->g:Ljava/io/File;

    invoke-static {v3}, Layu;->k(Ljava/io/File;)V

    .line 68
    iget-object v3, v1, Layu;->l:Ljava/util/LinkedHashMap;
    ...
    .line 71
    .local v4, "aysVar":Lays;
    iget-object v5, v4, Lays;->f:Layr;
    ...
    .line 73
    iget-wide v7, v1, Layu;->k:J

    iget-object v9, v4, Lays;->b:[J

    aget-wide v9, v9, v2

    add-long/2addr v7, v9

    iput-wide v7, v1, Layu;->k:J
    ...
    .line 78
    invoke-virtual {v4}, Lays;->c()Ljava/io/File;

    move-result-object v7

    invoke-static {v7}, Layu;->k(Ljava/io/File;)V

    .line 79
    invoke-virtual {v4}, Lays;->d()Ljava/io/File;
    ...
    .line 96
    invoke-virtual {v1}, Layu;->close()V

    .line 97
    iget-object v7, v1, Layu;->a:Ljava/io/File;

    invoke-static {v7}, Layx;->b(Ljava/io/File;)V
    ...
    invoke-direct {v2, p0, p1, p2}, Layu;-><init>(Ljava/io/File;J)V

    .line 102
    .local v2, "ayuVar2":Layu;
...
.method public final declared-synchronized a(Ljava/lang/String;)Layt;
    ...
    .line 203
    iget-object v1, p0, Layu;->e:Ljava/util/concurrent/ThreadPoolExecutor;

    iget-object v4, p0, Layu;->n:Ljava/util/concurrent/Callable;
    ...
    iget-object v4, v0, Lays;->c:[Ljava/io/File;

    invoke-direct {v1, v4}, Layt;-><init>([Ljava/io/File;)V
    :try_end_3
...
.method public final declared-synchronized b(Layr;Z)V
    ...
    .line 236
    .local v8, "length":J
    iget-object v10, v0, Lays;->b:[J

    aput-wide v8, v10, v1

    .line 237
    iget-wide v10, p0, Layu;->k:J

    sub-long/2addr v10, v6

    add-long/2addr v10, v8

    iput-wide v10, p0, Layu;->k:J
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .line 263
    iget-wide v1, p0, Layu;->m:J

    const-wide/16 v4, 0x1

    add-long/2addr v1, v4

    iput-wide v1, p0, Layu;->m:J
    ...
    invoke-static {v1}, Layu;->l(Ljava/io/Writer;)V

    .line 277
    iget-wide v1, p0, Layu;->k:J

    iget-wide v4, p0, Layu;->j:J
    ...
    iget-object v2, p0, Layu;->n:Ljava/util/concurrent/Callable;
...
.method public final declared-synchronized c()V
    ...
    iget-object v4, p0, Layu;->g:Ljava/io/File;
    ...
    .line 301
    iget-object v3, p0, Layu;->l:Ljava/util/LinkedHashMap;
    ...
    .line 303
    iget-object v5, v4, Lays;->a:Ljava/lang/String;
    ...
    invoke-virtual {v4}, Lays;->a()Ljava/lang/String;
    ...
    .line 320
    :cond_2
    invoke-static {v1}, Layu;->j(Ljava/io/Writer;)V
    ...
    iget-object v4, p0, Layu;->h:Ljava/io/File;

    invoke-static {v3, v4, v2}, Layu;->n(Ljava/io/File;Ljava/io/File;Z)V
    ...
    invoke-static {v3, v4, v5}, Layu;->n(Ljava/io/File;Ljava/io/File;Z)V

    .line 325
    iget-object v3, p0, Layu;->h:Ljava/io/File;
...
.method public final declared-synchronized close()V
    ...
    .line 346
    iget-object v2, p0, Layu;->c:Ljava/io/Writer;

    invoke-static {v2}, Layu;->j(Ljava/io/Writer;)V

    .line 347
    const/4 v2, 0x0

    iput-object v2, p0, Layu;->c:Ljava/io/Writer;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public final declared-synchronized f(Ljava/lang/String;)Layr;
    ...
    invoke-direct {v1, p0, p1}, Lays;-><init>(Layu;Ljava/lang/String;)V
    ...
    invoke-static {v2}, Layu;->l(Ljava/io/Writer;)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
