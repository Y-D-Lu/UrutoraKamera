...
.method public final onError(Landroid/media/MediaCodec;Landroid/media/MediaCodec$CodecException;)V
    ...
    iget-object p1, p0, Lmrw;->a:Lmrx;

    iget-object p1, p1, Lmrx;->e:Lpih;

    invoke-virtual {p1, p2}, Lpih;->a(Ljava/lang/Throwable;)Z

    iget-object p1, p0, Lmrw;->a:Lmrx;

    invoke-virtual {p1}, Lmrx;->c()V
    ...
    iget-object p1, p1, Lmrx;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p1, p1, Lmrx;->n:Lmsn;

    invoke-interface {p1, p2}, Lmsn;->e(I)V

    iget-object p1, p0, Lmrw;->a:Lmrx;

    iget-object p1, p1, Lmrx;->g:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final onInputBufferAvailable(Landroid/media/MediaCodec;I)V
    ...
    iget-object v0, v0, Lmrx;->f:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v0, p2}, Lmrx;->e(I)V
    ...
    iget-object v0, v0, Lmrx;->d:Ljava/util/Deque;
    ...
    iget-object p2, p0, Lmrw;->a:Lmrx;

    iget-object p2, p2, Lmrx;->n:Lmsn;

    iget-object v0, p0, Lmrw;->a:Lmrx;

    invoke-interface {p2, v0}, Lmsn;->a(Lmsa;)V
...
.method public final onOutputBufferAvailable(Landroid/media/MediaCodec;ILandroid/media/MediaCodec$BufferInfo;)V
    ...
    iget-object v1, v1, Lmrx;->h:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-interface {v1, p3}, Lmsn;->c(Landroid/media/MediaCodec$BufferInfo;)V
    :try_end_0
    ...
    iget-object v1, v1, Lmrx;->m:Lmth;

    iget-object v9, p0, Lmrw;->a:Lmrx;

    invoke-virtual {p1, p2}, Landroid/media/MediaCodec;->getOutputBuffer(I)Ljava/nio/ByteBuffer;

    move-result-object v5

    new-instance v10, Lmrv;
    ...
    :try_start_2
    iget-object p2, v9, Lmrx;->l:Ljava/util/Set;
    ...
    :try_start_3
    invoke-interface {v1, v10}, Lmth;->a(Lmrv;)V
    :try_end_3
    ...
    iget-object p3, p0, Lmrw;->a:Lmrx;

    iget-object p3, p3, Lmrx;->j:Lmrw;

    invoke-virtual {p3, p1, p2}, Lmrw;->onError(Landroid/media/MediaCodec;Landroid/media/MediaCodec$CodecException;)V
    ...
    invoke-virtual {p1, p3}, Lmrx;->a(Landroid/media/MediaCodec$BufferInfo;)V
...
.method public final onOutputFormatChanged(Landroid/media/MediaCodec;Landroid/media/MediaFormat;)V
    ...
    iget-object p1, p1, Lmrx;->m:Lmth;

    invoke-interface {p1, p2}, Lmth;->b(Landroid/media/MediaFormat;)V
