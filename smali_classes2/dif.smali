...
# direct methods
.method public constructor <init>(Ldij;JLjava/time/Instant;I)V
    .locals 0
    .param p1, "dijVar"    # Ldij;
    .param p2, "j"    # J
    ...
    .line 19
    iput-object p4, p0, Ldif;->c:Ljava/time/Instant;
...
.method public final run()V
    ...
    .line 137
    .local v0, "dijVar6":Ldij;
    iget-wide v4, p0, Ldif;->b:J

    .line 138
    .local v4, "j6":J
    iget-object v6, p0, Ldif;->c:Ljava/time/Instant;

    .local v6, "instant6":Ljava/time/Instant;
    goto/16 :goto_0

    .line 111
    .end local v0    # "dijVar6":Ldij;
    .end local v4    # "j6":J
    ...
    invoke-static {v9, v10}, Lmip;->bp(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v9

    invoke-interface {v8, v9}, Llis;->h(Ljava/lang/String;)V
    ...
    .line 124
    iget-object v8, v0, Ldij;->i:Ldiu;

    const-string v9, "marked stuck"

    invoke-static {v4, v5, v6, v9}, Ldij;->k(JLjava/time/Instant;Ljava/lang/String;)Ldiz;

    move-result-object v9

    invoke-interface {v8, v9}, Ldiu;->b(Ldiz;)V
    ...
    iget-object v11, v0, Ldij;->i:Ldiu;

    invoke-interface {v11, v4, v5}, Ldiu;->a(J)Ljava/util/List;

    move-result-object v11

    invoke-static {v11}, Ldij;->l(Ljava/util/List;)Ljava/lang/String;
    ...
    .line 58
    iget-object v10, v0, Ldij;->h:Ldil;

    invoke-interface {v10, v7}, Ldil;->c(Ldit;)V
    :try_end_3
