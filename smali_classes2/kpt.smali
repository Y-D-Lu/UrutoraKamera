...
.method public final b(Lcom/google/android/gms/googlehelp/GoogleHelp;)V
    ...
    .line 36
    iget-object v0, p0, Lkpt;->a:Landroid/content/Intent;
    ...
    sget-object v2, Lkpv;->a:Lcom/google/android/gms/common/api/Status;
    ...
    :cond_4
    iget-object v2, p0, Lkpt;->c:Lkpu;

    .line 64
    .local v2, "kpuVar":Lkpu;
    ...
    .local v8, "knqVar":Lknq;
    goto :goto_2

    .line 73
    .end local v8    # "knqVar":Lknq;
    :cond_6
    ...
    .line 82
    .local v9, "kpqVar":Lkpq;
    iput-object p1, v9, Lkpq;->a:Lcom/google/android/gms/googlehelp/GoogleHelp;
    ...
    invoke-static {v9, v10, v7}, Lkpg;->a(Lkpq;Landroid/os/Parcel;I)V
    ...
    invoke-direct {v4, v5}, Lksg;-><init>(Landroid/os/Looper;)V

    new-instance v5, Ldefpackage/Kt;

    invoke-direct {v5, p0, v0, v3}, Ldefpackage/Kt;-><init>(Lkpt;Landroid/app/Activity;Landroid/content/Intent;)V
    ...
    invoke-virtual {v2, v4}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->j(Lkiv;)V
