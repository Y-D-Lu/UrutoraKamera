...
.method public final x(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    invoke-direct {v9, v7}, Lkof;-><init>(Landroid/os/IBinder;)V
    ...
    invoke-direct {v11, v9}, Lkof;-><init>(Landroid/os/IBinder;)V
    ...
    :cond_5
    new-instance v12, Lkrh;

    invoke-direct {v12, v11}, Lkrh;-><init>(Landroid/os/IBinder;)V
    ...
    :cond_6
    new-instance v13, Lkof;

    invoke-direct {v13, v12}, Lkof;-><init>(Landroid/os/IBinder;)V
    ...
    :goto_7
    sget-object v13, Lpls;->a:Lpls;

    .line 91
    .local v13, "plsVar2":Lpls;
    ...
    invoke-static {v0, v14, v15}, Lppd;->s(Lppd;[BLpos;)Lppd;
    ...
    invoke-direct {v15, v3}, Lkre;-><init>(Lkrh;)V

    const/16 v4, 0x8

    move-object/from16 v16, v2

    .end local v2    # "krhVar2":Lkrh;
    .local v16, "krhVar2":Lkrh;
    invoke-virtual {v0}, Ljava/io/IOException;->getMessage()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v15, v4, v2}, Lkre;->a(ILjava/lang/String;)V

    goto :goto_8

    .line 92
    .end local v0    # "e":Lppp;
    .end local v16    # "krhVar2":Lkrh;
    .restart local v2    # "krhVar2":Lkrh;
    :cond_8
    move-object/from16 v16, v2

    .line 99
    .end local v2    # "krhVar2":Lkrh;
    .restart local v16    # "krhVar2":Lkrh;
    :goto_8
    iget-object v0, v1, Lkri;->a:Lkqh;

    invoke-static {v8}, Lkog;->c(Lkoh;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, v6, v2, v4, v15}, Lkqh;->d(Ljava/lang/String;[B[BLkre;)V
    ...
    invoke-static {v2, v3}, Lbmp;->b(Landroid/os/Parcel;Z)V
    ...
    :cond_a
    new-instance v8, Lkof;

    invoke-direct {v8, v6}, Lkof;-><init>(Landroid/os/IBinder;)V
    ...
    invoke-direct {v9, v8}, Lkof;-><init>(Landroid/os/IBinder;)V
    ...
    invoke-direct {v10, v9}, Lkrh;-><init>(Landroid/os/IBinder;)V

    .end local v16    # "krhVar2":Lkrh;
    .local v10, "krhVar2":Lkrh;
    :goto_d
    goto :goto_e

    .line 49
    .end local v3    # "queryLocalInterface3":Landroid/os/IInterface;
    .end local v10    # "krhVar2":Lkrh;
    .restart local v16    # "krhVar2":Lkrh;
    :cond_e
    ...
    .line 53
    .end local v16    # "krhVar2":Lkrh;
    .restart local v10    # "krhVar2":Lkrh;
    :goto_e
    new-instance v3, Lkre;

    invoke-direct {v3, v10}, Lkre;-><init>(Lkrh;)V

    .line 54
    .local v3, "kreVar":Lkre;
    sget-object v11, Lpls;->a:Lpls;

    .line 55
    .local v11, "plsVar":Lpls;
    iget-object v12, v1, Lkri;->a:Lkqh;

    invoke-static {v7}, Lkog;->c(Lkoh;)Ljava/lang/Object;
    ...
    invoke-virtual {v12, v4, v13, v14, v3}, Lkqh;->d(Ljava/lang/String;[B[BLkre;)V
