...
# direct methods
.method public constructor <init>(Lhin;Ljava/util/concurrent/Executor;Lhil;ILhsa;Llig;ILljf;)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lhja;-><init>(Lhin;Ljava/util/concurrent/Executor;Lhil;ILhsa;)V

    iput-object p6, p0, Lhiw;->a:Llig;

    iput p7, p0, Lhiw;->b:I

    iput-object p8, p0, Lhiw;->i:Lljf;
...
.method protected static final f(Lhin;)V
    .locals 1

    iget-object v0, p0, Lhin;->a:Lmad;

    invoke-interface {v0}, Lmad;->c()I

    iget-object p0, p0, Lhin;->a:Lmad;
...
.method protected static final g(Lmad;Landroid/graphics/Rect;IZ)[I
    .locals 32

    invoke-static/range {p0 .. p1}, Lhiw;->i(Lmad;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    invoke-static {v5}, Lhiw;->k(I)I

    move-result v19

    iget v0, v0, Landroid/graphics/Rect;->left:I

    invoke-static {v0}, Lhiw;->k(I)I

    move-result v20

    if-eqz p3, :cond_1

    invoke-static {v2, v3}, Lhiw;->d(II)I
    ...
    invoke-static {v7}, Lhiw;->k(I)I

    move-result v7

    add-int/2addr v2, v0

    invoke-static {v2}, Lhiw;->k(I)I
    ...
    invoke-static/range {v0 .. v7}, Lhiw;->a(IIIIIIII)I
...
# virtual methods
.method protected final b(Lhin;I)Lhix;
    .locals 3
    ...
    invoke-static {v0, v1}, Lhiw;->i(Lmad;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    invoke-static {v1, v0}, Lhiw;->d(II)I
    ...
    invoke-direct {p2, p1, v1, v0}, Lhix;-><init>(Llic;II)V

    return-object p2
.end method

.method protected final c(Lmad;Landroid/graphics/Rect;I)[I
    .locals 43
    ...
    invoke-static {v0, v1, v2, v3}, Lhiw;->g(Lmad;Landroid/graphics/Rect;IZ)[I
    ...
    :pswitch_0
    invoke-static {v0, v1, v8, v10}, Lhiw;->g(Lmad;Landroid/graphics/Rect;IZ)[I
    ...
    :pswitch_1
    invoke-static/range {p1 .. p2}, Lhiw;->i(Lmad;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    invoke-interface/range {v18 .. v18}, Lmac;->getRowStride()I
    ...
    invoke-interface/range {v19 .. v19}, Lmac;->getRowStride()I
    ...
    invoke-interface/range {v22 .. v22}, Lmac;->getPixelStride()I
...
.method public final e(Lhix;[II)V
    .locals 3

    new-instance v0, Lhiy;

    iget-wide v1, p0, Lhiw;->e:J

    invoke-direct {v0, v1, v2, p1, p3}, Lhiy;-><init>(JLhix;I)V

    iget-object p1, p0, Lhiw;->c:Lhil;
    ...
    invoke-direct {p3, p2}, Lhiz;-><init>([I)V

    invoke-interface {p1, v0, p3}, Lhih;->a(Lhiy;Lhiz;)V
...
.method public run()V
    ...
    iget-object v0, p0, Lhiw;->i:Lljf;

    const-string v1, "CAM_TaskRGBPreview"

    invoke-interface {v0, v1}, Lljf;->e(Ljava/lang/String;)V

    iget-object v0, p0, Lhiw;->f:Lhin;

    iget-object v1, v0, Lhin;->a:Lmad;

    iget-object v2, v0, Lhin;->e:Landroid/graphics/Rect;

    invoke-static {v1, v2}, Lhiw;->i(Lmad;Landroid/graphics/Rect;)Landroid/graphics/Rect;

    move-result-object v1

    invoke-static {v0}, Lhiw;->f(Lhin;)V
    ...
    invoke-static {v2, v3}, Lfcy;->u(II)Z
    ...
    :cond_4
    :goto_2
    invoke-virtual {p0, v0, v4}, Lhiw;->b(Lhin;I)Lhix;

    move-result-object v2

    :try_start_0
    iget-wide v6, p0, Lhiw;->e:J

    invoke-virtual {p0, v6, v7, v2, v5}, Lhja;->j(JLhix;I)V

    iget-object v3, v0, Lhin;->a:Lmad;
    ...
    invoke-virtual {p0, v3, v1, v4}, Lhiw;->c(Lmad;Landroid/graphics/Rect;I)[I

    move-result-object v1
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v3, p0, Lhiw;->c:Lhil;

    iget-object v0, v0, Lhin;->a:Lmad;

    iget-object v4, p0, Lhiw;->d:Ljava/util/concurrent/Executor;

    invoke-interface {v3, v0, v4}, Lhil;->b(Lmad;Ljava/util/concurrent/Executor;)V

    invoke-virtual {p0, v2, v1, v5}, Lhiw;->e(Lhix;[II)V
    ...
    iget-object v2, p0, Lhiw;->c:Lhil;

    iget-object v0, v0, Lhin;->a:Lmad;

    iget-object v3, p0, Lhiw;->d:Ljava/util/concurrent/Executor;
