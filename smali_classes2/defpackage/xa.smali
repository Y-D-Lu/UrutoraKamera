...
.field public final synthetic val$idkVar:Lidk;

.field public final synthetic val$materialManagedSwitchPreference6:Lcom/google/android/apps/camera/ui/preference/MaterialManagedSwitchPreference;


# direct methods
.method public constructor <init>(Lfbn;Lidk;Lcom/google/android/apps/camera/ui/preference/MaterialManagedSwitchPreference;)V
    .locals 0
    .param p1, "this$0"    # Lfbn;

    .line 549
    iput-object p1, p0, Ldefpackage/Xa;->this$0:Lfbn;

    iput-object p2, p0, Ldefpackage/Xa;->val$idkVar:Lidk;

    iput-object p3, p0, Ldefpackage/Xa;->val$materialManagedSwitchPreference6:Lcom/google/android/apps/camera/ui/preference/MaterialManagedSwitchPreference;
...
.method public final b(Landroidx/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 552
    iget-object v0, p0, Ldefpackage/Xa;->val$idkVar:Lidk;

    .line 553
    .local v0, "idkVar2":Lidk;
    iget-object v1, v0, Lidk;->f:Lfjs;

    iget-object v2, p1, Landroidx/preference/Preference;->t:Ljava/lang/String;

    iget-object v3, p0, Ldefpackage/Xa;->val$materialManagedSwitchPreference6:Lcom/google/android/apps/camera/ui/preference/MaterialManagedSwitchPreference;
    ...
    iget-object v8, v0, Lidk;->i:Ljava/util/Map;
    ...
    iget-object v10, v0, Lidk;->b:Lhub;

    invoke-virtual {v10, v9}, Lhub;->m(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v7, v10}, Lidk;->d(Lcom/google/android/apps/camera/ui/preference/MaterialManagedSwitchPreference;Z)V
    ...
    iget-object v7, v0, Lidk;->i:Ljava/util/Map;
    ...
    invoke-virtual {v0, v6, v8}, Lidk;->d(Lcom/google/android/apps/camera/ui/preference/MaterialManagedSwitchPreference;Z)V
    ...
    .line 578
    :cond_2
    iget-object v6, v0, Lidk;->i:Ljava/util/Map;
    ...
    :cond_3
    iget-object v4, v0, Lidk;->h:Ljava/util/Map;
    ...
    iget-object v7, v0, Lidk;->h:Ljava/util/Map;
    ...
    .line 590
    :cond_5
    iget-object v4, v0, Lidk;->e:Lidt;

    iget-object v5, v0, Lidk;->k:Loom;
    ...
    invoke-virtual {v0, v6, v7}, Lidk;->d(Lcom/google/android/apps/camera/ui/preference/MaterialManagedSwitchPreference;Z)V
