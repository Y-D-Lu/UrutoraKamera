.class public final Ldefpackage/ejw;
...
.field private final e:Ldefpackage/ejt;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ldefpackage/ejw;->a:Ldefpackage/ouj;

    return-void
.end method

.method public constructor <init>(Ldefpackage/ejt;Landroid/media/AudioRecord;)V
    .locals 2
    .param p1, "ejtVar"    # Ldefpackage/ejt;
    ...
    iput-object v0, p0, Ldefpackage/ejw;->f:[B

    .line 15
    const/4 v0, 0x0

    iput-boolean v0, p0, Ldefpackage/ejw;->b:Z

    .line 16
    const-wide/16 v0, 0x0

    iput-wide v0, p0, Ldefpackage/ejw;->c:J

    .line 19
    iput-object p1, p0, Ldefpackage/ejw;->e:Ldefpackage/ejt;

    .line 20
    iput-object p2, p0, Ldefpackage/ejw;->d:Landroid/media/AudioRecord;
...
.method public final run()V
    ...
    iget-object v3, v1, Ldefpackage/ejw;->d:Landroid/media/AudioRecord;
    ...
    .line 27
    iput-boolean v4, v1, Ldefpackage/ejw;->b:Z
    ...
    iput-boolean v5, v1, Ldefpackage/ejw;->b:Z
    ...
    sget-object v6, Ldefpackage/ejw;->a:Ldefpackage/ouj;
    ...
    invoke-interface {v6, v2, v7}, Ldefpackage/ova;->r(Ljava/lang/String;Ljava/lang/Object;)V

    .line 36
    .end local v0    # "e":Ljava/lang/IllegalStateException;
    :goto_0
    iget-boolean v0, v1, Ldefpackage/ejw;->b:Z

    if-eqz v0, :cond_7

    .line 37
    iget-object v0, v1, Ldefpackage/ejw;->d:Landroid/media/AudioRecord;

    iget-object v6, v1, Ldefpackage/ejw;->f:[B
    ...
    .line 41
    :cond_1
    iget-wide v7, v1, Ldefpackage/ejw;->c:J
    ...
    iget-wide v9, v1, Ldefpackage/ejw;->c:J

    add-long/2addr v7, v9

    .line 43
    .local v7, "nanoTime":J
    iget-object v9, v1, Ldefpackage/ejw;->e:Ldefpackage/ejt;

    .line 44
    .local v9, "ejtVar":Ldefpackage/ejt;
    iget-object v10, v1, Ldefpackage/ejw;->f:[B

    .line 45
    .local v10, "bArr":[B
    iget-boolean v0, v9, Ldefpackage/ejt;->d:Z

    if-eqz v0, :cond_5

    .line 47
    :try_start_1
    iget-object v0, v9, Ldefpackage/ejt;->b:Landroid/media/MediaCodec;
    ...
    iget-object v11, v9, Ldefpackage/ejt;->b:Landroid/media/MediaCodec;
    ...
    .line 50
    sget-object v11, Ldefpackage/ejt;->a:Ldefpackage/ouj;
    ...
    .line 55
    iget-boolean v11, v9, Ldefpackage/ejt;->c:Z
    ...
    .line 59
    iget-boolean v12, v9, Ldefpackage/ejt;->c:Z

    if-eqz v12, :cond_4

    .line 60
    iput-boolean v4, v9, Ldefpackage/ejt;->d:Z

    .line 61
    iput-boolean v4, v9, Ldefpackage/ejt;->c:Z
    :try_end_1
    ...
    .end local v9    # "ejtVar":Ldefpackage/ejt;
    ...
    :cond_6
    :goto_4
    sget-object v0, Ldefpackage/ejw;->a:Ldefpackage/ouj;
    ...
    invoke-static {v0, v7, v5}, Ldefpackage/d;->v(Ldefpackage/ova;Ljava/lang/String;C)V
    ...
    sget-object v5, Ldefpackage/ejw;->a:Ldefpackage/ouj;
    ...
    invoke-interface {v5, v0}, Ldefpackage/ova;->h(Ljava/lang/Throwable;)Ldefpackage/ova;
    ...
    invoke-interface {v5, v2, v6}, Ldefpackage/ova;->r(Ljava/lang/String;Ljava/lang/Object;)V
