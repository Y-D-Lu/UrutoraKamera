.class public final Ldefpackage/kcz;
...
.method static constructor <clinit>()V
    ...
    .line 41
    .local v0, "e2":Z
    sput-boolean v0, Ldefpackage/kcz;->s:Z
    ...
    .line 43
    .local v1, "e3":Z
    sput-boolean v1, Ldefpackage/kcz;->t:Z
    ...
    .line 45
    .local v2, "e4":Z
    sput-boolean v2, Ldefpackage/kcz;->u:Z
    ...
    .line 47
    .local v3, "e5":Z
    sput-boolean v3, Ldefpackage/kcz;->v:Z
    ...
    .line 49
    .local v4, "e6":Z
    sput-boolean v4, Ldefpackage/kcz;->w:Z
    ...
    .line 51
    .local v5, "e7":Z
    sput-boolean v5, Ldefpackage/kcz;->x:Z
    ...
    :goto_0
    sput-object v8, Ldefpackage/kcz;->a:Landroid/hardware/camera2/CameraCharacteristics$Key;

    .line 66
    if-eqz v0, :cond_5

    invoke-static {}, Ldefpackage/kcz;->g()Z
    ...
    :goto_2
    sput-object v8, Ldefpackage/kcz;->b:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_3
    sput-object v8, Ldefpackage/kcz;->c:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_4
    sput-object v8, Ldefpackage/kcz;->d:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_5
    sput-object v8, Ldefpackage/kcz;->e:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_6
    sput-object v8, Ldefpackage/kcz;->f:Landroid/hardware/camera2/CaptureResult$Key;

    .line 83
    if-eqz v0, :cond_10

    invoke-static {}, Ldefpackage/kcz;->e()Z
    ...
    :goto_8
    sput-object v8, Ldefpackage/kcz;->g:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_a
    sput-object v8, Ldefpackage/kcz;->h:Landroid/hardware/camera2/CaptureResult$Key;

    .line 85
    if-eqz v0, :cond_14

    invoke-static {}, Ldefpackage/kcz;->a()Z
    ...
    :goto_c
    sput-object v8, Ldefpackage/kcz;->i:Landroid/hardware/camera2/CaptureResult$Key;

    .line 86
    invoke-static {}, Ldefpackage/kcz;->c()Z
    ...
    :goto_d
    sput-object v8, Ldefpackage/kcz;->j:Landroid/hardware/camera2/CaptureRequest$Key;

    .line 99
    if-eqz v0, :cond_1b

    invoke-static {}, Ldefpackage/kcz;->b()Z
    ...
    :goto_10
    sput-object v8, Ldefpackage/kcz;->k:Landroid/hardware/camera2/CaptureRequest$Key;

    .line 100
    invoke-static {}, Ldefpackage/kcz;->h()Z
    ...
    invoke-static {}, Ldefpackage/kcz;->f()Z
    ...
    invoke-static {}, Ldefpackage/kcz;->i()Z
    ...
    :goto_13
    sput-object v8, Ldefpackage/kcz;->l:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :goto_16
    sput-object v8, Ldefpackage/kcz;->m:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :goto_19
    sput-object v8, Ldefpackage/kcz;->n:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :goto_1c
    sput-object v8, Ldefpackage/kcz;->o:Landroid/hardware/camera2/CameraCharacteristics$Key;

    .line 116
    if-eqz v0, :cond_47

    invoke-static {}, Ldefpackage/kcz;->d()Z
    ...
    :cond_4d
    :goto_1f
    sput-object v7, Ldefpackage/kcz;->p:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    sput-object v7, Ldefpackage/kcz;->q:Ljava/lang/Integer;
    ...
    :cond_5f
    :goto_24
    sput-object v6, Ldefpackage/kcz;->r:Landroid/hardware/camera2/CaptureResult$Key;
...
.method private static a()Z
    ...
    .line 161
    sget-boolean v0, Ldefpackage/kcz;->s:Z
...
.method private static b()Z
    ...
    .line 178
    :cond_1
    sget-boolean v0, Ldefpackage/kcz;->t:Z
