.class public final Ldefpackage/hjy;
...
.method public constructor <init>(ILandroid/graphics/Rect;ILandroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;)V
    ...
    invoke-direct/range {v0 .. v12}, Ldefpackage/hjy;-><init>(ILandroid/graphics/Rect;ILandroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;FFF)V
...
.method public constructor <init>(ILandroid/graphics/Rect;ILandroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;FFF)V
    ...
    .line 30
    iput-object p2, p0, Ldefpackage/hjy;->a:Landroid/graphics/Rect;

    .line 31
    iput p3, p0, Ldefpackage/hjy;->b:I

    .line 32
    iput-object p4, p0, Ldefpackage/hjy;->c:Landroid/graphics/PointF;

    .line 33
    iput-object p5, p0, Ldefpackage/hjy;->d:Landroid/graphics/PointF;

    .line 34
    iput-object p6, p0, Ldefpackage/hjy;->e:Landroid/graphics/PointF;

    .line 35
    iput-object p7, p0, Ldefpackage/hjy;->f:Landroid/graphics/PointF;

    .line 36
    iput-object p8, p0, Ldefpackage/hjy;->g:Landroid/graphics/PointF;

    .line 37
    iput-object p9, p0, Ldefpackage/hjy;->h:Landroid/graphics/PointF;

    .line 38
    iput p1, p0, Ldefpackage/hjy;->i:I

    .line 39
    iput p10, p0, Ldefpackage/hjy;->j:F

    .line 40
    iput p11, p0, Ldefpackage/hjy;->k:F

    .line 41
    iput p12, p0, Ldefpackage/hjy;->l:F

    .line 42
    return-void
.end method

.method public static a(Landroid/hardware/camera2/params/Face;)Ldefpackage/hjy;
    .locals 9
    .param p0, "face"    # Landroid/hardware/camera2/params/Face;

    .line 45
    new-instance v7, Ldefpackage/hjy;
    ...
    invoke-direct/range {v0 .. v6}, Ldefpackage/hjy;-><init>(ILandroid/graphics/Rect;ILandroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;)V

    return-object v7
.end method

.method public static b(Ldefpackage/lzs;)Ldefpackage/hjy;
    .locals 14
    .param p0, "lzsVar"    # Ldefpackage/lzs;

    .line 49
    new-instance v13, Ldefpackage/hjy;

    iget-object v0, p0, Ldefpackage/lzs;->a:Landroid/hardware/camera2/params/Face;
    ...
    invoke-virtual {p0, v0}, Ldefpackage/lzs;->a(B)Landroid/graphics/PointF;
    ...
    iget v10, p0, Ldefpackage/lzs;->b:F

    iget v11, p0, Ldefpackage/lzs;->c:F

    iget v12, p0, Ldefpackage/lzs;->d:F
