.class public final Ldefpackage/pwx;
...
.method public constructor <init>(Lcom/google/vr/ndk/base/DaydreamApi;Ljava/lang/Runnable;Landroid/app/PendingIntent;)V
    ...
    .line 19
    iput-object p1, p0, Ldefpackage/pwx;->c:Lcom/google/vr/ndk/base/DaydreamApi;

    .line 20
    iput-object p2, p0, Ldefpackage/pwx;->a:Ljava/lang/Runnable;

    .line 21
    iput-object p3, p0, Ldefpackage/pwx;->b:Landroid/app/PendingIntent;
...
.method public final run()V
    ...
    .line 26
    iget-object v0, p0, Ldefpackage/pwx;->c:Lcom/google/vr/ndk/base/DaydreamApi;

    .line 27
    .local v0, "daydreamApi":Lcom/google/vr/ndk/base/DaydreamApi;
    iget-object v1, v0, Lcom/google/vr/ndk/base/DaydreamApi;->f:Ldefpackage/pxk;

    .line 28
    .local v1, "pxkVar":Ldefpackage/pxk;
    ...
    .line 30
    iget-object v2, p0, Ldefpackage/pwx;->a:Ljava/lang/Runnable;
    ...
    .line 35
    :try_start_1
    iget-object v3, p0, Ldefpackage/pwx;->b:Landroid/app/PendingIntent;
    ...
    invoke-virtual {v1, v6, v4}, Ldefpackage/bmn;->y(ILandroid/os/Parcel;)Landroid/os/Parcel;

    move-result-object v6

    .line 39
    .local v6, "y":Landroid/os/Parcel;
    invoke-static {v6}, Ldefpackage/bmp;->f(Landroid/os/Parcel;)Z
    ...
    .line 45
    iget-object v5, p0, Ldefpackage/pwx;->a:Ljava/lang/Runnable;
    ...
    iget-object v6, p0, Ldefpackage/pwx;->b:Landroid/app/PendingIntent;
    ...
    .line 51
    iget-object v4, p0, Ldefpackage/pwx;->c:Lcom/google/vr/ndk/base/DaydreamApi;

    iget-object v4, v4, Lcom/google/vr/ndk/base/DaydreamApi;->f:Ldefpackage/pxk;

    .line 52
    .local v4, "pxkVar2":Ldefpackage/pxk;
    ...
    invoke-static {v6, v3}, Ldefpackage/bmp;->c(Landroid/os/Parcel;Landroid/os/Parcelable;)V

    .line 54
    const/16 v7, 0x11

    invoke-virtual {v4, v7, v6}, Ldefpackage/bmn;->y(ILandroid/os/Parcel;)Landroid/os/Parcel;
    ...
    .end local v4    # "pxkVar2":Ldefpackage/pxk;
