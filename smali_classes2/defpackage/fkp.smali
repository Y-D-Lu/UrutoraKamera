.class public final Ldefpackage/fkp;
.super Ljava/lang/Object;
.source ""

# interfaces
.implements Ldefpackage/fli;
...
.field private final c:Ldefpackage/ius;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ldefpackage/lar;Ldefpackage/ius;Ldefpackage/ojc;Ldefpackage/ddf;Llda;)V
    .locals 3
    ...
    .line 31
    iput-object p1, p0, Ldefpackage/fkp;->b:Landroid/content/Context;

    .line 32
    iput-object p2, p0, Ldefpackage/fkp;->a:Ldefpackage/lar;

    .line 33
    iput-object p3, p0, Ldefpackage/fkp;->c:Ldefpackage/ius;

    .line 34
    iput-object p4, p0, Ldefpackage/fkp;->d:Ldefpackage/ojc;

    .line 35
    iput-object p6, p0, Ldefpackage/fkp;->f:Llda;

    .line 36
    iput-object p5, p0, Ldefpackage/fkp;->g:Ldefpackage/ddf;

    .line 37
    sget-object v0, Ljava/util/concurrent/TimeUnit;->MILLISECONDS:Ljava/util/concurrent/TimeUnit;

    sget-object v1, Ldefpackage/ddm;->u:Ldefpackage/ddi;

    invoke-interface {p5, v1}, Ldefpackage/ddf;->a(Ldefpackage/ddi;)Ldefpackage/ojc;
    ...
    iput v0, p0, Ldefpackage/fkp;->e:F
...
.method public final a()V
    ...
    iget-object v1, p0, Ldefpackage/fkp;->b:Landroid/content/Context;
    ...
    iget-object v2, p0, Ldefpackage/fkp;->g:Ldefpackage/ddf;
    ...
    iget-object v2, p0, Ldefpackage/fkp;->b:Landroid/content/Context;
    ...
    iget-object v4, p0, Ldefpackage/fkp;->b:Landroid/content/Context;
    ...
    iget-object v4, p0, Ldefpackage/fkp;->d:Ldefpackage/ojc;
    ...
    iget-object v4, p0, Ldefpackage/fkp;->f:Llda;
    ...
    iget-object v5, p0, Ldefpackage/fkp;->d:Ldefpackage/ojc;
    ...
    iget v7, p0, Ldefpackage/fkp;->e:F
    ...
    :try_start_0
    invoke-static {v6, v7, v3}, Ldefpackage/l;->a(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    :cond_1
    :goto_1
    new-instance v3, Ldefpackage/fko;

    invoke-direct {v3, p0, v2, v0}, Ldefpackage/fko;-><init>(Ldefpackage/fkp;Landroid/graphics/drawable/AnimatedVectorDrawable;Landroid/widget/FrameLayout;)V
    ...
    .line 66
    iget-object v3, p0, Ldefpackage/fkp;->c:Ldefpackage/ius;

    const/4 v4, 0x6

    const v5, 0x7f110069

    invoke-virtual {v3, v4, v5, v0}, Ldefpackage/ius;->f(IILandroid/view/View;)V
