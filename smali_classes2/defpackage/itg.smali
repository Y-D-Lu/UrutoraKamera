.class public final Ldefpackage/itg;
.super Ljava/lang/Object;
.source ""

# interfaces
.implements Ldefpackage/itq;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ldefpackage/itg;->a:Ldefpackage/ouj;
...
.method public constructor <init>(Ldefpackage/ojc;Ldefpackage/ojc;Landroid/content/Context;)V
    .locals 2
    ...
    .line 27
    iput-object p1, p0, Ldefpackage/itg;->f:Ldefpackage/ojc;

    .line 28
    iput-object p2, p0, Ldefpackage/itg;->g:Ldefpackage/ojc;
    ...
    iput-wide v0, p0, Ldefpackage/itg;->c:J

    .line 30
    const-wide/16 v0, 0x0

    iput-wide v0, p0, Ldefpackage/itg;->d:J

    .line 31
    const/4 v0, 0x0

    iput v0, p0, Ldefpackage/itg;->e:I
...
.method public final declared-synchronized a()V
    ...
    .line 36
    :try_start_0
    iget-boolean v0, p0, Ldefpackage/itg;->b:Z

    if-nez v0, :cond_0

    .line 37
    iget-wide v0, p0, Ldefpackage/itg;->c:J
    ...
    .line 39
    .end local p0    # "this":Ldefpackage/itg;
    :cond_0
    monitor-exit p0
...
.method public final declared-synchronized b()V
    ...
    .line 47
    iget-object v0, p0, Ldefpackage/itg;->f:Ldefpackage/ojc;
    ...
    check-cast v0, Ldefpackage/itx;

    invoke-virtual {v0}, Ldefpackage/itx;->a()V
    :try_end_1
...
.method public final declared-synchronized c(Ldefpackage/mad;Landroid/graphics/PointF;)Ldefpackage/itz;
    .locals 35
    ...
    .line 54
    :try_start_0
    iget-boolean v2, v1, Ldefpackage/itg;->b:Z

    if-eqz v2, :cond_0

    .line 55
    sget-object v2, Ldefpackage/itg;->a:Ldefpackage/ouj;
    ...
    iput-wide v2, v1, Ldefpackage/itg;->d:J

    .line 59
    const/4 v2, 0x0

    iput v2, v1, Ldefpackage/itg;->e:I

    .line 60
    iget-object v3, v1, Ldefpackage/itg;->g:Ldefpackage/ojc;
    ...
    check-cast v3, Ldefpackage/itr;

    goto :goto_0

    :cond_1
    sget-object v3, Ldefpackage/itr;->OPTICAL_FLOW:Ldefpackage/itr;

    .line 61
    .local v3, "itrVar":Ldefpackage/itr;
    :goto_0
    iget-object v4, v1, Ldefpackage/itg;->f:Ldefpackage/ojc;
    ...
    invoke-virtual {v4, v5, v6, v7}, Ldefpackage/itx;->b(Ldefpackage/lig;J)Z
    ...
    .line 63
    sget-object v4, Ldefpackage/itg;->a:Ldefpackage/ouj;
    ...
    iget-object v4, v4, Ldefpackage/itx;->a:Ldefpackage/dvp;

    invoke-virtual {v4}, Ldefpackage/dvp;->b()Ldefpackage/hjz;

    move-result-object v4

    .line 66
    .local v4, "b":Ldefpackage/hjz;
    if-eqz v4, :cond_3

    iget-wide v5, v4, Ldefpackage/hjz;->c:J
    ...
    iget v5, v4, Ldefpackage/hjz;->e:I
    ...
    .line 67
    sget-object v5, Ldefpackage/itr;->GYRO:Ldefpackage/itr;

    move-object v3, v5

    .line 70
    .end local v4    # "b":Ldefpackage/hjz;
    :cond_3
    ...
    .line 72
    .local v5, "macVar2":Ldefpackage/mac;
    invoke-interface/range {p1 .. p1}, Ldefpackage/mad;->g()Ljava/util/List;
    ...
    iget-wide v10, v1, Ldefpackage/itg;->c:J
    ...
    .line 87
    .local v13, "f7":F
    iget v14, v1, Ldefpackage/itg;->e:I

    move-object/from16 v16, v3

    .end local v3    # "itrVar":Ldefpackage/itr;
    .local v16, "itrVar":Ldefpackage/itr;
    iget-wide v2, v1, Ldefpackage/itg;->c:J
    ...
    iput v14, v1, Ldefpackage/itg;->e:I
    ...
    invoke-virtual {v2, v0}, Ldefpackage/ity;->b(F)V

    .line 91
    invoke-static {v10}, Ldefpackage/iub;->a(I)I

    move-result v0

    iput v0, v2, Ldefpackage/ity;->a:I

    .line 92
    iget-wide v14, v1, Ldefpackage/itg;->c:J

    invoke-static {v14, v15}, Lcom/google/android/apps/camera/jni/tracking/RoiTrackerNative;->getCurrentTrackerIndex(J)I

    move-result v0

    invoke-static {v0}, Ldefpackage/itr;->a(I)Ldefpackage/itr;

    move-result-object v0

    invoke-virtual {v2, v0}, Ldefpackage/ity;->f(Ldefpackage/itr;)V

    .line 93
    iget v0, v1, Ldefpackage/itg;->e:I

    invoke-virtual {v2, v0}, Ldefpackage/ity;->c(I)V

    .line 94
    const-wide/16 v14, 0x0

    invoke-virtual {v2, v14, v15}, Ldefpackage/ity;->e(J)V
    ...
    .line 53
    .end local v2    # "a2":Ldefpackage/ity;
    .end local v4    # "macVar":Ldefpackage/mac;
    .end local v5    # "macVar2":Ldefpackage/mac;
    ...
    .end local v12    # "f5":F
    .end local v13    # "f7":F
    .end local v16    # "itrVar":Ldefpackage/itr;
...
.method public final declared-synchronized close()V
    ...
    :cond_0
    :try_start_1
    invoke-virtual {p0}, Ldefpackage/itg;->b()V
    ...
    invoke-virtual {v0}, Ldefpackage/itx;->close()V
    ...
    iput-boolean v0, p0, Ldefpackage/itg;->b:Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public final declared-synchronized d(Ldefpackage/mad;)Ldefpackage/itz;
    .locals 31
    .param p1, "madVar"    # Ldefpackage/mad;
    ...
    .line 113
    :try_start_0
    iget-boolean v0, v1, Ldefpackage/itg;->b:Z
    ...
    .line 117
    .local v0, "macVar":Ldefpackage/mac;
    invoke-interface/range {p1 .. p1}, Ldefpackage/mad;->g()Ljava/util/List;
    ...
    .line 122
    .local v26, "fArr":[F
    iget-object v9, v1, Ldefpackage/itg;->f:Ldefpackage/ojc;
    ...
    iget-object v8, v1, Ldefpackage/itg;->f:Ldefpackage/ojc;

    invoke-virtual {v8}, Ldefpackage/ojc;->c()Ljava/lang/Object;

    move-result-object v8

    check-cast v8, Ldefpackage/itx;

    invoke-interface/range {p1 .. p1}, Ldefpackage/mad;->d()J

    move-result-wide v9

    invoke-virtual {v8, v9, v10}, Ldefpackage/itx;->c(J)[F
    ...
    iget-wide v8, v1, Ldefpackage/itg;->c:J
    ...
    .end local v0    # "macVar":Ldefpackage/mac;
    ...
    .local v19, "macVar2":Ldefpackage/mac;
    ...
    invoke-virtual {v2, v4}, Ldefpackage/ity;->d(Landroid/graphics/RectF;)V

    .line 138
    invoke-virtual {v2, v15}, Ldefpackage/ity;->b(F)V

    .line 139
    invoke-static {v8}, Ldefpackage/iub;->a(I)I
    ...
    .line 140
    iget-wide v3, v1, Ldefpackage/itg;->c:J
    ...
    iget-wide v5, v1, Ldefpackage/itg;->d:J
    ...
    .end local v14    # "f7":F
    .end local v15    # "f8":F
    .end local v16    # "macVar":Ldefpackage/mac;
    .end local v18    # "macVar3":Ldefpackage/mac;
    .end local v19    # "macVar2":Ldefpackage/mac;
    .end local v20    # "b":I
    .end local v23    # "c2":[F
