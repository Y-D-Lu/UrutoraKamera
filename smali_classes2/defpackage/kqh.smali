...
.field private b:Ldefpackage/krj;

.field private final c:Ldefpackage/kri;
...
.method public constructor <init>()V
    ...
    .line 14
    new-instance v0, Ldefpackage/kri;

    invoke-direct {v0, p0}, Ldefpackage/kri;-><init>(Ldefpackage/kqh;)V

    iput-object v0, p0, Ldefpackage/kqh;->c:Ldefpackage/kri;
    ...
    iput-object v0, p0, Ldefpackage/kqh;->a:Ljava/lang/Object;

    return-void
.end method

.method private final a()Ldefpackage/krj;
    .locals 2

    .line 19
    iget-object v0, p0, Ldefpackage/kqh;->a:Ljava/lang/Object;

    monitor-enter v0

    .line 20
    :try_start_0
    iget-object v1, p0, Ldefpackage/kqh;->b:Ldefpackage/krj;

    .line 21
    .local v1, "krjVar":Ldefpackage/krj;
    monitor-exit v0
    ...
    .line 21
    .end local v1    # "krjVar":Ldefpackage/krj;
    :catchall_0
    move-exception v1
...
# virtual methods
.method public c(Ljava/lang/String;[B[BLdefpackage/kre;)V
    .locals 1
...
.method public d(Ljava/lang/String;[B[BLdefpackage/kre;)V
    .locals 0
    .param p1, "str"    # Ljava/lang/String;
    .param p2, "bArr"    # [B
    .param p3, "bArr2"    # [B
    ...
    .line 31
    invoke-virtual {p0, p1, p2, p3, p4}, Ldefpackage/kqh;->c(Ljava/lang/String;[B[BLdefpackage/kre;)V
...
.method public final onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    sget-object v4, Ldefpackage/krw;->b:Ldefpackage/krw;

    invoke-static {p0, v3, v4}, Ldefpackage/krp;->a(Landroid/content/Context;Ljava/lang/String;Ldefpackage/kro;)Landroid/os/IInterface;

    move-result-object v3

    check-cast v3, Ldefpackage/krj;
    :try_end_1
    ...
    .line 48
    .local v3, "b":Lkoh;
    iget-object v4, p0, Ldefpackage/kqh;->c:Ldefpackage/kri;

    .line 49
    .local v4, "kriVar":Ldefpackage/kri;
    ...
    invoke-virtual {v1, v6, v5}, Ldefpackage/bmn;->z(ILandroid/os/Parcel;)V

    .line 53
    iput-object v1, p0, Ldefpackage/kqh;->b:Ldefpackage/krj;
    :try_end_2
    ...
    .line 59
    .end local v3    # "b":Lkoh;
    .end local v4    # "kriVar":Ldefpackage/kri;
    ...
    .line 58
    :cond_2
    new-instance v4, Ldefpackage/krk;

    const-string v5, "No IInAppExampleStoreProxy implementation found"

    invoke-direct {v4, v5}, Ldefpackage/krk;-><init>(Ljava/lang/String;)V
    :try_end_3
    ...
    .line 64
    :cond_3
    new-instance v2, Ldefpackage/krk;

    const-string v4, "No IInAppExampleStoreProxy implementation found"

    invoke-direct {v2, v4}, Ldefpackage/krk;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v3, v0}, Ldefpackage/bmn;->y(ILandroid/os/Parcel;)Landroid/os/Parcel;
    ...
    invoke-direct {v2, v3}, Ldefpackage/krk;-><init>(Ljava/lang/String;)V
...
.method public final onDestroy()V
    ...
    .line 85
    invoke-direct {p0}, Ldefpackage/kqh;->a()Ldefpackage/krj;

    move-result-object v0

    .line 86
    .local v0, "a":Ldefpackage/krj;
    if-eqz v0, :cond_0
    ...
    invoke-virtual {v0, v1, v2}, Ldefpackage/bmn;->z(ILandroid/os/Parcel;)V
    :try_end_0
...
.method public final onRebind(Landroid/content/Intent;)V
    ...
    invoke-static {v1, p1}, Ldefpackage/bmp;->c(Landroid/os/Parcel;Landroid/os/Parcelable;)V

    .line 105
    const/4 v2, 0x6

    invoke-virtual {v0, v2, v1}, Ldefpackage/bmn;->z(ILandroid/os/Parcel;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final onUnbind(Landroid/content/Intent;)Z
    ...
    invoke-static {v2, p1}, Ldefpackage/bmp;->c(Landroid/os/Parcel;Landroid/os/Parcelable;)V

    .line 140
    invoke-virtual {v0, v1, v2}, Ldefpackage/bmn;->y(ILandroid/os/Parcel;)Landroid/os/Parcel;

    move-result-object v3

    .line 141
    .local v3, "y":Landroid/os/Parcel;
    invoke-static {v3}, Ldefpackage/bmp;->f(Landroid/os/Parcel;)Z
