...
.field final b:Ldefpackage/mln;

.field final c:Ldefpackage/frg;


# direct methods
.method public constructor <init>(Ldefpackage/frg;Ldefpackage/pih;Ldefpackage/mln;)V
    .locals 0
    .param p1, "frgVar"    # Ldefpackage/frg;
    .param p2, "pihVar"    # Ldefpackage/pih;
    .param p3, "mlnVar"    # Ldefpackage/mln;

    .line 16
    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    .line 17
    iput-object p1, p0, Ldefpackage/fre;->c:Ldefpackage/frg;

    .line 18
    iput-object p2, p0, Ldefpackage/fre;->a:Ldefpackage/pih;

    .line 19
    iput-object p3, p0, Ldefpackage/fre;->b:Ldefpackage/mln;
...
.method public final a(Ldefpackage/pht;)V
    ...
    .line 24
    iget-object v0, p0, Ldefpackage/fre;->a:Ldefpackage/pih;

    invoke-virtual {v0, p1}, Ldefpackage/pih;->e(Ldefpackage/pht;)Z

    .line 25
    iget-object v0, p0, Ldefpackage/fre;->b:Ldefpackage/mln;
...
.method public final b(Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V
    ...
    .line 32
    sget-object v0, Ldefpackage/frg;->a:Ldefpackage/ouj;
    ...
    invoke-static {v1}, Ldefpackage/mip;->aG(Ljava/lang/String;)Z
    ...
    .line 41
    :cond_2
    iget-object v1, p0, Ldefpackage/fre;->c:Ldefpackage/frg;

    iget-object v1, v1, Ldefpackage/frg;->b:Ldefpackage/frf;
    ...
    .line 42
    :try_start_1
    iget-object v2, p0, Ldefpackage/fre;->c:Ldefpackage/frg;

    iget-object v2, v2, Ldefpackage/frg;->b:Ldefpackage/frf;

    move-object v3, v2

    .line 43
    .local v3, "frfVar":Ldefpackage/frf;
    iget v4, v3, Ldefpackage/frf;->b:I
    ...
    iput-wide v4, v3, Ldefpackage/frf;->c:J
    ...
    .line 47
    iget v4, v2, Ldefpackage/frf;->a:I

    add-int/lit8 v4, v4, 0x1

    iput v4, v2, Ldefpackage/frf;->a:I
    ...
    .line 50
    .local v4, "frfVar2":Ldefpackage/frf;
    iget v5, v4, Ldefpackage/frf;->b:I

    add-int/lit8 v5, v5, 0x1

    iput v5, v4, Ldefpackage/frf;->b:I

    .line 51
    iget-wide v5, p2, Landroid/media/MediaCodec$BufferInfo;->presentationTimeUs:J

    iget-wide v7, v2, Ldefpackage/frf;->c:J

    invoke-static {v5, v6, v7, v8}, Ljava/lang/Math;->min(JJ)J

    move-result-wide v5

    iput-wide v5, v4, Ldefpackage/frf;->c:J
    ...
    iget-wide v7, v2, Ldefpackage/frf;->d:J

    invoke-static {v5, v6, v7, v8}, Ljava/lang/Math;->max(JJ)J

    move-result-wide v5

    iput-wide v5, v2, Ldefpackage/frf;->d:J

    .line 53
    .end local v3    # "frfVar":Ldefpackage/frf;
    .end local v4    # "frfVar2":Ldefpackage/frf;
    monitor-exit v1
    ...
    .end local p0    # "this":Ldefpackage/fre;
    ...
    .line 54
    .end local v0    # "mediaFormat":Landroid/media/MediaFormat;
    .restart local p0    # "this":Ldefpackage/fre;
