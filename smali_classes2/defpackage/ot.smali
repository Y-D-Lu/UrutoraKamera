...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lksc;->c(Landroid/content/Context;Ljava/util/concurrent/Executor;Lkqk;)Lkvk;
.end annotation
...
.field public final synthetic val$kqkVar:Lkqk;

.field public final synthetic val$kvmVar:Lkvm;


# direct methods
.method public constructor <init>(Landroid/content/Context;Lkvm;Ljava/util/concurrent/Executor;Lkqk;)V
    .locals 0

    .line 23
    iput-object p1, p0, Ldefpackage/Ot;->val$context:Landroid/content/Context;

    iput-object p2, p0, Ldefpackage/Ot;->val$kvmVar:Lkvm;

    iput-object p3, p0, Ldefpackage/Ot;->val$executor:Ljava/util/concurrent/Executor;

    iput-object p4, p0, Ldefpackage/Ot;->val$kqkVar:Lkqk;
...
.method public final run()V
    ...
    iget-object v2, v1, Ldefpackage/Ot;->val$context:Landroid/content/Context;

    .line 28
    .local v2, "context2":Landroid/content/Context;
    iget-object v3, v1, Ldefpackage/Ot;->val$kvmVar:Lkvm;

    .line 29
    .local v3, "kvmVar2":Lkvm;
    iget-object v4, v1, Ldefpackage/Ot;->val$executor:Ljava/util/concurrent/Executor;

    .line 30
    .local v4, "executor2":Ljava/util/concurrent/Executor;
    iget-object v5, v1, Ldefpackage/Ot;->val$kqkVar:Lkqk;

    .line 31
    .local v5, "kqkVar2":Lkqk;
    sget-object v6, Lkqf;->a:Ljava/lang/Object;

    monitor-enter v6

    .line 32
    :try_start_0
    sget-boolean v0, Lkqf;->b:Z
    ...
    invoke-direct {v10, v11}, Lkig;-><init>(Lcom/google/android/gms/common/api/Status;)V

    invoke-virtual {v3, v10}, Lkvm;->c(Ljava/lang/Exception;)V
    ...
    sget-object v9, Lkrw;->c:Lkrw;

    invoke-static {v2, v8, v9}, Lkrp;->a(Landroid/content/Context;Ljava/lang/String;Lkro;)Landroid/os/IInterface;
    ...
    .line 48
    .local v8, "krtVar":Lkrt;
    new-instance v9, Lkrz;

    invoke-direct {v9, v3, v8}, Lkrz;-><init>(Lkvm;Lkrt;)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_11

    .line 50
    .local v9, "krzVar":Lkrz;
    :try_start_2
    ...
    invoke-static {v13, v11}, Lbmp;->e(Landroid/os/Parcel;Landroid/os/IInterface;)V

    .line 54
    invoke-static {v13, v12}, Lbmp;->e(Landroid/os/Parcel;Landroid/os/IInterface;)V

    .line 55
    invoke-static {v13, v5}, Lbmp;->c(Landroid/os/Parcel;Landroid/os/Parcelable;)V

    .line 56
    invoke-static {v13, v9}, Lbmp;->e(Landroid/os/Parcel;Landroid/os/IInterface;)V

    .line 57
    invoke-virtual {v8, v0, v13}, Lbmn;->y(ILandroid/os/Parcel;)Landroid/os/Parcel;

    move-result-object v14

    .line 58
    .local v14, "y":Landroid/os/Parcel;
    invoke-static {v14}, Lbmp;->f(Landroid/os/Parcel;)Z
    ...
    .line 63
    :cond_1
    iget-object v6, v5, Lkqk;->k:Landroid/net/Uri;
    :try_end_2
    ...
    invoke-direct {v6, v10}, Lkig;-><init>(Lcom/google/android/gms/common/api/Status;)V

    invoke-virtual {v3, v6}, Lkvm;->c(Ljava/lang/Exception;)V
    :try_end_3
    ...
    invoke-static {v10, v1}, Lbmp;->e(Landroid/os/Parcel;Landroid/os/IInterface;)V

    .line 72
    invoke-static {v10, v6}, Lbmp;->e(Landroid/os/Parcel;Landroid/os/IInterface;)V

    .line 73
    invoke-static {v10, v5}, Lbmp;->c(Landroid/os/Parcel;Landroid/os/Parcelable;)V

    .line 74
    invoke-static {v10, v9}, Lbmp;->e(Landroid/os/Parcel;Landroid/os/IInterface;)V

    .line 75
    const/16 v0, 0x9

    invoke-virtual {v8, v0, v10}, Lbmn;->y(ILandroid/os/Parcel;)Landroid/os/Parcel;
    ...
    invoke-static/range {v17 .. v17}, Lbmp;->f(Landroid/os/Parcel;)Z
    ...
    invoke-virtual {v3, v0}, Lkvm;->c(Ljava/lang/Exception;)V
    :try_end_6
    ...
    invoke-static {v7, v1}, Lbmp;->e(Landroid/os/Parcel;Landroid/os/IInterface;)V

    .line 90
    invoke-static {v7, v6}, Lbmp;->e(Landroid/os/Parcel;Landroid/os/IInterface;)V

    .line 91
    invoke-static {v7, v5}, Lbmp;->c(Landroid/os/Parcel;Landroid/os/Parcelable;)V

    .line 92
    invoke-static {v7, v9}, Lbmp;->e(Landroid/os/Parcel;Landroid/os/IInterface;)V
    ...
    .local v22, "b5":Lkoh;
    invoke-virtual {v8, v1, v7}, Lbmn;->y(ILandroid/os/Parcel;)Landroid/os/Parcel;
    ...
    invoke-static {v1}, Lbmp;->f(Landroid/os/Parcel;)Z
    ...
    .line 99
    :cond_5
    iget-object v0, v5, Lkqk;->d:Ljava/lang/String;
    :try_end_7
    ...
    invoke-virtual {v8, v0, v7}, Lbmn;->y(ILandroid/os/Parcel;)Landroid/os/Parcel;
    ...
    invoke-static/range {v27 .. v27}, Lbmp;->f(Landroid/os/Parcel;)Z
    ...
    invoke-static {v6, v0}, Lbmp;->e(Landroid/os/Parcel;Landroid/os/IInterface;)V

    .line 127
    invoke-static {v6, v1}, Lbmp;->e(Landroid/os/Parcel;Landroid/os/IInterface;)V

    .line 128
    invoke-static {v6, v5}, Lbmp;->c(Landroid/os/Parcel;Landroid/os/Parcelable;)V

    .line 129
    invoke-static {v6, v9}, Lbmp;->e(Landroid/os/Parcel;Landroid/os/IInterface;)V

    .line 130
    const/4 v7, 0x6

    invoke-virtual {v8, v7, v6}, Lbmn;->y(ILandroid/os/Parcel;)Landroid/os/Parcel;
    ...
    invoke-virtual {v3, v1}, Lkvm;->c(Ljava/lang/Exception;)V
    :try_end_e
    ...
    .end local v8    # "krtVar":Lkrt;
    .end local v9    # "krzVar":Lkrz;
    :goto_9
    goto :goto_c
    ...
    invoke-direct {v2, v4}, Lkig;-><init>(Lcom/google/android/gms/common/api/Status;)V

    invoke-virtual {v3, v2}, Lkvm;->c(Ljava/lang/Exception;)V
