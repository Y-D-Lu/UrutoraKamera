.class public final Ldefpackage/bhe;
...
.field public static final c:Ldefpackage/azs;

.field public static final d:Ldefpackage/azs;

.field public static final e:Ldefpackage/bhd;

.field private static final h:Ljava/util/Queue;


# instance fields
.field public final f:Ldefpackage/bct;

.field public final g:Ljava/util/List;

.field private final i:Ldefpackage/bcv;

.field private final j:Landroid/util/DisplayMetrics;

.field private final k:Ldefpackage/bhk;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Ldefpackage/bhe;->a:Ldefpackage/azs;

    .line 22
    const-string v0, "com.bumptech.glide.load.resource.bitmap.Downsampler.PreferredColorSpace"

    invoke-static {v0}, Ldefpackage/azs;->b(Ljava/lang/String;)Ldefpackage/azs;

    move-result-object v0

    sput-object v0, Ldefpackage/bhe;->b:Ldefpackage/azs;

    .line 34
    sget-object v0, Ldefpackage/bhb;->a:Ldefpackage/bhb;

    .line 35
    .local v0, "bhbVar":Ldefpackage/bhb;
    const/4 v1, 0x0
    ...
    invoke-static {v3, v2}, Ldefpackage/azs;->c(Ljava/lang/String;Ljava/lang/Object;)Ldefpackage/azs;

    move-result-object v3

    sput-object v3, Ldefpackage/bhe;->c:Ldefpackage/azs;
    ...
    sput-object v2, Ldefpackage/bhe;->d:Ldefpackage/azs;
    ...
    .line 38
    new-instance v2, Ldefpackage/bhc;

    invoke-direct {v2}, Ldefpackage/bhc;-><init>()V

    sput-object v2, Ldefpackage/bhe;->e:Ldefpackage/bhd;
    ...
    .line 40
    invoke-static {v1}, Ldefpackage/bmf;->h(I)Ljava/util/Queue;

    move-result-object v1

    sput-object v1, Ldefpackage/bhe;->h:Ljava/util/Queue;

    .line 41
    .end local v0    # "bhbVar":Ldefpackage/bhb;
    return-void
.end method

.method public constructor <init>(Ljava/util/List;Landroid/util/DisplayMetrics;Ldefpackage/bcv;Ldefpackage/bct;)V
    .locals 1
    ...
    iput-object v0, p0, Ldefpackage/bhe;->k:Ldefpackage/bhk;

    .line 44
    iput-object p1, p0, Ldefpackage/bhe;->g:Ljava/util/List;

    .line 45
    invoke-static {p2}, Ldefpackage/aae;->s(Ljava/lang/Object;)Ljava/lang/Object;

    .line 46
    iput-object p2, p0, Ldefpackage/bhe;->j:Landroid/util/DisplayMetrics;

    .line 47
    invoke-static {p3}, Ldefpackage/aae;->s(Ljava/lang/Object;)Ljava/lang/Object;

    .line 48
    iput-object p3, p0, Ldefpackage/bhe;->i:Ldefpackage/bcv;

    .line 49
    invoke-static {p4}, Ldefpackage/aae;->s(Ljava/lang/Object;)Ljava/lang/Object;

    .line 50
    iput-object p4, p0, Ldefpackage/bhe;->f:Ldefpackage/bct;
...
.method private static d(Ldefpackage/bho;Landroid/graphics/BitmapFactory$Options;Ldefpackage/bhd;Ldefpackage/bcv;)Landroid/graphics/Bitmap;
    .locals 16
    .param p0, "bhoVar"    # Ldefpackage/bho;
    .param p1, "options"    # Landroid/graphics/BitmapFactory$Options;
    .param p2, "bhdVar"    # Ldefpackage/bhd;
    .param p3, "bcvVar"    # Ldefpackage/bcv;
    ...
    .line 69
    invoke-interface/range {p2 .. p2}, Ldefpackage/bhd;->b()V

    .line 70
    invoke-interface/range {p0 .. p0}, Ldefpackage/bho;->d()V
    ...
    :try_start_0
    invoke-interface/range {p0 .. p1}, Ldefpackage/bho;->b(Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    :try_start_2
    invoke-interface {v10, v0}, Ldefpackage/bcv;->d(Landroid/graphics/Bitmap;)V

    .line 119
    iput-object v5, v1, Landroid/graphics/BitmapFactory$Options;->inBitmap:Landroid/graphics/Bitmap;

    .line 120
    invoke-static/range {p0 .. p3}, Ldefpackage/bhe;->d(Ldefpackage/bho;Landroid/graphics/BitmapFactory$Options;Ldefpackage/bhd;Ldefpackage/bcv;)Landroid/graphics/Bitmap;

    move-result-object v0

    .line 121
    .local v0, "d2":Landroid/graphics/Bitmap;
    sget-object v11, Ldefpackage/bhy;->a:Ljava/util/concurrent/locks/Lock;
    :try_end_2
    ...
    .end local p0    # "bhoVar":Ldefpackage/bho;
    .end local p1    # "options":Landroid/graphics/BitmapFactory$Options;
    .end local p2    # "bhdVar":Ldefpackage/bhd;
    .end local p3    # "bcvVar":Ldefpackage/bcv;
    throw v9
    ...
    .restart local p0    # "bhoVar":Ldefpackage/bho;
    .restart local p1    # "options":Landroid/graphics/BitmapFactory$Options;
    .restart local p2    # "bhdVar":Ldefpackage/bhd;
    .restart local p3    # "bcvVar":Ldefpackage/bcv;
    :cond_2
    move-object/from16 v10, p3
...
.method private static declared-synchronized e()Landroid/graphics/BitmapFactory$Options;
    ...
    const-class v0, Ldefpackage/bhe;
    ...
    .line 142
    :try_start_1
    sget-object v1, Ldefpackage/bhe;->h:Ljava/util/Queue;
    ...
    invoke-static {v3}, Ldefpackage/bhe;->g(Landroid/graphics/BitmapFactory$Options;)V
...
.method private static f(Landroid/graphics/BitmapFactory$Options;)V
    ...
    .line 156
    invoke-static {p0}, Ldefpackage/bhe;->g(Landroid/graphics/BitmapFactory$Options;)V

    .line 157
    sget-object v0, Ldefpackage/bhe;->h:Ljava/util/Queue;
...
.method private static j(Ldefpackage/bho;Landroid/graphics/BitmapFactory$Options;Ldefpackage/bhd;Ldefpackage/bcv;)[I
    .locals 4
    .param p0, "bhoVar"    # Ldefpackage/bho;
    .param p1, "options"    # Landroid/graphics/BitmapFactory$Options;
    .param p2, "bhdVar"    # Ldefpackage/bhd;
    ...
    .line 192
    invoke-static {p0, p1, p2, p3}, Ldefpackage/bhe;->d(Ldefpackage/bho;Landroid/graphics/BitmapFactory$Options;Ldefpackage/bhd;Ldefpackage/bcv;)Landroid/graphics/Bitmap;
...
# virtual methods
.method public final a(Ldefpackage/bho;IILdefpackage/azt;Ldefpackage/bhd;)Ldefpackage/bcl;
    .locals 2
    .param p1, "r25"    # Ldefpackage/bho;
    .param p2, "r26"    # I
    .param p3, "r27"    # I
    .param p4, "r28"    # Ldefpackage/azt;
    .param p5, "r29"    # Ldefpackage/bhd;
