...
.field private final b:Ldefpackage/dos;

.field private final c:I


# direct methods
.method public constructor <init>(JLdefpackage/dos;I)V
    .locals 0
    .param p1, "j"    # J
    .param p3, "dosVar"    # Ldefpackage/dos;
    .param p4, "i"    # I
    ...
    .line 23
    iput-wide p1, p0, Ldefpackage/dnm;->a:J

    .line 24
    iput-object p3, p0, Ldefpackage/dnm;->b:Ldefpackage/dos;

    .line 25
    iput p4, p0, Ldefpackage/dnm;->c:I
...
.method public final call()Ljava/lang/Object;
    ...
    iget-object v1, v0, Ldefpackage/dnm;->b:Ldefpackage/dos;

    iget-object v1, v1, Ldefpackage/dos;->b:Ldefpackage/htf;

    invoke-virtual {v1}, Ldefpackage/htf;->b()Z
    ...
    invoke-interface {v1}, Ldefpackage/mad;->g()Ljava/util/List;
    ...
    .line 33
    .local v1, "macVar":Ldefpackage/mac;
    iget-object v3, v0, Ldefpackage/dnm;->b:Ldefpackage/dos;

    iget-object v3, v3, Ldefpackage/dos;->a:Ldefpackage/mad;
    ...
    iget-object v5, v0, Ldefpackage/dnm;->b:Ldefpackage/dos;

    iget-object v5, v5, Ldefpackage/dos;->a:Ldefpackage/mad;

    invoke-interface {v5}, Ldefpackage/mad;->g()Ljava/util/List;
    ...
    .line 35
    .local v5, "macVar3":Ldefpackage/mac;
    iget-object v7, v0, Ldefpackage/dnm;->b:Ldefpackage/dos;

    iget-object v7, v7, Ldefpackage/dos;->a:Ldefpackage/mad;

    invoke-interface {v7}, Ldefpackage/mad;->c()I

    move-result v7

    iget-object v8, v0, Ldefpackage/dnm;->b:Ldefpackage/dos;

    iget-object v8, v8, Ldefpackage/dos;->a:Ldefpackage/mad;

    invoke-interface {v8}, Ldefpackage/mad;->b()I
    ...
    .line 36
    .local v7, "d":Ldefpackage/mme;
    iget-object v8, v0, Ldefpackage/dnm;->b:Ldefpackage/dos;

    iget-object v8, v8, Ldefpackage/dos;->c:Ldefpackage/lzv;

    sget-object v9, Landroid/hardware/camera2/CaptureResult;->STATISTICS_FACES:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-interface {v8, v9}, Ldefpackage/lzr;->d(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    iget-object v9, v0, Ldefpackage/dnm;->b:Ldefpackage/dos;

    iget-object v9, v9, Ldefpackage/dos;->c:Ldefpackage/lzv;

    sget-object v10, Landroid/hardware/camera2/CaptureResult;->SCALER_CROP_REGION:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-interface {v9, v10}, Ldefpackage/lzr;->d(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    iget-object v11, v0, Ldefpackage/dnm;->b:Ldefpackage/dos;

    iget-object v11, v11, Ldefpackage/dos;->c:Ldefpackage/lzv;

    invoke-static {v9, v11}, Ldefpackage/pkr;->o(Landroid/graphics/Rect;Ldefpackage/lzr;)Lcom/google/googlex/gcam/MeshWarp;
    ...
    iget-object v15, v0, Ldefpackage/dnm;->b:Ldefpackage/dos;

    iget-object v15, v15, Ldefpackage/dos;->d:Ldefpackage/ojc;
    ...
    check-cast v15, Ldefpackage/hkn;

    iget-object v14, v15, Ldefpackage/hkn;->p:Ldefpackage/ojc;
    ...
    .local v31, "ojcVar":Ldefpackage/ojc;
    :goto_1
    const/4 v14, 0x0
    ...
    .line 53
    .local v6, "macVar4":Ldefpackage/mac;
    new-instance v10, Landroid/graphics/Point;
    ...
    .end local v5    # "macVar3":Ldefpackage/mac;
    .local v33, "macVar3":Ldefpackage/mac;
    ...
    invoke-static {v4, v11}, Ldefpackage/dkr;->d(Landroid/graphics/Point;Lcom/google/googlex/gcam/MeshWarp;)Landroid/graphics/Point;

    move-result-object v10

    .line 56
    .local v10, "d2":Landroid/graphics/Point;
    invoke-static {v2, v11}, Ldefpackage/dkr;->d(Landroid/graphics/Point;Lcom/google/googlex/gcam/MeshWarp;)Landroid/graphics/Point;
    ...
    invoke-static {v0, v11}, Ldefpackage/dkr;->d(Landroid/graphics/Point;Lcom/google/googlex/gcam/MeshWarp;)Landroid/graphics/Point;
    ...
    invoke-static {v5, v11}, Ldefpackage/dkr;->d(Landroid/graphics/Point;Lcom/google/googlex/gcam/MeshWarp;)Landroid/graphics/Point;
    ...
    .line 60
    .local v22, "macVar5":Ldefpackage/mac;
    move-object/from16 v23, v1

    .line 61
    .local v23, "macVar6":Ldefpackage/mac;
    ...
    invoke-static {v15}, Ldefpackage/oxh;->E([I)I
    ...
    .end local v3    # "macVar2":Ldefpackage/mac;
    .local v34, "macVar2":Ldefpackage/mac;
    new-array v3, v15, [I
    ...
    invoke-static {v3}, Ldefpackage/oxh;->E([I)I
    ...
    .end local v1    # "macVar":Ldefpackage/mac;
    .local v35, "macVar":Ldefpackage/mac;
    new-array v1, v15, [I
    ...
    invoke-static {v1}, Ldefpackage/oxh;->D([I)I
    ...
    .end local v6    # "macVar4":Ldefpackage/mac;
    .local v27, "macVar4":Ldefpackage/mac;
    ...
    invoke-static {v15}, Ldefpackage/oxh;->D([I)I
    ...
    invoke-static {v3, v7, v9}, Ldefpackage/dkr;->c(Landroid/graphics/Point;Ldefpackage/mmf;Landroid/graphics/Rect;)Landroid/graphics/Point;

    move-result-object v5

    .line 65
    .local v5, "c":Landroid/graphics/Point;
    invoke-static {v4, v7, v9}, Ldefpackage/dkr;->c(Landroid/graphics/Point;Ldefpackage/mmf;Landroid/graphics/Rect;)Landroid/graphics/Point;
    ...
    invoke-static {v1, v11}, Ldefpackage/dkr;->d(Landroid/graphics/Point;Lcom/google/googlex/gcam/MeshWarp;)Landroid/graphics/Point;

    move-result-object v15

    invoke-static {v15, v7, v9}, Ldefpackage/dkr;->c(Landroid/graphics/Point;Ldefpackage/mmf;Landroid/graphics/Rect;)Landroid/graphics/Point;
    ...
    invoke-static {v0}, Lcom/google/android/apps/camera/jni/facebeautification/FaceInfo;->builder(Landroid/graphics/Rect;)Ldefpackage/enk;

    move-result-object v1

    .line 72
    .local v1, "builder":Ldefpackage/enk;
    iput-object v15, v1, Ldefpackage/enk;->b:Landroid/graphics/Point;

    .line 73
    iput-object v3, v1, Ldefpackage/enk;->c:Landroid/graphics/Point;
    ...
    iget-object v0, v0, Ldefpackage/hkz;->g:Ldefpackage/ojc;
    ...
    check-cast v38, Ldefpackage/oom;
    ...
    .local v43, "ojcVar2":Ldefpackage/ojc;
    ...
    .end local v43    # "ojcVar2":Ldefpackage/ojc;
    .local v0, "ojcVar2":Ldefpackage/ojc;
    :cond_6
    move-object/from16 v43, v0
    ...
    .end local v0    # "ojcVar2":Ldefpackage/ojc;
    .end local v4    # "i2":I
    .restart local v43    # "ojcVar2":Ldefpackage/ojc;
    iput-object v3, v1, Ldefpackage/enk;->d:[F
    ...
    .restart local v42    # "point6":Landroid/graphics/Point;
    :goto_7
    iget-object v0, v1, Ldefpackage/enk;->a:Landroid/graphics/Rect;
    ...
    .line 90
    new-instance v2, Ldefpackage/enj;

    iget-object v3, v1, Ldefpackage/enk;->b:Landroid/graphics/Point;

    iget-object v4, v1, Ldefpackage/enk;->c:Landroid/graphics/Point;

    move-object/from16 v41, v5

    .end local v5    # "c":Landroid/graphics/Point;
    .local v41, "c":Landroid/graphics/Point;
    iget-object v5, v1, Ldefpackage/enk;->d:[F

    invoke-direct {v2, v0, v3, v4, v5}, Ldefpackage/enj;-><init>(Landroid/graphics/Rect;Landroid/graphics/Point;Landroid/graphics/Point;[F)V
    ...
    .line 93
    .end local v33    # "macVar3":Ldefpackage/mac;
    .local v5, "macVar3":Ldefpackage/mac;
    move-object/from16 v3, v22

    .line 94
    .end local v34    # "macVar2":Ldefpackage/mac;
    .local v3, "macVar2":Ldefpackage/mac;
    ...
    .end local v22    # "macVar5":Ldefpackage/mac;
    .end local v23    # "macVar6":Ldefpackage/mac;
    ...
    .end local v27    # "macVar4":Ldefpackage/mac;
    ...
    .end local v35    # "macVar":Ldefpackage/mac;
    ...
    .restart local v22    # "macVar5":Ldefpackage/mac;
    .restart local v23    # "macVar6":Ldefpackage/mac;
    ...
    .restart local v27    # "macVar4":Ldefpackage/mac;
    ...
    .restart local v33    # "macVar3":Ldefpackage/mac;
    .restart local v34    # "macVar2":Ldefpackage/mac;
    .restart local v35    # "macVar":Ldefpackage/mac;
    ...
    .end local v42    # "point6":Landroid/graphics/Point;
    .local v1, "macVar":Ldefpackage/mac;
    .restart local v3    # "macVar2":Ldefpackage/mac;
    .local v5, "macVar3":Ldefpackage/mac;
    .local v13, "length":I
    :cond_b
    move-object/from16 v35, v1
    ...
    .line 97
    .local v0, "macVar7":Ldefpackage/mac;
    move-object/from16 v1, v34

    .line 98
    .local v1, "macVar8":Ldefpackage/mac;
    move-object/from16 v2, v33

    .line 99
    .local v2, "macVar9":Ldefpackage/mac;
    const/4 v3, 0x0
    ...
    iget-object v5, v4, Ldefpackage/dnm;->b:Ldefpackage/dos;

    .line 101
    .local v5, "dosVar":Ldefpackage/dos;
    iget-object v6, v5, Ldefpackage/dos;->b:Ldefpackage/htf;

    .line 102
    .local v6, "htfVar":Ldefpackage/htf;
    ...
    .end local v7    # "d":Ldefpackage/mme;
    .end local v8    # "faceArr":[Landroid/hardware/camera2/params/Face;
    .local v10, "d":Ldefpackage/mme;
    .local v13, "faceArr":[Landroid/hardware/camera2/params/Face;
    iget-wide v7, v4, Ldefpackage/dnm;->a:J

    .line 104
    .local v7, "j":J
    iget-object v15, v5, Ldefpackage/dos;->a:Ldefpackage/mad;

    invoke-interface {v15}, Ldefpackage/mad;->a()I

    move-result v36

    .line 105
    .local v36, "a":I
    iget-object v15, v4, Ldefpackage/dnm;->b:Ldefpackage/dos;

    iget-object v15, v15, Ldefpackage/dos;->a:Ldefpackage/mad;

    invoke-interface {v15}, Ldefpackage/mad;->c()I
    ...
    invoke-interface {v15}, Ldefpackage/mad;->b()I
    ...
    iget v15, v6, Ldefpackage/htf;->f:I

    .line 117
    .local v15, "i4":I
    move-object/from16 v48, v0

    .end local v0    # "macVar7":Ldefpackage/mac;
    .local v48, "macVar7":Ldefpackage/mac;
    iget v0, v4, Ldefpackage/dnm;->c:I

    .line 118
    .local v0, "i5":I
    move-object/from16 v49, v1

    .end local v1    # "macVar8":Ldefpackage/mac;
    .local v49, "macVar8":Ldefpackage/mac;
    iget-object v1, v4, Ldefpackage/dnm;->b:Ldefpackage/dos;
    ...
    .line 127
    .local v15, "dosVar2":Ldefpackage/dos;
    move/from16 v16, v0

    .end local v0    # "i5":I
    .local v16, "i5":I
    new-instance v0, Ldefpackage/doc;

    move/from16 v17, v1

    .end local v1    # "i":I
    .local v17, "i":I
    iget-object v1, v15, Ldefpackage/dos;->a:Ldefpackage/mad;

    move-object/from16 v18, v2

    .end local v2    # "macVar9":Ldefpackage/mac;
    .local v18, "macVar9":Ldefpackage/mac;
    iget-object v2, v15, Ldefpackage/dos;->b:Ldefpackage/htf;

    invoke-direct {v0, v1, v14, v2}, Ldefpackage/doc;-><init>(Ldefpackage/mad;[BLdefpackage/htf;)V

    return-object v0

    .line 39
    .end local v6    # "htfVar":Ldefpackage/htf;
    .end local v10    # "d":Ldefpackage/mme;
    ...
    .end local v15    # "dosVar2":Ldefpackage/dos;
    .end local v16    # "i5":I
    .end local v17    # "i":I
    .end local v18    # "macVar9":Ldefpackage/mac;
    .end local v31    # "ojcVar":Ldefpackage/ojc;
    .end local v32    # "length":I
    .end local v33    # "macVar3":Ldefpackage/mac;
    .end local v34    # "macVar2":Ldefpackage/mac;
    .end local v35    # "macVar":Ldefpackage/mac;
    ...
    .end local v48    # "macVar7":Ldefpackage/mac;
    .end local v49    # "macVar8":Ldefpackage/mac;
    .end local v50    # "i4":I
    .local v1, "macVar":Ldefpackage/mac;
    .local v3, "macVar2":Ldefpackage/mac;
    .local v5, "macVar3":Ldefpackage/mac;
    ...
    .end local v7    # "d":Ldefpackage/mme;
    .end local v8    # "faceArr":[Landroid/hardware/camera2/params/Face;
    .restart local v10    # "d":Ldefpackage/mme;
    .local v13, "faceArr":[Landroid/hardware/camera2/params/Face;
    .restart local v32    # "length":I
    goto :goto_9
    ...
    .end local v32    # "length":I
    .restart local v7    # "d":Ldefpackage/mme;
    .restart local v8    # "faceArr":[Landroid/hardware/camera2/params/Face;
    :cond_d
    move-object v4, v0
    ...
    iget-object v2, v4, Ldefpackage/dnm;->b:Ldefpackage/dos;

    iget-object v2, v2, Ldefpackage/dos;->a:Ldefpackage/mad;

    invoke-direct {v0, v2}, Ldefpackage/dod;-><init>(Ldefpackage/mad;)V
