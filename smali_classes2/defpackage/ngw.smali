...
.method public static constructor <clinit>()V
    ...
    .line 17
    const-class v0, Ldefpackage/ngw;
    ...
    sput-object v0, Ldefpackage/ngw;->b:Ljava/util/logging/Logger;
...
.method public static a(Ljava/lang/Object;Ljava/util/concurrent/ConcurrentHashMap;)Ldefpackage/nhf;
    .locals 12
    ...
    check-cast v2, Ldefpackage/nhf;

    .line 320
    .local v2, "nhfVar":Ldefpackage/nhf;
    if-eqz v2, :cond_0
    ...
    const-class v4, Ldefpackage/ngw;
    ...
    :goto_0
    :try_start_1
    new-instance v6, Ldefpackage/nhg;

    invoke-direct {v6}, Ldefpackage/nhg;-><init>()V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    .line 338
    .local v6, "nhgVar":Ldefpackage/nhg;
    :try_start_2
    invoke-virtual {v6, v5}, Ldefpackage/nhg;->readExternal(Ljava/io/ObjectInput;)V
    :try_end_2
    ...
    :try_start_4
    sget-object v8, Ldefpackage/ngw;->b:Ljava/util/logging/Logger;
    ...
    :goto_1
    iget-object v7, v6, Ldefpackage/nhg;->a:Ljava/util/List;
    ...
    check-cast v8, Ldefpackage/nhf;

    .line 352
    .local v8, "nhfVar2":Ldefpackage/nhf;
    ...
    check-cast v9, Ldefpackage/nhf;

    move-object v0, v9

    .line 353
    .local v0, "nhfVar3":Ldefpackage/nhf;
    if-eqz v0, :cond_2
    ...
    .line 346
    .end local v0    # "nhfVar3":Ldefpackage/nhf;
    .end local v8    # "nhfVar2":Ldefpackage/nhf;
    :cond_3
    ...
    .end local v2    # "nhfVar":Ldefpackage/nhf;
    .end local v3    # "str":Ljava/lang/String;
    .end local v4    # "resourceAsStream":Ljava/io/InputStream;
    .end local v5    # "objectInputStream":Ljava/io/ObjectInputStream;
    .end local v6    # "nhgVar":Ldefpackage/nhg;
    ...
    .restart local v2    # "nhfVar":Ldefpackage/nhf;
    ...
    .restart local v6    # "nhgVar":Ldefpackage/nhg;
