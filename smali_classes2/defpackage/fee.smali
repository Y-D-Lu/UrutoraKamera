.class public final Ldefpackage/fee;
...
.method public constructor <init>(Ldefpackage/feg;)V
    ...
    .line 16
    iput-object p1, p0, Ldefpackage/fee;->b:Ldefpackage/feg;

    .line 17
    const/4 v0, 0x0

    iput-object v0, p0, Ldefpackage/fee;->a:Landroid/os/Handler;
...
.method public final onLooperPrepared()V
    ...
    .line 23
    iget-object v0, p0, Ldefpackage/fee;->b:Ldefpackage/feg;

    .line 24
    .local v0, "fegVar":Ldefpackage/feg;
    iget-object v1, v0, Ldefpackage/feg;->b:Landroid/hardware/SensorManager;

    .line 25
    .local v1, "sensorManager":Landroid/hardware/SensorManager;
    iget-object v2, v0, Ldefpackage/feg;->p:Landroid/hardware/SensorEventListener;
    ...
    iget-object v5, p0, Ldefpackage/fee;->a:Landroid/os/Handler;
    ...
    .line 26
    iget-object v2, p0, Ldefpackage/fee;->b:Ldefpackage/feg;

    .line 27
    .local v2, "fegVar2":Ldefpackage/feg;
    iget-object v4, v2, Ldefpackage/feg;->b:Landroid/hardware/SensorManager;

    .line 28
    .local v4, "sensorManager2":Landroid/hardware/SensorManager;
    iget-object v5, v2, Ldefpackage/feg;->p:Landroid/hardware/SensorEventListener;
    ...
    iget-object v7, p0, Ldefpackage/fee;->a:Landroid/os/Handler;
    ...
    .line 29
    iget-object v3, p0, Ldefpackage/fee;->b:Ldefpackage/feg;

    .line 30
    .local v3, "fegVar3":Ldefpackage/feg;
    iget-object v5, v3, Ldefpackage/feg;->b:Landroid/hardware/SensorManager;

    .line 31
    .local v5, "sensorManager3":Landroid/hardware/SensorManager;
    iget-object v6, v3, Ldefpackage/feg;->p:Landroid/hardware/SensorEventListener;
    ...
    iget-object v8, p0, Ldefpackage/fee;->a:Landroid/os/Handler;
