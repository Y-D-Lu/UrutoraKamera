...
.method private static c(Ljava/io/File;Ljava/io/IOException;)Ljava/io/IOException;
    ...
    invoke-static {p0, p1}, Ldefpackage/mzi;->b(Ljava/io/File;Ljava/io/IOException;)Ljava/io/IOException;
...
.method public static e(Landroid/content/Context;)Ldefpackage/ojc;
    .locals 17
    ...
    :cond_2
    :goto_0
    invoke-static/range {p0 .. p0}, Ldefpackage/mez;->a(Landroid/content/Context;)Landroid/content/Context;
    ...
    .restart local v7    # "ojcVar":Ldefpackage/ojc;
    :goto_2
    ...
    invoke-direct {v1, v0}, Ldefpackage/nvb;-><init>(Ljava/util/Map;)V

    .line 117
    .local v1, "nvbVar":Ldefpackage/nvb;
    ...
    .line 125
    .end local v1    # "nvbVar":Ldefpackage/nvb;
    ...
    invoke-static {v13}, Ldefpackage/mzi;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v14}, Ldefpackage/mzi;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v15}, Ldefpackage/mzi;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method public static f(Ldefpackage/neb;)Ljava/lang/Object;
    .locals 4
    .param p0, "nebVar"    # Ldefpackage/neb;

    .line 142
    :try_start_0
    invoke-interface {p0}, Ldefpackage/neb;->a()Ljava/lang/Object;
...
.method public static j(Ldefpackage/nio;Landroid/net/Uri;Ljava/io/IOException;)Ljava/io/IOException;
    .locals 3
    .param p0, "nioVar"    # Ldefpackage/nio;
    .param p1, "uri"    # Landroid/net/Uri;
    .param p2, "iOException"    # Ljava/io/IOException;

    .line 213
    :try_start_0
    new-instance v0, Ldefpackage/njf;

    invoke-direct {v0}, Ldefpackage/njf;-><init>()V

    .line 214
    .local v0, "njfVar":Ldefpackage/njf;
    const/4 v1, 0x1

    iput-boolean v1, v0, Ldefpackage/njf;->a:Z

    .line 215
    invoke-virtual {p0, p1, v0}, Ldefpackage/nio;->b(Landroid/net/Uri;Ldefpackage/nin;)Ljava/lang/Object;
    ...
    :cond_0
    :goto_0
    invoke-static {v1, p2}, Ldefpackage/mzi;->c(Ljava/io/File;Ljava/io/IOException;)Ljava/io/IOException;
    ...
    .line 217
    .end local v0    # "njfVar":Ldefpackage/njf;
