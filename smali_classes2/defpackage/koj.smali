.class public final Ldefpackage/koj;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ldefpackage/koj;->a:Ljava/lang/ClassLoader;

    .line 10
    sput-object v0, Ldefpackage/koj;->b:Ljava/lang/Thread;
...
.method public static declared-synchronized a()Ljava/lang/ClassLoader;
    ...
    const-class v0, Ldefpackage/koj;
    ...
    .line 15
    :try_start_1
    sget-object v1, Ldefpackage/koj;->a:Ljava/lang/ClassLoader;

    if-nez v1, :cond_0

    .line 16
    invoke-static {}, Ldefpackage/koj;->b()Ljava/lang/ClassLoader;

    move-result-object v1

    sput-object v1, Ldefpackage/koj;->a:Ljava/lang/ClassLoader;
...
.method private static declared-synchronized c()Ljava/lang/Thread;
    ...
    const-class v1, Ldefpackage/koj;
    ...
    .line 92
    .local v2, "koiVar2":Ldefpackage/koi;
    :try_start_0
    monitor-enter v1
    :try_end_0
    ...
    .end local v0    # "i":I
    .local v2, "i":I
    .local v12, "koiVar2":Ldefpackage/koi;
    :goto_3
    if-lt v2, v10, :cond_3
    ...
    .line 124
    .end local v12    # "koiVar2":Ldefpackage/koi;
    .local v0, "koiVar2":Ldefpackage/koi;
    move-object v12, v0

    goto :goto_4

    .line 126
    .end local v0    # "koiVar2":Ldefpackage/koi;
    .restart local v12    # "koiVar2":Ldefpackage/koi;
    :cond_3
    :try_start_6
    aget-object v0, v11, v2

    check-cast v0, Ldefpackage/koi;
    ...
    .line 134
    :try_start_7
    new-instance v0, Ldefpackage/koi;

    invoke-direct {v0, v9}, Ldefpackage/koi;-><init>(Ljava/lang/ThreadGroup;)V
    :try_end_7
    .catch Ljava/lang/SecurityException; {:try_start_7 .. :try_end_7} :catch_1
    .catchall {:try_start_7 .. :try_end_7} :catchall_1

    .line 138
    .local v0, "koiVar":Ldefpackage/koi;
    move-object v14, v0

    goto :goto_5

    .line 155
    .end local v0    # "koiVar":Ldefpackage/koi;
    .end local v2    # "i":I
    .end local v6    # "activeGroupCount":I
    .end local v7    # "threadGroupArr":[Ljava/lang/ThreadGroup;
    .end local v8    # "i2":I
    ...
    .local v14, "koiVar":Ldefpackage/koi;
    :goto_5
    :try_start_8
    ...
    .end local v14    # "koiVar":Ldefpackage/koi;
    ...
    .restart local v14    # "koiVar":Ldefpackage/koi;
    :cond_4
    move-object/from16 v16, v0
    ...
    .line 148
    .end local v12    # "koiVar2":Ldefpackage/koi;
    .local v3, "koiVar2":Ldefpackage/koi;
    :try_start_d
    monitor-exit v5
    :try_end_d
    ...
    .end local v3    # "koiVar2":Ldefpackage/koi;
    .restart local v12    # "koiVar2":Ldefpackage/koi;
    :catchall_4
    move-exception v0
    ...
    .end local v2    # "koiVar2":Ldefpackage/koi;
    :try_start_12
    throw v0

    .restart local v2    # "koiVar2":Ldefpackage/koi;
    :catchall_7
    move-exception v0
