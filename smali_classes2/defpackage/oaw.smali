.class public final Ldefpackage/oaw;
...
.method public constructor <init>(Ldefpackage/obd;)V
    ...
    iput v0, p0, Ldefpackage/oaw;->c:F
...
.method public final a()I
    ...
    iget v0, v0, Ldefpackage/oaf;->a:I
...
.method public final c(Landroid/graphics/Canvas;F)V
    ...
    iput v1, p0, Ldefpackage/oaw;->c:F
    ...
    iget v1, v1, Ldefpackage/oaf;->a:I
    ...
    .line 38
    iget-object v2, p0, Ldefpackage/oat;->a:Ldefpackage/oaf;

    check-cast v2, Ldefpackage/obd;

    iget-boolean v2, v2, Ldefpackage/obd;->i:Z
    ...
    .line 41
    :cond_0
    iget-object v2, p0, Ldefpackage/oat;->b:Ldefpackage/oas;

    invoke-virtual {v2}, Ldefpackage/oas;->f()Z
    ...
    iget v2, v2, Ldefpackage/oaf;->e:I
    ...
    invoke-virtual {v2}, Ldefpackage/oas;->e()Z
    ...
    iget v2, v2, Ldefpackage/oaf;->f:I
    ...
    iget v2, v2, Ldefpackage/oaf;->a:I
    ...
    .line 47
    :cond_5
    iget v2, p0, Ldefpackage/oaw;->c:F
    ...
    .line 49
    iget-object v3, p0, Ldefpackage/oat;->a:Ldefpackage/oaf;

    check-cast v3, Ldefpackage/obd;

    .line 50
    .local v3, "obdVar":Ldefpackage/obd;
    iget v4, v3, Ldefpackage/oaf;->a:I

    int-to-float v4, v4

    mul-float/2addr v4, p2

    iput v4, p0, Ldefpackage/oaw;->d:F

    .line 51
    iget v4, v3, Ldefpackage/oaf;->b:I

    int-to-float v4, v4

    mul-float/2addr v4, p2

    iput v4, p0, Ldefpackage/oaw;->e:F
...
.method public final d(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFI)V
    ...
    .line 59
    :cond_0
    iget v2, v0, Ldefpackage/oaw;->c:F
    ...
    .line 61
    .local v3, "f4":F
    iget v5, v0, Ldefpackage/oaw;->e:F
    ...
    .line 67
    iget v9, v0, Ldefpackage/oaw;->d:F
    ...
    iget v10, v0, Ldefpackage/oaw;->e:F
...
.method public final e(Landroid/graphics/Canvas;Landroid/graphics/Paint;)V
    ...
    .line 79
    iget v1, p0, Ldefpackage/oaw;->c:F

    .line 80
    .local v1, "f":F
    iget v2, p0, Ldefpackage/oaw;->d:F
    ...
    iget v4, p0, Ldefpackage/oaw;->e:F
