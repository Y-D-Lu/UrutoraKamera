...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Ldefpackage/lfv;->onOutputBufferAvailable(Landroid/media/MediaCodec;ILandroid/media/MediaCodec$BufferInfo;)V
.end annotation
...
# direct methods
.method public constructor <init>(Ldefpackage/lfv;ILandroid/media/MediaCodec$BufferInfo;)V
    .locals 0
    .param p1, "this$0"    # Ldefpackage/lfv;

    .line 169
    iput-object p1, p0, Ldefpackage/lfv$4;->this$0:Ldefpackage/lfv;

    iput p2, p0, Ldefpackage/lfv$4;->val$i:I

    iput-object p3, p0, Ldefpackage/lfv$4;->val$bufferInfo:Landroid/media/MediaCodec$BufferInfo;
...
.method public final run()V
    ...
    iget-object v1, v0, Ldefpackage/lfv$4;->this$0:Ldefpackage/lfv;

    .line 173
    .local v1, "lfvVar":Ldefpackage/lfv;
    iget v2, v0, Ldefpackage/lfv$4;->val$i:I

    .line 174
    .local v2, "i2":I
    iget-object v3, v0, Ldefpackage/lfv$4;->val$bufferInfo:Landroid/media/MediaCodec$BufferInfo;

    .line 175
    .local v3, "bufferInfo2":Landroid/media/MediaCodec$BufferInfo;
    iget-object v4, v1, Ldefpackage/lfv;->a:Ldefpackage/lfy;

    .line 176
    .local v4, "lfyVar3":Ldefpackage/lfy;
    ...
    .line 187
    iget-object v6, v4, Ldefpackage/lfy;->q:Ljava/util/Deque;
    ...
    check-cast v10, Ldefpackage/orj;

    .line 191
    .local v10, "orjVar":Ldefpackage/orj;
    ...
    invoke-virtual {v10, v11}, Ldefpackage/orj;->a(Ljava/lang/Comparable;)Z
    ...
    .line 194
    :cond_2
    invoke-virtual {v10}, Ldefpackage/orj;->m()Z
    ...
    .line 200
    .end local v10    # "orjVar":Ldefpackage/orj;
    goto :goto_0

    .line 201
    :cond_4
    :goto_1
    iget-object v10, v4, Ldefpackage/lfy;->i:Landroid/media/MediaCodec;
    ...
    .end local v8    # "j":J
    .local v16, "j":J
    iget-wide v7, v4, Ldefpackage/lfy;->t:J
    ...
    .line 205
    iget-object v7, v4, Ldefpackage/lfy;->v:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    .line 208
    iget-object v9, v4, Ldefpackage/lfy;->v:Ljava/util/concurrent/atomic/AtomicLong;

    invoke-virtual {v9, v7, v8}, Ljava/util/concurrent/atomic/AtomicLong;->set(J)V

    .line 209
    iget-object v7, v4, Ldefpackage/lfy;->w:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    .line 211
    .local v8, "d":D
    iget-wide v13, v4, Ldefpackage/lfy;->l:D
    ...
    .end local v1    # "lfvVar":Ldefpackage/lfv;
    .local v18, "lfvVar":Ldefpackage/lfv;
    ...
    .line 216
    iget-object v1, v4, Ldefpackage/lfy;->o:Ljava/util/Queue;

    new-instance v15, Ldefpackage/lfx;

    invoke-direct {v15, v3, v0}, Ldefpackage/lfx;-><init>(Landroid/media/MediaCodec$BufferInfo;Ljava/nio/ByteBuffer;)V
    ...
    .line 219
    iget-object v1, v4, Ldefpackage/lfy;->m:Ldefpackage/lge;

    sget-object v5, Ldefpackage/lga;->VIDEO_BUFFER_DELAY:Ldefpackage/lga;

    invoke-virtual {v1, v5}, Ldefpackage/lge;->a(Ldefpackage/lga;)V
    ...
    .end local v13    # "d2":D
    .end local v16    # "j":J
    .end local v18    # "lfvVar":Ldefpackage/lfv;
    .restart local v1    # "lfvVar":Ldefpackage/lfv;
    :cond_5
    move-object/from16 v18, v1

    .line 222
    .end local v1    # "lfvVar":Ldefpackage/lfv;
    .restart local v18    # "lfvVar":Ldefpackage/lfv;
    :cond_6
    :goto_2
    iget-object v0, v4, Ldefpackage/lfy;->i:Landroid/media/MediaCodec;
    ...
    .line 223
    iget-boolean v0, v4, Ldefpackage/lfy;->y:Z
    ...
    iget-wide v5, v4, Ldefpackage/lfy;->s:J
    ...
    iget-boolean v0, v4, Ldefpackage/lfy;->x:Z

    if-eqz v0, :cond_9

    iget-boolean v0, v4, Ldefpackage/lfy;->z:Z

    if-nez v0, :cond_a

    :cond_9
    iget-boolean v0, v4, Ldefpackage/lfy;->A:Z

    if-nez v0, :cond_a

    iget-boolean v0, v4, Ldefpackage/lfy;->B:Z
    ...
    .line 229
    :cond_a
    iget-object v0, v4, Ldefpackage/lfy;->N:Ldefpackage/pih;
