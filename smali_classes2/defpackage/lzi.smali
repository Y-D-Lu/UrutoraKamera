.class public final Ldefpackage/lzi;
...
.method private constructor <init>(J)V
    ...
    :goto_0
    iput-boolean v1, p0, Ldefpackage/lzi;->a:Z
    ...
    :goto_1
    iput-boolean v1, p0, Ldefpackage/lzi;->b:Z
    ...
    :goto_2
    iput-boolean v1, p0, Ldefpackage/lzi;->o:Z
    ...
    :goto_3
    iput-boolean v1, p0, Ldefpackage/lzi;->n:Z
    ...
    :goto_4
    iput-boolean v1, p0, Ldefpackage/lzi;->p:Z
    ...
    :goto_5
    iput-boolean v1, p0, Ldefpackage/lzi;->q:Z
    ...
    :goto_6
    iput-boolean v1, p0, Ldefpackage/lzi;->c:Z
    ...
    :goto_7
    iput-boolean v1, p0, Ldefpackage/lzi;->r:Z
    ...
    :goto_8
    iput-boolean v1, p0, Ldefpackage/lzi;->d:Z
    ...
    :goto_9
    iput-boolean v1, p0, Ldefpackage/lzi;->s:Z
    ...
    :goto_a
    iput-boolean v1, p0, Ldefpackage/lzi;->t:Z
    ...
    :goto_b
    iput-boolean v1, p0, Ldefpackage/lzi;->u:Z
    ...
    :goto_c
    iput-boolean v1, p0, Ldefpackage/lzi;->e:Z
    ...
    :goto_d
    iput-boolean v1, p0, Ldefpackage/lzi;->f:Z
    ...
    :goto_e
    iput-boolean v1, p0, Ldefpackage/lzi;->g:Z
    ...
    :goto_f
    iput-boolean v1, p0, Ldefpackage/lzi;->h:Z
    ...
    :goto_10
    iput-boolean v1, p0, Ldefpackage/lzi;->v:Z
    ...
    :goto_11
    iput-boolean v1, p0, Ldefpackage/lzi;->i:Z
    ...
    :goto_12
    iput-boolean v1, p0, Ldefpackage/lzi;->w:Z
    ...
    :goto_13
    iput-boolean v1, p0, Ldefpackage/lzi;->j:Z
    ...
    :goto_14
    iput-boolean v1, p0, Ldefpackage/lzi;->k:Z
    ...
    :goto_15
    iput-boolean v1, p0, Ldefpackage/lzi;->l:Z
    ...
    :goto_16
    iput-boolean v2, p0, Ldefpackage/lzi;->x:Z
    ...
    :goto_17
    iput-boolean v3, p0, Ldefpackage/lzi;->m:Z

    .line 64
    return-void
.end method

.method public static a()Ldefpackage/lzi;
    .locals 24
    ...
    invoke-static {v0}, Ldefpackage/lzi;->j(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    .line 77
    .local v5, "j":Ljava/lang/String;
    invoke-static {v3}, Ldefpackage/lzi;->j(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    .line 78
    .local v6, "j2":Ljava/lang/String;
    invoke-static {v4}, Ldefpackage/lzi;->j(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {}, Ldefpackage/oym;->a()Ldefpackage/oyk;

    move-result-object v10

    .line 89
    .local v10, "a":Ldefpackage/oyk;
    ...
    invoke-static {v14, v15, v13}, Ldefpackage/obr;->aI(ZLjava/lang/String;I)V

    .line 93
    move-object v14, v10

    check-cast v14, Ldefpackage/oyh;

    invoke-interface {v14}, Ldefpackage/oyk;->a()Ldefpackage/oxh;

    move-result-object v14

    .line 94
    .local v14, "a2":Ldefpackage/oxh;
    invoke-virtual {v11}, Ljava/lang/String;->length()I
    ...
    check-cast v2, Ldefpackage/oyg;

    .line 97
    .local v2, "oygVar":Ldefpackage/oyg;
    iget-object v0, v2, Ldefpackage/oyg;->a:Ljava/nio/ByteBuffer;
    ...
    check-cast v0, Ldefpackage/oyg;

    move-object v3, v14

    check-cast v3, Ldefpackage/oyg;

    iget-object v3, v3, Ldefpackage/oyg;->a:Ljava/nio/ByteBuffer;

    invoke-virtual {v3}, Ljava/nio/ByteBuffer;->array()[B

    move-result-object v3

    invoke-virtual {v0, v3}, Ldefpackage/oyg;->ae([B)V
    ...
    .line 95
    .end local v2    # "oygVar":Ldefpackage/oyg;
    ...
    .line 101
    .restart local v2    # "oygVar":Ldefpackage/oyg;
    :catchall_0
    move-exception v0

    .line 102
    .local v0, "th":Ljava/lang/Throwable;
    iget-object v3, v2, Ldefpackage/oyg;->a:Ljava/nio/ByteBuffer;
    ...
    check-cast v0, Ldefpackage/oyn;

    .line 107
    .local v0, "oynVar":Ldefpackage/oyn;
    invoke-virtual {v0}, Ldefpackage/oyn;->af()V

    .line 108
    const/4 v1, 0x1

    iput-boolean v1, v0, Ldefpackage/oyn;->d:Z

    .line 109
    iget v2, v0, Ldefpackage/oyn;->c:I

    iget-object v3, v0, Ldefpackage/oyn;->b:Ljava/security/MessageDigest;
    ...
    iget-object v2, v0, Ldefpackage/oyn;->b:Ljava/security/MessageDigest;

    invoke-virtual {v2}, Ljava/security/MessageDigest;->digest()[B

    move-result-object v2

    invoke-static {v2}, Ldefpackage/oyj;->e([B)Ldefpackage/oyj;
    ...
    iget v3, v0, Ldefpackage/oyn;->c:I
    ...
    :goto_3
    check-cast v2, Ldefpackage/oyi;

    .line 110
    .local v2, "oyiVar":Ldefpackage/oyi;
    iget-object v3, v2, Ldefpackage/oyi;->a:[B
    ...
    .end local v0    # "oynVar":Ldefpackage/oyn;
    .local v20, "oynVar":Ldefpackage/oyn;
    const-string v0, "HashCode#asLong() requires >= 8 bytes (it only has %s bytes)."

    invoke-static {v1, v0, v3}, Ldefpackage/obr;->aS(ZLjava/lang/String;I)V

    .line 112
    iget-object v0, v2, Ldefpackage/oyi;->a:[B
    ...
    iget-object v4, v2, Ldefpackage/oyi;->a:[B
    ...
    :cond_a
    new-instance v3, Ldefpackage/lzi;

    invoke-direct {v3, v0, v1}, Ldefpackage/lzi;-><init>(J)V
    ...
    .end local v10    # "a":Ldefpackage/oyk;
    .end local v11    # "upperCase":Ljava/lang/String;
    .end local v12    # "length":I
    .end local v13    # "i":I
    .end local v14    # "a2":Ldefpackage/oxh;
    .end local v15    # "length2":I
    .end local v16    # "str":Ljava/lang/String;
    .end local v18    # "length3":I
    .end local v19    # "SetDevice":Ljava/lang/String;
    .end local v20    # "oynVar":Ldefpackage/oyn;
    ...
    :goto_6
    new-instance v0, Ldefpackage/lzi;

    const-wide v1, -0x7c963b3dec50fbe5L

    invoke-direct {v0, v1, v2}, Ldefpackage/lzi;-><init>(J)V
...
.method public final b()Z
    ...
    .line 173
    iget-boolean v0, p0, Ldefpackage/lzi;->o:Z

    if-nez v0, :cond_1

    iget-boolean v0, p0, Ldefpackage/lzi;->n:Z
...
.method public final c()Z
    ...
    .line 177
    iget-boolean v0, p0, Ldefpackage/lzi;->p:Z

    if-nez v0, :cond_1

    iget-boolean v0, p0, Ldefpackage/lzi;->q:Z
...
.method public final d()Z
    ...
    .line 181
    iget-boolean v0, p0, Ldefpackage/lzi;->r:Z

    if-nez v0, :cond_1

    iget-boolean v0, p0, Ldefpackage/lzi;->c:Z
...
.method public final e()Z
    ...
    .line 185
    iget-boolean v0, p0, Ldefpackage/lzi;->t:Z

    if-nez v0, :cond_1

    iget-boolean v0, p0, Ldefpackage/lzi;->u:Z

    if-nez v0, :cond_1

    iget-boolean v0, p0, Ldefpackage/lzi;->e:Z
...
.method public final f()Z
    ...
    .line 189
    iget-boolean v0, p0, Ldefpackage/lzi;->d:Z

    if-nez v0, :cond_1

    iget-boolean v0, p0, Ldefpackage/lzi;->s:Z
...
.method public final g()Z
    ...
    .line 193
    iget-boolean v0, p0, Ldefpackage/lzi;->g:Z

    if-nez v0, :cond_1

    iget-boolean v0, p0, Ldefpackage/lzi;->h:Z
...
.method public final h()Z
    ...
    .line 197
    iget-boolean v0, p0, Ldefpackage/lzi;->v:Z

    if-nez v0, :cond_1

    iget-boolean v0, p0, Ldefpackage/lzi;->w:Z

    if-nez v0, :cond_1

    iget-boolean v0, p0, Ldefpackage/lzi;->j:Z

    if-nez v0, :cond_1

    iget-boolean v0, p0, Ldefpackage/lzi;->k:Z
...
.method public final i()Z
    ...
    .line 201
    iget-boolean v0, p0, Ldefpackage/lzi;->l:Z

    if-nez v0, :cond_1

    iget-boolean v0, p0, Ldefpackage/lzi;->x:Z
