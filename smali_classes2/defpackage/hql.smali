.class public final Ldefpackage/hql;
...
.field private static final d:Ldefpackage/ojz;
...
.field private final g:Ldefpackage/hsh;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ldefpackage/hql;->a:Ldefpackage/ouj;

    .line 18
    sget-object v0, Ldefpackage/fob;->e:Ldefpackage/fob;

    invoke-static {v0}, Ldefpackage/obr;->au(Ldefpackage/ojz;)Ldefpackage/ojz;

    move-result-object v0

    sput-object v0, Ldefpackage/hql;->d:Ldefpackage/ojz;

    return-void
.end method

.method public constructor <init>(Ljava/io/File;Ldefpackage/hsh;Ldefpackage/ddf;Ldefpackage/fjs;Ljava/util/concurrent/Executor;)V
    .locals 2
    ...
    iput-object v0, p0, Ldefpackage/hql;->e:Ljava/io/File;
    ...
    iput-object v0, p0, Ldefpackage/hql;->f:Ljava/io/File;

    .line 29
    iput-object p2, p0, Ldefpackage/hql;->g:Ldefpackage/hsh;

    .line 30
    iput-object p3, p0, Ldefpackage/hql;->b:Ldefpackage/ddf;

    .line 31
    iput-object p4, p0, Ldefpackage/hql;->h:Ldefpackage/fjs;

    .line 32
    iput-object p5, p0, Ldefpackage/hql;->c:Ljava/util/concurrent/Executor;
...
# virtual methods
.method public final a(Ldefpackage/hsa;)V
    .locals 7
    .param p1, "hsaVar"    # Ldefpackage/hsa;

    .line 36
    invoke-interface {p1}, Ldefpackage/hsa;->j()Ldefpackage/hss;
    ...
    iget-object v0, p0, Ldefpackage/hql;->f:Ljava/io/File;

    goto :goto_0

    :cond_0
    iget-object v0, p0, Ldefpackage/hql;->e:Ljava/io/File;

    .line 37
    .local v0, "file":Ljava/io/File;
    :goto_0
    invoke-interface {p1}, Ldefpackage/hsa;->d()J
    ...
    .line 42
    new-instance v4, Ldefpackage/hqk;
    ...
    invoke-direct {v4, p0, v5, p1}, Ldefpackage/hqk;-><init>(Ldefpackage/hql;Ljava/io/File;Ldefpackage/hsa;)V

    invoke-interface {p1, v4}, Ldefpackage/hsa;->u(Ldefpackage/hsn;)V
...
.method public final b(Z)V
    ...
    iget-object v0, v1, Ldefpackage/hql;->f:Ljava/io/File;

    goto :goto_0

    :cond_0
    iget-object v0, v1, Ldefpackage/hql;->e:Ljava/io/File;
    ...
    .line 59
    :try_start_1
    sget-object v0, Ldefpackage/hql;->a:Ldefpackage/ouj;
    ...
    invoke-interface {v0, v9}, Ldefpackage/ova;->G(I)Ldefpackage/ova;
    ...
    invoke-interface {v0, v9, v8}, Ldefpackage/ova;->r(Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_1
    ...
    :try_start_3
    sget-object v10, Ldefpackage/hql;->a:Ldefpackage/ouj;
    ...
    invoke-interface {v12, v9}, Ldefpackage/ova;->h(Ljava/lang/Throwable;)Ldefpackage/ova;

    move-result-object v12

    check-cast v12, Loug;

    invoke-interface {v12, v11}, Ldefpackage/ova;->G(I)Ldefpackage/ova;

    move-result-object v12

    check-cast v12, Loug;

    invoke-interface {v12, v2, v8}, Ldefpackage/ova;->r(Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_3
    ...
    .end local v10    # "b":Ldefpackage/ova;
    .end local v11    # "c":C
    :catchall_0
    move-exception v0
    ...
    :cond_1
    :try_start_4
    sget-object v0, Ldefpackage/hql;->d:Ldefpackage/ojz;
    ...
    .end local p0    # "this":Ldefpackage/hql;
    .end local p1    # "z":Z
    throw v10
    :try_end_6
    ...
    .restart local p0    # "this":Ldefpackage/hql;
    ...
    .line 78
    .local v6, "convert":J
    iget-object v0, v1, Ldefpackage/hql;->b:Ldefpackage/ddf;
    ...
    invoke-interface/range {v23 .. v23}, Ldefpackage/ddf;->d()V

    .line 81
    iget-object v15, v1, Ldefpackage/hql;->g:Ldefpackage/hsh;

    sget-object v18, Ldefpackage/dxh;->NONE:Ldefpackage/dxh;
    ...
    .end local v23    # "ddfVar":Ldefpackage/ddf;
    .end local v24    # "ddiVar":Ldefpackage/ddi;
    :catchall_1
    move-exception v0
    ...
    .restart local v23    # "ddfVar":Ldefpackage/ddf;
    .restart local v24    # "ddiVar":Ldefpackage/ddi;
    :cond_4
    :try_start_a
    sget-object v11, Ldefpackage/hss;->MEDIA_STORE:Ldefpackage/hss;
    ...
    invoke-virtual/range {v15 .. v20}, Ldefpackage/hsh;->b(JLdefpackage/dxh;Ljava/lang/String;Ldefpackage/hss;)Ldefpackage/hsg;
    ...
    .line 83
    .local v11, "hsgVar":Ldefpackage/hsg;
    :try_start_b
    const-string v0, "jpg"

    invoke-virtual {v11, v0}, Ldefpackage/hsg;->a(Ljava/lang/String;)Ldefpackage/hsc;
    ...
    iget-object v0, v12, Ldefpackage/hsc;->a:Ldefpackage/mak;
    ...
    .line 93
    invoke-virtual {v12}, Ldefpackage/hsc;->c()V

    .line 94
    invoke-virtual {v11}, Ldefpackage/hsg;->g()V
    ...
    :try_start_e
    iget-object v4, v12, Ldefpackage/hsc;->a:Ldefpackage/mak;

    invoke-interface {v4}, Ldefpackage/mak;->b()Landroid/net/Uri;

    move-result-object v4

    invoke-interface {v0, v3, v4}, Ldefpackage/ova;->r(Ljava/lang/String;Ljava/lang/Object;)V

    .line 96
    iget-object v0, v1, Ldefpackage/hql;->h:Ldefpackage/fjs;

    move-object v3, v0

    .line 97
    .local v3, "fjsVar":Ldefpackage/fjs;
    sget-object v0, Ldefpackage/pbz;->d:Ldefpackage/pbz;
    ...
    .end local v12    # "a2":Ldefpackage/hsc;
    ...
    .line 119
    .restart local v12    # "a2":Ldefpackage/hsc;
    :catch_2
    move-exception v0
    ...
    .line 98
    .restart local v3    # "fjsVar":Ldefpackage/fjs;
    ...
    check-cast v0, Ldefpackage/pbz;

    move-object/from16 v19, v0

    .line 103
    .local v19, "pbzVar":Ldefpackage/pbz;
    move-object/from16 v1, v19

    .end local v19    # "pbzVar":Ldefpackage/pbz;
    .local v1, "pbzVar":Ldefpackage/pbz;
    iget v0, v1, Ldefpackage/pbz;->a:I
    :try_end_10
    ...
    .local v9, "i":I
    :try_start_11
    iput v9, v1, Ldefpackage/pbz;->a:I

    .line 105
    iput-wide v6, v1, Ldefpackage/pbz;->b:J

    .line 106
    iput v5, v1, Ldefpackage/pbz;->c:I

    .line 107
    or-int/lit8 v0, v9, 0x2

    iput v0, v1, Ldefpackage/pbz;->a:I
    ...
    invoke-interface {v3, v0}, Ldefpackage/fjs;->g(Ldefpackage/pbz;)V
    :try_end_11
    ...
    :try_start_13
    sget-object v22, Ldefpackage/hql;->a:Ldefpackage/ouj;
    ...
    .end local v1    # "pbzVar":Ldefpackage/pbz;
    .local v26, "pbzVar":Ldefpackage/pbz;
    move-object/from16 v1, v22

    check-cast v1, Loug;

    invoke-interface {v1, v5}, Ldefpackage/ova;->h(Ljava/lang/Throwable;)Ldefpackage/ova;
    ...
    invoke-interface {v1, v2, v8}, Ldefpackage/ova;->r(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    .end local v15    # "fileInputStream":Ljava/io/FileInputStream;
    .end local v16    # "e2":Ljava/io/FileOutputStream;
    .end local v22    # "b":Ldefpackage/ova;
    .end local v25    # "e3":Ljava/lang/Exception;
    .end local v26    # "pbzVar":Ldefpackage/pbz;
    :goto_5
    goto :goto_8
    ...
    .end local v6    # "convert":J
    .end local v10    # "group":Ljava/lang/String;
    .end local v11    # "hsgVar":Ldefpackage/hsg;
    .end local v12    # "a2":Ldefpackage/hsc;
    .end local v13    # "parseLong":J
    ...
    .local v9, "matcher":Ljava/util/regex/Matcher;
    .restart local v10    # "group":Ljava/lang/String;
    .restart local v11    # "hsgVar":Ldefpackage/hsg;
    .restart local v13    # "parseLong":J
    .restart local v23    # "ddfVar":Ldefpackage/ddf;
    .restart local v24    # "ddiVar":Ldefpackage/ddi;
    :catch_4
    ...
    .restart local v1    # "hscVar":Ldefpackage/hsc;
    .restart local v12    # "a2":Ldefpackage/hsc;
    :cond_7
    :goto_7
    nop
    ...
    .line 125
    invoke-virtual {v11}, Ldefpackage/hsg;->d()V
    ...
    :try_start_17
    sget-object v3, Ldefpackage/hql;->a:Ldefpackage/ouj;
    ...
    invoke-interface {v3, v2, v8}, Ldefpackage/ova;->r(Ljava/lang/String;Ljava/lang/Object;)V
