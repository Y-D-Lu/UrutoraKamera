.class public final Ldefpackage/kuf;
...
.method public final b(Landroid/os/IBinder;)Landroid/os/IInterface;
    ...
    instance-of v1, v0, Ldefpackage/kue;

    if-eqz v1, :cond_1

    move-object v1, v0

    check-cast v1, Ldefpackage/kue;

    goto :goto_0

    :cond_1
    new-instance v1, Ldefpackage/kue;

    invoke-direct {v1, p1}, Ldefpackage/kue;-><init>(Landroid/os/IBinder;)V
...
.method public final e()[Ldefpackage/khk;
    ...
    .line 43
    sget-object v0, Ldefpackage/ktr;->e:[Ldefpackage/khk;
