.class public final Ldefpackage/nit;
...
.method public final c(Landroid/net/Uri;)Ljava/io/File;
    ...
    .line 27
    invoke-static {p1}, Ldefpackage/myw;->c(Landroid/net/Uri;)Ljava/io/File;
...
.method public final d(Landroid/net/Uri;)Ljava/io/InputStream;
    ...
    :try_start_0
    new-instance v1, Ldefpackage/nja;

    new-instance v2, Ljava/io/FileInputStream;

    invoke-direct {v2, v0}, Ljava/io/FileInputStream;-><init>(Ljava/io/File;)V

    invoke-direct {v1, v2, v0}, Ldefpackage/nja;-><init>(Ljava/io/FileInputStream;Ljava/io/File;)V
    :try_end_0
...
.method public final g(Landroid/net/Uri;Landroid/net/Uri;)V
    ...
    .line 54
    .local v0, "c":Ljava/io/File;
    invoke-static {p2}, Ldefpackage/myw;->c(Landroid/net/Uri;)Ljava/io/File;

    move-result-object v1

    .line 55
    .local v1, "c2":Ljava/io/File;
    invoke-static {v1}, Ldefpackage/oxh;->v(Ljava/io/File;)V
    ...
    .end local p0    # "this":Ldefpackage/nit;
    ...
    .restart local p0    # "this":Ldefpackage/nit;
...
.method public final j(Landroid/net/Uri;)Ljava/io/OutputStream;
    ...
    .line 71
    :try_start_0
    new-instance v1, Ldefpackage/njb;

    new-instance v2, Ljava/io/FileOutputStream;

    invoke-direct {v2, v0}, Ljava/io/FileOutputStream;-><init>(Ljava/io/File;)V

    invoke-direct {v1, v2, v0}, Ldefpackage/njb;-><init>(Ljava/io/FileOutputStream;Ljava/io/File;)V
    :try_end_0
    .catch Ljava/io/FileNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
