.class public final Ldefpackage/kdd;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Ldefpackage/kdd;->u:Z
    ...
    invoke-static {v2}, Ldefpackage/kdd;->a(I)Z
    ...
    :goto_0
    sput-object v3, Ldefpackage/kdd;->a:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_1
    sput-object v3, Ldefpackage/kdd;->b:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    invoke-static {v5}, Ldefpackage/kdd;->a(I)Z
    ...
    :goto_2
    sput-object v3, Ldefpackage/kdd;->c:Landroid/hardware/camera2/CaptureResult$Key;

    .line 60
    const/4 v3, 0x5

    invoke-static {v3}, Ldefpackage/kdd;->a(I)Z
    ...
    .line 66
    :cond_b
    invoke-static {v0}, Ldefpackage/kdd;->a(I)Z
    ...
    :goto_3
    sput-object v3, Ldefpackage/kdd;->d:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_4
    sput-object v0, Ldefpackage/kdd;->e:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_5
    sput-object v3, Ldefpackage/kdd;->f:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_6
    sput-object v3, Ldefpackage/kdd;->g:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_7
    sput-object v0, Ldefpackage/kdd;->h:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_8
    sput-object v3, Ldefpackage/kdd;->i:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_9
    sput-object v3, Ldefpackage/kdd;->j:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_a
    sput-object v0, Ldefpackage/kdd;->k:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_b
    sput-object v3, Ldefpackage/kdd;->l:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :goto_c
    sput-object v0, Ldefpackage/kdd;->m:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :goto_d
    sput-object v3, Ldefpackage/kdd;->n:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_e
    sput-object v0, Ldefpackage/kdd;->o:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_f
    sput-object v0, Ldefpackage/kdd;->p:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_10
    sput-object v2, Ldefpackage/kdd;->q:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_11
    sput-object v2, Ldefpackage/kdd;->r:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :cond_31
    sput-object v4, Ldefpackage/kdd;->s:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    .line 151
    :cond_32
    sput-object v1, Ldefpackage/kdd;->t:Landroid/hardware/camera2/CaptureRequest$Key;
...
.method public static a(I)Z
    ...
    .line 158
    sget-boolean v0, Ldefpackage/kdd;->u:Z
