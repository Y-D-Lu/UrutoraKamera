.class public final Ldefpackage/arl;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ldefpackage/arl;->a:Ljava/lang/String;
    ...
    sput-wide v0, Ldefpackage/arl;->b:J
...
.method public constructor <init>(Landroid/content/Context;Ldefpackage/aof;)V
    ...
    iput v0, p0, Ldefpackage/arl;->e:I
    ...
    iput-object v0, p0, Ldefpackage/arl;->c:Landroid/content/Context;

    .line 38
    iput-object p2, p0, Ldefpackage/arl;->d:Ldefpackage/aof;
...
.method public static a(Landroid/content/Context;)V
    ...
    invoke-static {p0, v1}, Ldefpackage/arl;->b(Landroid/content/Context;I)Landroid/app/PendingIntent;
    ...
    sget-wide v4, Ldefpackage/arl;->b:J
...
.method public final run()V
    ...
    invoke-virtual {v0, v10}, Ldefpackage/kus;->h([Ljava/lang/Throwable;)V
    :try_end_1
    ...
    :cond_0
    :try_start_2
    iget-object v0, v1, Ldefpackage/arl;->c:Landroid/content/Context;
    ...
    invoke-virtual {v10, v11}, Ldefpackage/kus;->h([Ljava/lang/Throwable;)V
    :try_end_2
    ...
    .line 72
    :try_start_3
    iget-object v2, v1, Ldefpackage/arl;->d:Ldefpackage/aof;

    .line 73
    .local v2, "aofVar":Ldefpackage/aof;
    invoke-virtual {v2}, Ldefpackage/aof;->f()V
    :try_end_3
    ...
    .line 78
    .end local v0    # "a3":Z
    .end local v2    # "aofVar":Ldefpackage/aof;
    .end local v10    # "l":Ldefpackage/kus;
    :cond_1
    :goto_0
    :try_start_4
    iget-object v0, v1, Ldefpackage/arl;->c:Landroid/content/Context;
    ...
    invoke-static {v10}, Ldefpackage/aod;->a(Landroid/content/Context;)Ljava/io/File;
    ...
    invoke-virtual {v0, v12}, Ldefpackage/kus;->h([Ljava/lang/Throwable;)V
    ...
    .line 83
    sget-object v12, Ldefpackage/aod;->b:[Ljava/lang/String;
    ...
    .line 95
    sget-object v14, Ldefpackage/aod;->a:Ljava/lang/String;
    ...
    invoke-static {v14, v11, v0}, Ldefpackage/kus;->k(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v0, v14}, Ldefpackage/kus;->h([Ljava/lang/Throwable;)V
    :try_end_5
    ...
    invoke-virtual {v0, v8}, Ldefpackage/kus;->h([Ljava/lang/Throwable;)V
    :try_end_6
    ...
    iget-object v7, v1, Ldefpackage/arl;->d:Ldefpackage/aof;

    invoke-static {v0, v7}, Ldefpackage/aoz;->f(Landroid/content/Context;Ldefpackage/aof;)Z
    ...
    .line 109
    .local v7, "f":Z
    iget-object v0, v1, Ldefpackage/arl;->d:Ldefpackage/aof;
    ...
    .line 111
    .local v9, "s":Ldefpackage/aqu;
    invoke-virtual {v8}, Landroidx/work/impl/WorkDatabase;->v()Ldefpackage/aqq;
    ...
    .line 114
    :try_start_8
    invoke-interface {v9}, Ldefpackage/aqu;->b()Ljava/util/List;
    ...
    check-cast v14, Ldefpackage/aqt;

    .line 118
    .local v14, "aqtVar":Ldefpackage/aqt;
    move-object/from16 v17, v0
    ...
    iget-object v15, v14, Ldefpackage/aqt;->a:Ljava/lang/String;
    ...
    invoke-interface {v9, v15, v0}, Ldefpackage/aqu;->k(I[Ljava/lang/String;)V

    .line 119
    iget-object v0, v14, Ldefpackage/aqt;->a:Ljava/lang/String;
    :try_end_9
    ...
    :try_start_a
    invoke-interface {v9, v0, v5, v6}, Ldefpackage/aqu;->j(Ljava/lang/String;J)V
    :try_end_a
    .catchall {:try_start_a .. :try_end_a} :catchall_1

    .line 120
    .end local v14    # "aqtVar":Ldefpackage/aqt;
    move-object v5, v15
    ...
    :goto_7
    :try_start_b
    iget-object v0, v11, Ldefpackage/aqq;->a:Ldefpackage/aii;

    invoke-virtual {v0}, Ldefpackage/aii;->g()V

    .line 123
    iget-object v0, v11, Ldefpackage/aqq;->c:Ldefpackage/aiy;
    ...
    invoke-virtual {v0, v5}, Ldefpackage/aiy;->f(Ldefpackage/ake;)V
    ...
    iget-object v0, v0, Ldefpackage/aof;->j:Ldefpackage/arm;

    iget-object v0, v0, Ldefpackage/arm;->a:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v0}, Landroidx/work/impl/WorkDatabase;->y()Ldefpackage/arg;

    move-result-object v0

    invoke-virtual {v0, v3}, Ldefpackage/arg;->b(Ljava/lang/String;)Ljava/lang/Long;
    ...
    invoke-virtual {v0}, Ldefpackage/aof;->g()V
    ...
    new-instance v5, Ldefpackage/aqf;
    :try_end_d
    ...
    .end local v9    # "s":Ldefpackage/aqu;
    .end local v10    # "context":Landroid/content/Context;
    .local v7, "context":Landroid/content/Context;
    .local v20, "s":Ldefpackage/aqu;
    const-wide/16 v9, 0x0

    :try_start_e
    invoke-direct {v5, v3, v9, v10}, Ldefpackage/aqf;-><init>(Ljava/lang/String;J)V

    invoke-virtual {v0, v5}, Ldefpackage/arg;->c(Ldefpackage/aqf;)V
    :try_end_e
    ...
    .end local v17    # "e":Ldefpackage/ake;
    .end local v20    # "s":Ldefpackage/aqu;
    .restart local v9    # "s":Ldefpackage/aqu;
    ...
    .restart local v20    # "s":Ldefpackage/aqu;
    goto/16 :goto_e
    ...
    .end local v10    # "context":Landroid/content/Context;
    .local v7, "context":Landroid/content/Context;
    .restart local v17    # "e":Ldefpackage/ake;
    ...
    invoke-static {v0, v5}, Ldefpackage/arl;->b(Landroid/content/Context;I)Landroid/app/PendingIntent;
    ...
    .line 138
    :cond_d
    iget-object v5, v1, Ldefpackage/arl;->c:Landroid/content/Context;
    ...
    invoke-virtual {v9, v3}, Ldefpackage/kus;->h([Ljava/lang/Throwable;)V

    .line 162
    iget-object v3, v1, Ldefpackage/arl;->d:Ldefpackage/aof;

    invoke-virtual {v3}, Ldefpackage/aof;->g()V
    ...
    invoke-virtual {v0, v9}, Ldefpackage/kus;->h([Ljava/lang/Throwable;)V

    .line 169
    iget-object v0, v1, Ldefpackage/arl;->d:Ldefpackage/aof;

    .line 170
    .local v0, "aofVar2":Ldefpackage/aof;
    iget-object v3, v0, Ldefpackage/aof;->c:Ldefpackage/amj;

    iget-object v9, v0, Ldefpackage/aof;->d:Landroidx/work/impl/WorkDatabase;

    iget-object v10, v0, Ldefpackage/aof;->e:Ljava/util/List;

    invoke-static {v3, v9, v10}, Ldefpackage/anp;->b(Ldefpackage/amj;Landroidx/work/impl/WorkDatabase;Ljava/util/List;)V

    .line 177
    .end local v0    # "aofVar2":Ldefpackage/aof;
    ...
    .end local v11    # "v":Ldefpackage/aqq;
    .end local v19    # "f":Z
    .end local v20    # "s":Ldefpackage/aqu;
    goto/16 :goto_10
    ...
    .restart local v11    # "v":Ldefpackage/aqq;
    .restart local v19    # "f":Z
    .restart local v20    # "s":Ldefpackage/aqu;
    :catchall_5
    move-exception v0
    ...
    .line 151
    sget-object v3, Ldefpackage/arl;->a:Ljava/lang/String;
    ...
    invoke-static {v3, v2, v9}, Ldefpackage/kus;->k(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v3, v9}, Ldefpackage/kus;->h([Ljava/lang/Throwable;)V
    ...
    .line 155
    .local v3, "aofVar":Ldefpackage/aof;
    invoke-virtual {v3}, Ldefpackage/aof;->f()V
    :try_end_13
    ...
    .end local v3    # "aofVar":Ldefpackage/aof;
    :catch_1
    move-exception v0
    ...
    .line 146
    .restart local v3    # "aofVar":Ldefpackage/aof;
    invoke-virtual {v3}, Ldefpackage/aof;->f()V
    :try_end_15
    ...
    .end local v15    # "a2":Ljava/io/File;
    .end local v18    # "file":Ljava/io/File;
    .end local p0    # "this":Ldefpackage/arl;
    throw v0
    :try_end_16
    ...
    .restart local v15    # "a2":Ljava/io/File;
    .restart local v18    # "file":Ljava/io/File;
    .restart local p0    # "this":Ldefpackage/arl;
    :catch_2
    move-exception v0
    ...
    :try_start_17
    iget v0, v1, Ldefpackage/arl;->e:I
    ...
    .line 183
    .local v6, "i3":I
    iput v6, v1, Ldefpackage/arl;->e:I
    ...
    invoke-virtual {v5, v0}, Ldefpackage/kus;->h([Ljava/lang/Throwable;)V
    :try_end_17
    ...
    .line 186
    sget-object v0, Ldefpackage/arl;->a:Ljava/lang/String;
    ...
    invoke-static {v0, v4, v2}, Ldefpackage/kus;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
