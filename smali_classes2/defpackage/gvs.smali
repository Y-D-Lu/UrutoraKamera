.class public final Ldefpackage/gvs;
...
.field private final b:Ldefpackage/dwh;

.field private final c:Ldefpackage/ghb;
...
# direct methods
.method public constructor <init>(Ldefpackage/ghb;Ldefpackage/dwm;Ldefpackage/lnc;Ldefpackage/dwh;)V
    .locals 1
    .param p1, "ghbVar"    # Ldefpackage/ghb;
    .param p2, "dwmVar"    # Ldefpackage/dwm;
    .param p3, "lncVar"    # Ldefpackage/lnc;
    .param p4, "dwhVar"    # Ldefpackage/dwh;
    ...
    iput-boolean v0, p0, Ldefpackage/gvs;->g:Z

    .line 29
    iput-object p3, p0, Ldefpackage/gvs;->a:Ldefpackage/lnc;

    .line 30
    iput-object p4, p0, Ldefpackage/gvs;->b:Ldefpackage/dwh;

    .line 31
    iput-object p1, p0, Ldefpackage/gvs;->c:Ldefpackage/ghb;

    .line 32
    iget-object v0, p2, Ldefpackage/dwm;->a:Ldefpackage/lce;

    iput-object v0, p0, Ldefpackage/gvs;->d:Llda;
...
.method private final w(Ljava/util/List;)V
    ...
    iget-boolean v0, p0, Ldefpackage/gvs;->g:Z

    if-eqz v0, :cond_6

    .line 38
    :cond_0
    sget-object v0, Ldefpackage/kdd;->d:Landroid/hardware/camera2/CaptureRequest$Key;

    if-eqz v0, :cond_5

    .line 39
    iget-object v0, p0, Ldefpackage/gvs;->a:Ldefpackage/lnc;

    .line 40
    .local v0, "lncVar":Ldefpackage/lnc;
    sget-object v1, Ldefpackage/kdd;->d:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    sget-object v4, Ldefpackage/bql;->g:Ldefpackage/bql;
    ...
    check-cast v5, Ldefpackage/dwr;

    .line 46
    .local v5, "dwrVar":Ldefpackage/dwr;
    iget-object v6, v5, Ldefpackage/dwr;->c:Ldefpackage/ojc;
    ...
    .local v8, "i2":I
    :goto_2
    iget-object v9, v5, Ldefpackage/dwr;->c:Ldefpackage/ojc;
    ...
    invoke-interface {v0, v1, v4}, Ldefpackage/lnc;->h(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V
    ...
    .line 64
    iget-object v0, p0, Ldefpackage/gvs;->c:Ldefpackage/ghb;
    ...
    invoke-virtual {v0, v1}, Ldefpackage/ghb;->a(Z)V
...
.method public final b(Ldefpackage/lzv;)V
    ...
    iget-object v5, v0, Ldefpackage/gvs;->c:Ldefpackage/ghb;

    invoke-virtual {v5}, Ldefpackage/ghb;->d()Z
    ...
    .line 78
    :cond_0
    iget-object v5, v0, Ldefpackage/gvs;->d:Llda;
    ...
    invoke-interface {v5, v7}, Ldefpackage/lij;->fB(Ljava/lang/Object;)V
    ...
    iget-object v9, v0, Ldefpackage/gvs;->b:Ldefpackage/dwh;

    invoke-interface {v9, v7, v8}, Ldefpackage/dwh;->a(J)Ldefpackage/dwg;

    move-result-object v9

    .line 84
    .local v9, "a":Ldefpackage/dwg;
    if-eqz v9, :cond_e

    iget-object v11, v9, Ldefpackage/dwg;->b:Ljava/util/List;
    ...
    check-cast v12, Ldefpackage/dwf;

    .line 86
    .local v12, "dwfVar":Ldefpackage/dwf;
    iget-object v13, v12, Ldefpackage/dwf;->c:Ldefpackage/ojc;
    ...
    check-cast v14, Ldefpackage/oom;
    ...
    .line 90
    :cond_3
    iget v14, v12, Ldefpackage/dwf;->b:F
    ...
    iget-wide v6, v12, Ldefpackage/dwf;->a:J
    ...
    new-instance v7, Ldefpackage/dwq;

    const/4 v8, 0x0

    invoke-direct {v7, v8}, Ldefpackage/dwq;-><init>([B)V

    .line 93
    .local v7, "dwqVar":Ldefpackage/dwq;
    move-object/from16 v18, v11

    iget-wide v10, v12, Ldefpackage/dwf;->a:J
    ...
    iput-object v10, v7, Ldefpackage/dwq;->a:Ljava/lang/Integer;

    .line 94
    iget v10, v12, Ldefpackage/dwf;->b:F

    invoke-static {v10}, Ljava/lang/Float;->valueOf(F)Ljava/lang/Float;

    move-result-object v10

    iput-object v10, v7, Ldefpackage/dwq;->b:Ljava/lang/Float;

    .line 95
    if-eqz v13, :cond_b

    .line 98
    iput-object v13, v7, Ldefpackage/dwq;->c:Ldefpackage/ojc;

    .line 99
    iget v10, v12, Ldefpackage/dwf;->d:F

    invoke-static {v10}, Ljava/lang/Float;->valueOf(F)Ljava/lang/Float;

    move-result-object v10

    iput-object v10, v7, Ldefpackage/dwq;->d:Ljava/lang/Float;

    .line 100
    iget-object v11, v7, Ldefpackage/dwq;->a:Ljava/lang/Integer;

    .line 101
    .local v11, "num":Ljava/lang/Integer;
    if-eqz v11, :cond_7

    iget-object v8, v7, Ldefpackage/dwq;->b:Ljava/lang/Float;
    ...
    .line 118
    :cond_4
    new-instance v8, Ldefpackage/dwr;

    invoke-virtual {v11}, Ljava/lang/Integer;->intValue()I

    move-result v10

    iget-object v14, v7, Ldefpackage/dwq;->b:Ljava/lang/Float;

    invoke-virtual {v14}, Ljava/lang/Float;->floatValue()F

    move-result v14

    iget-object v15, v7, Ldefpackage/dwq;->c:Ldefpackage/ojc;

    iget-object v1, v7, Ldefpackage/dwq;->d:Ljava/lang/Float;

    invoke-virtual {v1}, Ljava/lang/Float;->floatValue()F

    move-result v1

    invoke-direct {v8, v10, v14, v15, v1}, Ldefpackage/dwr;-><init>(IFLdefpackage/ojc;F)V

    move-object v1, v8

    .line 119
    .local v1, "dwrVar2":Ldefpackage/dwr;
    iget-object v8, v1, Ldefpackage/dwr;->c:Ldefpackage/ojc;
    ...
    .line 102
    .end local v1    # "dwrVar2":Ldefpackage/dwr;
    :cond_7
    :goto_2
    ...
    iget-object v8, v7, Ldefpackage/dwq;->a:Ljava/lang/Integer;
    ...
    .line 109
    :cond_9
    iget-object v8, v7, Ldefpackage/dwq;->d:Ljava/lang/Float;
    ...
    .line 124
    .end local v7    # "longValue":J
    .end local v12    # "dwfVar":Ldefpackage/dwf;
    ...
    check-cast v10, Ldefpackage/dwr;

    move-object v11, v10

    .local v11, "dwrVar":Ldefpackage/dwr;
    if-eqz v10, :cond_f

    iget v10, v11, Ldefpackage/dwr;->b:F
    ...
    .end local v11    # "dwrVar":Ldefpackage/dwr;
    :cond_f
    ...
    .line 133
    :cond_10
    sget-object v6, Ldefpackage/cdg;->k:Ldefpackage/cdg;
    ...
    .line 138
    :cond_11
    invoke-direct {v0, v1}, Ldefpackage/gvs;->w(Ljava/util/List;)V
    ...
    .end local v9    # "a":Ldefpackage/dwg;
    .end local v16    # "longValue":J
    :cond_12
    :goto_6
