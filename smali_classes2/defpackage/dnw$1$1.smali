...
.method public constructor <init>(Ldefpackage/dnw$1;Ldefpackage/dnw;Landroid/view/View;Landroid/view/View;Landroid/view/View;IILandroid/widget/TextView;Landroid/widget/TextView;Landroid/widget/TextView;IILandroid/widget/ImageView;Landroid/widget/ImageView;Landroid/widget/ImageView;[Landroid/widget/FrameLayout;)V
    ...
    iput-object v1, v0, Ldefpackage/dnw$1$1;->this$1:Ldefpackage/dnw$1;

    move-object v2, p2

    iput-object v2, v0, Ldefpackage/dnw$1$1;->val$dnwVar:Ldefpackage/dnw;

    move-object v2, p3

    iput-object v2, v0, Ldefpackage/dnw$1$1;->val$findViewById:Landroid/view/View;

    move-object v2, p4

    iput-object v2, v0, Ldefpackage/dnw$1$1;->val$findViewById2:Landroid/view/View;

    move-object v2, p5

    iput-object v2, v0, Ldefpackage/dnw$1$1;->val$findViewById3:Landroid/view/View;

    move v2, p6

    iput v2, v0, Ldefpackage/dnw$1$1;->val$i8:I

    move v2, p7

    iput v2, v0, Ldefpackage/dnw$1$1;->val$i9:I

    move-object v2, p8

    iput-object v2, v0, Ldefpackage/dnw$1$1;->val$textView7:Landroid/widget/TextView;

    move-object v2, p9

    iput-object v2, v0, Ldefpackage/dnw$1$1;->val$textView8:Landroid/widget/TextView;

    move-object v2, p10

    iput-object v2, v0, Ldefpackage/dnw$1$1;->val$textView9:Landroid/widget/TextView;

    move v2, p11

    iput v2, v0, Ldefpackage/dnw$1$1;->val$e:I

    move v2, p12

    iput v2, v0, Ldefpackage/dnw$1$1;->val$i7:I

    move-object/from16 v2, p13

    iput-object v2, v0, Ldefpackage/dnw$1$1;->val$imageView7:Landroid/widget/ImageView;

    move-object/from16 v2, p14

    iput-object v2, v0, Ldefpackage/dnw$1$1;->val$imageView8:Landroid/widget/ImageView;

    move-object/from16 v2, p15

    iput-object v2, v0, Ldefpackage/dnw$1$1;->val$imageView9:Landroid/widget/ImageView;

    move-object/from16 v2, p16

    iput-object v2, v0, Ldefpackage/dnw$1$1;->val$frameLayoutArr:[Landroid/widget/FrameLayout;
...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object v1, v0, Ldefpackage/dnw$1$1;->val$dnwVar:Ldefpackage/dnw;

    .line 266
    .local v1, "dnwVar4":Ldefpackage/dnw;
    iget-object v8, v0, Ldefpackage/dnw$1$1;->val$findViewById:Landroid/view/View;

    .line 267
    .local v8, "view8":Landroid/view/View;
    iget-object v9, v0, Ldefpackage/dnw$1$1;->val$findViewById2:Landroid/view/View;

    .line 268
    .local v9, "view9":Landroid/view/View;
    iget-object v10, v0, Ldefpackage/dnw$1$1;->val$findViewById3:Landroid/view/View;

    .line 269
    .local v10, "view10":Landroid/view/View;
    iget v11, v0, Ldefpackage/dnw$1$1;->val$i8:I

    .line 270
    .local v11, "i18":I
    iget v12, v0, Ldefpackage/dnw$1$1;->val$i9:I

    .line 271
    .local v12, "i19":I
    iget-object v13, v0, Ldefpackage/dnw$1$1;->val$textView7:Landroid/widget/TextView;

    .line 272
    .local v13, "textView16":Landroid/widget/TextView;
    iget-object v14, v0, Ldefpackage/dnw$1$1;->val$textView8:Landroid/widget/TextView;

    .line 273
    .local v14, "textView17":Landroid/widget/TextView;
    iget-object v15, v0, Ldefpackage/dnw$1$1;->val$textView9:Landroid/widget/TextView;

    .line 274
    .local v15, "textView18":Landroid/widget/TextView;
    iget v7, v0, Ldefpackage/dnw$1$1;->val$e:I

    .line 275
    .local v7, "i20":I
    iget v6, v0, Ldefpackage/dnw$1$1;->val$i7:I

    .line 276
    .local v6, "i21":I
    iget-object v5, v0, Ldefpackage/dnw$1$1;->val$imageView7:Landroid/widget/ImageView;

    .line 277
    .local v5, "imageView16":Landroid/widget/ImageView;
    iget-object v4, v0, Ldefpackage/dnw$1$1;->val$imageView8:Landroid/widget/ImageView;

    .line 278
    .local v4, "imageView17":Landroid/widget/ImageView;
    iget-object v3, v0, Ldefpackage/dnw$1$1;->val$imageView9:Landroid/widget/ImageView;

    .line 279
    .local v3, "imageView18":Landroid/widget/ImageView;
    iget-object v2, v0, Ldefpackage/dnw$1$1;->val$frameLayoutArr:[Landroid/widget/FrameLayout;
