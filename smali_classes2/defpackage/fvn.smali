.class public final Ldefpackage/fvn;
...
.field private final e:Ldefpackage/huj;
...
# direct methods
.method public constructor <init>(Ldefpackage/ius;Ldefpackage/huj;Landroid/util/DisplayMetrics;Landroid/content/Context;Ldefpackage/ddf;)V
    .locals 1
    .param p1, "iusVar"    # Ldefpackage/ius;
    .param p2, "hujVar"    # Ldefpackage/huj;
    ...
    iput-object v0, p0, Ldefpackage/fvn;->g:Landroid/view/View;

    .line 23
    iput-object v0, p0, Ldefpackage/fvn;->d:Landroid/view/View;

    .line 26
    iput-object p1, p0, Ldefpackage/fvn;->a:Ldefpackage/ius;

    .line 27
    iput-object p2, p0, Ldefpackage/fvn;->e:Ldefpackage/huj;

    .line 28
    iput-object p4, p0, Ldefpackage/fvn;->b:Landroid/content/Context;

    .line 29
    iput-object p3, p0, Ldefpackage/fvn;->f:Landroid/util/DisplayMetrics;

    .line 30
    iput-object p5, p0, Ldefpackage/fvn;->c:Ldefpackage/ddf;
...
.method public final a()V
    ...
    .line 35
    iget-object v0, p0, Ldefpackage/fvn;->g:Landroid/view/View;
    ...
    iget-object v1, p0, Ldefpackage/fvn;->b:Landroid/content/Context;
    ...
    iget-object v3, p0, Ldefpackage/fvn;->c:Ldefpackage/ddf;
    ...
    new-instance v2, Ldefpackage/fvm;

    const/4 v3, 0x0

    invoke-direct {v2, p0, v3}, Ldefpackage/fvm;-><init>(Ldefpackage/fvn;I)V
    ...
    iget-object v4, p0, Ldefpackage/fvn;->f:Landroid/util/DisplayMetrics;
    ...
    .line 55
    :goto_2
    iget-object v6, p0, Ldefpackage/fvn;->b:Landroid/content/Context;
    ...
    iget-object v7, p0, Ldefpackage/fvn;->b:Landroid/content/Context;
    ...
    .end local v5    # "f":F
    :cond_3
    iget-object v0, p0, Ldefpackage/fvn;->a:Ldefpackage/ius;

    const/4 v1, 0x7

    const v2, 0x7f11036c

    iget-object v3, p0, Ldefpackage/fvn;->g:Landroid/view/View;

    invoke-virtual {v0, v1, v2, v3}, Ldefpackage/ius;->f(IILandroid/view/View;)V

    .line 59
    iget-object v0, p0, Ldefpackage/fvn;->e:Ldefpackage/huj;
