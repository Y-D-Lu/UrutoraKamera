.class public final Ldefpackage/mrs;
...
# direct methods
.method public constructor <init>(Ldefpackage/mrp;Ljava/util/concurrent/ExecutorService;)V
    .locals 3
    ...
    iput-wide v0, p0, Ldefpackage/mrs;->e:J

    .line 23
    iput-wide v0, p0, Ldefpackage/mrs;->f:J

    .line 24
    const/4 v0, 0x0

    iput-object v0, p0, Ldefpackage/mrs;->g:Ljava/util/concurrent/Future;

    .line 25
    const/4 v0, 0x0

    iput-boolean v0, p0, Ldefpackage/mrs;->h:Z

    .line 28
    iput-object p1, p0, Ldefpackage/mrs;->a:Ldefpackage/mrp;

    .line 29
    iput-object p2, p0, Ldefpackage/mrs;->b:Ljava/util/concurrent/ExecutorService;

    .line 30
    invoke-interface {p1}, Ldefpackage/mrp;->a()Landroid/media/AudioFormat;
    ...
    iput v0, p0, Ldefpackage/mrs;->c:I
    ...
    iput-wide v0, p0, Ldefpackage/mrs;->d:J
...
.method private final e()J
    ...
    .line 35
    iget-object v0, p0, Ldefpackage/mrs;->a:Ldefpackage/mrp;

    check-cast v0, Ldefpackage/mrq;

    iget v0, v0, Ldefpackage/mrq;->b:I
...
.method private final declared-synchronized f()V
    ...
    .line 44
    :try_start_0
    iget-boolean v0, p0, Ldefpackage/mrs;->h:Z

    if-eqz v0, :cond_0

    .line 45
    iget-object v0, p0, Ldefpackage/mrs;->g:Ljava/util/concurrent/Future;
    ...
    .line 47
    .end local p0    # "this":Ldefpackage/mrs;
    :cond_0
    monitor-exit p0
...
.method public final declared-synchronized b(Ljava/nio/ByteBuffer;I)Ldefpackage/mro;
    ...
    :cond_2
    :try_start_2
    iget-wide v2, v0, Ldefpackage/mro;->c:J

    iget-wide v4, p0, Ldefpackage/mrs;->e:J
    :try_end_2
    ...
    :cond_3
    :try_start_3
    iget-wide v2, p0, Ldefpackage/mrs;->e:J
    ...
    .line 76
    invoke-direct {p0}, Ldefpackage/mrs;->e()J
    ...
    .line 77
    iput-wide v2, p0, Ldefpackage/mrs;->e:J
    ...
    .line 82
    .restart local p0    # "this":Ldefpackage/mrs;
    :cond_5
    :try_start_4
    ...
    iget-wide v4, p0, Ldefpackage/mrs;->f:J
    ...
    .line 85
    invoke-static {p1, p2, v4, v5}, Ldefpackage/mro;->a(Ljava/nio/ByteBuffer;IJ)Ldefpackage/mro;

    move-result-object v1

    .line 86
    .local v1, "a":Ldefpackage/mro;
    iget v4, p0, Ldefpackage/mrs;->c:I
    ...
    .line 87
    .local v4, "j2":J
    iget-wide v6, p0, Ldefpackage/mrs;->f:J

    add-long/2addr v6, v4

    iput-wide v6, p0, Ldefpackage/mrs;->f:J

    .line 88
    iget-wide v6, p0, Ldefpackage/mrs;->e:J

    .line 89
    .local v6, "j3":J
    iget-wide v8, p0, Ldefpackage/mrs;->d:J
    ...
    iput-wide v10, p0, Ldefpackage/mrs;->e:J
    ...
    .end local v1    # "a":Ldefpackage/mro;
    .end local v2    # "j":J
    .end local v4    # "j2":J
    .end local v6    # "j3":J
    .end local v8    # "j4":J
...
.method public final declared-synchronized c()V
    ...
    .line 104
    iget-object v0, p0, Ldefpackage/mrs;->b:Ljava/util/concurrent/ExecutorService;

    .line 105
    .local v0, "executorService":Ljava/util/concurrent/ExecutorService;
    iget-object v1, p0, Ldefpackage/mrs;->a:Ldefpackage/mrp;

    .line 106
    .local v1, "mrpVar":Ldefpackage/mrp;
    new-instance v2, Ldefpackage/mrs$1;

    invoke-direct {v2, p0, v1}, Ldefpackage/mrs$1;-><init>(Ldefpackage/mrs;Ldefpackage/mrp;)V

    invoke-interface {v0, v2}, Ljava/util/concurrent/ExecutorService;->submit(Ljava/lang/Runnable;)Ljava/util/concurrent/Future;

    move-result-object v2

    iput-object v2, p0, Ldefpackage/mrs;->g:Ljava/util/concurrent/Future;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .end local v1    # "mrpVar":Ldefpackage/mrp;
    :catchall_0
    move-exception v0
...
.method public final declared-synchronized close()V
    ...
    .line 117
    invoke-virtual {p0}, Ldefpackage/mrs;->d()V
...
.method public final declared-synchronized d()V
    ...
    :cond_0
    :try_start_1
    invoke-direct {p0}, Ldefpackage/mrs;->f()V
