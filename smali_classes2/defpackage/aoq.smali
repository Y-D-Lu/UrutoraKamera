.class public final Ldefpackage/aoq;
...
.method public constructor <init>(Landroid/content/Intent;Landroid/content/Context;Landroid/content/BroadcastReceiver$PendingResult;)V
    ...
    .line 21
    iput-object p1, p0, Ldefpackage/aoq;->a:Landroid/content/Intent;

    .line 22
    iput-object p2, p0, Ldefpackage/aoq;->b:Landroid/content/Context;

    .line 23
    iput-object p3, p0, Ldefpackage/aoq;->c:Landroid/content/BroadcastReceiver$PendingResult;
...
.method public final run()V
    ...
    .line 29
    :try_start_0
    iget-object v0, p0, Ldefpackage/aoq;->a:Landroid/content/Intent;
    ...
    iget-object v1, p0, Ldefpackage/aoq;->a:Landroid/content/Intent;
    ...
    iget-object v3, p0, Ldefpackage/aoq;->a:Landroid/content/Intent;
    ...
    iget-object v4, p0, Ldefpackage/aoq;->a:Landroid/content/Intent;
    ...
    invoke-virtual {v5, v2}, Ldefpackage/kus;->h([Ljava/lang/Throwable;)V

    .line 37
    iget-object v2, p0, Ldefpackage/aoq;->b:Landroid/content/Context;

    const-class v7, Landroidx/work/impl/background/systemalarm/ConstraintProxy$BatteryNotLowProxy;

    invoke-static {v2, v7, v0}, Ldefpackage/arn;->a(Landroid/content/Context;Ljava/lang/Class;Z)V
    ...
    invoke-static {v2, v7, v1}, Ldefpackage/arn;->a(Landroid/content/Context;Ljava/lang/Class;Z)V
    ...
    invoke-static {v2, v7, v3}, Ldefpackage/arn;->a(Landroid/content/Context;Ljava/lang/Class;Z)V
    ...
    invoke-static {v2, v7, v4}, Ldefpackage/arn;->a(Landroid/content/Context;Ljava/lang/Class;Z)V
    :try_end_0
    ...
    .end local v6    # "i":I
    iget-object v0, p0, Ldefpackage/aoq;->c:Landroid/content/BroadcastReceiver$PendingResult;
    ...
    iget-object v1, p0, Ldefpackage/aoq;->c:Landroid/content/BroadcastReceiver$PendingResult;
