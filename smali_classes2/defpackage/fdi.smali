...
# direct methods
.method public constructor <init>(Ldefpackage/fdj;[B)V
    .locals 0
    ...
    .line 19
    iput-object p1, p0, Ldefpackage/fdi;->b:Ldefpackage/fdj;

    .line 20
    iput-object p2, p0, Ldefpackage/fdi;->a:[B
...
.method public final run()V
    ...
    .line 28
    :try_start_0
    iget-object v0, p0, Ldefpackage/fdi;->b:Ldefpackage/fdj;

    iget-object v0, v0, Ldefpackage/fdj;->E:Ljava/util/List;
    ...
    .line 32
    invoke-static {}, Ldefpackage/fcv;->b()Z
    ...
    .line 33
    iget-object v4, p0, Ldefpackage/fdi;->a:[B
    ...
    .line 41
    iget-object v4, p0, Ldefpackage/fdi;->b:Ldefpackage/fdj;

    .line 42
    .local v4, "fdjVar":Ldefpackage/fdj;
    iget v5, v4, Ldefpackage/fdj;->n:I

    iget-object v6, v4, Ldefpackage/fdj;->C:Ljava/util/List;
    ...
    .line 43
    iget-object v5, p0, Ldefpackage/fdi;->b:Ldefpackage/fdj;

    .line 44
    .local v5, "fdjVar2":Ldefpackage/fdj;
    iget-object v6, v5, Ldefpackage/fdj;->C:Ljava/util/List;

    iget v7, v5, Ldefpackage/fdj;->n:I

    invoke-interface {v6, v7}, Ljava/util/List;->get(I)Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Ldefpackage/few;

    invoke-virtual {v3}, Ljava/io/File;->getAbsolutePath()Ljava/lang/String;

    move-result-object v7

    iput-object v7, v6, Ldefpackage/few;->b:Ljava/lang/String;

    .line 46
    .end local v5    # "fdjVar2":Ldefpackage/fdj;
    :cond_1
    iget-object v5, p0, Ldefpackage/fdi;->a:[B

    array-length v5, v5

    .line 47
    .local v5, "length":I
    iget-object v6, p0, Ldefpackage/fdi;->b:Ldefpackage/fdj;

    .line 48
    .local v6, "fdjVar3":Ldefpackage/fdj;
    iget-object v7, v6, Ldefpackage/fdj;->m:Ljava/util/Vector;

    iget v8, v6, Ldefpackage/fdj;->n:I

    invoke-virtual {v7, v8}, Ljava/util/Vector;->get(I)Ljava/lang/Object;

    .line 49
    iget-object v7, p0, Ldefpackage/fdi;->b:Ldefpackage/fdj;

    iget-object v7, v7, Ldefpackage/fdj;->D:Ljava/util/List;

    invoke-interface {v7, v1}, Ljava/util/List;->remove(I)Ljava/lang/Object;

    .line 50
    iget-object v1, p0, Ldefpackage/fdi;->b:Ldefpackage/fdj;

    iget-object v1, v1, Ldefpackage/fdj;->A:Ldefpackage/fcx;

    .line 51
    .local v1, "fcxVar":Ldefpackage/fcx;
    invoke-virtual {v3}, Ljava/io/File;->getAbsolutePath()Ljava/lang/String;
    ...
    :goto_1
    :try_start_2
    iget-object v9, v1, Ldefpackage/fcx;->a:Ljava/util/concurrent/ArrayBlockingQueue;

    invoke-virtual {v9, v7}, Ljava/util/concurrent/ArrayBlockingQueue;->put(Ljava/lang/Object;)V

    .line 60
    iget-object v9, p0, Ldefpackage/fdi;->b:Ldefpackage/fdj;

    .line 61
    .local v9, "fdjVar4":Ldefpackage/fdj;
    iget v10, v9, Ldefpackage/fdj;->n:I

    add-int/lit8 v10, v10, 0x1

    iput v10, v9, Ldefpackage/fdj;->n:I

    .line 62
    iget-object v10, v9, Ldefpackage/fdj;->F:Ldefpackage/fdo;
    :try_end_2
    ...
    .line 64
    .local v10, "fdoVar":Ldefpackage/fdo;
    :try_start_3
    ...
    :goto_4
    :try_start_5
    iput-wide v12, v10, Ldefpackage/fdo;->b:D

    .line 78
    invoke-virtual {v10}, Ldefpackage/fdo;->a()V
    :try_end_5
    ...
    .line 82
    .end local v9    # "fdjVar4":Ldefpackage/fdj;
    .end local v10    # "fdoVar":Ldefpackage/fdo;
    nop

    .line 87
    .end local v0    # "str":Ljava/lang/String;
    .end local v1    # "fcxVar":Ldefpackage/fcx;
    .end local v2    # "fileOutputStream":Ljava/io/FileOutputStream;
    .end local v3    # "file":Ljava/io/File;
    .end local v4    # "fdjVar":Ldefpackage/fdj;
    ...
    .restart local v1    # "fcxVar":Ldefpackage/fcx;
    .restart local v2    # "fileOutputStream":Ljava/io/FileOutputStream;
    .restart local v3    # "file":Ljava/io/File;
    .restart local v4    # "fdjVar":Ldefpackage/fdj;
    .restart local v5    # "length":I
    .restart local v6    # "fdjVar3":Ldefpackage/fdj;
    ...
    .end local p0    # "this":Ldefpackage/fdi;
    throw v10
    :try_end_6
    ...
    .restart local p0    # "this":Ldefpackage/fdi;
    :catch_3
    move-exception v0
