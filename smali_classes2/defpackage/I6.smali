...
# direct methods
.method public constructor <init>(Ldpt;Landroid/hardware/HardwareBuffer;)V
    .locals 0
    .param p1, "this$0"    # Ldpt;

    .line 90
    iput-object p1, p0, Ldefpackage/I6;->this$0:Ldpt;

    iput-object p2, p0, Ldefpackage/I6;->val$hardwareBuffer:Landroid/hardware/HardwareBuffer;
...
.method public final call()Ljava/lang/Object;
    ...
    .line 94
    iget-object v0, p0, Ldefpackage/I6;->this$0:Ldpt;

    .line 95
    .local v0, "dptVar":Ldpt;
    iget-object v1, p0, Ldefpackage/I6;->val$hardwareBuffer:Landroid/hardware/HardwareBuffer;

    .line 96
    .local v1, "hardwareBuffer3":Landroid/hardware/HardwareBuffer;
    iget-object v2, v0, Ldpt;->c:Ldps;

    .line 97
    .local v2, "dpsVar":Ldps;
    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    .line 99
    :try_start_0
    iget-object v3, v2, Ldps;->b:Lpih;

    const-wide/16 v4, 0xbb8

    sget-object v6, Ljava/util/concurrent/TimeUnit;->MILLISECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v3, v4, v5, v6}, Lpfx;->get(JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
    :try_end_0
    ...
    .line 107
    :goto_1
    iget-object v3, v2, Ldps;->d:Ljava/lang/Object;

    monitor-enter v3

    .line 108
    :try_start_1
    iget-object v4, v2, Ldps;->e:Landroid/hardware/HardwareBuffer;
    ...
    invoke-direct {v3, v1, v4, v5}, Ldpf;-><init>(Landroid/hardware/HardwareBuffer;Landroid/hardware/HardwareBuffer;I)V
