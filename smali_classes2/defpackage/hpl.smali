.class public final Ldefpackage/hpl;
...
.method public constructor <init>(Landroid/hardware/SensorManager;Ljava/util/concurrent/Executor;)V
    ...
    .line 19
    iput-object p1, p0, Ldefpackage/hpl;->a:Landroid/hardware/SensorManager;

    .line 20
    iput-object p2, p0, Ldefpackage/hpl;->c:Ljava/util/concurrent/Executor;
    ...
    .line 32
    :goto_1
    iput-object v1, p0, Ldefpackage/hpl;->b:Landroid/hardware/Sensor;
...
.method public final a(Landroid/hardware/SensorEventListener;)V
    ...
    .line 36
    iget-object v0, p0, Ldefpackage/hpl;->b:Landroid/hardware/Sensor;

    if-eqz v0, :cond_0

    .line 37
    iget-object v0, p0, Ldefpackage/hpl;->c:Ljava/util/concurrent/Executor;

    new-instance v1, Ldefpackage/hpk;

    const/4 v2, 0x0

    invoke-direct {v1, p0, p1, v2}, Ldefpackage/hpk;-><init>(Ldefpackage/hpl;Landroid/hardware/SensorEventListener;I)V
