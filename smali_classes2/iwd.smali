...
.method public final onClick(Landroid/view/View;)V
    ...
    .line 46
    iget-object v0, p0, Liwd;->a:Lcom/google/android/apps/camera/ui/compositevideoview/CompositeVideoView;

    iget-object v0, v0, Lcom/google/android/apps/camera/ui/compositevideoview/CompositeVideoView;->b:Liwg;

    .line 47
    .local v0, "iwgVar3":Liwg;
    if-nez v0, :cond_4
    ...
    iget-object v2, v0, Lcom/google/android/apps/camera/ui/compositevideoview/CompositeVideoView;->b:Liwg;

    .line 40
    .local v2, "iwgVar2":Liwg;
    if-eqz v2, :cond_1
    ...
    .line 28
    .local v1, "ihjVar":Lihj;
    iget-object v2, v1, Lihj;->a:Landroid/content/Context;

    invoke-static {v2}, Lmip;->ef(Landroid/content/Context;)I
    ...
    .line 32
    :cond_3
    iget-object v2, v1, Lihj;->g:Ljts;

    iget-object v3, v1, Lihj;->c:Landroid/net/Uri;

    invoke-virtual {v2, v3}, Ljts;->b(Landroid/net/Uri;)V

    .line 33
    iget-object v2, v1, Lihj;->b:Liwh;

    invoke-interface {v2}, Liwh;->h()V

    .line 34
    invoke-virtual {v1}, Lihj;->b()V

    .line 35
    return-void

    .line 50
    .end local v1    # "ihjVar":Lihj;
    .local v0, "iwgVar3":Liwg;
    :cond_4
    move-object v1, v0
    ...
    invoke-interface {v2}, Liwh;->a()V

    .line 52
    iget-object v2, v1, Lihj;->d:Lihg;

    .line 53
    .local v2, "ihgVar":Lihg;
    iget-object v3, v2, Lihg;->d:Lihj;
    ...
    .line 54
    iget-object v3, v2, Lihg;->c:Lihj;

    invoke-virtual {v3}, Lihj;->c()V
    ...
    :cond_6
    :goto_1
    iget-object v3, v1, Lihj;->b:Liwh;

    invoke-interface {v3}, Liwh;->i()V
