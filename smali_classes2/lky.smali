...
.method private final f(Z)V
    ...
    iput-boolean v1, p0, Llky;->h:Z

    .line 26
    iget-boolean v1, p0, Llky;->f:Z
    ...
    .line 29
    :cond_0
    iget-object v1, p0, Llky;->a:Ljava/lang/Object;
    ...
    .line 30
    :try_start_1
    iget-object v2, p0, Llky;->g:Ljava/util/Queue;
    ...
    .line 38
    .local v2, "lkxVar":Llkx;
    iput-object v2, p0, Llky;->d:Llkx;

    .line 39
    iget-object v3, p0, Llky;->c:Ljava/util/Set;
    ...
    invoke-interface {v2, v6}, Llkx;->a(Llkc;)V
    ...
    .end local p0    # "this":Llky;
    .end local p1    # "z":Z
    :try_start_4
    throw v2

    .line 47
    .restart local p0    # "this":Llky;
...
.method public final b()V
    ...
    .line 115
    iget-object v3, p0, Llky;->g:Ljava/util/Queue;

    new-instance v4, Llku;

    const/4 v5, 0x0

    invoke-direct {v4, v5}, Llku;-><init>(I)V
    ...
    invoke-direct {p0, v0}, Llky;->f(Z)V
...
.method public final c(Llju;)V
    ...
    invoke-direct {v4, p1}, Llkv;-><init>(Llju;)V
...
.method public d(Llzp;)V
    ...
    invoke-direct {v2, p1, p0}, Llkt;-><init>(Llzp;Llky;)V

    iput-object v2, p0, Llky;->e:Llzp;
    ...
    invoke-direct {v4, v2}, Llkw;-><init>(Llzp;)V
...
.method public final e(Llkc;)V
    ...
    .line 181
    :cond_0
    iget-object v2, p0, Llky;->d:Llkx;

    move-object v1, v2

    .line 182
    .local v1, "lkxVar":Llkx;
    monitor-exit v0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
