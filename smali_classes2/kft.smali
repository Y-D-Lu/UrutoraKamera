...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    invoke-direct {v0, v1}, Lklf;-><init>(Lkim;)V

    iput-object v0, p0, Lkft;->c:Lklf;
...
.method public static a(Ljava/lang/String;)Lkip;
    ...
    .line 26
    iget-object v1, v0, Lkft;->c:Lklf;

    return-object v1

    .line 28
    .end local v0    # "kftVar":Lkft;
    :cond_0
    ...
    invoke-static {v1, v2}, Lmip;->dm(ZLjava/lang/Object;)V

    .line 30
    new-instance v1, Lkiq;

    invoke-direct {v1, v0}, Lkiq;-><init>(Lkiv;)V

    .line 31
    .local v1, "kiqVar":Lkiq;
...
.method public final run()V
    ...
    .line 46
    :cond_1
    sget-object v4, Lkft;->a:Lknw;

    const-string v5, "Unable to revoke access!"

    invoke-virtual {v4, v5}, Lknw;->c(Ljava/lang/String;)V
    :try_end_1
    ...
    invoke-virtual {v4, v6}, Lknw;->b(Ljava/lang/String;)V
    :try_end_2
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_2} :catch_0

    .line 65
    .end local v4    # "knwVar":Lknw;
    ...
    .line 56
    :try_start_3
    sget-object v5, Lkft;->a:Lknw;

    .line 57
    .local v5, "knwVar2":Lknw;
    ...
    :goto_2
    invoke-virtual {v5, v7}, Lknw;->c(Ljava/lang/String;)V

    .line 59
    iget-object v7, p0, Lkft;->c:Lklf;

    invoke-virtual {v7, v0}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->j(Lkiv;)V
    :try_end_4
