...
# virtual methods
.method public final declared-synchronized a(Ljava/nio/ByteBuffer;I)Llgp;
    .locals 8
    ...
    .line 20
    :try_start_0
    iget-object v0, p0, Lcip;->b:Lnih;

    .line 21
    .local v0, "nihVar":Lnih;
    iget-object v1, v0, Lnih;->a:[B
    ...
    iput-object v2, v0, Lnih;->a:[B

    goto :goto_0

    .line 24
    .end local p0    # "this":Lcip;
    :cond_0
    array-length v2, v1
    ...
    .line 37
    .restart local p0    # "this":Lcip;
    :cond_2
    :try_start_3
    iget-object v5, p0, Lcip;->a:Lcjd;

    invoke-virtual {v5, v3}, Lcjd;->a(I)J
    ...
    invoke-static {p1, v3, v5, v6}, Lmro;->a(Ljava/nio/ByteBuffer;IJ)Lmro;

    move-result-object v7

    invoke-direct {v4, v7}, Llgp;-><init>(Lmro;)V
    :try_end_3
...
.method public final declared-synchronized b(Llgp;)V
    .locals 8
    .param p1, "lgpVar"    # Llgp;

    monitor-enter p0

    .line 43
    :try_start_0
    invoke-virtual {p1}, Llgp;->c()Ljava/nio/ByteBuffer;
    ...
    :cond_2
    :goto_2
    iget-object v3, p0, Lcip;->a:Lcjd;

    invoke-virtual {p1}, Llgp;->b()J
    ...
    invoke-virtual {v3, v4, v5, v6}, Lcjd;->b(JI)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
