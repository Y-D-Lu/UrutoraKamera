...
.method public static a(Landroid/content/Context;Laof;)Lano;
    .locals 3
    ...
    .line 23
    .local v0, "aozVar":Laoz;
    const-class v1, Landroidx/work/impl/background/systemjob/SystemJobService;

    const/4 v2, 0x1

    invoke-static {p0, v1, v2}, Larn;->a(Landroid/content/Context;Ljava/lang/Class;Z)V
...
.method public static b(Lamj;Landroidx/work/impl/WorkDatabase;Ljava/util/List;)V
    ...
    .end local v1    # "aisVar":Lais;
    .local v18, "aisVar":Lais;
    :try_start_0
    iget v0, v1, Lamj;->e:I
    ...
    .end local v20    # "a":Lais;
    .local v4, "a":Lais;
    .local v23, "l3":I
    :try_start_1
    invoke-virtual {v4, v1, v2, v3}, Lais;->e(IJ)V
    ...
    invoke-static {v0, v4, v2}, Lfy;->i(Laii;Lajw;Z)Landroid/database/Cursor;
    ...
    .line 76
    .end local v18    # "aisVar":Lais;
    .local v16, "aisVar":Lais;
    move/from16 v18, v0
    ...
    .line 96
    .local v35, "i5":I
    new-instance v37, Laml;

    invoke-direct/range {v37 .. v37}, Laml;-><init>()V
    :try_end_7
    ...
    .local v40, "l":I
    :try_start_9
    invoke-static/range {v20 .. v20}, Lgh;->l(I)I
    ...
    .end local v38    # "amlVar":Laml;
    .local v12, "amlVar":Laml;
    .local v20, "l11":I
    :try_start_a
    iput v10, v12, Laml;->i:I
    ...
    iput-object v0, v12, Laml;->h:Lamn;
    ...
    .local v34, "l2":I
    :try_start_b
    invoke-direct {v0, v1, v4}, Laqt;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static/range {v36 .. v36}, Lgh;->n(I)I
    ...
    invoke-static/range {v36 .. v36}, Lamq;->a([B)Lamq;

    move-result-object v4

    iput-object v4, v0, Laqt;->e:Lamq;
    :try_end_b
    ...
    .end local v1    # "i8":I
    .local v51, "i8":I
    invoke-static/range {v50 .. v50}, Lgh;->k(I)I
    ...
    .local v57, "l5":I
    :try_start_11
    invoke-static/range {v56 .. v56}, Lgh;->m(I)I
    ...
    .line 142
    iput-object v12, v0, Laqt;->i:Laml;
    ...
    .line 162
    invoke-interface/range {v33 .. v33}, Laqu;->i()Ljava/util/List;
    ...
    .line 166
    .local v5, "aqtVar2":Laqt;
    move-object/from16 v7, v33

    .line 167
    .local v7, "aquVar2":Laqu;
    iget-object v8, v5, Laqt;->a:Ljava/lang/String;

    invoke-interface {v7, v8, v1, v2}, Laqu;->j(Ljava/lang/String;J)V

    .line 168
    move-object/from16 v33, v7

    .line 169
    .end local v5    # "aqtVar2":Laqt;
    .end local v7    # "aquVar2":Laqu;
    goto :goto_8
    ...
    .line 178
    .local v4, "anoVar":Lano;
    invoke-interface {v4}, Lano;->d()Z
    ...
    .line 179
    invoke-interface {v4, v1}, Lano;->c([Laqt;)V

    .line 181
    .end local v4    # "anoVar":Lano;
    :cond_8
    goto :goto_9

    .line 183
    .end local v1    # "aqtVarArr":[Laqt;
    ...
    .line 193
    .end local v4    # "anoVar2":Lano;
    :cond_b
    goto :goto_a

    .line 198
    .end local v0    # "i23":Ljava/util/List;
    .end local v1    # "aqtVarArr2":[Laqt;
    ...
    .end local v31    # "a":Lais;
    .end local v33    # "aquVar":Laqu;
    .end local v34    # "l2":I
    .end local v36    # "l6":I
    .end local v39    # "l9":I
    .end local v40    # "l":I
    ...
    .local v4, "l3":I
    .local v15, "l8":I
    .restart local v31    # "a":Lais;
    .restart local v33    # "aquVar":Laqu;
    .restart local v34    # "l2":I
    .restart local v36    # "l6":I
    .restart local v46    # "l7":I
    .restart local v47    # "l12":I
