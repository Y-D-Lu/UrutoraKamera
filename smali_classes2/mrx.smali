...
.method public constructor <init>(Landroid/media/MediaCodec;Landroid/media/MediaFormat;Loiu;ZLandroid/os/Handler;)V
    ...
    iput-object v0, p0, Lmrx;->g:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, Lmrx;->f:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, Lmrx;->i:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {v0, p0}, Lmrw;-><init>(Lmrx;)V

    .line 41
    .local v0, "mrwVar":Lmrw;
    iput-object v0, p0, Lmrx;->j:Lmrw;
    ...
    :goto_1
    iput-object v1, p0, Lmrx;->c:Landroid/view/Surface;
...
.method private final j(Z)V
    ...
    .line 84
    iget-object v2, p0, Lmrx;->c:Landroid/view/Surface;

    .line 85
    .local v2, "surface":Landroid/view/Surface;
    if-eqz v2, :cond_2

    iget-boolean v3, p0, Lmrx;->o:Z
...
.method public final a(Landroid/media/MediaCodec$BufferInfo;)V
    ...
    .line 107
    iget-object v0, p0, Lmrx;->g:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final declared-synchronized d()V
    ...
    :cond_1
    :try_start_2
    iget-object v1, p0, Lmrx;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .line 138
    iget-object v1, p0, Lmrx;->f:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final g()Lmru;
    ...
    invoke-direct {v3, p0, v2, v0}, Lmru;-><init>(Lmrx;Ljava/nio/ByteBuffer;I)V

    .line 192
    .local v3, "mruVar":Lmru;
    monitor-enter p0
    :try_end_0
    .catch Landroid/media/MediaCodec$CodecException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1
    ...
    .line 193
    :try_start_1
    iget-object v4, p0, Lmrx;->k:Ljava/util/Set;
    ...
    .end local v3    # "mruVar":Lmru;
    .restart local v0    # "h":I
    .restart local p0    # "this":Lmrx;
    :catchall_1
    move-exception v2
    ...
    iget-object v3, p0, Lmrx;->j:Lmrw;

    iget-object v4, p0, Lmrx;->a:Landroid/media/MediaCodec;

    invoke-virtual {v3, v4, v2}, Lmrw;->onError(Landroid/media/MediaCodec;Landroid/media/MediaCodec$CodecException;)V
