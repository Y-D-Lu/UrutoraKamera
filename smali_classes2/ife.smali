...
.method public constructor <init>(ZZLandroid/content/Context;Ljava/util/concurrent/Executor;Lcom/google/android/apps/camera/bottombar/BottomBarController;Lddf;Lcom/google/android/apps/camera/bottombar/RoundedThumbnailView;Lhuf;Lhug;Lifj;)V
    ...
    iput-object v0, p0, Life;->e:Ljava/util/ArrayList;
...
.method private final m(Loom;)V
    ...
    .line 79
    iget-object v1, p0, Life;->s:Landroid/animation/AnimatorSet;
    ...
    iput-object v1, p0, Life;->s:Landroid/animation/AnimatorSet;

    .line 83
    invoke-virtual {v1, p1}, Landroid/animation/AnimatorSet;->playTogether(Ljava/util/Collection;)V

    .line 84
    iget-object v2, p0, Life;->s:Landroid/animation/AnimatorSet;
...
.method public final a(Ljava/util/ArrayList;)Lpht;
    ...
    .line 97
    .local v2, "f2":Lpih;
    new-instance v3, Ldefpackage/Ni;

    invoke-direct {v3, p0, p1, v2}, Ldefpackage/Ni;-><init>(Life;Ljava/util/ArrayList;Lpih;)V

    iget-object v4, p0, Life;->n:Ljava/util/concurrent/Executor;

    const-string v5, "ssui"

    invoke-static {v3, v4, v5}, Laas;->e(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;Ljava/lang/String;)Lbvv;
    ...
    .line 122
    new-instance v3, Ldefpackage/Pi;

    invoke-direct {v3, p0, v0}, Ldefpackage/Pi;-><init>(Life;Lpih;)V
...
.method public final b()Lpht;
    ...
    .line 219
    iget-object v3, p0, Life;->u:Lief;

    .line 220
    .local v3, "iefVar":Lief;
    iget-object v4, v3, Lief;->a:Landroid/graphics/drawable/TransitionDrawable;

    invoke-virtual {v4}, Landroid/graphics/drawable/TransitionDrawable;->resetTransition()V

    .line 221
    iget-object v4, v3, Lief;->b:Landroid/view/View$OnClickListener;
    ...
    .line 223
    iget-object v4, p0, Life;->o:Lddf;

    sget-object v5, Lddl;->aI:Lddg;
    ...
    .line 238
    :cond_1
    iget-object v4, p0, Life;->j:Lies;

    .line 239
    .local v4, "iesVar":Lies;
    new-instance v5, Ldefpackage/Ri;

    invoke-direct {v5, p0, v0}, Ldefpackage/Ri;-><init>(Life;Lpih;)V

    .line 245
    .local v5, "acrVar":Lacr;
    invoke-virtual {v4}, Lies;->d()Landroid/animation/Animator;
    ...
    invoke-virtual {v4}, Lies;->c()I

    move-result v10

    const v11, 0x7f070302

    invoke-virtual {v4, v11}, Lies;->a(I)I
    ...
    .line 249
    new-instance v8, Ldefpackage/Ti;

    invoke-direct {v8, p0, v4, v5}, Ldefpackage/Ti;-><init>(Life;Lies;Lacr;)V

    invoke-static {v8}, Lmip;->ev(Ljava/util/function/Consumer;)Landroid/animation/Animator$AnimatorListener;
    ...
    .line 224
    .end local v4    # "iesVar":Lies;
    .end local v5    # "acrVar":Lacr;
    ...
    new-instance v4, Ldefpackage/Qi;

    invoke-direct {v4, p0, v0}, Ldefpackage/Qi;-><init>(Life;Lpih;)V

    invoke-static {v4}, Lmip;->ev(Ljava/util/function/Consumer;)Landroid/animation/Animator$AnimatorListener;
    ...
    invoke-direct {v4, p0, v2}, Lifa;-><init>(Life;I)V
...
.method public final c(Z)V
    ...
    .line 298
    iget-object v4, v0, Life;->m:Lcom/google/android/apps/camera/bottombar/BottomBarController;
    ...
    .line 301
    .local v7, "iesVar":Lies;
    const/16 v8, 0x8

    invoke-virtual {v7, v8}, Landroid/widget/LinearLayout;->setVisibility(I)V

    .line 302
    invoke-virtual {v7, v5}, Lies;->f(Z)V
    ...
    .line 314
    iget-object v3, v0, Life;->j:Lies;

    iget-object v3, v3, Lies;->b:Ljava/util/ArrayList;

    sget-object v9, Lgui;->b:Lgui;

    invoke-virtual {v3, v9}, Ljava/util/ArrayList;->forEach(Ljava/util/function/Consumer;)V

    .line 315
    iget-object v3, v0, Life;->r:Lifj;

    .line 316
    .local v3, "ifjVar":Lifj;
    iget-object v9, v3, Lifj;->a:Lcom/google/android/apps/camera/bottombar/RoundedThumbnailView;

    invoke-virtual {v9, v4}, Landroid/widget/ImageButton;->setAlpha(F)V

    .line 317
    iget-object v4, v3, Lifj;->a:Lcom/google/android/apps/camera/bottombar/RoundedThumbnailView;
    ...
    .line 321
    .local v7, "e":Looh;
    iget-object v8, v0, Life;->j:Lies;

    .line 322
    .local v8, "iesVar2":Lies;
    new-array v9, v6, [I
    ...
    iget v11, v8, Lies;->f:I

    if-ne v11, v3, :cond_6

    .line 331
    sget-object v11, Ljur;->a:Ljava/time/Duration;
    ...
    .line 333
    :cond_6
    iget-object v11, v8, Lies;->a:Ljava/time/Duration;
    ...
    .line 335
    :goto_2
    new-instance v11, Lier;

    invoke-direct {v11, v8, v3}, Lier;-><init>(Lies;I)V

    invoke-static {v11}, Lmip;->ew(Ljava/util/function/Consumer;)Landroid/animation/Animator$AnimatorListener;
    ...
    invoke-direct {v11, v8, v5}, Lier;-><init>(Lies;I)V

    invoke-static {v11}, Lmip;->ev(Ljava/util/function/Consumer;)Landroid/animation/Animator$AnimatorListener;
    ...
    .line 337
    new-instance v11, Liep;

    invoke-direct {v11, v8, v3}, Liep;-><init>(Lies;I)V
    ...
    .line 338
    invoke-virtual {v7, v2}, Looh;->g(Ljava/lang/Object;)V

    .line 339
    iget-object v11, v0, Life;->j:Lies;

    iget-object v11, v11, Lies;->b:Ljava/util/ArrayList;

    invoke-virtual {v11}, Ljava/util/ArrayList;->stream()Ljava/util/stream/Stream;

    move-result-object v11

    sget-object v12, Licd;->q:Licd;
    ...
    invoke-direct {v12, v7}, Lifb;-><init>(Looh;)V
    ...
    .line 341
    iget-object v11, v0, Life;->r:Lifj;

    .line 342
    .local v11, "ifjVar2":Lifj;
    iget-object v12, v11, Lifj;->a:Lcom/google/android/apps/camera/bottombar/RoundedThumbnailView;
    ...
    iget-object v4, v11, Lifj;->b:Ljava/time/Duration;
    ...
    .line 345
    invoke-virtual {v7, v3}, Looh;->g(Ljava/lang/Object;)V

    .line 347
    .end local v3    # "ofPropertyValuesHolder":Landroid/animation/ObjectAnimator;
    .end local v11    # "ifjVar2":Lifj;
    :cond_7
    invoke-virtual {v7}, Looh;->f()Loom;

    move-result-object v3

    invoke-direct {v0, v3}, Life;->m(Loom;)V
...
.method public final d(Landroid/view/View;)V
    ...
    iput-object v1, v0, Life;->v:Landroid/view/View;

    .line 356
    new-instance v2, Landroid/view/GestureDetector;

    iget-object v3, v0, Life;->c:Landroid/content/Context;

    new-instance v4, Lifd;

    invoke-direct {v4, v0}, Lifd;-><init>(Life;)V

    invoke-direct {v2, v3, v4}, Landroid/view/GestureDetector;-><init>(Landroid/content/Context;Landroid/view/GestureDetector$OnGestureListener;)V

    iput-object v2, v0, Life;->f:Landroid/view/GestureDetector;
    ...
    invoke-direct {v2, v0, v3}, Lifc;-><init>(Life;Landroid/content/Context;)V

    .line 358
    .local v2, "ifcVar":Lifc;
    iput-object v2, v0, Life;->u:Lief;
    ...
    invoke-virtual {v2, v6}, Lief;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    iput-object v3, v2, Lief;->a:Landroid/graphics/drawable/TransitionDrawable;
    ...
    :cond_0
    iget-object v9, v0, Life;->c:Landroid/content/Context;
    ...
    iget-object v11, v0, Life;->c:Landroid/content/Context;

    iget-object v12, v0, Life;->u:Lief;

    iget-object v13, v0, Life;->o:Lddf;
    ...
    invoke-direct {v10, v11, v12, v13}, Ljhm;-><init>(Landroid/content/Context;Landroid/view/View;Z)V

    .line 368
    .local v10, "jhmVar":Ljhm;
    iput-object v10, v0, Life;->g:Ljhm;

    .line 369
    add-int v11, v5, v9

    invoke-virtual {v10, v7, v7, v11}, Ljhm;->c(III)V

    .line 370
    new-instance v11, Lies;

    iget-object v12, v0, Life;->c:Landroid/content/Context;

    iget-boolean v13, v0, Life;->a:Z

    invoke-direct {v11, v12, v13}, Lies;-><init>(Landroid/content/Context;Z)V

    .line 371
    .local v11, "iesVar":Lies;
    iput-object v11, v0, Life;->j:Lies;
    ...
    .line 375
    iput-object v12, v11, Lies;->d:Landroid/graphics/drawable/GradientDrawable;

    .line 376
    const v7, 0x7f070309

    invoke-virtual {v11, v7}, Lies;->a(I)I

    move-result v7

    .line 377
    .local v7, "a":I
    invoke-virtual {v11, v6}, Lies;->a(I)I
    ...
    iget-object v8, v11, Lies;->d:Landroid/graphics/drawable/GradientDrawable;
    ...
    .line 385
    iget-object v6, v0, Life;->j:Lies;

    .line 386
    .local v6, "iesVar2":Lies;
    iget-object v8, v0, Life;->u:Lief;

    .line 387
    .local v8, "iefVar":Lief;
    ...
    .line 389
    iput-object v8, v6, Lies;->e:Lief;

    .line 390
    iget-object v15, v6, Lies;->c:Lieh;

    invoke-virtual {v15, v8}, Lieh;->a(Lieg;)V
    ...
    iput-object v15, v0, Life;->t:Landroid/widget/FrameLayout;

    .line 394
    iget-object v1, v0, Life;->j:Lies;

    invoke-virtual {v15, v1}, Landroid/widget/FrameLayout;->addView(Landroid/view/View;)V

    .line 395
    iget-object v1, v0, Life;->p:Lcom/google/android/apps/camera/bottombar/RoundedThumbnailView;

    move-object/from16 v16, v2

    .end local v2    # "ifcVar":Lifc;
    .local v16, "ifcVar":Lifc;
    ...
    invoke-direct {v2, v0, v3}, Liew;-><init>(Life;I)V
...
.method public final f(Ljrz;)V
    ...
    invoke-static {v1, p1}, Lmip;->et(Landroid/view/View;Ljrz;)V
    ...
    invoke-direct {v2, p1, v3}, Liem;-><init>(Ljrz;I)V
...
.method public final h()V
    ...
    .line 427
    .local v4, "ifmVar":Lifm;
    iget-boolean v5, v4, Lifm;->c:Z

    if-nez v5, :cond_0

    .line 428
    iget-object v5, v4, Lifm;->a:Landroid/content/pm/ResolveInfo;
    ...
    .end local v3    # "i":I
    :cond_1
    iget-object v3, p0, Life;->j:Lies;

    iget-object v3, v3, Lies;->b:Ljava/util/ArrayList;

    new-instance v4, Ldefpackage/Ui;

    invoke-direct {v4, p0, v0}, Ldefpackage/Ui;-><init>(Life;Ljava/util/ArrayList;)V
...
.method public final i(Ljava/lang/Runnable;)V
    ...
    iput-object v1, v0, Life;->i:Ljava/lang/Runnable;
    ...
    invoke-interface {v4, v5, v7}, Lhug;->e(Lhts;Ljava/lang/Object;)V
    ...
    .line 459
    iget-object v4, v0, Life;->u:Lief;

    .line 460
    .local v4, "iefVar":Lief;
    iget-object v5, v4, Lief;->a:Landroid/graphics/drawable/TransitionDrawable;
    ...
    .line 462
    iget-object v5, v4, Lief;->c:Landroid/view/View$OnClickListener;
    ...
    .line 464
    iget-object v5, v0, Life;->j:Lies;

    .line 465
    .local v5, "iesVar":Lies;
    ...
    invoke-virtual {v5, v8}, Lies;->h(I)V

    .line 467
    iget-object v9, v5, Lies;->c:Lieh;

    .line 468
    .local v9, "iehVar":Lieh;
    invoke-static {}, Llar;->a()V

    .line 469
    iget-object v10, v9, Lieh;->a:Ljava/util/ArrayList;
    ...
    .line 473
    .local v13, "iegVar":Lieg;
    if-eqz v13, :cond_1

    .line 474
    invoke-interface {v13}, Lieg;->c()V

    .line 471
    .end local v13    # "iegVar":Lieg;
    :cond_1
    ...
    invoke-virtual {v5, v12}, Lies;->a(I)I
    ...
    invoke-virtual {v5, v13}, Lies;->a(I)I
    ...
    iget-object v15, v5, Lies;->b:Ljava/util/ArrayList;
    ...
    invoke-virtual {v5, v7}, Lies;->a(I)I
    ...
    iget-object v14, v5, Lies;->a:Ljava/time/Duration;
    ...
    .line 481
    new-instance v14, Lier;

    invoke-direct {v14, v5, v8}, Lier;-><init>(Lies;I)V

    invoke-static {v14}, Lmip;->ew(Ljava/util/function/Consumer;)Landroid/animation/Animator$AnimatorListener;
    ...
    invoke-direct {v14, v5, v3}, Lier;-><init>(Lies;I)V

    invoke-static {v14}, Lmip;->ev(Ljava/util/function/Consumer;)Landroid/animation/Animator$AnimatorListener;
    ...
    invoke-direct {v3, v5, v14}, Liep;-><init>(Lies;I)V
    ...
    invoke-direct {v3, v0, v6}, Lifa;-><init>(Life;I)V
    ...
    invoke-direct {v3, v0, v14}, Lifa;-><init>(Life;I)V
    ...
    .line 487
    .local v3, "e":Looh;
    invoke-virtual {v3, v7}, Looh;->g(Ljava/lang/Object;)V

    .line 488
    iget-object v14, v0, Life;->j:Lies;

    iget-object v14, v14, Lies;->b:Ljava/util/ArrayList;

    invoke-virtual {v14}, Ljava/util/ArrayList;->stream()Ljava/util/stream/Stream;

    move-result-object v14

    sget-object v15, Licd;->p:Licd;
    ...
    invoke-direct {v15, v3}, Lifb;-><init>(Looh;)V

    invoke-interface {v14, v15}, Ljava/util/stream/Stream;->forEachOrdered(Ljava/util/function/Consumer;)V

    .line 489
    iget-object v14, v0, Life;->r:Lifj;

    .line 490
    .local v14, "ifjVar":Lifj;
    iget-object v15, v14, Lifj;->a:Lcom/google/android/apps/camera/bottombar/RoundedThumbnailView;
    ...
    new-instance v6, Ldefpackage/Vi;

    invoke-direct {v6, v0, v14}, Ldefpackage/Vi;-><init>(Life;Lifj;)V

    invoke-static {v6}, Lmip;->ev(Ljava/util/function/Consumer;)Landroid/animation/Animator$AnimatorListener;
    ...
    .line 503
    iget-object v6, v14, Lifj;->b:Ljava/time/Duration;

    move-object v8, v4

    move-object v15, v5

    .end local v4    # "iefVar":Lief;
    .end local v5    # "iesVar":Lies;
    .local v8, "iefVar":Lief;
    .local v15, "iesVar":Lies;
    ...
    invoke-direct {v0, v4}, Life;->m(Loom;)V
    ...
    .end local v8    # "iefVar":Lief;
    .end local v9    # "iehVar":Lieh;
    .end local v10    # "arrayList":Ljava/util/ArrayList;
    .end local v11    # "size":I
    .end local v12    # "a":I
    .end local v13    # "a2":I
    .end local v14    # "ifjVar":Lifj;
    .end local v15    # "iesVar":Lies;
    :cond_3
    const/4 v1, 0x0
...
.method public final j(Liby;)V
    ...
    .line 517
    new-instance v1, Ldefpackage/Wi;

    invoke-direct {v1, p0, p1}, Ldefpackage/Wi;-><init>(Life;Liby;)V
    ...
    invoke-direct {v1, p0, p1}, Ldefpackage/Xi;-><init>(Life;Liby;)V

    iput-object v1, v0, Lief;->c:Landroid/view/View$OnClickListener;

    .line 543
    iget-object v1, v0, Lief;->b:Landroid/view/View$OnClickListener;
...
.method public final k()V
    ...
    .line 552
    iget-object v2, p0, Life;->p:Lcom/google/android/apps/camera/bottombar/RoundedThumbnailView;
    ...
    .line 556
    :goto_0
    iget-object v2, p0, Life;->t:Landroid/widget/FrameLayout;
