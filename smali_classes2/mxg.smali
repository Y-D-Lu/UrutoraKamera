...
.method public constructor <init>(Ljava/lang/String;ZLqyk;Lqxe;Ljava/lang/String;Ljava/lang/Long;ZLmvp;)V
    ...
    .param p2, "z"    # Z
    .param p3, "qykVar"    # Lqyk;
    .param p4, "qxeVar"    # Lqxe;
    .param p5, "str2"    # Ljava/lang/String;
    .param p6, "l"    # Ljava/lang/Long;
    .param p7, "z2"    # Z
    .param p8, "mvpVar"    # Lmvp;
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    .line 47
    .local v1, "mxgVar":Lmxg;
    iget-object v3, p0, Lmxg;->a:Ljava/lang/String;

    .line 48
    .local v3, "str2":Ljava/lang/String;
    iget-object v4, v1, Lmxg;->a:Ljava/lang/String;
    ...
    .line 49
    :goto_0
    iget-boolean v4, p0, Lmxg;->b:Z

    iget-boolean v5, v1, Lmxg;->b:Z

    if-ne v4, v5, :cond_7

    iget-object v4, p0, Lmxg;->c:Lqyk;

    iget-object v5, v1, Lmxg;->c:Lqyk;

    invoke-virtual {v4, v5}, Lppd;->equals(Ljava/lang/Object;)Z

    move-result v4

    if-eqz v4, :cond_7

    iget-object v4, p0, Lmxg;->d:Lqxe;

    move-object v5, v4

    .local v5, "qxeVar":Lqxe;
    if-eqz v4, :cond_3

    iget-object v4, v1, Lmxg;->d:Lqxe;

    invoke-virtual {v5, v4}, Lppd;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v4, v1, Lmxg;->e:Ljava/lang/String;
    ...
    :goto_2
    iget-object v4, p0, Lmxg;->f:Ljava/lang/Long;
    ...
    iget-object v4, v1, Lmxg;->f:Ljava/lang/Long;
    ...
    :goto_3
    iget-boolean v4, p0, Lmxg;->g:Z

    iget-boolean v8, v1, Lmxg;->g:Z

    if-ne v4, v8, :cond_7

    .line 50
    iget-object v4, p0, Lmxg;->h:Lmvp;

    .line 51
    .local v4, "mvpVar":Lmvp;
    iget-object v8, v1, Lmxg;->h:Lmvp;

    .line 52
    .local v8, "mvpVar2":Lmvp;
    if-eqz v4, :cond_6
    ...
    .end local v5    # "qxeVar":Lqxe;
    .end local v6    # "str":Ljava/lang/String;
    .end local v7    # "l":Ljava/lang/Long;
    .end local v8    # "mvpVar2":Lmvp;
    :cond_7
    return v2
.end method
...
.method public final hashCode()I
    ...
    iget-object v1, v0, Lmxg;->a:Ljava/lang/String;
    ...
    invoke-virtual {v10, v7}, Lpqu;->b(Ljava/lang/Object;)Lprb;

    move-result-object v10

    invoke-interface {v10, v7}, Lprb;->b(Ljava/lang/Object;)I

    move-result v9

    .line 70
    iput v9, v7, Lpnm;->aD:I
    ...
    .line 73
    .local v10, "i5":I
    iget-object v11, v0, Lmxg;->d:Lqxe;

    .line 74
    .local v11, "qxeVar":Lqxe;
    if-nez v11, :cond_3
    ...
    .line 84
    .local v13, "i6":I
    iget-object v14, v0, Lmxg;->e:Ljava/lang/String;
    ...
    iget-object v4, v0, Lmxg;->f:Ljava/lang/Long;
    ...
    .line 92
    .local v6, "i7":I
    iget-object v8, v0, Lmxg;->h:Lmvp;

    .line 93
    .local v8, "mvpVar":Lmvp;
    if-eqz v8, :cond_8
