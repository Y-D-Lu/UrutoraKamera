...
.method public final a(Landroid/content/Context;Ljava/lang/String;Lkro;)Landroid/os/IInterface;
    ...
    :try_start_0
    sget-object v7, Lkrl;->a:Ljava/lang/Object;
    ...
    .line 38
    :try_start_2
    sget-object v0, Lkor;->a:Ljava/lang/Boolean;
    ...
    :try_end_2
    .catch Lkoo; {:try_start_2 .. :try_end_2} :catch_1
    ...
    .line 45
    sget-object v6, Lkor;->e:Lkop;

    invoke-static {v1, v6}, Lmip;->cj(Landroid/content/Context;Lkop;)Lkoq;

    move-result-object v6

    .line 46
    .local v6, "cj":Lkoq;
    iget v15, v6, Lkoq;->c:I
    :try_end_3
    ...
    .line 65
    :goto_1
    iget-object v8, v11, Lkom;->a:Landroid/database/Cursor;
    ...
    iget v0, v6, Lkoq;->b:I
    :try_end_5
    .catch Lkoo; {:try_start_5 .. :try_end_5} :catch_0
    ...
    .end local v10    # "komVar":Lkom;
    .end local v11    # "komVar2":Lkom;
    .end local v13    # "longValue":J
    .end local v15    # "i2":I
    .end local p0    # "this":Lkrl;
    .end local p1    # "context":Landroid/content/Context;
    .end local p2    # "str":Ljava/lang/String;
    .end local p3    # "kroVar":Lkro;
    :try_start_8
    throw v0
    :try_end_8
    ...
    .restart local v10    # "komVar":Lkom;
    .restart local v11    # "komVar2":Lkom;
    .restart local v13    # "longValue":J
    .restart local v15    # "i2":I
    .restart local p0    # "this":Lkrl;
    .restart local p1    # "context":Landroid/content/Context;
    .restart local p2    # "str":Ljava/lang/String;
    .restart local p3    # "kroVar":Lkro;
    :catchall_2
    move-exception v0
    ...
    invoke-direct {v12, v8, v0}, Lkoo;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    throw v12
    :try_end_9
    .catch Lkoo; {:try_start_9 .. :try_end_9} :catch_0
    ...
    invoke-direct {v5, v4}, Lkon;-><init>(I)V

    invoke-static {v1, v5}, Lmip;->cj(Landroid/content/Context;Lkop;)Lkoq;
    ...
    .line 102
    :goto_3
    iget-object v4, v11, Lkom;->a:Landroid/database/Cursor;
    :try_end_f
    ...
    :cond_8
    :try_start_11
    sget-object v12, Lkor;->c:Ljava/lang/ThreadLocal;
    :try_end_11
    ...
    .line 113
    :try_start_13
    sget-object v0, Lkor;->f:Lkot;

    move-object/from16 v19, v0

    .line 114
    .local v19, "kotVar":Lkot;
    monitor-exit v3
    :try_end_13
    ...
    .end local v19    # "kotVar":Lkot;
    .local v8, "kotVar":Lkot;
    if-eqz v8, :cond_11

    .line 118
    :try_start_14
    sget-object v19, Lkor;->c:Ljava/lang/ThreadLocal;
    ...
    .line 119
    .local v21, "komVar3":Lkom;
    move-object/from16 v12, v21

    .end local v21    # "komVar3":Lkom;
    .local v12, "komVar3":Lkom;
    if-eqz v12, :cond_10

    iget-object v0, v12, Lkom;->a:Landroid/database/Cursor;
    ...
    invoke-static/range {v18 .. v18}, Lkog;->b(Ljava/lang/Object;)Lkoh;
    ...
    .line 129
    invoke-static/range {v22 .. v22}, Lkog;->b(Ljava/lang/Object;)Lkoh;

    move-result-object v3

    .line 130
    .local v3, "b2":Lkoh;
    invoke-static/range {v23 .. v23}, Lkog;->b(Ljava/lang/Object;)Lkoh;
    ...
    invoke-static {v0, v3}, Lbmp;->e(Landroid/os/Parcel;Landroid/os/IInterface;)V
    ...
    .line 135
    invoke-static {v0, v5}, Lbmp;->e(Landroid/os/Parcel;Landroid/os/IInterface;)V

    .line 136
    const/4 v3, 0x3

    invoke-virtual {v8, v3, v0}, Lbmn;->y(ILandroid/os/Parcel;)Landroid/os/Parcel;
    ...
    invoke-direct {v9, v0}, Lkof;-><init>(Landroid/os/IBinder;)V
    ...
    invoke-static {v5, v0}, Lbmp;->e(Landroid/os/Parcel;Landroid/os/IInterface;)V
    ...
    invoke-virtual {v8, v9, v5}, Lbmn;->y(ILandroid/os/Parcel;)Landroid/os/Parcel;
    ...
    invoke-direct {v5, v0}, Lkof;-><init>(Landroid/os/IBinder;)V
    ...
    .local v9, "kofVar2":Lkoh;
    :goto_8
    invoke-static {v9}, Lkog;->c(Lkoh;)Ljava/lang/Object;
    ...
    invoke-direct {v3, v0}, Lkor;-><init>(Landroid/content/Context;)V

    move-object v0, v3

    .line 169
    .end local v12    # "komVar3":Lkom;
    ...
    .line 166
    .local v0, "context2":Landroid/content/Context;
    .restart local v12    # "komVar3":Lkom;
    ...
    invoke-direct {v3, v5}, Lkoo;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v0, v3}, Lkoo;-><init>(Ljava/lang/String;)V
    ...
    .line 181
    .local v8, "b6":Lkoh;
    iget-object v9, v0, Lkom;->a:Landroid/database/Cursor;

    invoke-static {v9}, Lkog;->b(Ljava/lang/Object;)Lkoh;
    ...
    invoke-static {v12, v8}, Lbmp;->e(Landroid/os/Parcel;Landroid/os/IInterface;)V

    .line 184
    move-object/from16 v19, v0

    .end local v0    # "komVar4":Lkom;
    .local v19, "komVar4":Lkom;
    ...
    .line 186
    invoke-static {v12, v9}, Lbmp;->e(Landroid/os/Parcel;Landroid/os/IInterface;)V

    .line 187
    const/16 v0, 0x8

    invoke-virtual {v3, v0, v12}, Lbmn;->y(ILandroid/os/Parcel;)Landroid/os/Parcel;
    ...
    :cond_14
    new-instance v12, Lkof;

    invoke-direct {v12, v8}, Lkof;-><init>(Landroid/os/IBinder;)V
    ...
    .end local v0    # "komVar4":Lkom;
    .restart local v19    # "komVar4":Lkom;
    new-instance v0, Lkoo;

    const-string v8, "No cached result cursor holder"

    invoke-direct {v0, v8}, Lkoo;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v8, v0}, Lbmp;->e(Landroid/os/Parcel;Landroid/os/IInterface;)V
    ...
    invoke-virtual {v3, v9, v8}, Lbmn;->y(ILandroid/os/Parcel;)Landroid/os/Parcel;
    ...
    invoke-direct {v5, v12}, Lkof;-><init>(Landroid/os/IBinder;)V
    ...
    invoke-virtual {v3, v8, v5}, Lbmn;->y(ILandroid/os/Parcel;)Landroid/os/Parcel;
    ...
    invoke-direct {v0, v9}, Lkof;-><init>(Landroid/os/IBinder;)V
    ...
    :goto_f
    invoke-static {v12}, Lkog;->c(Lkoh;)Ljava/lang/Object;
    ...
    invoke-direct {v0, v5}, Lkor;-><init>(Landroid/content/Context;)V
    ...
    .line 235
    sget-object v0, Lkor;->d:Ljava/lang/ThreadLocal;
    ...
    .line 239
    :goto_11
    iget-object v0, v11, Lkom;->a:Landroid/database/Cursor;
    ...
    invoke-direct {v0, v5}, Lkoo;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v3, v4, v0}, Lkoo;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v3, v8}, Lkoo;-><init>(Ljava/lang/String;)V
    ...
    .line 56
    new-instance v9, Lkoo;

    invoke-virtual {v8}, Ljava/lang/StringBuilder;->toString()Ljava/lang/String;

    move-result-object v12

    invoke-direct {v9, v12}, Lkoo;-><init>(Ljava/lang/String;)V
    ...
    .line 253
    :goto_15
    iget-object v3, v11, Lkom;->a:Landroid/database/Cursor;
    ...
    throw v0
    :try_end_21
    .catch Lkoo; {:try_start_21 .. :try_end_21} :catch_1
    ...
    .line 270
    :try_start_23
    invoke-virtual {v3, v2}, Lkor;->b(Ljava/lang/String;)Landroid/os/IBinder;

    move-result-object v0
    :try_end_23
    .catch Lkoo; {:try_start_23 .. :try_end_23} :catch_4
    ...
    :try_start_24
    invoke-interface {v8, v6}, Lkro;->a(Landroid/os/IBinder;)Landroid/os/IInterface;

    move-result-object v0
    :try_end_24
    .catch Lkoo; {:try_start_24 .. :try_end_24} :catch_3
    ...
    :goto_18
    invoke-direct {v0, v9}, Lkrn;-><init>(Ljava/lang/String;)V

    .end local v3    # "korVar":Lkor;
    .end local v4    # "i":I
    .end local v5    # "bool":Ljava/lang/Boolean;
    ...
    throw v0
    :try_end_25
    .catch Lkrn; {:try_start_25 .. :try_end_25} :catch_2
    .catch Lkoo; {:try_start_25 .. :try_end_25} :catch_3

    .line 277
    .restart local v3    # "korVar":Lkor;
    .restart local v4    # "i":I
    .restart local v5    # "bool":Ljava/lang/Boolean;
    ...
    :try_end_26
    .catch Lkoo; {:try_start_26 .. :try_end_26} :catch_3
    ...
    throw v0
    :try_end_28
    .catch Lkoo; {:try_start_28 .. :try_end_28} :catch_3
    ...
    invoke-direct {v0, v9, v3}, Lkrn;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V

    .end local v3    # "e6":Lkoo;
    .end local v4    # "i":I
    .end local v5    # "bool":Ljava/lang/Boolean;
    ...
    throw v0
    :try_end_29
    .catch Lkrn; {:try_start_29 .. :try_end_29} :catch_5

    .line 289
    .restart local v3    # "e6":Lkoo;
    .restart local v4    # "i":I
    .restart local v5    # "bool":Ljava/lang/Boolean;
