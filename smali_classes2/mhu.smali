...
.method public final a(Ljava/lang/String;)Lcom/google/android/libraries/lens/lenslite/dynamicloading/DLEngineApi;
    ...
    iget-object v2, v1, Lmhu;->c:Lmhm;

    new-instance v3, Lmhl;

    iget-object v4, v2, Lmhm;->a:Lqkg;

    check-cast v4, Lpyt;

    iget-object v4, v4, Lpyt;->a:Ljava/lang/Object;

    check-cast v4, Landroid/content/Context;

    iget-object v2, v2, Lmhm;->b:Lqkg;
    ...
    invoke-direct {v3, v4, v2, v0}, Lmhl;-><init>(Landroid/content/Context;Ljava/util/Set;Ljava/lang/String;)V

    iget-object v2, v3, Lmhl;->d:Landroid/content/Context;

    iget-object v4, v3, Lmhl;->f:Ljava/lang/String;
    ...
    invoke-static {v2, v4}, Lmhl;->c(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    sget-object v8, Lmhl;->b:Ljava/lang/Object;

    monitor-enter v8

    :try_start_1
    sget-object v9, Lmhl;->c:Ljava/util/Map;
    ...
    iget-object v10, v3, Lmhl;->d:Landroid/content/Context;
    ...
    iget-object v9, v3, Lmhl;->d:Landroid/content/Context;
    ...
    iget-object v11, v3, Lmhl;->d:Landroid/content/Context;
    ...
    iget-object v12, v3, Lmhl;->d:Landroid/content/Context;

    invoke-virtual {v12}, Landroid/content/Context;->getClassLoader()Ljava/lang/ClassLoader;

    move-result-object v12

    sget-object v13, Lmhl;->a:Ljava/util/Set;

    invoke-direct {v6, v12, v13}, Lmhk;-><init>(Ljava/lang/ClassLoader;Ljava/util/Set;)V
    ...
    :goto_1
    sget-object v5, Lmhl;->c:Ljava/util/Map;
    ...
    iget-object v5, v3, Lmhl;->d:Landroid/content/Context;

    invoke-direct {v4, v2, v5}, Lmhj;-><init>(Landroid/content/Context;Landroid/content/Context;)V

    iput-object v4, v3, Lmhl;->g:Landroid/content/Context;

    iget-object v2, v3, Lmhl;->f:Ljava/lang/String;

    iget-object v4, v3, Lmhl;->e:Ljava/util/Set;
    ...
    iget-object v10, v5, Lmhp;->b:Lmip;

    invoke-static {v3}, Lmip;->C(Lmhl;)I

    move-result v10

    int-to-long v10, v10

    iget-object v12, v5, Lmhp;->b:Lmip;

    invoke-static {v3}, Lmip;->B(Lmhl;)I

    move-result v12

    int-to-long v12, v12

    iget-object v5, v5, Lmhp;->a:Lmgr;

    invoke-interface {v5}, Lmgr;->a()Lcom/google/android/libraries/lens/lenslite/api/LinkConfig;
    ...
    invoke-static {v10}, Lmip;->A(I)I

    move-result v11

    iput v11, v9, Lmhx;->a:I
    ...
    invoke-static {v5}, Lmip;->A(I)I

    move-result v15

    iput v15, v14, Lmhx;->a:I
    ...
    iput-object v8, v9, Lmhx;->b:Ljava/lang/String;
    ...
    iget-object v2, v8, Lmhx;->b:Ljava/lang/String;
    ...
    invoke-direct {v0, v2}, Lmhn;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v2}, Lmhl;->b(Ljava/lang/String;)Ljava/lang/Class;
    ...
    invoke-virtual {v3}, Lmhl;->a()Landroid/content/Context;
    ...
    iget-object v6, v1, Lmhu;->b:Landroid/content/Context;
    ...
    invoke-direct {v5, v1, v6}, Lmht;-><init>(Lmhu;I)V
    ...
    invoke-direct {v3, v1, v7}, Lmht;-><init>(Lmhu;I)V
    ...
    :goto_5
    iget-object v3, v1, Lmhu;->b:Landroid/content/Context;
    ...
    invoke-direct {v3, v2, v0}, Lmhn;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v2, v3, v0}, Lmhn;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v0, v3, v2}, Lmho;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
