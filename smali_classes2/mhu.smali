...
.field private final c:Lmhm;


# direct methods
.method public constructor <init>(Landroid/content/Context;Lmhm;Lmgr;)V
    .locals 0
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "mhmVar"    # Lmhm;
    .param p3, "mgrVar"    # Lmgr;

    .line 27
    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    .line 28
    iput-object p1, p0, Lmhu;->b:Landroid/content/Context;

    .line 29
    iput-object p2, p0, Lmhu;->c:Lmhm;

    .line 30
    iput-object p3, p0, Lmhu;->a:Lmgr;
...
.method public final a(Ljava/lang/String;)Lcom/google/android/libraries/lens/lenslite/dynamicloading/DLEngineApi;
    ...
    iget-object v3, v1, Lmhu;->c:Lmhm;

    .line 39
    .local v3, "mhmVar":Lmhm;
    iget-object v0, v3, Lmhm;->b:Lqkg;
    ...
    iget-object v5, v3, Lmhm;->a:Lqkg;

    check-cast v5, Lpyt;

    iget-object v5, v5, Lpyt;->a:Ljava/lang/Object;

    check-cast v5, Landroid/content/Context;

    invoke-direct {v0, v5, v4, v2}, Lmhl;-><init>(Landroid/content/Context;Ljava/util/Set;Ljava/lang/String;)V

    move-object v5, v0

    .line 43
    .local v5, "mhlVar":Lmhl;
    iget-object v6, v5, Lmhl;->d:Landroid/content/Context;

    .line 44
    .local v6, "context":Landroid/content/Context;
    iget-object v7, v5, Lmhl;->f:Ljava/lang/String;
    ...
    iget-object v0, v5, Lmhl;->f:Ljava/lang/String;

    invoke-static {v11, v0}, Lmhl;->c(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v13, Lmhl;->b:Ljava/lang/Object;
    ...
    .line 49
    :try_start_1
    sget-object v0, Lmhl;->c:Ljava/util/Map;
    ...
    iget-object v14, v5, Lmhl;->d:Landroid/content/Context;
    ...
    .line 51
    :try_start_3
    iget-object v0, v5, Lmhl;->d:Landroid/content/Context;
    ...
    .end local v3    # "mhmVar":Lmhm;
    .local v17, "mhmVar":Lmhm;
    :try_start_6
    const-string v3, "!/lib/"
    ...
    .end local v17    # "mhmVar":Lmhm;
    .restart local v3    # "mhmVar":Lmhm;
    :catchall_2
    move-exception v0
    ...
    iget-object v8, v5, Lmhl;->d:Landroid/content/Context;
    ...
    sget-object v9, Lmhl;->a:Ljava/util/Set;

    invoke-direct {v6, v8, v9}, Lmhk;-><init>(Ljava/lang/ClassLoader;Ljava/util/Set;)V
    ...
    .local v0, "dexClassLoader":Ljava/lang/ClassLoader;
    :goto_2
    sget-object v3, Lmhl;->c:Ljava/util/Map;
    ...
    iget-object v3, v5, Lmhl;->d:Landroid/content/Context;

    invoke-direct {v0, v11, v3}, Lmhj;-><init>(Landroid/content/Context;Landroid/content/Context;)V

    iput-object v0, v5, Lmhl;->g:Landroid/content/Context;
    ...
    iget-object v0, v5, Lmhl;->e:Ljava/util/Set;
    ...
    .line 82
    .local v10, "mhpVar":Lmhp;
    iget-object v0, v10, Lmhp;->b:Lmip;

    move-object v13, v0

    .line 83
    .local v13, "mipVar":Lmip;
    invoke-static {v5}, Lmip;->C(Lmhl;)I
    ...
    .line 85
    .local v22, "mipVar2":Lmip;
    invoke-static {v5}, Lmip;->B(Lmhl;)I
    ...
    .local v6, "B":J
    :try_start_d
    iget-object v0, v10, Lmhp;->a:Lmgr;
    ...
    .end local v0    # "c2":C
    .local v25, "c2":C
    invoke-static/range {v18 .. v18}, Lmip;->A(I)I
    ...
    .local v4, "mhxVar":Lmhx;
    goto :goto_6

    .line 105
    .end local v0    # "m4":Lpoy;
    .end local v4    # "mhxVar":Lmhx;
    :cond_b
    :goto_5
    sget-object v0, Lmhx;->c:Lmhx;
    ...
    iput-object v4, v8, Lmhx;->b:Ljava/lang/String;
    ...
    :try_end_e
    .catch Lmhn; {:try_start_e .. :try_end_e} :catch_1
    ...
    iget-object v7, v4, Lmhx;->b:Ljava/lang/String;
    ...
    invoke-direct {v0, v6}, Lmhn;-><init>(Ljava/lang/String;)V

    .end local v3    # "str5":Ljava/lang/String;
    .end local v4    # "mhxVar":Lmhx;
    .end local v5    # "mhlVar":Lmhl;
    .end local v8    # "c2":C
    .end local v10    # "mhpVar":Lmhp;
    ...
    .end local v20    # "mo37get":Ljava/util/Set;
    .end local v21    # "context":Landroid/content/Context;
    .end local v22    # "mipVar2":Lmip;
    .end local v23    # "str2":Ljava/lang/String;
    .end local v25    # "B":J
    .end local p0    # "this":Lmhu;
    .end local p1    # "str":Ljava/lang/String;
    throw v0
    :try_end_f
    .catch Lmhn; {:try_start_f .. :try_end_f} :catch_0
    ...
    .restart local v4    # "mhxVar":Lmhx;
    .restart local v5    # "mhlVar":Lmhl;
    .restart local v8    # "c2":C
    .restart local v10    # "mhpVar":Lmhp;
    ...
    invoke-virtual {v5, v0}, Lmhl;->b(Ljava/lang/String;)Ljava/lang/Class;
    ...
    invoke-virtual {v5}, Lmhl;->a()Landroid/content/Context;
    ...
    iget-object v8, v1, Lmhu;->b:Landroid/content/Context;
    ...
    .line 157
    new-instance v7, Ldefpackage/Pv;

    invoke-direct {v7, v1}, Ldefpackage/Pv;-><init>(Lmhu;)V
    ...
    :cond_10
    new-instance v6, Ldefpackage/Qv;

    invoke-direct {v6, v1}, Ldefpackage/Qv;-><init>(Lmhu;)V
    ...
    iget-object v10, v1, Lmhu;->b:Landroid/content/Context;
    ...
    :goto_b
    invoke-direct {v4, v6, v0}, Lmhn;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v3, v4, v0}, Lmho;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
