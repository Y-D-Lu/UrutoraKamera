...
.method public constructor <init>(Landroid/util/Size;Landroid/util/Size;Landroid/util/Size;Ljava/lang/Integer;ZZLjrz;Ljrl;Ljce;)V
    ...
    .param p5, "z"    # Z
    .param p6, "z2"    # Z
    .param p7, "jrzVar"    # Ljrz;
    .param p8, "jrlVar"    # Ljrl;
    .param p9, "jceVar"    # Ljce;
    ...
    .line 38
    sget-object v0, Ldep;->sh:Ldep;

    sget-object v1, Ldcy;->cd:Lddg;

    invoke-virtual {v0, v1}, Ldep;->k(Lddg;)Z

    move-result v0

    iput-boolean v0, p0, Ljbv;->g:Z
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    .line 60
    .local v1, "jbvVar":Ljbv;
    iget-object v3, p0, Ljbv;->b:Landroid/util/Size;

    .line 61
    .local v3, "size":Landroid/util/Size;
    iget-object v4, v1, Ljbv;->b:Landroid/util/Size;
    ...
    .line 62
    :goto_0
    iget-object v4, p0, Ljbv;->c:Landroid/util/Size;

    .line 63
    .local v4, "size2":Landroid/util/Size;
    iget-object v5, v1, Ljbv;->c:Landroid/util/Size;
    ...
    .line 64
    :goto_1
    iget-object v5, p0, Ljbv;->d:Landroid/util/Size;

    .line 65
    .local v5, "size3":Landroid/util/Size;
    iget-object v6, v1, Ljbv;->d:Landroid/util/Size;
    ...
    .line 66
    :goto_2
    iget-object v6, p0, Ljbv;->e:Ljava/lang/Integer;

    .line 67
    .local v6, "num":Ljava/lang/Integer;
    iget-object v7, v1, Ljbv;->e:Ljava/lang/Integer;
    ...
    .line 68
    :goto_3
    iget-boolean v7, p0, Ljbv;->f:Z

    iget-boolean v8, v1, Ljbv;->f:Z

    if-ne v7, v8, :cond_6

    iget-boolean v7, p0, Ljbv;->g:Z

    iget-boolean v8, v1, Ljbv;->g:Z

    if-ne v7, v8, :cond_6

    iget-object v7, p0, Ljbv;->h:Ljrz;

    iget-object v8, v1, Ljbv;->h:Ljrz;
    ...
    iget-object v7, p0, Ljbv;->i:Ljrl;

    iget-object v8, v1, Ljbv;->i:Ljrl;
    ...
    iget-object v7, p0, Ljbv;->j:Ljce;

    iget-object v8, v1, Ljbv;->j:Ljce;
...
.method public final hashCode()I
    ...
    .line 82
    .local v3, "hashCode":I
    iget-object v5, p0, Ljbv;->c:Landroid/util/Size;
    ...
    iget-object v7, p0, Ljbv;->d:Landroid/util/Size;
    ...
    iget-object v8, p0, Ljbv;->e:Ljava/lang/Integer;
    ...
    iget-object v12, p0, Ljbv;->h:Ljrz;
    ...
    iget-object v12, p0, Ljbv;->i:Ljrl;
