...
.method public constructor <init>(Lohd;Lohw;Ljava/io/PipedInputStream;Ljava/io/PipedOutputStream;Lohf;)V
    ...
    iput-object v0, p0, Lohb;->g:Ljava/util/Optional;
...
.method public final a()V
    ...
    sget-object v2, Logz;->UNINITIALIZED:Logz;
    ...
    sget-object v2, Logz;->INITIALIZING:Logz;
    ...
    sget-object v2, Logz;->READY:Logz;
    ...
    sget-object v2, Logz;->SHUTTING_DOWN:Logz;
    ...
    sget-object v2, Logz;->SHUT_DOWN:Logz;
    ...
    sget-object v2, Logz;->PAUSED:Logz;
    ...
    .line 51
    :cond_6
    iget-object v1, p0, Lohb;->f:Lohf;

    invoke-interface {v1}, Lohf;->flush()V

    .line 52
    iget-object v1, p0, Lohb;->c:Lohd;

    iget-object v1, v1, Lohd;->a:Ljava/util/Optional;

    sget-object v2, Lgui;->f:Lgui;
...
.method public final available()I
    ...
    .line 60
    :try_start_0
    iget-object v2, p0, Lohb;->e:Ljava/io/PipedInputStream;
...
.method public final b()V
    ...
    iget-object v2, v0, Lohd;->b:Ljava/util/Optional;
    ...
    invoke-direct {v3, p0}, Logu;-><init>(Lohb;)V

    iget-object v4, p0, Lohb;->c:Lohd;

    iget-object v4, v4, Lohd;->c:Lphv;

    invoke-direct {v1, v2, v3, v4}, Lohj;-><init>(Ljava/io/InputStream;Logu;Ljava/util/concurrent/ExecutorService;)V

    invoke-static {v1}, Ljava/util/Optional;->of(Ljava/lang/Object;)Ljava/util/Optional;

    move-result-object v1

    iput-object v1, p0, Lohb;->g:Ljava/util/Optional;
...
.method public final d(Lohy;)V
    ...
    .line 100
    .local v1, "z":Z
    iget-object v2, v0, Lohb;->d:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-virtual {v2}, Ljava/util/concurrent/atomic/AtomicReference;->get()Ljava/lang/Object;

    move-result-object v2

    sget-object v3, Logz;->UNINITIALIZED:Logz;
    ...
    sget-object v3, Logz;->INITIALIZING:Logz;
    ...
    sget-object v3, Logz;->READY:Logz;
    ...
    sget-object v3, Logz;->SHUTTING_DOWN:Logz;
    ...
    sget-object v3, Logz;->SHUT_DOWN:Logz;
    ...
    sget-object v3, Logz;->PAUSED:Logz;
    ...
    .line 110
    :cond_4
    iget-object v2, v0, Lohb;->h:Lohw;

    .line 111
    .local v2, "ohwVar":Lohw;
    iget-object v3, v2, Lohw;->b:Lohq;

    iget-boolean v3, v3, Lohq;->b:Z

    if-eqz v3, :cond_9

    .line 112
    iget-object v3, v2, Lohw;->c:Lohr;

    invoke-virtual {v3}, Lohr;->b()V

    .line 113
    sget-object v3, Lpff;->a:Lpff;

    .line 114
    .local v3, "pffVar":Lpff;
    ...
    iget-object v5, v2, Lohw;->g:Ljava/time/Instant;
    ...
    :cond_5
    iget-object v5, v2, Lohw;->b:Lohq;

    iget-object v5, v5, Lohq;->h:Ljava/time/Duration;
    ...
    :goto_2
    iget-object v6, v2, Lohw;->b:Lohq;

    iget-object v6, v6, Lohq;->h:Ljava/time/Duration;
    ...
    .line 116
    iput-object v4, v2, Lohw;->g:Ljava/time/Instant;

    .line 117
    iget-object v5, v2, Lohw;->c:Lohr;

    invoke-virtual {v5}, Lohr;->a()D

    move-result-wide v5

    .line 118
    .local v5, "a2":D
    iget-object v7, v2, Lohw;->b:Lohq;

    .line 119
    .local v7, "ohqVar":Lohq;
    iget v8, v7, Lohq;->d:I
    ...
    :cond_7
    :goto_3
    iget-object v12, v2, Lohw;->k:Loha;

    .line 123
    .local v12, "ohaVar":Loha;
    ...
    invoke-interface {v0, v1, v15}, Lova;->r(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {v0, v14, v1}, Ld;->v(Lova;Ljava/lang/String;C)V

    goto :goto_4

    .line 115
    .end local v5    # "a2":D
    .end local v7    # "ohqVar":Lohq;
    .end local v8    # "d":D
    .end local v10    # "d2":D
    .end local v12    # "ohaVar":Loha;
    ...
    .line 143
    :pswitch_0
    iget-object v3, v2, Lohw;->i:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public final e(D)V
    ...
    invoke-interface {v1, p1, p2}, Lohf;->setRawAudioMixingRatio(D)V
...
.method public final f()V
    ...
    iget-object v2, p0, Lohb;->i:Ljava/lang/Thread;
    ...
    .line 176
    :cond_6
    iget-object v1, p0, Lohb;->h:Lohw;

    invoke-virtual {v1}, Ljava/lang/Thread;->start()V

    .line 177
    iget-object v1, p0, Lohb;->g:Ljava/util/Optional;

    sget-object v2, Lgui;->g:Lgui;
    ...
    sget-object v2, Logz;->PROCESSING:Logz;
...
.method public final g()V
    ...
    sget-object v4, Logz;->SHUT_DOWN:Logz;
    ...
    .line 194
    .local v0, "ohwVar":Lohw;
    iget-object v1, v0, Lohw;->f:Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-virtual {v1, v3}, Ljava/util/concurrent/atomic/AtomicBoolean;->set(Z)V

    .line 195
    iget-object v1, v0, Lohw;->e:Loht;

    check-cast v1, Loho;

    iget-object v1, v1, Loho;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final h()V
    ...
    invoke-static {v3, v5, v4}, Lobr;->aK(ZLjava/lang/String;Ljava/lang/Object;)V

    .line 210
    iget-object v3, p0, Lohb;->f:Lohf;

    invoke-interface {v3, v1, v2}, Lohf;->setAllSpeechMixingRatio(D)V
...
.method public final i(Ljava/nio/ByteBuffer;)V
    ...
    .line 217
    iget-object v1, v0, Lohd;->a:Ljava/util/Optional;

    new-instance v2, Lgui;

    const/4 v3, 0x6

    invoke-direct {v2, v3}, Lgui;-><init>(I)V
    ...
    invoke-interface {v2, v1}, Lohf;->provideRawAudio([B)V
...
.method public final read()I
    ...
    .line 229
    iget-object v3, p0, Lohb;->d:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-virtual {v3}, Ljava/util/concurrent/atomic/AtomicReference;->get()Ljava/lang/Object;

    move-result-object v3

    sget-object v4, Logz;->UNINITIALIZED:Logz;
    ...
    sget-object v4, Logz;->INITIALIZING:Logz;
    ...
    sget-object v4, Logz;->READY:Logz;
    ...
    .line 235
    :try_start_0
    iget-object v3, p0, Lohb;->e:Ljava/io/PipedInputStream;
