...
.method public constructor <init>(Landroidx/preference/PreferenceGroup;)V
    ...
    invoke-direct {v0, p0}, Lahb;-><init>(Lahe;)V

    iput-object v0, p0, Lahe;->i:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, Lahe;->h:Landroid/os/Handler;

    .line 32
    iput-object p1, p0, Lahe;->e:Landroidx/preference/PreferenceGroup;

    .line 33
    iput-object p0, p1, Landroidx/preference/Preference;->C:Lagl;
    ...
    iput-object v0, p0, Lahe;->f:Ljava/util/List;
    ...
    iput-object v0, p0, Lahe;->d:Ljava/util/List;
    ...
    iput-object v0, p0, Lahe;->g:Ljava/util/List;
    ...
    invoke-virtual {p0, v0}, Lpu;->g(Z)V
...
.method private final l(Landroidx/preference/PreferenceGroup;)Ljava/util/List;
    ...
    .line 53
    invoke-static {p1}, Lahe;->n(Landroidx/preference/PreferenceGroup;)Z
    ...
    invoke-static {v6}, Lahe;->n(Landroidx/preference/PreferenceGroup;)Z
    ...
    :cond_5
    :goto_3
    invoke-direct {p0, v6}, Lahe;->l(Landroidx/preference/PreferenceGroup;)Ljava/util/List;
    ...
    invoke-direct {v4, v5, v1, v6, v7}, Lagb;-><init>(Landroid/content/Context;Ljava/util/List;J)V

    .line 81
    .local v4, "agbVar":Lagb;
    new-instance v5, Lahc;

    invoke-direct {v5, p0, p1}, Lahc;-><init>(Lahe;Landroidx/preference/PreferenceGroup;)V

    iput-object v5, v4, Landroidx/preference/Preference;->o:Lagn;

    .line 82
    invoke-virtual {v0, v4}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 84
    .end local v4    # "agbVar":Lagb;
    :cond_a
    return-object v0
.end method
...
.method private final m(Ljava/util/List;Landroidx/preference/PreferenceGroup;)V
    ...
    invoke-direct {v3, v2}, Lahd;-><init>(Landroidx/preference/Preference;)V

    .line 96
    .local v3, "ahdVar":Lahd;
    iget-object v4, p0, Lahe;->g:Ljava/util/List;
    ...
    .line 102
    invoke-direct {p0, p1, v4}, Lahe;->m(Ljava/util/List;Landroidx/preference/PreferenceGroup;)V

    .line 105
    .end local v4    # "preferenceGroup2":Landroidx/preference/PreferenceGroup;
    :cond_1
    iput-object p0, v2, Landroidx/preference/Preference;->C:Lagl;

    .line 92
    .end local v2    # "o":Landroidx/preference/Preference;
    .end local v3    # "ahdVar":Lahd;
...
.method public final a()I
    ...
    .line 115
    iget-object v0, p0, Lahe;->d:Ljava/util/List;
...
.method public final b(I)I
    ...
    invoke-virtual {p0, p1}, Lahe;->j(I)Landroidx/preference/Preference;

    move-result-object v1

    invoke-direct {v0, v1}, Lahd;-><init>(Landroidx/preference/Preference;)V

    .line 121
    .local v0, "ahdVar":Lahd;
    iget-object v1, p0, Lahe;->g:Ljava/util/List;
    ...
    .line 125
    :cond_0
    iget-object v2, p0, Lahe;->g:Ljava/util/List;
    ...
    .line 126
    .local v2, "size":I
    iget-object v3, p0, Lahe;->g:Ljava/util/List;
...
.method public final d(Landroid/view/ViewGroup;I)Lqs;
    ...
    .line 140
    iget-object v0, p0, Lahe;->g:Ljava/util/List;
    ...
    invoke-static {v5, v6}, Ljr;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 150
    invoke-static {v3, v4}, Lgl;->G(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-direct {v6, v3}, Lahm;-><init>(Landroid/view/View;)V
...
.method public final e(Lqs;I)V
    ...
    .line 167
    .local v0, "ahmVar":Lahm;
    invoke-virtual {p0, p2}, Lahe;->j(I)Landroidx/preference/Preference;
    ...
    iget-object v3, v0, Lahm;->s:Landroid/graphics/drawable/Drawable;
    ...
    .line 171
    iget-object v4, v0, Lqs;->a:Landroid/view/View;

    invoke-static {v4, v3}, Lgl;->G(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    .line 173
    :cond_0
    const v4, 0x1020016

    invoke-virtual {v0, v4}, Lahm;->B(I)Landroid/view/View;
    ...
    iget-object v5, v0, Lahm;->t:Landroid/content/res/ColorStateList;
    ...
    iget-object v6, v0, Lahm;->t:Landroid/content/res/ColorStateList;
    ...
    .line 177
    :cond_1
    invoke-virtual {v1, v0}, Landroidx/preference/Preference;->a(Lahm;)V
...
.method public final f()V
    ...
    .line 182
    iget-object v0, p0, Lahe;->h:Landroid/os/Handler;

    iget-object v1, p0, Lahe;->i:Ljava/lang/Runnable;
...
.method public final k()V
    ...
    .line 195
    iget-object v0, p0, Lahe;->f:Ljava/util/List;
    ...
    iput-object v2, v1, Landroidx/preference/Preference;->C:Lagl;
    ...
    iget-object v1, p0, Lahe;->f:Ljava/util/List;
    ...
    .line 200
    iget-object v1, p0, Lahe;->e:Landroidx/preference/PreferenceGroup;

    invoke-direct {p0, v0, v1}, Lahe;->m(Ljava/util/List;Landroidx/preference/PreferenceGroup;)V

    .line 201
    iget-object v1, p0, Lahe;->e:Landroidx/preference/PreferenceGroup;

    invoke-direct {p0, v1}, Lahe;->l(Landroidx/preference/PreferenceGroup;)Ljava/util/List;

    move-result-object v1

    iput-object v1, p0, Lahe;->d:Ljava/util/List;

    .line 202
    iget-object v1, p0, Lahe;->e:Landroidx/preference/PreferenceGroup;

    iget-object v1, v1, Landroidx/preference/Preference;->k:Lahj;

    .line 203
    .local v1, "ahjVar":Lahj;
    iget-object v2, p0, Lpu;->a:Lpv;

    invoke-virtual {v2}, Lpv;->a()V

    .line 204
    iget-object v2, p0, Lahe;->f:Ljava/util/List;
