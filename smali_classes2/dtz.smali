...
.method public constructor <init>(Landroid/content/Context;ZLpyn;Lixj;Ldej;Lemb;Lhrd;Lfjs;Landroid/app/Activity;Llar;Ljue;Ljnr;Livj;Lpyn;Likm;Lbqh;Lhuf;Z[B[B)V
    ...
    .param p4, "ixjVar"    # Lixj;
    .param p5, "dejVar"    # Ldej;
    .param p6, "embVar"    # Lemb;
    .param p7, "hrdVar"    # Lhrd;
    .param p8, "fjsVar"    # Lfjs;
    .param p9, "activity"    # Landroid/app/Activity;
    .param p10, "larVar"    # Llar;
    .param p11, "jueVar"    # Ljue;
    .param p12, "jnrVar"    # Ljnr;
    .param p13, "ivjVar"    # Livj;
    .param p14, "pynVar2"    # Lpyn;
    .param p15, "ikmVar"    # Likm;
    .param p16, "bqhVar"    # Lbqh;
    .param p17, "hufVar"    # Lhuf;
    .param p18, "z2"    # Z
    .param p19, "bArr"    # [B
    .param p20, "bArr2"    # [B
    ...
    iput-boolean v3, v0, Ldtz;->j:Z

    .line 63
    move-object/from16 v4, p3

    iput-object v4, v0, Ldtz;->b:Lpyn;

    .line 64
    move-object/from16 v5, p4

    iput-object v5, v0, Ldtz;->k:Lixj;

    .line 65
    move-object/from16 v6, p5

    iput-object v6, v0, Ldtz;->l:Ldej;

    .line 66
    move-object/from16 v7, p6

    iput-object v7, v0, Ldtz;->w:Lemb;

    .line 67
    move-object/from16 v8, p7

    iput-object v8, v0, Ldtz;->m:Lhrd;

    .line 68
    move-object/from16 v9, p8

    iput-object v9, v0, Ldtz;->n:Lfjs;

    .line 69
    move-object/from16 v10, p10

    iput-object v10, v0, Ldtz;->e:Llar;

    .line 70
    move-object/from16 v11, p16

    iput-object v11, v0, Ldtz;->s:Lbqh;

    .line 71
    move-object/from16 v12, p9

    iput-object v12, v0, Ldtz;->r:Landroid/app/Activity;

    .line 72
    move-object/from16 v13, p11

    iput-object v13, v0, Ldtz;->o:Ljue;

    .line 73
    iget-object v14, v1, Ljnr;->c:Ljus;

    const v15, 0x7f0a00c3

    invoke-virtual {v14, v15}, Ljus;->c(I)Ljava/lang/Object;

    move-result-object v14

    check-cast v14, Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionLayout;

    iput-object v14, v0, Ldtz;->c:Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionLayout;
    ...
    iput-object v14, v0, Ldtz;->d:Lcom/google/android/apps/camera/bottombar/RoundedThumbnailView;

    .line 75
    move-object/from16 v14, p13

    iput-object v14, v0, Ldtz;->p:Livj;

    .line 76
    move-object/from16 v15, p14

    iput-object v15, v0, Ldtz;->q:Lpyn;
...
.method private final i(Landroid/content/Intent;)Lpht;
    ...
    invoke-virtual {v0}, Ldtt;->fV()V

    .line 85
    iget-object v0, p0, Ldtz;->d:Lcom/google/android/apps/camera/bottombar/RoundedThumbnailView;
    ...
    .line 98
    iget-object v4, v2, Lemb;->a:Landroid/app/Activity;
...
.method public final b()V
    ...
    iget-object v4, v0, Likm;->a:Landroid/content/Context;

    iget v5, v0, Likm;->b:I

    invoke-direct {v3, v4, v5}, Lnyj;-><init>(Landroid/content/Context;I)V

    .line 131
    .local v3, "nyjVar":Lnyj;
    const v4, 0x7f1103b1

    invoke-virtual {v3, v4}, Lnyj;->s(I)V

    .line 132
    const v4, 0x7f1103b0

    invoke-virtual {v3, v4}, Lnyj;->l(I)V

    .line 133
    const v4, 0x7f1103be

    new-instance v5, Ldefpackage/Z6;

    invoke-direct {v5, p0, v0}, Ldefpackage/Z6;-><init>(Ldtz;Likm;)V

    invoke-virtual {v3, v4, v5}, Lnyj;->q(ILandroid/content/DialogInterface$OnClickListener;)V

    .line 151
    invoke-virtual {v3, v2, v1}, Lnyj;->n(ILandroid/content/DialogInterface$OnClickListener;)V

    .line 152
    invoke-virtual {v3}, Lid;->c()Lie;

    .line 153
    return-void

    .line 156
    .end local v0    # "ikmVar":Likm;
    .end local v3    # "nyjVar":Lnyj;
    :cond_1
    :try_start_0
    iget-object v0, p0, Ldtz;->o:Ljue;
    ...
    :cond_3
    :goto_0
    iget-object v5, p0, Ldtz;->r:Landroid/app/Activity;
    ...
    invoke-virtual {p0, v4}, Ldtz;->f(Lbue;)Lbty;
    ...
    invoke-static {v5}, Lplk;->U(Ljava/lang/Throwable;)Lpht;
    ...
    :cond_6
    :goto_2
    iget-object v5, p0, Ldtz;->p:Livj;

    invoke-interface {v5}, Livj;->b()Lojc;

    move-result-object v5

    new-instance v6, Ldefpackage/c7;

    invoke-direct {v6, p0, v4}, Ldefpackage/c7;-><init>(Ldtz;Lbty;)V

    invoke-virtual {v5, v6}, Lojc;->b(Loiu;)Lojc;

    move-result-object v5

    new-instance v6, Ldefpackage/b7;

    invoke-direct {v6, p0, v4}, Ldefpackage/b7;-><init>(Ldtz;Lbty;)V

    .line 199
    invoke-virtual {v5, v6}, Lojc;->d(Lojz;)Ljava/lang/Object;
    ...
    sget-object v7, Lbxe;->q:Lbxe;

    sget-object v8, Lpgr;->a:Lpgr;

    .line 162
    invoke-static {v5, v6, v7, v8}, Lpfj;->h(Lpht;Ljava/lang/Class;Loiu;Ljava/util/concurrent/Executor;)Lpht;

    move-result-object v5

    .line 213
    .local v5, "h2":Lpht;
    iput-object v5, p0, Ldtz;->g:Lpht;
    ...
    invoke-direct {v6, v7}, Lcdd;-><init>(I)V

    invoke-static {v5, v6, v8}, Lplk;->af(Lpht;Lphh;Ljava/util/concurrent/Executor;)V
    :try_end_0
    ...
    .end local v3    # "applicationEnabledSetting":I
    .end local v4    # "f":Lbty;
    .end local v5    # "h2":Lpht;
    :catch_0
    move-exception v0

    .line 218
    .local v0, "e":Ljava/lang/IllegalArgumentException;
    sget-object v3, Ljue;->a:Louj;
    ...
    new-instance v5, Ldefpackage/d7;

    invoke-direct {v5, p0, v0}, Ldefpackage/d7;-><init>(Ldtz;Likm;)V
...
.method public final f(Lbue;)Lbty;
    .locals 7
    .param p1, "bueVar"    # Lbue;
    ...
    .line 283
    iget-object v3, p0, Ldtz;->m:Lhrd;

    iget-object v3, v3, Lhrd;->a:Ljava/util/Set;
...
.method public final g(Lbty;)Lpht;
    ...
    .line 303
    .local v8, "btyVar2":Lbty;
    invoke-interface {v8}, Lbty;->a()Lbtz;
    ...
    iget-object v11, v0, Ldtz;->n:Lfjs;

    invoke-interface {v11}, Lfjs;->a()J
    ...
    invoke-static {v2, v13, v14}, Lobr;->aI(ZLjava/lang/String;I)V
    ...
    :cond_b
    invoke-virtual {v1}, Lfmh;->b()I

    move-result v2

    if-lez v2, :cond_8

    iget-object v2, v1, Lfmh;->b:Lfmg;
    ...
    invoke-virtual {v1}, Lfmh;->c()Ljava/lang/String;
    ...
    :cond_c
    sget-object v2, Lhsr;->VIDEO:Lhsr;
    ...
    .line 349
    .local v3, "a3":Lbtz;
    iget-object v14, v0, Ldtz;->f:Lhuf;

    sget-object v15, Lhtu;->ab:Lhuk;
    ...
    .line 354
    :cond_d
    iget-object v14, v0, Ldtz;->m:Lhrd;

    .line 355
    .local v14, "hrdVar":Lhrd;
    invoke-interface {v3}, Lbtz;->d()Lhsp;
    ...
    .end local v1    # "c":Lfmh;
    .local v16, "c":Lfmh;
    iget-object v1, v14, Lhrd;->b:Ljava/util/Map;
    ...
    iget-object v4, v1, Lhsj;->b:Landroid/net/Uri;
    ...
    .local v19, "hsjVar":Lhsj;
    sget-object v1, Lmbs;->c:Lmbs;

    iget-object v1, v1, Lmbs;->i:Ljava/lang/String;
    ...
    .end local v5    # "btxVar":Lbtx;
    .local v20, "btxVar":Lbtx;
    ...
    iget-object v5, v0, Ldtz;->l:Ldej;

    iget-object v5, v5, Ldej;->e:Ljava/lang/String;
    ...
    .line 349
    .end local v14    # "hrdVar":Lhrd;
    .end local v15    # "d2":Lhsp;
    .end local v16    # "c":Lfmh;
    .end local v17    # "isVoiceInteractionRoot":Z
    .end local v19    # "hsjVar":Lhsj;
    .end local v20    # "btxVar":Lbtx;
    .local v1, "c":Lfmh;
    .local v4, "isVoiceInteractionRoot":Z
    .restart local v5    # "btxVar":Lbtx;
    :cond_10
    move-object/from16 v16, v1
    ...
    .end local v4    # "isVoiceInteractionRoot":Z
    .end local v5    # "btxVar":Lbtx;
    .restart local v16    # "c":Lfmh;
    .restart local v17    # "isVoiceInteractionRoot":Z
    .restart local v20    # "btxVar":Lbtx;
    :goto_9
    ...
    .local v1, "hsrVar":Lhsr;
    :goto_a
    iget-object v4, v0, Ldtz;->o:Ljue;

    invoke-virtual {v4}, Ljue;->a()Landroid/content/pm/PackageInfo;
    ...
    :goto_b
    iget-object v15, v0, Ldtz;->n:Lfjs;

    invoke-interface/range {p1 .. p1}, Lbty;->a()Lbtz;

    move-result-object v19

    invoke-interface/range {v19 .. v19}, Lbtz;->j()Z
    ...
    invoke-interface/range {v24 .. v29}, Lfjs;->B(Ljava/lang/String;ZLhsr;Ljava/lang/String;I)V

    .line 375
    invoke-direct {v0, v10}, Ldtz;->i(Landroid/content/Intent;)Lpht;
...
.method public final h(Lbty;)Lpht;
    ...
    new-instance v2, Ldefpackage/e7;

    invoke-direct {v2, p0, v0}, Ldefpackage/e7;-><init>(Ldtz;Lpih;)V

    iget-object v3, p0, Ldtz;->e:Llar;
