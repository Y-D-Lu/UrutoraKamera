...
.method private final aC()V
    ...
    :try_start_0
    iget-object v1, p0, Lpoj;->g:Ljava/io/OutputStream;
...
.method public final e(J)V
    ...
    .line 143
    iget v10, p0, Lpoj;->d:I

    add-int/2addr v10, v6

    iput v10, p0, Lpoj;->d:I
...
.method public final f(II)V
    ...
    invoke-virtual {p0, v0}, Lpoj;->g(I)V
...
.method public final g(I)V
    ...
    invoke-static {v2, v4, v5, v6}, Lprv;->n([BJB)V
...
.method public final h(J)V
    ...
    invoke-static {v0, v9, v10, v11}, Lprv;->n([BJB)V
...
.method public final k([BII)V
    ...
    :cond_1
    :try_start_0
    iget-object v5, p0, Lpoj;->g:Ljava/io/OutputStream;
...
.method public final s(II)V
    ...
    invoke-virtual {p0, v0, v1}, Lpoj;->h(J)V
...
.method public final u(ILpqm;Lprb;)V
    ...
    .line 332
    :cond_0
    invoke-virtual {p0, v1}, Lpoj;->C(I)V
...
.method public final z(Ljava/lang/String;)V
    ...
    invoke-static {p1, v4, v5, v0}, Lprx;->a(Ljava/lang/CharSequence;[BII)I

    move-result v6

    .line 376
    .local v6, "a":I
    invoke-virtual {p0, v6}, Lpoj;->C(I)V

    .line 377
    invoke-virtual {p0, v4, v5, v6}, Lpoj;->k([BII)V
    ...
    iget v5, p0, Lpoj;->c:I
    :try_end_0
    .catch Lprw; {:try_start_0 .. :try_end_0} :catch_3
    ...
    .line 389
    iget-object v7, p0, Lpoj;->a:[B

    iget v8, p0, Lpoj;->b:I

    sub-int/2addr v8, v6

    invoke-static {p1, v7, v6, v8}, Lprx;->a(Ljava/lang/CharSequence;[BII)I
    ...
    .line 392
    .local v8, "b":I
    invoke-virtual {p0, v8}, Lpoj;->g(I)V
    ...
    .line 397
    iget-object v6, p0, Lpoj;->a:[B

    iget v7, p0, Lpoj;->c:I

    invoke-static {p1, v6, v7, v8}, Lprx;->a(Ljava/lang/CharSequence;[BII)I
    ...
    .catch Lprw; {:try_start_1 .. :try_end_1} :catch_0
    ...
    .end local p0    # "this":Lpoj;
    .end local p1    # "str":Ljava/lang/String;
    throw v6
    :try_end_2
    .catch Lprw; {:try_start_2 .. :try_end_2} :catch_3

    .line 400
    .end local v6    # "e2":Lprw;
    .restart local p0    # "this":Lpoj;
    ...
    invoke-direct {v7, v6}, Lpol;-><init>(Ljava/lang/Throwable;)V
    ...
    throw v7
    :try_end_3
    .catch Lpol; {:try_start_3 .. :try_end_3} :catch_2
    .catch Lprw; {:try_start_3 .. :try_end_3} :catch_3
    ...
    :try_end_4
    .catch Lprw; {:try_start_4 .. :try_end_4} :catch_3

    .line 410
    .end local v6    # "e":Ljava/lang/ArrayIndexOutOfBoundsException;
    .end local v7    # "ex":Lpol;
    nop
