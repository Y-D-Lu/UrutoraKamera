...
.method public b()Lie;
    ...
    iget-object v2, v0, Lid;->a:Lhz;

    iget-object v2, v2, Lhz;->a:Landroid/content/Context;

    iget v3, v0, Lid;->b:I

    invoke-direct {v1, v2, v3}, Lie;-><init>(Landroid/content/Context;I)V

    .line 36
    .local v1, "ieVar":Lie;
    iget-object v8, v0, Lid;->a:Lhz;

    .line 37
    .local v8, "hzVar":Lhz;
    iget-object v9, v1, Lie;->a:Lic;

    .line 38
    .local v9, "icVar":Lic;
    iget-object v10, v8, Lhz;->e:Landroid/view/View;
    ...
    .line 40
    iput-object v10, v9, Lic;->x:Landroid/view/View;

    goto :goto_0

    .line 42
    :cond_0
    iget-object v2, v8, Lhz;->d:Ljava/lang/CharSequence;
    ...
    .line 44
    invoke-virtual {v9, v2}, Lic;->a(Ljava/lang/CharSequence;)V

    .line 46
    :cond_1
    iget-object v3, v8, Lhz;->c:Landroid/graphics/drawable/Drawable;
    ...
    .line 48
    iput-object v3, v9, Lic;->t:Landroid/graphics/drawable/Drawable;

    .line 49
    iput v11, v9, Lic;->s:I

    .line 50
    iget-object v4, v9, Lic;->u:Landroid/widget/ImageView;
    ...
    .line 53
    iget-object v5, v9, Lic;->u:Landroid/widget/ImageView;
    ...
    :cond_2
    :goto_0
    iget-object v12, v8, Lhz;->f:Ljava/lang/CharSequence;
    ...
    .line 59
    iput-object v12, v9, Lic;->e:Ljava/lang/CharSequence;

    .line 60
    iget-object v2, v9, Lic;->w:Landroid/widget/TextView;
    ...
    :cond_3
    iget-object v13, v8, Lhz;->g:Ljava/lang/CharSequence;
    ...
    iget-object v3, v8, Lhz;->h:Landroid/content/DialogInterface$OnClickListener;

    invoke-virtual {v9, v2, v13, v3}, Lic;->e(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)V

    .line 69
    :cond_4
    iget-object v14, v8, Lhz;->i:Ljava/lang/CharSequence;
    ...
    iget-object v3, v8, Lhz;->j:Landroid/content/DialogInterface$OnClickListener;

    invoke-virtual {v9, v2, v14, v3}, Lic;->e(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)V

    .line 73
    :cond_5
    iget-object v2, v8, Lhz;->n:[Ljava/lang/CharSequence;
    ...
    iget-object v2, v8, Lhz;->o:Landroid/widget/ListAdapter;

    if-eqz v2, :cond_e

    .line 74
    :cond_6
    iget-object v2, v8, Lhz;->b:Landroid/view/LayoutInflater;
    ...
    iget-object v4, v8, Lhz;->a:Landroid/content/Context;

    iget v5, v9, Lic;->D:I

    iget-object v3, v8, Lhz;->n:[Ljava/lang/CharSequence;
    ...
    invoke-direct/range {v2 .. v7}, Lhw;-><init>(Lhz;Landroid/content/Context;I[Ljava/lang/CharSequence;Landroid/support/v7/app/AlertController$RecycleListView;)V
    ...
    .local v2, "i":I
    :goto_1
    iget-object v3, v8, Lhz;->o:Landroid/widget/ListAdapter;
    ...
    iget-object v5, v8, Lhz;->a:Landroid/content/Context;

    iget-object v6, v8, Lhz;->n:[Ljava/lang/CharSequence;

    invoke-direct {v4, v5, v2, v6}, Lib;-><init>(Landroid/content/Context;I[Ljava/lang/CharSequence;)V
    ...
    .local v2, "listAdapter":Landroid/widget/ListAdapter;
    :goto_2
    iput-object v2, v9, Lic;->y:Landroid/widget/ListAdapter;
    ...
    .line 86
    iget-object v3, v8, Lhz;->p:Landroid/content/DialogInterface$OnClickListener;
    ...
    invoke-direct {v3, v8, v9}, Lhx;-><init>(Lhz;Lic;)V
    ...
    iget-object v3, v8, Lhz;->w:Landroid/content/DialogInterface$OnMultiChoiceClickListener;
    ...
    invoke-direct {v3, v8, v4, v9}, Lhy;-><init>(Lhz;Landroid/support/v7/app/AlertController$RecycleListView;Lic;)V
    ...
    :cond_d
    :goto_4
    iput-object v4, v9, Lic;->f:Landroid/widget/ListView;

    .line 98
    .end local v2    # "listAdapter":Landroid/widget/ListAdapter;
    .end local v4    # "alertController$RecycleListView":Landroid/support/v7/app/AlertController$RecycleListView;
    :cond_e
    iget-object v2, v8, Lhz;->r:Landroid/view/View;
    ...
    .line 100
    iput-object v2, v9, Lic;->g:Landroid/view/View;

    .line 101
    iput v11, v9, Lic;->h:I

    .line 102
    iput-boolean v11, v9, Lic;->i:Z
    ...
    iput-object v4, v9, Lic;->g:Landroid/view/View;
    ...
    iget-object v3, v3, Lhz;->l:Landroid/content/DialogInterface$OnDismissListener;
    ...
    iget-object v3, v3, Lhz;->m:Landroid/content/DialogInterface$OnKeyListener;
