...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I[B)V
    ...
    invoke-direct {v1, p0, v0}, Lpj;-><init>(Lpk;I)V

    iput-object v1, p0, Lpk;->n:Lpj;

    .line 59
    new-instance v1, Lpi;

    invoke-direct {v1, p0}, Lpi;-><init>(Lpk;)V

    iput-object v1, p0, Lpk;->u:Lpi;

    .line 60
    new-instance v1, Lph;

    invoke-direct {v1, p0}, Lph;-><init>(Lpk;)V

    iput-object v1, p0, Lpk;->v:Lph;
    ...
    invoke-direct {v1, p0, v2}, Lpj;-><init>(Lpk;I)V

    iput-object v1, p0, Lpk;->y:Lpj;
    ...
    iput-object v1, p0, Lpk;->w:Landroid/graphics/Rect;
    ...
    iput-object v1, p0, Lpk;->o:Landroid/os/Handler;

    .line 65
    sget-object v1, Ljq;->n:[I
    ...
    invoke-direct {v3, p1, p2, p3}, Lmz;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    .line 74
    .local v3, "mzVar":Lmz;
    iput-object v3, p0, Lpk;->q:Landroid/widget/PopupWindow;
...
.method public e(Landroid/widget/ListAdapter;)V
    ...
    invoke-direct {v1, p0}, Lpg;-><init>(Lpk;)V

    iput-object v1, p0, Lpk;->t:Landroid/database/DataSetObserver;
    ...
    .line 105
    iget-object v1, p0, Lpk;->t:Landroid/database/DataSetObserver;
...
.method public final s()V
    ...
    .line 174
    iget-object v1, v0, Lpk;->a:Landroid/content/Context;

    iget-boolean v3, v0, Lpk;->p:Z

    xor-int/2addr v3, v2

    invoke-virtual {v0, v1, v3}, Lpk;->p(Landroid/content/Context;Z)Lom;

    move-result-object v1

    .line 175
    .local v1, "p":Lom;
    iput-object v1, v0, Lpk;->e:Lom;

    .line 176
    iget-object v3, v0, Lpk;->b:Landroid/widget/ListAdapter;

    invoke-virtual {v1, v3}, Landroid/widget/ListView;->setAdapter(Landroid/widget/ListAdapter;)V

    .line 177
    iget-object v3, v0, Lpk;->e:Lom;

    iget-object v4, v0, Lpk;->m:Landroid/widget/AdapterView$OnItemClickListener;
    ...
    invoke-direct {v4, v0}, Lpf;-><init>(Lpk;)V
    ...
    .line 184
    :cond_0
    iget-object v1, v0, Lpk;->q:Landroid/widget/PopupWindow;
    ...
    .line 189
    iget-object v4, v0, Lpk;->w:Landroid/graphics/Rect;
    ...
    :cond_2
    :goto_1
    iget-object v5, v0, Lpk;->q:Landroid/widget/PopupWindow;

    iget-object v6, v0, Lpk;->l:Landroid/view/View;
    ...
    :pswitch_0
    iget-object v9, v0, Lpk;->a:Landroid/content/Context;
    ...
    iget-object v11, v0, Lpk;->w:Landroid/graphics/Rect;
    ...
    .end local v8    # "makeMeasureSpec":I
    :pswitch_1
    iget-object v8, v0, Lpk;->a:Landroid/content/Context;
    ...
    iget-object v9, v0, Lpk;->w:Landroid/graphics/Rect;
    ...
    .line 214
    :goto_3
    iget-object v9, v0, Lpk;->e:Lom;

    invoke-virtual {v9, v8, v5}, Lom;->b(II)I
    ...
    .local v6, "paddingTop":I
    :goto_5
    invoke-virtual/range {p0 .. p0}, Lpk;->w()Z

    move-result v8

    .line 218
    .local v8, "w":Z
    iget-object v9, v0, Lpk;->q:Landroid/widget/PopupWindow;

    iget v11, v0, Lpk;->r:I

    invoke-static {v9, v11}, Lhr;->b(Landroid/widget/PopupWindow;I)V
    ...
    .line 220
    iget-object v9, v0, Lpk;->l:Landroid/view/View;

    invoke-static {v9}, Lgl;->U(Landroid/view/View;)Z
    ...
    .line 227
    iget-object v12, v0, Lpk;->l:Landroid/view/View;
    ...
    .line 235
    iget-object v11, v0, Lpk;->q:Landroid/widget/PopupWindow;
    ...
    .line 238
    :cond_b
    iget-object v10, v0, Lpk;->q:Landroid/widget/PopupWindow;
    ...
    .line 249
    iget-object v13, v0, Lpk;->q:Landroid/widget/PopupWindow;

    iget-object v14, v0, Lpk;->l:Landroid/view/View;
    ...
    .line 256
    iget-object v10, v0, Lpk;->l:Landroid/view/View;
    ...
    iget-boolean v11, v0, Lpk;->h:Z

    invoke-static {v2, v11}, Lhr;->a(Landroid/widget/PopupWindow;Z)V

    .line 272
    :cond_16
    iget-object v2, v0, Lpk;->q:Landroid/widget/PopupWindow;

    iget-object v11, v0, Lpk;->x:Landroid/graphics/Rect;
    ...
    iget-object v11, v0, Lpk;->l:Landroid/view/View;
    ...
    invoke-static {v2, v11, v12, v13, v14}, Lhq;->a(Landroid/widget/PopupWindow;Landroid/view/View;III)V

    .line 274
    iget-object v2, v0, Lpk;->e:Lom;
    ...
    invoke-virtual {v2}, Lom;->isInTouchMode()Z
    ...
    .line 276
    :cond_17
    invoke-virtual/range {p0 .. p0}, Lpk;->q()V
    ...
    .line 281
    :cond_19
    iget-object v2, v0, Lpk;->o:Landroid/os/Handler;

    iget-object v7, v0, Lpk;->y:Lpj;
