...
.method public final a(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
    ...
    iget-object v0, p0, Lsu;->f:Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Lsu;->b:Landroid/graphics/Rect;
    ...
    iget-object v5, p0, Lsu;->c:Landroid/text/TextPaint;
    ...
    invoke-virtual {p0, v5}, Lsu;->f(Landroid/text/TextPaint;)V
    ...
    iget-object v6, p0, Lsu;->c:Landroid/text/TextPaint;
    ...
    iget-object v4, p0, Lsu;->f:Ljava/lang/CharSequence;
    ...
    iget-object v4, p0, Lsu;->k:Landroid/text/TextUtils$TruncateAt;
    ...
    iget-object v7, p0, Lsu;->f:Ljava/lang/CharSequence;
    ...
    :goto_4
    iput-object v4, p0, Lsu;->d:Ljava/lang/String;
    ...
    iget-object v4, p0, Lsu;->l:Landroid/text/Layout$Alignment;
    ...
    iput-object v0, p0, Lsu;->h:Landroid/text/StaticLayout;

    iput-boolean v3, p0, Lsu;->p:Z

    iput-boolean v1, p0, Lsu;->q:Z

    :cond_a
    iget-boolean v0, p0, Lsu;->q:Z
    ...
    invoke-virtual {p0}, Lsu;->h()Z

    move-result p2

    xor-int/lit8 v9, p2, 0x1

    iget-object p2, p0, Lsu;->b:Landroid/graphics/Rect;
    ...
    :goto_7
    iget-object v4, p0, Lsu;->b:Landroid/graphics/Rect;

    invoke-virtual {v4}, Landroid/graphics/Rect;->height()I

    move-result v4

    iget-object v5, p0, Lsu;->b:Landroid/graphics/Rect;

    invoke-virtual {v5}, Landroid/graphics/Rect;->height()I

    move-result v5

    iget-object v6, p0, Lsu;->m:Landroid/graphics/Rect;

    iget-object v7, p0, Lsu;->b:Landroid/graphics/Rect;
    ...
    iget-object p2, p0, Lsu;->h:Landroid/text/StaticLayout;
    ...
    iget-object v7, p0, Lsu;->m:Landroid/graphics/Rect;

    iget-object v8, p0, Lsu;->n:Landroid/graphics/Rect;

    invoke-static/range {v4 .. v9}, Landroid/view/Gravity;->apply(IIILandroid/graphics/Rect;Landroid/graphics/Rect;I)V

    iput-boolean v3, p0, Lsu;->q:Z

    :cond_e
    invoke-virtual {p1}, Landroid/graphics/Canvas;->save()I

    iget-object p2, p0, Lsu;->n:Landroid/graphics/Rect;

    iget p2, p2, Landroid/graphics/Rect;->left:I

    int-to-float p2, p2

    iget-object v0, p0, Lsu;->n:Landroid/graphics/Rect;
...
.method public final d(Z)V
    ...
    iget-object p1, p0, Lsu;->d:Ljava/lang/String;
