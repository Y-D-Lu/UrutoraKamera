...
.method public final call()Ljava/lang/Object;
    ...
    iget-object v2, v1, Lmps;->a:Lmrh;

    .line 27
    .local v2, "mrhVar":Lmrh;
    iget-object v3, v1, Lmps;->b:Lmov;

    .line 28
    .local v3, "movVar":Lmov;
    const/4 v0, 0x1

    invoke-static {v0, v0}, Lmmf;->d(II)Lmme;
    ...
    :goto_0
    invoke-direct {v5, v6}, Lmow;-><init>(Ljava/lang/String;)V
    ...
    :goto_1
    invoke-direct {v5, v7}, Lmow;-><init>(Ljava/lang/String;)V

    .end local v2    # "mrhVar":Lmrh;
    .end local v3    # "movVar":Lmov;
    .end local v4    # "d":Lmme;
    .end local v14    # "eglGetDisplay":Landroid/opengl/EGLDisplay;
    .end local p0    # "this":Lmps;
    throw v5

    .line 39
    .end local v0    # "valueOf2":Ljava/lang/String;
    .restart local v2    # "mrhVar":Lmrh;
    .restart local v3    # "movVar":Lmov;
    .restart local v4    # "d":Lmme;
    .restart local v14    # "eglGetDisplay":Landroid/opengl/EGLDisplay;
    .restart local p0    # "this":Lmps;
    :cond_3
    monitor-exit v6
    :try_end_0
    ...
    .line 79
    new-instance v9, Lmow;

    invoke-virtual {v0}, Ljava/lang/StringBuilder;->toString()Ljava/lang/String;

    move-result-object v1

    invoke-direct {v9, v1}, Lmow;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v9, v0, v5}, Lmrh;-><init>(II)V

    iget-object v0, v3, Lmov;->a:Lmoq;

    invoke-static {v0, v4}, Lmwp;->p(Lmoq;Lmmf;)Lmoq;
    ...
    .line 83
    .local v0, "mqrVar":Lmqr;
    iget-object v1, v0, Lmqh;->a:Lmrh;

    invoke-virtual {v1, v2}, Lmrh;->compareTo(Ljava/lang/Object;)I
    ...
    .line 95
    invoke-static {v2}, Lmow;->a(Lmrh;)Lmow;
    ...
    invoke-direct {v7, v8}, Lmow;-><init>(Ljava/lang/String;)V
