...
.method public static d(Lpht;)V
    .locals 2
    .param p0, "phtVar"    # Lpht;

    .line 705
    new-instance v0, Ldefpackage/bx;

    invoke-direct {v0, p0}, Ldefpackage/bx;-><init>(Lpht;)V
...
.method public static e(Lqbd;Lqmj;)Lqbd;
    .locals 4
    .param p0, "qbdVar"    # Lqbd;
    ...
    invoke-direct {v1, p1}, Lnml;-><init>(Lqmj;)V

    invoke-direct {v0, v1}, Lqdx;-><init>(Ljava/util/concurrent/Callable;)V

    .line 719
    .local v0, "qdxVar":Lqdx;
    ...
    invoke-direct {v2, p0, v0}, Lqdu;-><init>(Lqbf;Lqbf;)V

    .line 721
    .local v2, "qduVar":Lqdu;
    sget-object v3, Lqmd;->n:Lqco;
...
.method public static f(Lqbd;Lqmj;)Lqbu;
    .locals 3
    .param p0, "qbdVar"    # Lqbd;
    .param p1, "qmjVar"    # Lqmj;
    ...
    invoke-direct {v0, v1}, Lqhc;-><init>(Ljava/util/concurrent/Callable;)V

    .line 727
    .local v0, "qhcVar":Lqhc;
    sget-object v1, Lqmd;->m:Lqco;

    .line 728
    .local v1, "qcoVar":Lqco;
    invoke-virtual {p0, v0}, Lqbd;->c(Lqbw;)Lqbu;
...
.method public static g(Lqbd;Ljava/lang/Throwable;)Lqbu;
    .locals 1
    .param p0, "qbdVar"    # Lqbd;
...
.method public static h(Lpht;)Lqbu;
    .locals 3
    .param p0, "phtVar"    # Lpht;
    ...
    invoke-direct {v1}, Lqke;-><init>()V

    .line 740
    .local v1, "qkeVar":Lqke;
    new-instance v2, Lnmm;

    invoke-direct {v2, v1}, Lnmm;-><init>(Lqke;)V

    invoke-static {p0, v2, v0}, Lplk;->af(Lpht;Lphh;Ljava/util/concurrent/Executor;)V
...
.method public static j(Ljava/util/List;Lnmc;Ljava/util/List;)V
    .locals 7
    .param p0, "list"    # Ljava/util/List;
    .param p1, "nmcVar"    # Lnmc;
    ...
    iget-object v2, v2, Lpnj;->c:Lpnc;

    .line 753
    .local v2, "pncVar":Lpnc;
    if-nez v2, :cond_0

    .line 754
    sget-object v2, Lpnc;->g:Lpnc;
    ...
    .line 757
    .end local v2    # "pncVar":Lpnc;
    goto :goto_0

    .line 758
    :cond_1
    invoke-static {v0}, Lond;->c(Ljava/lang/Iterable;)Lond;

    move-result-object v2

    sget-object v3, Lmcz;->f:Lmcz;

    invoke-virtual {v2, v3}, Lond;->b(Lojf;)Lond;

    move-result-object v2

    sget-object v3, Lnlq;->b:Lnlq;

    invoke-virtual {v2, v3}, Lond;->d(Loiu;)Lond;

    move-result-object v2

    .line 759
    .local v2, "d":Lond;
    invoke-virtual {v2}, Lond;->e()Ljava/lang/Iterable;
    ...
    sget-object v3, Lnlq;->c:Lnlq;

    invoke-virtual {v2, v3}, Lond;->d(Loiu;)Lond;

    move-result-object v3

    sget-object v4, Lmcz;->e:Lmcz;

    invoke-virtual {v3, v4}, Lond;->b(Lojf;)Lond;

    move-result-object v3

    invoke-virtual {v3}, Lond;->e()Ljava/lang/Iterable;

    move-result-object v3

    invoke-static {v3}, Lohh;->q(Ljava/lang/Iterable;)I
    ...
    sget-object v4, Lmcz;->c:Lmcz;

    invoke-virtual {v3, v4}, Lond;->b(Lojf;)Lond;

    move-result-object v3

    sget-object v4, Lmcz;->d:Lmcz;

    invoke-virtual {v3, v4}, Lond;->b(Lojf;)Lond;

    move-result-object v3

    sget-object v4, Lnlq;->a:Lnlq;

    invoke-virtual {v3, v4}, Lond;->d(Loiu;)Lond;

    move-result-object v3

    sget-object v4, Limd;->t:Limd;

    invoke-virtual {v3, v4}, Lond;->d(Loiu;)Lond;

    move-result-object v3

    sget-object v4, Limd;->s:Limd;
    ...
    invoke-static {v3}, Loom;->i(Ljava/lang/Iterable;)Loom;
    ...
    invoke-virtual {p1, v3}, Lnmc;->j(Loom;)V

    .line 763
    invoke-virtual {p1}, Lnmc;->a()Lnme;
