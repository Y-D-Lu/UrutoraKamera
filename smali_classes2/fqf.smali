...
.method public constructor <init>(Llis;Ljava/lang/String;)V
    ...
    :goto_0
    invoke-interface {p1, v1}, Llis;->a(Ljava/lang/String;)Llis;

    move-result-object v1

    iput-object v1, p0, Lfqf;->a:Llis;
...
.method public final b(Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V
    ...
    .line 47
    :try_start_0
    iget-object v5, v4, Lmss;->b:Landroid/media/MediaCodec$BufferInfo;

    iget-wide v5, v5, Landroid/media/MediaCodec$BufferInfo;->presentationTimeUs:J

    iput-wide v5, p0, Lfqf;->c:J

    .line 48
    iget-wide v5, p0, Lfqf;->e:J
    ...
    iput-wide v7, p0, Lfqf;->e:J

    .line 50
    iget-object v7, p0, Lfqf;->b:Ljava/util/HashMap;
    ...
    .line 51
    iget-object v7, p0, Lfqf;->h:Ljava/util/List;
    ...
    .line 53
    invoke-virtual {v8, v4, v5, v6}, Lfqe;->c(Lmss;J)V

    .line 55
    :cond_0
    invoke-virtual {v8}, Lfqe;->b()V

    .line 56
    .end local v8    # "fqeVar":Lfqe;
    goto :goto_0
...
.method public final declared-synchronized c()V
    ...
    .line 67
    iget-object v6, v1, Lfqf;->b:Ljava/util/HashMap;
    ...
    .line 72
    iget-object v6, v1, Lfqf;->h:Ljava/util/List;
    ...
    .line 73
    .local v11, "fqeVar":Lfqe;
    iget-object v12, v1, Lfqf;->a:Llis;

    .line 74
    .local v12, "lisVar2":Llis;
    ...
    invoke-interface {v12, v8}, Llis;->b(Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 81
    .end local v11    # "fqeVar":Lfqe;
    .end local v12    # "lisVar2":Llis;
...
.method public final declared-synchronized close()V
    ...
    .line 88
    .local v1, "fqeVar":Lfqe;
    invoke-virtual {v1}, Lfqe;->b()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 89
    .end local v1    # "fqeVar":Lfqe;
    goto :goto_0
...
.method public final declared-synchronized d(J)V
    ...
    iget-object v1, p0, Lfqf;->h:Ljava/util/List;
    ...
    .line 112
    .local v2, "fqeVar":Lfqe;
    iget-boolean v3, v2, Lfqe;->e:Z
    ...
    iput-wide v7, p0, Lfqf;->i:J

    .line 108
    iget-wide v7, p0, Lfqf;->d:J

    add-long/2addr v7, v2

    iput-wide v7, p0, Lfqf;->d:J
    :try_end_1
...
.method public final declared-synchronized e(Lmln;J)Lfqe;
    ...
    .line 124
    .local v0, "fqeVar":Lfqe;
    iget-object v1, p0, Lfqf;->g:Lpih;
