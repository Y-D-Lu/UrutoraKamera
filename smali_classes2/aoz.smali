...
.method public constructor <init>(Landroid/content/Context;Laof;)V
    ...
    iput-object v1, p0, Laoz;->c:Landroid/app/job/JobScheduler;

    .line 36
    iput-object v0, p0, Laoz;->e:Laoy;
...
.method public static a(Landroid/content/Context;)V
    ...
    invoke-static {v0, v4}, Laoz;->i(Landroid/app/job/JobScheduler;I)V
...
.method public static f(Landroid/content/Context;Laof;)Z
    ...
    invoke-static {p0, v3}, Laoz;->h(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/List;

    move-result-object v4

    .line 53
    .local v4, "h":Ljava/util/List;, "Ljava/util/List<Landroid/app/job/JobInfo;>;"
    iget-object v0, v2, Laof;->d:Landroidx/work/impl/WorkDatabase;
    ...
    invoke-static {v0, v7}, Lais;->a(Ljava/lang/String;I)Lais;

    move-result-object v8

    .line 56
    .local v8, "a2":Lais;
    iget-object v0, v5, Laqk;->a:Laii;
    ...
    invoke-static {v0, v8, v7}, Lfy;->i(Laii;Lajw;Z)Landroid/database/Cursor;
    ...
    invoke-static {v12}, Laoz;->g(Landroid/app/job/JobInfo;)Ljava/lang/String;
    ...
    invoke-static {v3, v14}, Laoz;->i(Landroid/app/job/JobScheduler;I)V
    ...
    invoke-interface {v0, v14, v1, v2}, Laqu;->j(Ljava/lang/String;J)V
...
.method public final b(Ljava/lang/String;)V
    ...
    .line 159
    .local v3, "jobInfo":Landroid/app/job/JobInfo;
    invoke-static {v3}, Laoz;->g(Landroid/app/job/JobInfo;)Ljava/lang/String;
    ...
    iget-object v4, p0, Laoz;->c:Landroid/app/job/JobScheduler;

    invoke-virtual {v3}, Ljava/lang/Integer;->intValue()I

    move-result v5

    invoke-static {v4, v5}, Laoz;->i(Landroid/app/job/JobScheduler;I)V
    ...
    .line 171
    :cond_4
    iget-object v2, p0, Laoz;->d:Laof;

    iget-object v2, v2, Laof;->d:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v2}, Landroidx/work/impl/WorkDatabase;->u()Laqk;

    move-result-object v2

    invoke-virtual {v2, p1}, Laqk;->c(Ljava/lang/String;)V
...
.method public final varargs c([Laqt;)V
    ...
    .line 185
    sget-object v7, Laoz;->a:Ljava/lang/String;
    ...
    iget-object v9, v5, Laqt;->a:Ljava/lang/String;
    ...
    invoke-static {v7, v8, v9}, Lkus;->k(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v7, v9}, Laqk;->a(Ljava/lang/String;)Laqh;
    ...
    .end local v8    # "i":I
    :cond_2
    iget-object v9, p0, Laoz;->d:Laof;

    iget-object v9, v9, Laof;->c:Lamj;

    iget v9, v9, Lamj;->d:I

    .line 197
    .local v9, "i2":I
    const-class v10, Larm;
    ...
    invoke-virtual {v1, v11}, Larm;->a(Ljava/lang/String;)I
    ...
    invoke-virtual {v1, v12, v8}, Larm;->b(Ljava/lang/String;I)V
    ...
    invoke-virtual {v9}, Landroidx/work/impl/WorkDatabase;->u()Laqk;

    move-result-object v9

    new-instance v10, Laqh;

    iget-object v11, v5, Laqt;->a:Ljava/lang/String;

    invoke-direct {v10, v11, v8}, Laqh;-><init>(Ljava/lang/String;I)V

    invoke-virtual {v9, v10}, Laqk;->b(Laqh;)V

    .line 210
    :cond_4
    invoke-virtual {p0, v5, v8}, Laoz;->e(Laqt;I)V

    .line 211
    invoke-virtual {v0}, Laii;->j()V

    .line 213
    .end local v7    # "a3":Laqh;
    .end local v8    # "i":I
    :goto_3
    ...
    .line 217
    .end local v6    # "a2":Laqt;
    nop

    .line 179
    .end local v5    # "aqtVar":Laqt;
    add-int/lit8 v4, v4, 0x1

    goto/16 :goto_0

    .line 205
    .restart local v5    # "aqtVar":Laqt;
    .restart local v6    # "a2":Laqt;
    .restart local v7    # "a3":Laqh;
    ...
    .end local v1    # "armVar":Larm;
    .end local v5    # "aqtVar":Laqt;
    .end local p0    # "this":Laoz;
    .end local p1    # "aqtVarArr":[Laqt;
    :try_start_4
    throw v2
    :try_end_4
    ...
    .restart local v1    # "armVar":Larm;
    .restart local v5    # "aqtVar":Laqt;
    .restart local p0    # "this":Laoz;
    .restart local p1    # "aqtVarArr":[Laqt;
    :catchall_1
    move-exception v2
...
.method public final e(Laqt;I)V
    ...
    iget-object v3, v1, Laoz;->e:Laoy;

    .line 229
    .local v3, "aoyVar":Laoy;
    iget-object v4, v2, Laqt;->i:Laml;

    .line 230
    .local v4, "amlVar":Laml;
    ...
    iget-object v0, v2, Laqt;->a:Ljava/lang/String;
    ...
    .line 232
    invoke-virtual/range {p1 .. p1}, Laqt;->d()Z
    ...
    invoke-static {v8}, Lge;->c(I)Ljava/lang/String;
    ...
    .line 270
    :cond_2
    invoke-virtual/range {p1 .. p1}, Laqt;->a()J
    ...
    .line 278
    .local v14, "ammVar":Lamm;
    new-instance v15, Landroid/app/job/JobInfo$TriggerContentUri;

    iget-object v11, v14, Lamm;->a:Landroid/net/Uri;

    iget-boolean v9, v14, Lamm;->b:Z
    ...
    iget-object v15, v2, Laqt;->a:Ljava/lang/String;
    ...
    invoke-virtual {v14, v0}, Lkus;->h([Ljava/lang/Throwable;)V

    .line 295
    :try_start_0
    iget-object v0, v1, Laoz;->c:Landroid/app/job/JobScheduler;
    ...
    .end local v3    # "aoyVar":Laoy;
    .local v19, "aoyVar":Laoy;
    :try_start_1
    new-array v3, v10, [Ljava/lang/Object;

    iget-object v10, v2, Laqt;->a:Ljava/lang/String;
    :try_end_1
    ...
    .end local v4    # "amlVar":Laml;
    .local v20, "amlVar":Laml;
    :try_start_2
    ...
    invoke-static {v0, v3, v10}, Lkus;->k(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
    ...
    .line 306
    invoke-virtual/range {p0 .. p2}, Laoz;->e(Laqt;I)V
    :try_end_2
    ...
    .line 316
    .end local v20    # "amlVar":Laml;
    .restart local v4    # "amlVar":Laml;
    :catchall_1
    move-exception v0
    ...
    .line 316
    .end local v19    # "aoyVar":Laoy;
    .end local v20    # "amlVar":Laml;
    .restart local v3    # "aoyVar":Laoy;
    .restart local v4    # "amlVar":Laml;
    :catchall_2
    move-exception v0
    ...
    .end local v4    # "amlVar":Laml;
    .local v0, "th":Ljava/lang/Throwable;
    .restart local v19    # "aoyVar":Laoy;
    .restart local v20    # "amlVar":Laml;
    :goto_6
    invoke-static {}, Lkus;->l()Lkus;

    .line 318
    sget-object v3, Laoz;->a:Ljava/lang/String;
    ...
    invoke-static {v3, v10, v4}, Lkus;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
    ...
    .restart local v20    # "amlVar":Laml;
    :goto_8
    iget-object v3, v1, Laoz;->b:Landroid/content/Context;

    iget-object v4, v1, Laoz;->c:Landroid/app/job/JobScheduler;

    invoke-static {v3, v4}, Laoz;->h(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/List;
    ...
    iget-object v15, v1, Laoz;->d:Laof;

    iget-object v15, v15, Laof;->c:Lamj;

    iget v15, v15, Lamj;->e:I
    ...
    invoke-interface {v3}, Laqu;->c()Ljava/util/List;
    ...
    invoke-static {v3, v2, v1}, Lkus;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
