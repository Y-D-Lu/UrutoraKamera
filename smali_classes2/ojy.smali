...
# static fields
.field private static final a:Lojx;

.field private static final b:Lojx;
...
.method public static constructor <clinit>()V
    ...
    .line 16
    sget-object v1, Loik;->a:Loir;

    invoke-static {v1}, Lojq;->c(Loir;)Lojq;

    .line 17
    const-string v1, "\u0091\u0092\u2018\u2019"

    invoke-static {v1}, Loir;->e(Ljava/lang/CharSequence;)V
    ...
    invoke-static {v6, v7}, Loir;->f(CC)V
    ...
    invoke-direct {v6}, Lojw;-><init>()V

    .line 277
    .local v6, "ojwVar":Lojw;
    const-string v7, "&lt;"

    invoke-virtual {v6, v2, v7}, Lojw;->a(CLjava/lang/String;)V

    .line 278
    const-string v2, "&gt;"

    invoke-virtual {v6, v4, v2}, Lojw;->a(CLjava/lang/String;)V
    ...
    invoke-static {v3, v7}, Lobr;->az(ILjava/util/Set;)V
    ...
    invoke-static {v3, v8, v7}, Lobr;->aA(IILjava/util/Set;)V
    ...
    invoke-static {v3, v5, v7}, Lobr;->aA(IILjava/util/Set;)V
    ...
    .line 323
    invoke-static {v0, v7}, Lobr;->az(ILjava/util/Set;)V
    ...
    invoke-static {v0, v5, v7}, Lobr;->aA(IILjava/util/Set;)V
    ...
    invoke-static {v5, v7}, Lobr;->az(ILjava/util/Set;)V
    ...
    invoke-static {v8, v7}, Lobr;->az(ILjava/util/Set;)V

    .line 334
    invoke-static {v7}, Lobr;->ay(Ljava/util/Set;)Lojx;

    move-result-object v8

    .line 335
    .local v8, "ay":Lojx;
    sput-object v8, Lojy;->a:Lojx;
    ...
    invoke-static {v0, v9}, Lobr;->az(ILjava/util/Set;)V
    ...
    invoke-static {v3, v0, v9}, Lobr;->aA(IILjava/util/Set;)V

    .line 340
    invoke-static {v9}, Lobr;->ay(Ljava/util/Set;)Lojx;

    move-result-object v0

    .line 341
    .local v0, "ay2":Lojx;
    sput-object v0, Lojy;->b:Lojx;
    ...
    invoke-static {v0, v3}, Lobr;->aB(Lojx;Ljava/util/Set;)V

    .line 344
    invoke-static {v8, v3}, Lobr;->aB(Lojx;Ljava/util/Set;)V

    .line 345
    invoke-static {v3}, Lobr;->ay(Ljava/util/Set;)Lojx;

    .line 346
    .end local v0    # "ay2":Lojx;
    .end local v1    # "hashMap":Ljava/util/HashMap;
    .end local v2    # "i":I
    .end local v3    # "hashSet4":Ljava/util/HashSet;
    .end local v4    # "hashSet":Ljava/util/HashSet;
    .end local v6    # "ojwVar":Lojw;
    .end local v7    # "hashSet2":Ljava/util/HashSet;
    .end local v8    # "ay":Lojx;
