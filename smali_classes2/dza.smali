...
.method public constructor <init>(Landroid/util/SizeF;Llig;Llig;ILenm;Lenr;Ljava/util/Set;)V
    ...
    .param p4, "i"    # I
    .param p5, "enmVar"    # Lenm;
    .param p6, "enrVar"    # Lenr;
    ...
    .end local v3    # "i2":I
    :cond_0
    iget-object v3, p0, Ldza;->f:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public final e(Ljava/lang/String;JJJLlig;[FZ)[F
    ...
    iget-object v5, v0, Ldza;->k:Ljava/util/Set;
    ...
    iget-object v5, v0, Ldza;->g:Lenr;

    move-wide/from16 v10, p6

    invoke-interface {v5, v8, v9, v10, v11}, Lenr;->b(JJ)[F
    ...
    invoke-interface {v5, v8, v9}, Lenr;->a(J)[F
