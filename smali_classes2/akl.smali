...
.method public constructor <init>(Lakl;Lwy;)V
    ...
    .line 71
    :cond_0
    iget-object v4, p1, Lakl;->j:Landroid/graphics/Matrix;

    invoke-virtual {v0, v4}, Landroid/graphics/Matrix;->set(Landroid/graphics/Matrix;)V

    .line 72
    iget-object v4, p1, Lakl;->b:Ljava/util/ArrayList;
    ...
    instance-of v7, v6, Lakl;

    if-eqz v7, :cond_1

    .line 76
    iget-object v7, p0, Lakl;->b:Ljava/util/ArrayList;

    new-instance v8, Lakl;

    move-object v9, v6

    check-cast v9, Lakl;

    invoke-direct {v8, v9, p2}, Lakl;-><init>(Lakl;Lwy;)V
    ...
    invoke-direct {v7, v8}, Lakk;-><init>(Lakk;)V

    .local v7, "akjVar":Lakm;
    goto :goto_1

    .line 80
    .end local v7    # "akjVar":Lakm;
    :cond_2
    instance-of v7, v6, Lakj;

    if-eqz v7, :cond_4

    .line 83
    new-instance v7, Lakj;

    move-object v8, v6

    check-cast v8, Lakj;

    invoke-direct {v7, v8}, Lakj;-><init>(Lakj;)V

    .line 85
    .restart local v7    # "akjVar":Lakm;
    :goto_1
    iget-object v8, p0, Lakl;->b:Ljava/util/ArrayList;

    invoke-virtual {v8, v7}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 86
    iget-object v8, v7, Lakm;->n:Ljava/lang/String;
    ...
    .line 88
    invoke-virtual {p2, v8, v7}, Lxf;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
