...
.field private final b:Ldha;

.field private c:D


# direct methods
.method public constructor <init>(Llir;Ldha;)V
    .locals 2
    ...
    iput-object p1, p0, Lgru;->a:Llis;

    iput-object p2, p0, Lgru;->b:Ldha;
...
.method public final a(Llzv;DD)V
    ...
    invoke-interface {p1, p4}, Llzv;->d(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-interface {p1, p5}, Llzv;->d(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-interface {p5, v0, v1, v2, v3}, Ldha;->b(JJ)V

    :cond_0
    iget-wide p4, p0, Lgru;->c:D
    ...
    invoke-interface {p1, p4}, Llis;->f(Ljava/lang/String;)V
