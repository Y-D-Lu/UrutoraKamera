...
.method public constructor <init>(Lfqf;Lmln;J)V
    ...
    :goto_0
    iget-wide v4, p1, Lfqf;->e:J

    cmp-long p2, v0, v4

    if-gez p2, :cond_1

    iget-object p2, p1, Lfqf;->b:Ljava/util/HashMap;
    ...
    iget-object p2, p2, Lmss;->b:Landroid/media/MediaCodec$BufferInfo;
...
.method public final a(JZ)V
    ...
    :goto_0
    iget-object p3, p0, Lfqe;->f:Lfqf;

    iget-wide v5, p3, Lfqf;->e:J

    cmp-long v7, v1, v5

    if-gez v7, :cond_5

    iget-wide v5, p3, Lfqf;->d:J
    ...
    invoke-interface {p3, v5}, Llis;->h(Ljava/lang/String;)V

    goto :goto_1

    :cond_1
    iget-object p3, p3, Lfqf;->b:Ljava/util/HashMap;
    ...
    iget-object v5, p3, Lmss;->b:Landroid/media/MediaCodec$BufferInfo;
    ...
    :cond_3
    invoke-virtual {p0, p3, v1, v2}, Lfqe;->c(Lmss;J)V
...
.method public final b()V
    ...
    iget-boolean v0, v0, Lfqf;->f:Z

    if-nez v0, :cond_1

    iget-wide v0, p0, Lfqe;->a:J
...
.method public final c(Lmss;J)V
    ...
    iget-object v1, p1, Lmss;->a:Ljava/nio/ByteBuffer;

    iget-object p1, p1, Lmss;->b:Landroid/media/MediaCodec$BufferInfo;

    invoke-interface {v0, v1, p1}, Lmln;->b(Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V
