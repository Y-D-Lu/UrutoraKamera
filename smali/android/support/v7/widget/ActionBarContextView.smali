...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p0, p3}, Lgl;->G(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    const/4 p3, 0x5

    invoke-virtual {p1, p3, p2}, Lrn;->f(II)I

    move-result p3

    iput p3, p0, Landroid/support/v7/widget/ActionBarContextView;->p:I
    ...
    iput p3, p0, Landroid/support/v7/widget/ActionBarContextView;->q:I
    ...
    invoke-virtual {p1, p2, p3}, Lrn;->f(II)I
...
.method public final h(Ljw;)V
    ...
    invoke-direct {v2, p1}, Llw;-><init>(Ljw;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lmh;
    ...
    invoke-direct {v0, v2}, Lmh;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lmh;

    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lmh;

    invoke-virtual {v0}, Lmh;->p()V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lmh;

    iget-object v3, p0, Landroid/support/v7/widget/ActionBarContextView;->b:Landroid/content/Context;

    check-cast p1, Lkw;

    invoke-virtual {p1, v2, v3}, Lkw;->h(Llk;Landroid/content/Context;)V

    iget-object p1, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lmh;

    iget-object v2, p1, Lmh;->f:Llm;

    iget-object v3, p1, Lkj;->f:Llm;

    if-nez v3, :cond_3

    iget-object v3, p1, Lkj;->d:Landroid/view/LayoutInflater;
    ...
    iput-object v1, p1, Lkj;->f:Llm;

    iget-object v1, p1, Lkj;->f:Llm;

    iget-object v3, p1, Lkj;->c:Lkw;

    invoke-interface {v1, v3}, Llm;->a(Lkw;)V
    ...
    invoke-virtual {v2, p1}, Landroid/support/v7/widget/ActionMenuView;->k(Lmh;)V
    ...
    invoke-static {p1, v1}, Lgl;->G(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
...
.method public final onDetachedFromWindow()V
    ...
    invoke-super {p0}, Llu;->onDetachedFromWindow()V
...
.method public final onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    :cond_0
    invoke-super {p0, p1}, Llu;->onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
...
.method protected final onLayout(ZIIII)V
    ...
    invoke-static {v3, v0, v1, p5, p1}, Landroid/support/v7/widget/ActionBarContextView;->g(Landroid/view/View;IIIZ)I
    ...
    invoke-static {p3, v0, v1, p5, p1}, Landroid/support/v7/widget/ActionBarContextView;->g(Landroid/view/View;IIIZ)I
    ...
    invoke-static {p3, p2, v1, p5, p1}, Landroid/support/v7/widget/ActionBarContextView;->g(Landroid/view/View;IIIZ)I
...
.method protected final onMeasure(II)V
    ...
    invoke-static {v6, v2, v5}, Landroid/support/v7/widget/ActionBarContextView;->f(Landroid/view/View;II)I
