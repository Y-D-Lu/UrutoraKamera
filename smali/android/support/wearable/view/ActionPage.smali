...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iget-object v15, v0, Landroid/support/wearable/view/ActionPage;->b:Lth;

    invoke-virtual {v2, v6}, Landroid/content/res/TypedArray;->getColorStateList(I)Landroid/content/res/ColorStateList;

    move-result-object v6

    iput-object v6, v15, Lth;->b:Landroid/content/res/ColorStateList;

    iget-object v6, v15, Lth;->a:Landroid/graphics/drawable/ShapeDrawable;

    invoke-virtual {v6}, Landroid/graphics/drawable/ShapeDrawable;->getPaint()Landroid/graphics/Paint;

    move-result-object v6

    iget-object v15, v15, Lth;->b:Landroid/content/res/ColorStateList;
    ...
    iget-object v4, v15, Lth;->c:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v6, v15, Lth;->c:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v15}, Lth;->requestLayout()V

    invoke-virtual {v15}, Lth;->invalidate()V
    ...
    iget-object v6, v0, Landroid/support/wearable/view/ActionPage;->b:Lth;
    ...
    iget-object v4, v6, Lth;->c:Landroid/graphics/drawable/Drawable;

    if-eqz v4, :cond_5

    invoke-virtual {v6}, Lth;->invalidate()V

    invoke-virtual {v6}, Lth;->requestLayout()V
    ...
    invoke-virtual {v6, v4}, Lth;->b(I)V
    ...
    invoke-virtual {v4, v6}, Lth;->a(F)V
    ...
    iget-object v6, v0, Landroid/support/wearable/view/ActionPage;->a:Ltd;
    ...
    iget-object v15, v6, Ltd;->c:Ljava/lang/CharSequence;
    ...
    iput-object v8, v6, Ltd;->a:Landroid/text/Layout;

    iput-object v4, v6, Ltd;->c:Ljava/lang/CharSequence;

    invoke-virtual {v6}, Ltd;->requestLayout()V

    invoke-virtual {v6}, Ltd;->invalidate()V
    ...
    invoke-virtual {v6}, Ltd;->getContext()Landroid/content/Context;
    ...
    iput-object v15, v6, Ltd;->b:Landroid/content/res/ColorStateList;

    invoke-virtual {v6}, Ltd;->e()V
    ...
    invoke-virtual {v6, v4}, Ltd;->b(I)V
    ...
    iget-object v15, v0, Landroid/support/wearable/view/ActionPage;->a:Ltd;

    invoke-virtual {v2, v4, v3}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v4

    invoke-virtual {v15, v4}, Ltd;->a(I)V
    ...
    invoke-virtual {v15, v4}, Lth;->setStateListAnimator(Landroid/animation/StateListAnimator;)V
    ...
    iget-object v1, v0, Landroid/support/wearable/view/ActionPage;->a:Ltd;
    ...
    iget-object v2, v1, Ltd;->a:Landroid/text/Layout;

    if-eqz v2, :cond_1c

    iput-object v8, v1, Ltd;->a:Landroid/text/Layout;

    invoke-virtual {v1}, Ltd;->requestLayout()V

    invoke-virtual {v1}, Ltd;->invalidate()V

    :cond_1c
    iget-object v1, v0, Landroid/support/wearable/view/ActionPage;->a:Ltd;

    invoke-virtual {v1, v14, v12, v13}, Ltd;->d(Ljava/lang/String;II)V

    iget-object v1, v0, Landroid/support/wearable/view/ActionPage;->a:Ltd;

    invoke-virtual {v0, v1}, Landroid/support/wearable/view/ActionPage;->addView(Landroid/view/View;)V

    iget-object v1, v0, Landroid/support/wearable/view/ActionPage;->b:Lth;
...
.method protected final onLayout(ZIIII)V
    ...
    iget-object p1, p0, Landroid/support/wearable/view/ActionPage;->b:Lth;
    ...
    invoke-virtual {p1, p3, p5, v0, v1}, Lth;->layout(IIII)V
    ...
    iget-object p2, p0, Landroid/support/wearable/view/ActionPage;->a:Ltd;

    iget-object p3, p0, Landroid/support/wearable/view/ActionPage;->b:Lth;

    invoke-virtual {p3}, Lth;->getBottom()I
    ...
    iget-object p5, p0, Landroid/support/wearable/view/ActionPage;->b:Lth;

    invoke-virtual {p5}, Lth;->getBottom()I
    ...
    invoke-virtual {p2, p1, p3, p4, p5}, Ltd;->layout(IIII)V
...
.method protected final onMeasure(II)V
    ...
    iget-object v1, v0, Lth;->c:Landroid/graphics/drawable/Drawable;

    if-eqz v1, :cond_0

    const/4 v1, 0x0

    invoke-virtual {v0, v1, v1}, Lth;->measure(II)V

    iget-object v0, p0, Landroid/support/wearable/view/ActionPage;->b:Lth;

    invoke-virtual {v0}, Lth;->getMeasuredWidth()I

    move-result v0

    iget-object v1, p0, Landroid/support/wearable/view/ActionPage;->b:Lth;

    invoke-virtual {v1}, Lth;->getMeasuredHeight()I
    ...
    invoke-virtual {v1, v0, v2}, Lth;->measure(II)V
    ...
    iget-object p1, p0, Landroid/support/wearable/view/ActionPage;->a:Ltd;
    ...
    invoke-virtual {p1, p2, v0}, Ltd;->measure(II)V
...
.method public final setEnabled(Z)V
    ...
    invoke-virtual {v0, p1}, Lth;->setEnabled(Z)V
...
.method public final setOnClickListener(Landroid/view/View$OnClickListener;)V
    ...
    invoke-virtual {v0, p1}, Lth;->setOnClickListener(Landroid/view/View$OnClickListener;)V
...
.method public final setStateListAnimator(Landroid/animation/StateListAnimator;)V
    ...
    invoke-virtual {v0, p1}, Lth;->setStateListAnimator(Landroid/animation/StateListAnimator;)V
