...
.method public synthetic constructor <init>(Landroid/os/Parcel;Lsk;)V
    .locals 0
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v8, v0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mComplicationRenderer:Lsq;
    ...
    iget-object v6, v8, Lsq;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    iget-object v6, v8, Lsq;->c:Landroid/graphics/Rect;
    ...
    iget-object v3, v8, Lsq;->w:Lsp;

    iget-boolean v6, v3, Lsp;->j:Z

    if-ne v6, v4, :cond_1

    iget-boolean v3, v3, Lsp;->k:Z
    ...
    iget-object v6, v8, Lsq;->z:Lsr;

    invoke-direct {v3, v6, v12, v4, v5}, Lsp;-><init>(Lsr;ZZZ)V

    iput-object v3, v8, Lsq;->w:Lsp;
    ...
    :cond_3
    iget-object v3, v8, Lsq;->v:Lsp;

    move-object v10, v3

    :goto_0
    iget-object v3, v8, Lsq;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    iget-object v3, v8, Lsq;->l:Lsu;

    invoke-virtual {v3, v12}, Lsu;->e(I)V

    iget-object v3, v8, Lsq;->l:Lsu;

    iget-object v5, v8, Lsq;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    iget-object v6, v8, Lsq;->a:Landroid/content/Context;
    ...
    invoke-virtual {v3, v5}, Lsu;->g(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v3, v4}, Lsu;->g(Ljava/lang/CharSequence;)V
    ...
    iget-object v4, v8, Lsq;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    iget-object v5, v8, Lsq;->a:Landroid/content/Context;
    ...
    invoke-virtual {v3, v1}, Lsu;->g(Ljava/lang/CharSequence;)V

    iget-object v1, v8, Lsq;->l:Lsu;

    invoke-virtual {v1, v12}, Lsu;->e(I)V

    goto :goto_2

    :cond_6
    iget-object v1, v8, Lsq;->m:Lsu;

    invoke-virtual {v1, v4}, Lsu;->g(Ljava/lang/CharSequence;)V

    iget-object v1, v8, Lsq;->l:Lsu;

    invoke-virtual {v1, v11}, Lsu;->e(I)V

    :cond_7
    :goto_2
    invoke-virtual/range {p1 .. p1}, Landroid/graphics/Canvas;->save()I

    iget-object v1, v8, Lsq;->c:Landroid/graphics/Rect;

    iget v1, v1, Landroid/graphics/Rect;->left:I

    int-to-float v1, v1

    iget-object v2, v8, Lsq;->c:Landroid/graphics/Rect;
    ...
    iget-object v1, v10, Lsp;->h:Lsr;

    invoke-virtual {v8, v1}, Lsq;->a(Lsr;)I

    move-result v1

    int-to-float v2, v1

    iget-object v3, v8, Lsq;->o:Landroid/graphics/RectF;

    iget-object v4, v10, Lsp;->f:Landroid/graphics/Paint;

    invoke-virtual {v7, v3, v2, v2, v4}, Landroid/graphics/Canvas;->drawRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/Paint;)V

    iget-object v2, v10, Lsp;->h:Lsr;

    iget-object v2, v2, Lsr;->c:Landroid/graphics/drawable/Drawable;

    if-eqz v2, :cond_8

    invoke-virtual {v10}, Lsp;->a()Z

    move-result v2

    if-nez v2, :cond_8

    iget-object v2, v8, Lsq;->i:Lst;

    iget-object v3, v10, Lsp;->h:Lsr;

    iget-object v3, v3, Lsr;->c:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v2, v3}, Lst;->a(Landroid/graphics/drawable/Drawable;)V

    iget-object v2, v8, Lsq;->i:Lst;

    iput v1, v2, Lst;->b:I

    iget-object v1, v8, Lsq;->n:Landroid/graphics/Rect;

    invoke-virtual {v2, v1}, Lst;->setBounds(Landroid/graphics/Rect;)V

    iget-object v1, v8, Lsq;->i:Lst;

    invoke-virtual {v1, v7}, Lst;->draw(Landroid/graphics/Canvas;)V

    :cond_8
    iget-object v1, v8, Lsq;->p:Landroid/graphics/Rect;
    ...
    :cond_9
    iget-object v1, v8, Lsq;->d:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, v8, Lsq;->e:Landroid/graphics/drawable/Drawable;
    ...
    :cond_a
    iget-object v3, v10, Lsp;->l:Landroid/graphics/ColorFilter;

    invoke-virtual {v1, v3}, Landroid/graphics/drawable/Drawable;->setColorFilter(Landroid/graphics/ColorFilter;)V

    iget-object v3, v8, Lsq;->p:Landroid/graphics/Rect;
    ...
    :cond_b
    :goto_3
    iget-object v1, v8, Lsq;->q:Landroid/graphics/Rect;
    ...
    iget-object v1, v8, Lsq;->k:Lst;

    iget-object v3, v8, Lsq;->f:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1, v3}, Lst;->a(Landroid/graphics/drawable/Drawable;)V

    iget-object v1, v8, Lsq;->f:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, v8, Lsq;->g:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1, v3}, Lst;->a(Landroid/graphics/drawable/Drawable;)V

    iget-object v1, v8, Lsq;->g:Landroid/graphics/drawable/Drawable;
    ...
    :cond_e
    :goto_4
    iget-object v1, v8, Lsq;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    invoke-virtual {v1, v3}, Lst;->setColorFilter(Landroid/graphics/ColorFilter;)V
    ...
    iget-object v2, v2, Lsr;->j:Landroid/graphics/ColorFilter;

    invoke-virtual {v1, v2}, Lst;->setColorFilter(Landroid/graphics/ColorFilter;)V

    iget-object v1, v8, Lsq;->k:Lst;

    iget-object v2, v10, Lsp;->h:Lsr;

    iget-object v3, v8, Lsq;->q:Landroid/graphics/Rect;

    invoke-virtual {v8, v2, v3}, Lsq;->b(Lsr;Landroid/graphics/Rect;)I
    ...
    iget-object v2, v8, Lsq;->q:Landroid/graphics/Rect;

    invoke-virtual {v1, v2}, Lst;->setBounds(Landroid/graphics/Rect;)V
    ...
    :cond_10
    :goto_6
    iget-object v1, v8, Lsq;->r:Landroid/graphics/Rect;
    ...
    iget-object v1, v8, Lsq;->j:Lst;

    iget-object v2, v8, Lsq;->h:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1, v2}, Lst;->a(Landroid/graphics/drawable/Drawable;)V

    iget-object v1, v8, Lsq;->j:Lst;

    iget-object v2, v10, Lsp;->h:Lsr;

    iget-object v3, v8, Lsq;->r:Landroid/graphics/Rect;
    ...
    iget-object v2, v8, Lsq;->r:Landroid/graphics/Rect;
    ...
    :cond_12
    :goto_7
    iget-object v1, v8, Lsq;->u:Landroid/graphics/RectF;
    ...
    iget-object v2, v8, Lsq;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    iget-object v1, v10, Lsp;->c:Landroid/graphics/Paint;
    ...
    iget-object v2, v8, Lsq;->u:Landroid/graphics/RectF;
    ...
    iget-object v6, v10, Lsp;->c:Landroid/graphics/Paint;
    ...
    iget-object v6, v10, Lsp;->d:Landroid/graphics/Paint;
    ...
    :goto_9
    iget-object v1, v8, Lsq;->s:Landroid/graphics/Rect;
    ...
    :cond_15
    iget-object v1, v8, Lsq;->x:Landroid/text/TextPaint;

    iget-object v2, v10, Lsp;->a:Landroid/text/TextPaint;

    if-eq v1, v2, :cond_16

    iput-object v2, v8, Lsq;->x:Landroid/text/TextPaint;

    iget-object v1, v8, Lsq;->l:Lsu;

    iget-object v2, v8, Lsq;->x:Landroid/text/TextPaint;

    invoke-virtual {v1, v2}, Lsu;->f(Landroid/text/TextPaint;)V

    iget-object v1, v8, Lsq;->l:Lsu;

    iget-boolean v2, v10, Lsp;->i:Z

    invoke-virtual {v1, v2}, Lsu;->d(Z)V

    :cond_16
    iget-object v1, v8, Lsq;->l:Lsu;

    iget-object v2, v8, Lsq;->s:Landroid/graphics/Rect;

    invoke-virtual {v1, v7, v2}, Lsu;->a(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V

    :goto_a
    iget-object v1, v8, Lsq;->t:Landroid/graphics/Rect;
    ...
    :cond_17
    iget-object v1, v8, Lsq;->y:Landroid/text/TextPaint;

    iget-object v2, v10, Lsp;->b:Landroid/text/TextPaint;

    if-eq v1, v2, :cond_18

    iput-object v2, v8, Lsq;->y:Landroid/text/TextPaint;

    iget-object v1, v8, Lsq;->m:Lsu;

    iget-object v2, v8, Lsq;->y:Landroid/text/TextPaint;
    ...
    iget-object v2, v8, Lsq;->t:Landroid/graphics/Rect;
    ...
    iget-object v2, v8, Lsq;->o:Landroid/graphics/RectF;

    iget-object v3, v10, Lsp;->g:Landroid/graphics/Paint;
    ...
    iget-object v3, v10, Lsp;->e:Landroid/graphics/Paint;
...
.method getComplicationRenderer()Lsq;
    .locals 1
...
.method public onTap(II)Z
    ...
    :cond_0
    iget-object v0, v0, Lsq;->b:Landroid/support/wearable/complications/ComplicationData;
...
.method public setContext(Landroid/content/Context;)V
    ...
    :goto_0
    iget-object p1, p0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mComplicationRenderer:Lsq;

    iget-boolean v0, p0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mRangedValueProgressHidden:Z

    invoke-virtual {p1, v0}, Lsq;->f(Z)V
    ...
    invoke-virtual {p1, v0}, Lsq;->h(Landroid/graphics/Rect;)V
...
.method public setNoDataText(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, v0}, Lsq;->e(Ljava/lang/CharSequence;)V
