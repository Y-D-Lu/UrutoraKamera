...
.method public static read(Laks;)Landroid/support/v4/graphics/drawable/IconCompat;
    ...
    invoke-virtual {p0, v1, v3}, Laks;->b(Landroid/os/Parcelable;I)Landroid/os/Parcelable;
    ...
    invoke-virtual {p0, v1, v4}, Laks;->a(II)I
    ...
    invoke-virtual {p0, v1, v4}, Laks;->b(Landroid/os/Parcelable;I)Landroid/os/Parcelable;
    ...
    invoke-virtual {p0, v1, v4}, Laks;->e(Ljava/lang/String;I)Ljava/lang/String;

    move-result-object v1

    iput-object v1, v0, Landroid/support/v4/graphics/drawable/IconCompat;->j:Ljava/lang/String;

    iget-object v1, v0, Landroid/support/v4/graphics/drawable/IconCompat;->k:Ljava/lang/String;
    ...
    iget-object p0, v0, Landroid/support/v4/graphics/drawable/IconCompat;->j:Ljava/lang/String;

    invoke-static {p0}, Landroid/graphics/PorterDuff$Mode;->valueOf(Ljava/lang/String;)Landroid/graphics/PorterDuff$Mode;

    move-result-object p0

    iput-object p0, v0, Landroid/support/v4/graphics/drawable/IconCompat;->i:Landroid/graphics/PorterDuff$Mode;

    iget p0, v0, Landroid/support/v4/graphics/drawable/IconCompat;->b:I
    ...
    :pswitch_1
    iget-object p0, v0, Landroid/support/v4/graphics/drawable/IconCompat;->d:[B
    ...
    iget-object p0, v0, Landroid/support/v4/graphics/drawable/IconCompat;->k:Ljava/lang/String;

    if-nez p0, :cond_4

    iget-object p0, v0, Landroid/support/v4/graphics/drawable/IconCompat;->c:Ljava/lang/Object;
    ...
    :pswitch_3
    iget-object p0, v0, Landroid/support/v4/graphics/drawable/IconCompat;->e:Landroid/os/Parcelable;
    ...
    iput v3, v0, Landroid/support/v4/graphics/drawable/IconCompat;->b:I

    iput v1, v0, Landroid/support/v4/graphics/drawable/IconCompat;->f:I

    array-length p0, p0

    iput p0, v0, Landroid/support/v4/graphics/drawable/IconCompat;->g:I
...
.method public static write(Landroid/support/v4/graphics/drawable/IconCompat;Laks;)V
    ...
    invoke-virtual {p1, v1}, Laks;->p(I)V

    iget-object v1, p1, Laks;->d:Landroid/os/Parcel;
    ...
    invoke-virtual {p1, v0, v1}, Laks;->j(Ljava/lang/String;I)V

    :cond_6
    iget-object p0, p0, Landroid/support/v4/graphics/drawable/IconCompat;->k:Ljava/lang/String;

    if-eqz p0, :cond_7

    const/16 v0, 0x8

    invoke-virtual {p1, p0, v0}, Laks;->j(Ljava/lang/String;I)V
