...
.method private final a(III)Z
    ...
    invoke-static {p1}, Lgl;->X(Landroid/view/View;)Z

    move-result v0

    if-eqz v0, :cond_3

    invoke-static {p1}, Lgl;->j(Landroid/view/View;)I

    move-result v0

    invoke-static {p1}, Lgl;->i(Landroid/view/View;)I

    move-result v2

    invoke-static {p1, v0, p2, v2, p3}, Lgl;->O(Landroid/view/View;IIII)V
