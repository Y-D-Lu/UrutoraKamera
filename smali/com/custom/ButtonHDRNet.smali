...
.method public UpdateUi(Landroid/content/Context;)V
    ...
    sget v3, Lcom/custom/ButtonHDRNet;->SelState:I

    packed-switch v3, :pswitch_data_0

    :goto_0
    invoke-virtual {p0}, Lcom/custom/ButtonHDRNet;->invalidate()V

    return-void

    :pswitch_0
    invoke-virtual {p0}, Lcom/custom/ButtonHDRNet;->getResources()Landroid/content/res/Resources;

    move-result-object v3

    const-string v4, "hdrnet_off"
    ...
    invoke-virtual {p0, v0}, Lcom/custom/ButtonHDRNet;->setBackgroundResource(I)V
    ...
    invoke-virtual {p0, v1}, Lcom/custom/ButtonHDRNet;->setBackgroundResource(I)V
...
.method public getVisibility()V
    ...
    const-string v1, "pref_show_button_hdrnet"
    ...
    invoke-virtual {p0, v0}, Lcom/custom/ButtonHDRNet;->setVisibility(I)V
...
.method public init(Landroid/content/Context;)V
    ...
    invoke-virtual {p0}, Lcom/custom/ButtonHDRNet;->getVisibility()V
    ...
    invoke-virtual {p0, v0}, Lcom/custom/ButtonHDRNet;->setOnCheckedChangeListener(Landroid/widget/CompoundButton$OnCheckedChangeListener;)V

    iget-object v0, p0, Lcom/custom/ButtonHDRNet;->myClickListener:Landroid/view/View$OnClickListener;

    invoke-virtual {p0, v0}, Lcom/custom/ButtonHDRNet;->setOnClickListener(Landroid/view/View$OnClickListener;)V
