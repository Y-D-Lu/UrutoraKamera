...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-object v0, Lbhy;->a:Ljava/util/concurrent/locks/Lock;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0, v2}, Landroid/graphics/Paint;-><init>(I)V

    sput-object v0, Lbhy;->d:Landroid/graphics/Paint;
...
.method public static c(Lbcv;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    invoke-interface {p0, p2, p3, v1}, Lbcv;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;

    move-result-object p0

    invoke-static {p1, p0}, Lbhy;->h(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V

    invoke-static {p1, p0, v0}, Lbhy;->g(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
...
.method public static e(Lbcv;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1}, Lbhy;->j(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap$Config;
    ...
    invoke-interface {p0, v2, v4, p3}, Lbcv;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    invoke-interface {p0, p2, p2, v2}, Lbcv;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v4}, Lbhy;->k(Landroid/graphics/Canvas;)V
    :try_end_0
    ...
    invoke-interface {p0, p3}, Lbcv;->d(Landroid/graphics/Bitmap;)V
...
.method public static f(Lbcv;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    invoke-interface {p0, p3, v0, v1}, Lbcv;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, p0, p3}, Lbhy;->g(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
...
.method public static g(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
    ...
    sget-object p1, Lbhy;->b:Landroid/graphics/Paint;
