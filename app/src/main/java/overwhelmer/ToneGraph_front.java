...
public class ToneGraph_front extends GraphView {
    public static double[] _ToneGraph;
    public static ToneGraph_front sToneGraph;

    public ToneGraph_front(Context context) {
        super(context);
        sToneGraph = this;
        drawTone();
    }

    public ToneGraph_front(Context context, AttributeSet attributeSet) {
    ...
    public static void ArrayLogPointDouble(Point[] pointArr, String str) {
        ...
        sb.append("");
        sb.append(getToneCurve.tonePresetName_front);
        sb.append("\n");
        sb.append("\n");
    ...
    public static void drawTone() {
        /*
            ...
            com.SDE.getToneCurve.tonePresetName_front = r0
            r0 = 1
            double[] r0 = com.SDE.getToneCurve.getToneCurve(r0)
            overwhelmer.ToneGraph_front._ToneGraph = r0
            r17 = 17
            r0 = r17
        ...
        L3c:
            ...
            overwhelmer.ToneGraph_front r3 = overwhelmer.ToneGraph_front.sToneGraph
            ...
            r12.setGraph(r2)
            java.lang.String r13 = "addlogsdir/_ToneGraphPoint_front.log"
            com.softmoore.android.graphlib.Point[] r0 = (com.softmoore.android.graphlib.Point[]) r0
            ArrayLogPointDouble(r0, r13)
            return
        L7c:
            com.softmoore.android.graphlib.Point r3 = new com.softmoore.android.graphlib.Point
            double[] r4 = overwhelmer.ToneGraph_front._ToneGraph
            int r5 = r13 + 0
            r4 = r4[r5]
            r3.<init>(r14, r4)
            r18[r13] = r3
            goto L2a
        */
        throw new UnsupportedOperationException("Method not decompiled: overwhelmer.ToneGraph_front.drawTone():void");
    }
