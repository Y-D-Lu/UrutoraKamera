...
public class GammaGraph_front extends GraphView {
    ...
    public static void drawGamma() {
        /*
            ...
            com.SDE.getGammaCurve.gammaPresetName_front = r0
            r0 = 1
            double[] r0 = com.SDE.getGammaCurve.getGammaCurve(r0)
            overwhelmer.GammaGraph_front._GammaGraph = r0
            r17 = 33
            r0 = r17
        ...
        L3c:
            ...
            overwhelmer.GammaGraph_front r3 = overwhelmer.GammaGraph_front.sGammaGraph
            ...
            r12.setGraph(r2)
            java.lang.String r13 = "addlogsdir/_GammaGraphPoint_front.log"
            com.softmoore.android.graphlib.Point[] r0 = (com.softmoore.android.graphlib.Point[]) r0
            ArrayLogPointDouble(r0, r13)
            return
        L7c:
            com.softmoore.android.graphlib.Point r3 = new com.softmoore.android.graphlib.Point
            double[] r4 = overwhelmer.GammaGraph_front._GammaGraph
            int r5 = r13 + 0
            r4 = r4[r5]
            r3.<init>(r14, r4)
            r18[r13] = r3
            goto L2a
        */
        throw new UnsupportedOperationException("Method not decompiled: overwhelmer.GammaGraph_front.drawGamma():void");
    }
