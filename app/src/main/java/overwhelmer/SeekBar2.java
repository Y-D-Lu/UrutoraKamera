...
public class SeekBar2 extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    public SeekBar2(Context context, AttributeSet attributeSet, int i) {
    ...
    public void setInf(int i) {
        this.mTextView.setText("" + prog2men(i));
    }
