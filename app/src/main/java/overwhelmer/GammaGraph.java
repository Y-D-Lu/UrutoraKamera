...
public class GammaGraph extends GraphView {
    public static double[] _GammaGraph;
    public static GammaGraph sGammaGraph;

    public GammaGraph(Context context) {
        super(context);
        sGammaGraph = this;
        drawGamma();
    }

    public GammaGraph(Context context, AttributeSet attributeSet) {
    ...
    public static void ArrayLogPointDouble(Point[] pointArr, String str) {
        ...
        sb.append("");
        sb.append(getGammaCurve.gammaPresetName);
        sb.append("\n");
        sb.append("\n");
    ...
    public static void drawGamma() {
        /*
            ...
            com.SDE.getGammaCurve.gammaPresetName = r0
            r0 = 0
            double[] r0 = com.SDE.getGammaCurve.getGammaCurve(r0)
            overwhelmer.GammaGraph._GammaGraph = r0
            r17 = 33
            r0 = r17
        ...
        L3c:
            ...
            overwhelmer.GammaGraph r3 = overwhelmer.GammaGraph.sGammaGraph
        ...
        L7c:
            ...
            goto L2a
        */
        throw new UnsupportedOperationException("Method not decompiled: overwhelmer.GammaGraph.drawGamma():void");
    }
