...
public final class ScriptIntrinsicBLAS extends ScriptIntrinsic {
    ...
    public void CGBMV(int i, int i2, int i3, Float2 float2, Allocation allocation, Allocation allocation2, int i4, Float2 float22, Allocation allocation3, int i5) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 64, i, 0, 0, 0, 0, y, x, 0, float2.x, float2.y, j, j2, float22.x, float22.y, j3, i4, i5, i2, i3, isIncSupp);
    }
    ...
    public void CGEMM(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, Float2 float22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 125, i, i2, 0, 0, 0, y, y2, x, float2.x, float2.y, j, j2, float22.x, float22.y, j3, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CGEMV(int i, Float2 float2, Allocation allocation, Allocation allocation2, int i2, Float2 float22, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 63, i, 0, 0, 0, 0, y, x, 0, float2.x, float2.y, j, j2, float22.x, float22.y, j3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void CGERC(Float2 float2, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 99, 0, 0, 0, 0, 0, y, x, 0, float2.x, float2.y, j2, j3, DisplayHelper.DENSITY, DisplayHelper.DENSITY, j, i, i2, 0, 0, isIncSupp);
    }
    ...
    public void CGERU(Float2 float2, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 98, 0, 0, 0, 0, 0, y, x, 0, float2.x, float2.y, j2, j3, DisplayHelper.DENSITY, DisplayHelper.DENSITY, j, i, i2, 0, 0, isIncSupp);
    }
    ...
    public void CHBMV(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, int i3, Float2 float22, Allocation allocation3, int i4) {
        ...
        if (i2 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 96, 0, 0, 0, i, 0, 0, validateSYR2, i2, float2.x, float2.y, j, j2, float22.x, float22.y, j3, i3, i4, 0, 0, isIncSupp);
            return;
        }
    ...
    public void CHEMV(int i, Float2 float2, Allocation allocation, Allocation allocation2, int i2, Float2 float22, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 95, 0, 0, 0, i, 0, 0, validateSYR2, 0, float2.x, float2.y, j, j2, float22.x, float22.y, j3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void CHER(int i, float f, Allocation allocation, int i2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 100, 0, 0, 0, i, 0, 0, validateSYR, 0, f, DisplayHelper.DENSITY, j2, 0L, DisplayHelper.DENSITY, DisplayHelper.DENSITY, j, i2, 0, 0, 0, isIncSupp);
    }
    ...
    public void CHER2(int i, Float2 float2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 102, 0, 0, 0, i, 0, 0, validateSYR2, 0, float2.x, float2.y, j2, j3, DisplayHelper.DENSITY, DisplayHelper.DENSITY, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void CHER2K(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, float f, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), RsBlas_cher2k, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), x, float2.x, float2.y, allocation.getID(this.mRS), j, f, DisplayHelper.DENSITY, j2, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CHERK(int i, int i2, float f, Allocation allocation, float f2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), RsBlas_cherk, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), y, f, DisplayHelper.DENSITY, j, 0L, f2, DisplayHelper.DENSITY, j2, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CHPMV(int i, Float2 float2, Allocation allocation, Allocation allocation2, int i2, Float2 float22, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 97, 0, 0, 0, i, 0, 0, validateSPR2, 0, float2.x, float2.y, j, j2, float22.x, float22.y, j3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void CHPR(int i, float f, Allocation allocation, int i2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 101, 0, 0, 0, i, 0, 0, validateSPR, 0, f, DisplayHelper.DENSITY, j2, 0L, DisplayHelper.DENSITY, DisplayHelper.DENSITY, j, i2, 0, 0, 0, isIncSupp);
    }
    ...
    public void CHPR2(int i, Float2 float2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 103, 0, 0, 0, i, 0, 0, validateSPR2, 0, float2.x, float2.y, j2, j3, DisplayHelper.DENSITY, DisplayHelper.DENSITY, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void CSYMM(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, Float2 float22, Allocation allocation3) {
        ...
        if (allocation.getType().getX() == allocation.getType().getY()) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 126, 0, 0, i, i2, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, float2.x, float2.y, j, j2, float22.x, float22.y, j3, 0, 0, 0, 0, isIncSupp);
            return;
        }
    ...
    public void CSYRK(int i, int i2, Float2 float2, Allocation allocation, Float2 float22, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), RsBlas_csyrk, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), y, float2.x, float2.y, j, 0L, float22.x, float22.y, allocation2.getID(this.mRS), 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CTBMV(int i, int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        if (i4 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 66, i2, 0, 0, i, i3, 0, y, i4, DisplayHelper.DENSITY, DisplayHelper.DENSITY, j, j2, DisplayHelper.DENSITY, DisplayHelper.DENSITY, 0L, i5, 0, 0, 0, isIncSupp);
            return;
        }
    ...
    public void CTBSV(int i, int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        if (i4 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 69, i2, 0, 0, i, i3, 0, y, i4, DisplayHelper.DENSITY, DisplayHelper.DENSITY, j, j2, DisplayHelper.DENSITY, DisplayHelper.DENSITY, 0L, i5, 0, 0, 0, isIncSupp);
            return;
        }
    ...
    public void CTPMV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 67, i2, 0, 0, i, i3, 0, validateTPMV, 0, DisplayHelper.DENSITY, DisplayHelper.DENSITY, j, j2, DisplayHelper.DENSITY, DisplayHelper.DENSITY, 0L, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void CTPSV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 70, i2, 0, 0, i, i3, 0, validateTPMV, 0, DisplayHelper.DENSITY, DisplayHelper.DENSITY, j, j2, DisplayHelper.DENSITY, DisplayHelper.DENSITY, 0L, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void CTRMM(int i, int i2, int i3, int i4, Float2 float2, Allocation allocation, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), RsBlas_ctrmm, i3, 0, i, i2, i4, allocation2.getType().getY(), allocation2.getType().getX(), 0, float2.x, float2.y, j, j2, DisplayHelper.DENSITY, DisplayHelper.DENSITY, 0L, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CTRMV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 65, i2, 0, 0, i, i3, 0, y, 0, DisplayHelper.DENSITY, DisplayHelper.DENSITY, j, j2, DisplayHelper.DENSITY, DisplayHelper.DENSITY, 0L, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void CTRSM(int i, int i2, int i3, int i4, Float2 float2, Allocation allocation, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), RsBlas_ctrsm, i3, 0, i, i2, i4, allocation2.getType().getY(), allocation2.getType().getX(), 0, float2.x, float2.y, j, j2, DisplayHelper.DENSITY, DisplayHelper.DENSITY, 0L, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CTRSV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 68, i2, 0, 0, i, i3, 0, y, 0, DisplayHelper.DENSITY, DisplayHelper.DENSITY, j, j2, DisplayHelper.DENSITY, DisplayHelper.DENSITY, 0L, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void DGBMV(int i, int i2, int i3, double d, Allocation allocation, Allocation allocation2, int i4, double d2, Allocation allocation3, int i5) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 56, i, 0, 0, 0, 0, y, x, 0, d, j, j2, d2, j3, i4, i5, i2, i3, isIncSupp);
    }
    ...
    public void DGEMM(int i, int i2, double d, Allocation allocation, Allocation allocation2, double d2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 119, i, i2, 0, 0, 0, y, y2, x, d, j, j2, d2, j3, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DGEMV(int i, double d, Allocation allocation, Allocation allocation2, int i2, double d2, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 55, i, 0, 0, 0, 0, y, x, 0, d, j, j2, d2, j3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void DGER(double d, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 90, 0, 0, 0, 0, 0, y, x, 0, d, j2, j3, 0.0d, j, i, i2, 0, 0, isIncSupp);
    }
    ...
    public void DSBMV(int i, int i2, double d, Allocation allocation, Allocation allocation2, int i3, double d2, Allocation allocation3, int i4) {
        ...
        if (i2 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 88, 0, 0, 0, i, 0, 0, validateSYMV, i2, d, j, j2, d2, j3, i3, i4, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("K must be greater than or equal to 0");
    }
    ...
    public void DSPMV(int i, double d, Allocation allocation, Allocation allocation2, int i2, double d2, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 89, 0, 0, 0, i, 0, 0, validateSPMV, 0, d, j, j2, d2, j3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void DSPR2(int i, double d, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 94, 0, 0, 0, i, 0, 0, validateSPR2, 0, d, j2, j3, 0.0d, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void DSYMM(int i, int i2, double d, Allocation allocation, Allocation allocation2, double d2, Allocation allocation3) {
        ...
        if (allocation.getType().getX() == allocation.getType().getY()) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 120, 0, 0, i, i2, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, d, j, j2, d2, j3, 0, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("Matrix A is not symmetric");
    }
    ...
    public void DSYMV(int i, double d, Allocation allocation, Allocation allocation2, int i2, double d2, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 87, 0, 0, 0, i, 0, 0, validateSYMV, 0, d, j, j2, d2, j3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void DSYR2(int i, double d, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 93, 0, 0, 0, i, 0, 0, validateSYR2, 0, d, j2, j3, 0.0d, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void DSYRK(int i, int i2, double d, Allocation allocation, double d2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 121, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), y, d, j, 0L, d2, j2, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTBMV(int i, int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        if (i4 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 58, i2, 0, 0, i, i3, 0, y, i4, 0.0d, j, j2, 0.0d, 0L, i5, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("K must be greater than or equal to 0");
    }
    ...
    public void DTBSV(int i, int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        if (i4 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 61, i2, 0, 0, i, i3, 0, y, i4, 0.0d, j, j2, 0.0d, 0L, i5, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("Number of diagonals must be positive");
    }
    ...
    public void DTPMV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 59, i2, 0, 0, i, i3, 0, validateTPMV, 0, 0.0d, j, j2, 0.0d, 0L, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTPSV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 62, i2, 0, 0, i, i3, 0, validateTPMV, 0, 0.0d, j, j2, 0.0d, 0L, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTRMM(int i, int i2, int i3, int i4, double d, Allocation allocation, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 123, i3, 0, i, i2, i4, allocation2.getType().getY(), allocation2.getType().getX(), 0, d, j, j2, 0.0d, 0L, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTRMV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 57, i2, 0, 0, i, i3, 0, y, 0, 0.0d, j, j2, 0.0d, 0L, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTRSM(int i, int i2, int i3, int i4, double d, Allocation allocation, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 124, i3, 0, i, i2, i4, allocation2.getType().getY(), allocation2.getType().getX(), 0, d, j, j2, 0.0d, 0L, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTRSV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 60, i2, 0, 0, i, i3, 0, y, 0, 0.0d, j, j2, 0.0d, 0L, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void SGBMV(int i, int i2, int i3, float f, Allocation allocation, Allocation allocation2, int i4, float f2, Allocation allocation3, int i5) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 48, i, 0, 0, 0, 0, y, x, 0, f, j, j2, f2, j3, i4, i5, i2, i3, isIncSupp);
    }
    ...
    public void SGEMM(int i, int i2, float f, Allocation allocation, Allocation allocation2, float f2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 113, i, i2, 0, 0, 0, y, y2, x, f, j3, j, f2, j2, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void SGEMV(int i, float f, Allocation allocation, Allocation allocation2, int i2, float f2, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 47, i, 0, 0, 0, 0, y, x, 0, f, j, j2, f2, j3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void SGER(float f, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 82, 0, 0, 0, 0, 0, y, x, 0, f, j2, j3, DisplayHelper.DENSITY, j, i, i2, 0, 0, isIncSupp);
    }
    ...
    public void SSBMV(int i, int i2, float f, Allocation allocation, Allocation allocation2, int i3, float f2, Allocation allocation3, int i4) {
        ...
        if (i2 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 80, 0, 0, 0, i, 0, 0, validateSYMV, i2, f, j, j2, f2, j3, i3, i4, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("K must be greater than or equal to 0");
    }
    ...
    public void SSPMV(int i, float f, Allocation allocation, Allocation allocation2, int i2, float f2, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 81, 0, 0, 0, i, 0, 0, validateSPMV, 0, f, j, j2, f2, j3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void SSPR(int i, float f, Allocation allocation, int i2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 84, 0, 0, 0, i, 0, 0, validateSPR, 0, f, j2, j, DisplayHelper.DENSITY, 0L, i2, 0, 0, 0, isIncSupp);
    }
    ...
    public void SSPR2(int i, float f, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 86, 0, 0, 0, i, 0, 0, validateSPR2, 0, f, j2, j3, DisplayHelper.DENSITY, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void SSYMM(int i, int i2, float f, Allocation allocation, Allocation allocation2, float f2, Allocation allocation3) {
        ...
        if (allocation.getType().getX() == allocation.getType().getY()) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 114, 0, 0, i, i2, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, f, j, j2, f2, j3, 0, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("Matrix A is not symmetric");
    }
    ...
    public void SSYMV(int i, float f, Allocation allocation, Allocation allocation2, int i2, float f2, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 79, 0, 0, 0, i, 0, 0, validateSYMV, 0, f, j, j2, f2, j3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void SSYR(int i, float f, Allocation allocation, int i2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 83, 0, 0, 0, i, 0, 0, validateSYR, 0, f, j2, j, DisplayHelper.DENSITY, 0L, i2, 0, 0, 0, isIncSupp);
    }
    ...
    public void SSYR2(int i, float f, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 85, 0, 0, 0, i, 0, 0, validateSYR2, 0, f, j2, j3, DisplayHelper.DENSITY, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void SSYRK(int i, int i2, float f, Allocation allocation, float f2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 115, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), y, f, j, 0L, f2, j2, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void STBMV(int i, int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        if (i4 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 50, i2, 0, 0, i, i3, 0, y, i4, DisplayHelper.DENSITY, j, j2, DisplayHelper.DENSITY, 0L, i5, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("K must be greater than or equal to 0");
    }
    ...
    public void STBSV(int i, int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        if (i4 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 53, i2, 0, 0, i, i3, 0, y, i4, DisplayHelper.DENSITY, j, j2, DisplayHelper.DENSITY, 0L, i5, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("Number of diagonals must be positive");
    }
    ...
    public void STPMV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 51, i2, 0, 0, i, i3, 0, validateTPMV, 0, DisplayHelper.DENSITY, j, j2, DisplayHelper.DENSITY, 0L, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void STPSV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 54, i2, 0, 0, i, i3, 0, validateTPMV, 0, DisplayHelper.DENSITY, j, j2, DisplayHelper.DENSITY, 0L, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void STRMM(int i, int i2, int i3, int i4, float f, Allocation allocation, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 117, i3, 0, i, i2, i4, allocation2.getType().getY(), allocation2.getType().getX(), 0, f, j, j2, DisplayHelper.DENSITY, 0L, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void STRMV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 49, i2, 0, 0, i, i3, 0, y, 0, DisplayHelper.DENSITY, j, j2, DisplayHelper.DENSITY, 0L, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void STRSM(int i, int i2, int i3, int i4, float f, Allocation allocation, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 118, i3, 0, i, i2, i4, allocation2.getType().getY(), allocation2.getType().getX(), 0, f, j, j2, DisplayHelper.DENSITY, 0L, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void STRSV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 52, i2, 0, 0, i, i3, 0, y, 0, DisplayHelper.DENSITY, j, j2, DisplayHelper.DENSITY, 0L, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZGBMV(int i, int i2, int i3, Double2 double2, Allocation allocation, Allocation allocation2, int i4, Double2 double22, Allocation allocation3, int i5) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 72, i, 0, 0, 0, 0, y, x, 0, double2.x, double2.y, j, j2, double22.x, double22.y, j3, i4, i5, i2, i3, isIncSupp);
    }
    ...
    public void ZGEMM(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, Double2 double22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 131, i, i2, 0, 0, 0, y, y2, x, double2.x, double2.y, j, j2, double22.x, double22.y, j3, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZGEMV(int i, Double2 double2, Allocation allocation, Allocation allocation2, int i2, Double2 double22, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 71, i, 0, 0, 0, 0, y, x, 0, double2.x, double2.y, j, j2, double22.x, double22.y, j3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZGERC(Double2 double2, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 108, 0, 0, 0, 0, 0, y, x, 0, double2.x, double2.y, j2, j3, 0.0d, 0.0d, j, i, i2, 0, 0, isIncSupp);
    }
    ...
    public void ZGERU(Double2 double2, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 107, 0, 0, 0, 0, 0, y, x, 0, double2.x, double2.y, j2, j3, 0.0d, 0.0d, j, i, i2, 0, 0, isIncSupp);
    }
    ...
    public void ZHBMV(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, int i3, Double2 double22, Allocation allocation3, int i4) {
        ...
        if (i2 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 105, 0, 0, 0, i, 0, 0, validateSYR2, i2, double2.x, double2.y, j, j2, double22.x, double22.y, j3, i3, i4, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("K must be 0 or greater for HBMV");
    }
    ...
    public void ZHEMV(int i, Double2 double2, Allocation allocation, Allocation allocation2, int i2, Double2 double22, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 104, 0, 0, 0, i, 0, 0, validateSYR2, 0, double2.x, double2.y, j, j2, double22.x, double22.y, j3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZHER2(int i, Double2 double2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 111, 0, 0, 0, i, 0, 0, validateSYR2, 0, double2.x, double2.y, j2, j3, 0.0d, 0.0d, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZHPMV(int i, Double2 double2, Allocation allocation, Allocation allocation2, int i2, Double2 double22, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 106, 0, 0, 0, i, 0, 0, validateSPR2, 0, double2.x, double2.y, j, j2, double22.x, double22.y, j3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZHPR2(int i, Double2 double2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 112, 0, 0, 0, i, 0, 0, validateSPR2, 0, double2.x, double2.y, j2, j3, 0.0d, 0.0d, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZSYMM(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, Double2 double22, Allocation allocation3) {
        ...
        if (allocation.getType().getX() == allocation.getType().getY()) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 132, 0, 0, i, i2, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, double2.x, double2.y, j, j2, double22.x, double22.y, j3, 0, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("Matrix A is not symmetric");
    }
    ...
    public void ZSYRK(int i, int i2, Double2 double2, Allocation allocation, Double2 double22, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), RsBlas_zsyrk, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), y, double2.x, double2.y, j, 0L, double22.x, double22.y, allocation2.getID(this.mRS), 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTBMV(int i, int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        if (i4 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 74, i2, 0, 0, i, i3, 0, y, i4, 0.0d, 0.0d, j, j2, 0.0d, 0.0d, 0L, i5, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("K must be greater than or equal to 0");
    }
    ...
    public void ZTBSV(int i, int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        if (i4 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 77, i2, 0, 0, i, i3, 0, y, i4, 0.0d, 0.0d, j, j2, 0.0d, 0.0d, 0L, i5, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("Number of diagonals must be positive");
    }
    ...
    public void ZTPMV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 75, i2, 0, 0, i, i3, 0, validateTPMV, 0, 0.0d, 0.0d, j, j2, 0.0d, 0.0d, 0L, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTPSV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 78, i2, 0, 0, i, i3, 0, validateTPMV, 0, 0.0d, 0.0d, j, j2, 0.0d, 0.0d, 0L, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTRMM(int i, int i2, int i3, int i4, Double2 double2, Allocation allocation, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), RsBlas_ztrmm, i3, 0, i, i2, i4, allocation2.getType().getY(), allocation2.getType().getX(), 0, double2.x, double2.y, j, j2, 0.0d, 0.0d, 0L, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTRMV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 73, i2, 0, 0, i, i3, 0, y, 0, 0.0d, 0.0d, j, j2, 0.0d, 0.0d, 0L, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTRSM(int i, int i2, int i3, int i4, Double2 double2, Allocation allocation, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), RsBlas_ztrsm, i3, 0, i, i2, i4, allocation2.getType().getY(), allocation2.getType().getX(), 0, double2.x, double2.y, j, j2, 0.0d, 0.0d, 0L, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTRSV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 76, i2, 0, 0, i, i3, 0, y, 0, 0.0d, 0.0d, j, j2, 0.0d, 0.0d, 0L, i4, 0, 0, 0, isIncSupp);
    }
}
