...
public class ScriptIntrinsicColorMatrix extends ScriptIntrinsic {
    ...
    public ScriptIntrinsicColorMatrix(long j, RenderScript renderScript) {
    ...
    public void setYUVtoRGB() {
        ...
        this.mMatrix.set(1, 0, DisplayHelper.DENSITY);
        ...
        this.mMatrix.set(2, 2, DisplayHelper.DENSITY);
        setMatrix();
    }
}
