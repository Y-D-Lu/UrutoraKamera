...
public class Element extends BaseObj {
    ...
    public Element(long j, RenderScript renderScript, DataType dataType, DataKind dataKind, boolean z, int i) {
        super(j, renderScript);
    ...
    public Element(long j, RenderScript renderScript, Element[] elementArr, String[] strArr, int[] iArr) {
        super(j, renderScript);
        int i = 0;
        this.mSize = 0;
        this.mVectorSize = 1;
    ...
    public static Element createVector(RenderScript renderScript, DataType dataType, int i) {
        ...
        switch (dataType.ordinal()) {
            ...
            case 10:
            case 11:
                DataKind dataKind2 = DataKind.USER;
                return new Element(renderScript.nElementCreate(dataType.mID, dataKind2.mID, false, i), renderScript, dataType, dataKind2, false, i);
            default:
        ...
        if (this.mElements != null) {
            ...
            while (true) {
                ...
                if (i >= elementArr.length) {
                    break;
                } else if (elementArr[i].mElements != null) {
                    return true;
                } else {
                    i++;
                }
