...
public final class bvk implements btv {
    ...
    public bvk(final bts btsVar, MainActivityLayout mainActivityLayout, jns jnsVar, jnr jnrVar, jcf jcfVar, jng jngVar, bqg bqgVar, DisplayManager displayManager, WindowManager windowManager, ivj ivjVar, ixx ixxVar, final buc bucVar, BottomBarController bottomBarController, jlb jlbVar, epj epjVar, fjs fjsVar, CameraActivityTiming cameraActivityTiming, qkg qkgVar, jfn jfnVar, jak jakVar, gtg gtgVar, jjp jjpVar, pih pihVar, dju djuVar, ddf ddfVar, hoj hojVar, boolean z) {
        ...
        this.G = hojVar;
        this.H = ddfVar;
        this.e = (ViewfinderCover) jnrVar.c.c(Rb.id.viewfinder_cover);
        this.x = fjsVar;
        ...
        this.h = (ShutterButton) jnsVar.k.c(Rb.id.shutter_button);
        jus a2 = jus.a(constraintLayout);
        this.g = (FrameLayout) a2.c(Rb.id.module_layout);
        this.m = (PreviewOverlay) a2.c(Rb.id.preview_overlay);
        this.I = (CaptureAnimationOverlay) a2.c(Rb.id.capture_animation_overlay);
        ViewStub viewStub = (ViewStub) a2.c(Rb.id.face_view_ui_stub);
        this.B = new enl(null);
        djuVar.b((DebugCanvasView) a2.c(Rb.id.debug_viz_view));
        jim jimVar = new jim(new jir((ConstraintLayout) mainActivityLayout.findViewById(Rb.id.activity_root_view), jcfVar, windowManager, this));
        this.M = jimVar;
        this.q = jimVar;
