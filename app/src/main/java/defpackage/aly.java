...
final class aly implements TimeInterpolator {
    ...
    public final float getInterpolation(float f) {
        ...
        float[] fArr = b;
        return fArr[min] + (((f - (min * 0.01f)) / 0.01f) * (fArr[min + 1] - fArr[min]));
    }
}
