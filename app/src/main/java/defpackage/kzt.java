...
public final class kzt {
    ...
    public static kzt a(Context context) {
        mip.dk(context);
    ...
    static final boolean c(PackageInfo packageInfo, boolean z) {
        if (packageInfo.signatures.length != 1) {
            Log.w("WearSignatureVerifier", "Package has more than one signature.");
            return false;
        }
        packageInfo.signatures[0].toByteArray();
        return z ? e(packageInfo, a, b) : e(packageInfo, a);
    }
    ...
    private static final boolean e(PackageInfo packageInfo, byte[]... bArr) {
    ...
    public final boolean b() {
        ...
        try {
            packageInfo = koe.b(this.d).g("com.google.android.wearable.app.cn", 64);
