...
/* renamed from: save  reason: default package */
/* loaded from: classes3.dex */
public final class save extends Activity {
    ...
    private static void config(Context context, AssetManager assetManager, String str) throws Exception {
        if (context.getSharedPreferences("settings", 0).getBoolean("notfirst", false)) {
            return;
        }
        context.getSharedPreferences("settings", 0).edit().putBoolean("notfirst", true).commit();
