...
public final class epw extends iux implements esi {
    ...
    public final void d(esn esnVar, int i) {
        ...
        View e = e();
        ViewPager2 f = f(e, (List) arrayList.stream().map(cgw.k).collect(Collectors.toList()), ((orr) ((epv) arrayList.get(0)).c.c).c, new eps(this, animatedVectorDrawable2, animatedVectorDrawable), new epq(arrayList, 0));
