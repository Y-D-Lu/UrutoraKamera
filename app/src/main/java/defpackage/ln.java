...
public final class ln extends kk implements Menu {
    private final er c;

    public ln(Context context, er erVar) {
        super(context);
        this.c = erVar;
    }
    ...
    public final MenuItem add(int i, int i2, int i3, CharSequence charSequence) {
        return a(((kw) this.c).c(i, i2, i3, charSequence));
    }
    ...
    public final void removeItem(int i) {
        if (this.b != null) {
            ...
            while (true) {
                ...
                if (i2 >= xfVar.j) {
                    break;
                } else if (((es) xfVar.f(i2)).getItemId() == i) {
                    this.b.g(i2);
                    break;
                } else {
                    i2++;
