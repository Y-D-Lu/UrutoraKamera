...
public final class cvr implements cwk {
    ...
    private final Runnable e(final int i, final int i2) {
        return new Runnable() { // from class: cvq
            ...
            public final void run() {
                ...
                StringBuilder sb = new StringBuilder(length + Rb.styleable.AppCompatTheme_textAppearanceListItemSmall + s.length());
    ...
    public final ie a(int i) {
        ...
        nyjVar.u(c);
        nyjVar.k(false);
        nyjVar.n(R.string.camera_fallback_close_app, new cvp(this, i, 1));
        nyjVar.q(R.string.contact_us, new cvp(this, i, 0));
        return nyjVar.b();
    }
    ...
    public final ie b(int i) {
        nyj nyjVar = new nyj(this.a, this.g);
        nyjVar.t(this.a.getResources().getString(R.string.camera_issue_title));
        nyjVar.u(akf.d(R.string.camera_issue_restart_message, this.a, e(5, i)));
        nyjVar.k(false);
        nyjVar.n(R.string.camera_fallback_close_app, new cvp(this, i, 2));
        return nyjVar.b();
    }
    ...
    public final ie c(int i) {
        nyj nyjVar = new nyj(this.a, this.g);
        nyjVar.t(this.a.getResources().getString(R.string.camera_issue_title));
        nyjVar.u(akf.d(R.string.camera_issue_reboot_message, this.a, e(3, i)));
        nyjVar.k(false);
        nyjVar.n(R.string.camera_fallback_close_app, new cvp(this, i, 3));
        return nyjVar.b();
    }
    ...
    public final void d(int i, int i2) {
        ...
        String s = oxh.s(i);
        int length = String.valueOf(a).length();
        StringBuilder sb = new StringBuilder(length + Rb.styleable.AppCompatTheme_textAppearanceListItemSecondary + s.length());
        sb.append("Hardware help dialog for unavailability of any cameras due to reason: ");
        sb.append(a);
        sb.append(" at stage ");
        sb.append(s);
