...
abstract class StreamSpliterators$AbstractWrappingSpliterator implements Spliterator {
    ...
    public final void init() {
        if (this.spliterator == null) {
            this.spliterator = (Spliterator) this.spliteratorSupplier.mo291get();
            this.spliteratorSupplier = null;
        }
    }
    ...
    public Spliterator mo314trySplit() {
        ...
        init();
        Spliterator mo314trySplit = this.spliterator.mo314trySplit();
        if (mo314trySplit != null) {
            return mo319wrap(mo314trySplit);
        }
        return null;
    }

    /* renamed from: wrap */
    abstract StreamSpliterators$AbstractWrappingSpliterator mo319wrap(Spliterator spliterator);
}
