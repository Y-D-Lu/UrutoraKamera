...
public final class MinguoDate extends ChronoLocalDateImpl {
    ...
    public static MinguoDate readExternal(DataInput dataInput) {
        return MinguoChronology.INSTANCE.mo152date(dataInput.readInt(), (int) dataInput.readByte(), (int) dataInput.readByte());
    }
    ...
    public MinguoDate mo156minus(long j, TemporalUnit temporalUnit) {
        return (MinguoDate) super.mo156minus(j, temporalUnit);
    }

    @Override // j$.time.chrono.ChronoLocalDateImpl, j$.time.chrono.ChronoLocalDate, j$.time.temporal.Temporal
    /* renamed from: plus  reason: collision with other method in class */
    public MinguoDate mo157plus(long j, TemporalUnit temporalUnit) {
        return (MinguoDate) super.mo157plus(j, temporalUnit);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // j$.time.chrono.ChronoLocalDateImpl
    /* renamed from: plusDays  reason: collision with other method in class */
    public MinguoDate mo158plusDays(long j) {
    ...
    public MinguoDate mo159plusMonths(long j) {
    ...
    public MinguoDate mo160plusYears(long j) {
    ...
    /* renamed from: with */
    public MinguoDate mo162with(TemporalAdjuster temporalAdjuster) {
        return (MinguoDate) super.mo162with(temporalAdjuster);
    }
    ...
    */
    public j$.time.chrono.MinguoDate mo161with(j$.time.temporal.TemporalField r8, long r9) {
        /*
            r7 = this;
        ...
        L10:
            ...
            goto L53
        L25:
            j$.time.chrono.MinguoChronology r8 = r7.mo154getChronology()
            j$.time.temporal.ValueRange r8 = r8.range(r0)
            r8.checkValidValue(r9, r0)
            long r0 = r7.getProlepticMonth()
            long r9 = r9 - r0
            j$.time.chrono.MinguoDate r8 = r7.mo159plusMonths(r9)
            return r8
        L3a:
            j$.time.chrono.MinguoChronology r2 = r7.mo154getChronology()
        ...
        L94:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: j$.time.chrono.MinguoDate.mo161with(j$.time.temporal.TemporalField, long):j$.time.chrono.MinguoDate");
    }
