...
public final class LocalDate implements Temporal, TemporalAdjuster, ChronoLocalDate, Serializable {
    ...
    /* renamed from: atTime */
    public LocalDateTime mo63atTime(LocalTime localTime) {
    ...
    public IsoChronology mo154getChronology() {
    ...
    public boolean isAfter(ChronoLocalDate chronoLocalDate) {
        return chronoLocalDate instanceof LocalDate ? compareTo0((LocalDate) chronoLocalDate) > 0 : ChronoLocalDate.CC.$default$isAfter(this, chronoLocalDate);
    }
    ...
    /* renamed from: minus */
    public LocalDate mo156minus(long j, TemporalUnit temporalUnit) {
    ...
    @Override // j$.time.temporal.Temporal
    /* renamed from: plus */
    public LocalDate mo157plus(long j, TemporalUnit temporalUnit) {
        long m;
        long m2;
        long m3;
    ...
    @Override // j$.time.temporal.Temporal
    /* renamed from: with */
    public LocalDate mo162with(TemporalAdjuster temporalAdjuster) {
        return temporalAdjuster instanceof LocalDate ? (LocalDate) temporalAdjuster : (LocalDate) temporalAdjuster.adjustInto(this);
    }

    @Override // j$.time.temporal.Temporal
    /* renamed from: with */
    public LocalDate mo161with(TemporalField temporalField, long j) {
        if (temporalField instanceof ChronoField) {
            ChronoField chronoField = (ChronoField) temporalField;
