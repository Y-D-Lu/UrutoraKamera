...
public final class LocalTime implements Temporal, TemporalAdjuster, Comparable, Serializable {
    ...
    public Temporal adjustInto(Temporal temporal) {
        return temporal.mo161with(ChronoField.NANO_OF_DAY, toNanoOfDay());
    }
    ...
    /* renamed from: minus */
    public LocalTime mo156minus(long j, TemporalUnit temporalUnit) {
        return j == Long.MIN_VALUE ? mo157plus(Long.MAX_VALUE, temporalUnit).mo157plus(1L, temporalUnit) : mo157plus(-j, temporalUnit);
    }

    @Override // j$.time.temporal.Temporal
    /* renamed from: plus */
    public LocalTime mo157plus(long j, TemporalUnit temporalUnit) {
    ...
    public Object query(TemporalQuery temporalQuery) {
        ...
        return temporalQuery == TemporalQueries.precision() ? ChronoUnit.NANOS : temporalQuery.mo183queryFrom(this);
    }
    ...
    @Override // j$.time.temporal.Temporal
    /* renamed from: with */
    public LocalTime mo162with(TemporalAdjuster temporalAdjuster) {
        return temporalAdjuster instanceof LocalTime ? (LocalTime) temporalAdjuster : (LocalTime) temporalAdjuster.adjustInto(this);
    }

    @Override // j$.time.temporal.Temporal
    /* renamed from: with */
    public LocalTime mo161with(TemporalField temporalField, long j) {
