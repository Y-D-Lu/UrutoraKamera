...
public final class UTF_8 extends Unicode {
    ...
    class Decoder extends CharsetDecoder {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:49:0x00e0, code lost:
            if (isMalformed3_2(r1, r0[r5 + 1]) == false) goto L92;
         */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:73:0x014e, code lost:
            if (isMalformed4_2(r1, r0[r5 + 1] & 255) == false) goto L56;
         */
        /* JADX WARN: Code restructure failed: missing block: B:75:0x0151, code lost:
            if (r3 <= 2) goto L61;
         */
        /* JADX WARN: Code restructure failed: missing block: B:77:0x015b, code lost:
            if (isMalformed4_3(r0[r5 + 2]) == false) goto L61;
         */
        ...
        */
        ...
        private CoderResult decodeBufferLoop(ByteBuffer byteBuffer, CharBuffer charBuffer) {
            ...
            while (position < limit) {
                ...
                if (b >= 0) {
                    ...
                    if ((b >> 4) == -2) {
                        ...
                        if (i2 < 4 || charBuffer.remaining() < 2) {
                            int i3 = b & 255;
                            return (i3 > 244 || (i2 > 1 && isMalformed4_2(i3, byteBuffer.get() & 255))) ? malformedForLength(byteBuffer, position, 1) : (i2 <= 2 || !isMalformed4_3(byteBuffer.get())) ? xflow(byteBuffer, position, 4) : malformedForLength(byteBuffer, position, 2);
                        }
                ...
                } else if (limit - position < 2 || charBuffer.remaining() < 1) {
        ...
        private static CoderResult malformedN(ByteBuffer byteBuffer, int i) {
            ...
            if (i != 3) {
                ...
                return (i3 > 244 || (i3 == 240 && (i4 < 144 || i4 > 191)) || ((i3 == 244 && (i4 & 240) != 128) || isNotContinuation(i4))) ? CoderResult.malformedForLength(1) : isNotContinuation(byteBuffer.get()) ? CoderResult.malformedForLength(2) : CoderResult.malformedForLength(3);
            }
            byte b = byteBuffer.get();
            byte b2 = byteBuffer.get();
    ...
    final class Encoder extends CharsetEncoder {
            ...
            while (arrayOffset < arrayOffset2) {
                ...
                if (c >= 128) {
                    if (c < 2048) {
                        ...
                        } else if (arrayOffset4 - arrayOffset3 < 4) {
                            return overflow(charBuffer, arrayOffset, byteBuffer, arrayOffset3);
                        } else {
                    ...
                    } else if (arrayOffset4 - arrayOffset3 < 3) {
                        return overflow(charBuffer, arrayOffset, byteBuffer, arrayOffset3);
                    } else {
        ...
        private CoderResult encodeBufferLoop(CharBuffer charBuffer, ByteBuffer byteBuffer) {
            ...
            CharBuffer charBuffer3 = (CharBuffer) charBuffer.position(position);
            return CoderResult.UNDERFLOW;
        }

        private static CoderResult overflow(CharBuffer charBuffer, int i) {
            CharBuffer charBuffer2 = (CharBuffer) charBuffer.position(i);
