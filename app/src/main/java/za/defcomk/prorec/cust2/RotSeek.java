package za.defcomk.prorec.cust2;
...
public class RotSeek extends View {
    ...
    public void checkifCurrentValueHasChanged() {
        ...
        if (i != this.currentValue) {
            ...
            this.currentValue = i;
            simplified_lol.mIsoIndex = i;
            SeekBar.OnSeekBarChangeListener onSeekBarChangeListener = this.mListener;
            performHapticFeedback(4);
            if (onSeekBarChangeListener == null) {
                return;
            }
            this.handler.post(new Runnable() { // from class: za.defcomk.prorec.cust2.RotSeek.2
    ...
    public void handleAutoScroll() {
        this.handler.post(new Runnable() { // from class: za.defcomk.prorec.cust2.RotSeek.1
            @Override // java.lang.Runnable
            public void run() {
                boolean z;
    ...
    private int switchalpha(int r2) {
        ...
        L1a:
            ...
            goto L4
        */
        throw new UnsupportedOperationException("Method not decompiled: za.defcomk.prorec.cust2.RotSeek.switchalpha(int):int");
    }
    ...
    public void setProgress(int i, boolean z) {
        ...
        this.handler.post(new Runnable() { // from class: za.defcomk.prorec.cust2.RotSeek.3
            @Override // java.lang.Runnable
            public void run() {
                RotSeek.this.mListener.onProgressChanged(null, RotSeek.this.currentValue, true);
            }
