...
public final class LightCycleNative {
    static {
    ...
    public static native void Init(int i, int i2, float f, LightCycle$LightCycleProgressCallback lightCycle$LightCycleProgressCallback);
